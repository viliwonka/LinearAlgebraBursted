...
namespace BULA.Sparse
{
    ...
    public static partial class BSR
    {
        ...
        /// <see cref="floatBSR.MirrorToFull"/>. diagScale=1 is the plain (unscaled)
        ...
        public static void sweepLower(in floatBSR A, in floatBlockJacobi Jacobi, float diagScale, in floatN r, ref floatN y)
        {
            ...
            if (A.Symmetric)
                throw new ArgumentException("sweepLower: A must be full-storage BSR (Symmetric lower-block-triangle storage is not supported here -- mirror it first via floatBSR.MirrorToFull)");
        ...
        public static void sweepUpper(in floatBSR A, in floatBlockJacobi Jacobi, float diagScale, in floatN r, ref floatN y)
        {
            ...
            if (A.Symmetric)
                throw new ArgumentException("sweepUpper: A must be full-storage BSR (Symmetric lower-block-triangle storage is not supported here -- mirror it first via floatBSR.MirrorToFull)");
            if (Jacobi.BlockRows != A.BlockRows || Jacobi.BR != A.BR)
