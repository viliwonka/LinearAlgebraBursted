...
namespace LinearAlgebra.Gallery
{
    ...
    public static partial class floatGallery
    {
        ...
        public static floatBSR floatPenalizedGrid3D(this ref Arena arena, int nx, int ny, int nz, float EA, float penalty)
        {
            if (nx < 1 || ny < 1 || nz < 1)
            ...
            var builder = arena.floatBSRBuilder(nb, nb, 3, 3, nb + 3 * barCount);
