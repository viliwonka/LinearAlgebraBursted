...
namespace LinearAlgebra.Sparse
{
    ...
    public readonly struct doubleAdditiveSchwarz : IdoublePreconditioner
    {
        ...
        public unsafe void Apply(in doubleN r, ref doubleN z)
        {
            ...
            for (int i = 0; i < n; i++) z[i] = (double)0;
        ...
        static void CholSolveInPlace(doubleN factors, int fbase, int nn, doubleN b)
        {
            for (int r = 0; r < nn; r++)
            {
                double s = b[r];
    ...
    public readonly struct doubleRestrictedSchwarz : IdoublePreconditioner
    {
        ...
        static void LUSolveInPlace(doubleN factors, int fbase, int nn, doubleN b)
        {
            for (int r = 0; r < nn; r++)
            {
                double s = b[r];
