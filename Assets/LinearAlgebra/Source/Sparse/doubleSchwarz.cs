...
namespace LinearAlgebra.Sparse
{
    ...
    /// gather. Both <see cref="doubleAdditiveSchwarz"/> and <see cref="doubleRestrictedSchwarz"/>
    ...
    internal static class doubleSchwarzShared
    {
        ...
        internal static void GatherBlock(in doubleBSR A, int gr, int gc, ref doubleMxN M, int rowOff, int colOff, double diagShift, int BR)
        {
        ...
        internal static double DiagMax(in doubleBSR A)
        {
    ...
    /// </summary>
    public readonly struct doubleAdditiveSchwarz : IdoublePreconditioner
    {
        ...
        public readonly doubleN Factors;
        ...
        {
            int n = Rows;
            if (r.N != n) throw new ArgumentException("doubleAdditiveSchwarz.Apply: r.N must equal Rows");
            if (z.N != n) throw new ArgumentException("doubleAdditiveSchwarz.Apply: z.N must equal Rows");
            if (z.Data.Ptr == r.Data.Ptr) throw new ArgumentException("doubleAdditiveSchwarz.Apply: z must not alias r");
            if (z.Data.Ptr == Scratch.Data.Ptr) throw new ArgumentException("doubleAdditiveSchwarz.Apply: z must not alias Scratch");
            if (r.Data.Ptr == Scratch.Data.Ptr) throw new ArgumentException("doubleAdditiveSchwarz.Apply: r must not alias Scratch");

            doubleN buf = Scratch;
            double* zp = z.Data.Ptr;
            double* rp = r.Data.Ptr;
            double* bufp = buf.Data.Ptr;

            for (int i = 0; i < n; i++) zp[i] = (double)0;
        ...
        static unsafe void CholSolveInPlace(doubleN factors, int fbase, int nn, doubleN b)
        {
            double* f = factors.Data.Ptr;
    ...
    /// nonsymmetric sibling of <see cref="doubleAdditiveSchwarz"/>, mirroring the IC0/ILU0 split.
    ///
    ...
    /// </summary>
    public readonly struct doubleRestrictedSchwarz : IdoublePreconditioner
    {
        /// <summary>Prefix offsets into <see cref="SubBlocks"/> (CSR-of-subdomains), length K+1.</summary>
        public readonly Indices SubStart;
        /// <summary>Each subdomain's overlapped block ids, ascending; concatenated per SubStart.</summary>
        ...
        public readonly doubleN Scratch2;
        ...
        {
            int n = Rows;
            if (r.N != n) throw new ArgumentException("doubleRestrictedSchwarz.Apply: r.N must equal Rows");
            if (z.N != n) throw new ArgumentException("doubleRestrictedSchwarz.Apply: z.N must equal Rows");
            if (z.Data.Ptr == r.Data.Ptr) throw new ArgumentException("doubleRestrictedSchwarz.Apply: z must not alias r");
            if (z.Data.Ptr == Scratch.Data.Ptr || z.Data.Ptr == Scratch2.Data.Ptr) throw new ArgumentException("doubleRestrictedSchwarz.Apply: z must not alias Scratch");
            if (r.Data.Ptr == Scratch.Data.Ptr || r.Data.Ptr == Scratch2.Data.Ptr) throw new ArgumentException("doubleRestrictedSchwarz.Apply: r must not alias Scratch");

            doubleN gatherBuf = Scratch;
            doubleN solveBuf = Scratch2;
            double* rp = r.Data.Ptr;
            double* zp = z.Data.Ptr;
            double* gatherp = gatherBuf.Data.Ptr;
            double* solvep = solveBuf.Data.Ptr;
        ...
        static unsafe void LUSolveInPlace(doubleN factors, int fbase, int nn, doubleN b)
        {
            double* f = factors.Data.Ptr;
            double* bp = b.Data.Ptr;
            for (int r = 0; r < nn; r++)
