...
namespace LinearAlgebra.Sparse
{
    ...
    public partial struct doubleBSR : IDisposable
    {
        ...
        /// </summary>
        public doubleMxN ToDense(Allocator allocator = Allocator.Temp)
        {
            var dense = new doubleMxN(M_Rows, N_Cols, allocator); // zero-initialized
        ...
        /// <summary>
        /// Standalone twin of <see cref="Sparse.Arena.doubleBSRTranspose"/>: materializes Aᵀ (block
        ...
        /// </summary>
        public unsafe doubleBSR Transpose(Allocator allocator)
        {
            if (Symmetric)
                return this;

            var builder = new doubleBSRBuilder(BlockCols, BlockRows, BC, BR, allocator, Nnzb);
            ...
            for (int bi = 0; bi < BlockRows; bi++)
            {
                ...
                {
                    int bj = ColInd[k];
                    double* block = Values.Ptr + k * blockLen;
        ...
        /// <summary>
        /// Standalone twin of <see cref="Sparse.Arena.doubleBSRMirrorToFull"/>: mirrors a SYMMETRIC-
        ...
        /// one of them.
        /// </summary>
        public unsafe doubleBSR MirrorToFull(Allocator allocator)
        {
            if (!Symmetric)
                return this;

            var builder = new doubleBSRBuilder(BlockRows, BlockCols, BR, BC, allocator, Nnzb * 2);
