...
namespace LinearAlgebra.Sparse
{
    ...
    public partial struct floatBSR : IDisposable
    {
        ...
        /// </summary>
        public floatMxN ToDense(Allocator allocator = Allocator.Temp)
        {
            var dense = new floatMxN(M_Rows, N_Cols, allocator); // zero-initialized
        ...
        public unsafe floatBSR Transpose(Allocator allocator)
        {
            ...
            var builder = new floatBSRBuilder(BlockCols, BlockRows, BC, BR, allocator, Nnzb);
            ...
            for (int bi = 0; bi < BlockRows; bi++)
            {
                ...
                {
                    int bj = ColInd[k];
                    float* block = Values.Ptr + k * blockLen;
        ...
        public unsafe floatBSR MirrorToFull(Allocator allocator)
        {
            ...
            var builder = new floatBSRBuilder(BlockRows, BlockCols, BR, BC, allocator, Nnzb * 2);
