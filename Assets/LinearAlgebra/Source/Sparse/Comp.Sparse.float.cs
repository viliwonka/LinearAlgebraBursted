...
namespace LinearAlgebra
{
    ...
    public static partial class floatComp
    {
        ...
        /// </summary>
        public static void addScaledInPlace(this in floatBSR y, float a, in floatBSR x)
        {
