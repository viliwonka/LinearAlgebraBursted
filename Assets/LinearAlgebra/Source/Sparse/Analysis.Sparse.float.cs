...
namespace LinearAlgebra
{
    public static partial class Analysis
    {
        ...
        /// </summary>
        public static float trace(in floatBSR A)
        {
        ...
        /// requirement as <see cref="trace(in floatBSR)"/>; entries in absent diagonal blocks
        /// come out 0.
        /// </summary>
        public static void diagonal(in floatBSR A, ref floatN d)
        {
            if (A.BR != A.BC || A.BlockRows != A.BlockCols)
        ...
        /// </summary>
        public static void diagonal(in floatMxN A, ref floatN d)
        {
