// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/Sparse/Analysis.Sparse.fProxy.cs
...
namespace BULA
{
    public static partial class Analysis
    {
        ...
        /// </summary>
        public static double trace(in doubleBSR A)
        {
        ...
        /// requirement as <see cref="trace(in doubleBSR)"/>; entries in absent diagonal blocks
        /// come out 0.
        /// </summary>
        public static void diagonal(in doubleBSR A, ref doubleN d)
        {
            if (A.BR != A.BC || A.BlockRows != A.BlockCols)
        ...
        /// </summary>
        public static void diagonal(in doubleMxN A, ref doubleN d)
        {
