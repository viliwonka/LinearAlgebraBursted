...
namespace LinearAlgebra.Sparse
{
    ...
    public readonly partial struct doubleBlockJacobi : IdoublePreconditioner, IDisposable
    {
        ...
        {
            this = new doubleBlockJacobi(in A, allocator, out DirectSolveInfo info);
            if (!info.Solved)
        ...
        /// </summary>
        public unsafe doubleBlockJacobi(in doubleBSR A, Allocator allocator, out DirectSolveInfo info)
        {
            _rec = null;
            _inlineDInv = default;
        ...
        internal unsafe doubleBlockJacobi(in doubleBSR A, doubleBlockJacobiRecord* rec, Allocator allocator, out DirectSolveInfo info) : this(in A, allocator, out info)
        {
            if (!info.Solved)
                return;
            rec->DInv = _inlineDInv;
