...
namespace LinearAlgebra.Sparse
{
    ...
    public readonly struct floatSSOR : IfloatPreconditioner, IDisposable
    {
        ...
        public unsafe floatSSOR(in floatBSR a, float omega, Allocator allocator)
        {
            ...
            int blockLen = A.BR * A.BR;
            var scaledD = new floatN(A.BlockRows * blockLen, allocator);
            float c = ((float)2 - omega) / omega;
            ...
            Scratch1 = new floatN(A.M_Rows, allocator);
            Scratch2 = new floatN(A.M_Rows, allocator);
        }

        /// <summary>floatSSOR with omega=1 (symmetric Gauss-Seidel), allocated from <paramref name="allocator"/>.</summary>
        public unsafe floatSSOR(in floatBSR a, Allocator allocator) : this(in a, (float)1, allocator) { }
