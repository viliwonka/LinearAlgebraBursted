...
namespace LinearAlgebra.Sparse
{
    ...
    /// </summary>
    public readonly struct floatILU0 : IfloatPreconditioner, IDisposable
    {
        ...
        /// <summary>
        /// Standalone twin of <see cref="floatILU0(in floatBSR, ref Arena)"/>: allocates F from
        ...
        /// </summary>
        public unsafe floatILU0(in floatBSR a, Allocator allocator)
        {
            this = new floatILU0(in a, allocator, out PreconditionerInfo info);
            if (!info.Solved)
            {
                Dispose();
                throw new ArgumentException("floatILU0: factorization broke down at every diagonal shift — pivot blocks numerically singular");
        ...
        /// <summary>Standalone twin of <see cref="floatILU0(in floatBSR, ref Arena, out PreconditionerInfo)"/>.
        ...
        public unsafe floatILU0(in floatBSR a, Allocator allocator, out PreconditionerInfo info)
        {
            if (a.BlockRows != a.BlockCols || a.BR != a.BC)
                throw new ArgumentException("floatILU0: A must be square (BlockRows==BlockCols, BR==BC)");
            if (a.BR > 16)
            ...
            var Fm = new floatBSR(nb, nb, BR, BR, A.Nnzb, allocator, true);
            {
                var fRowPtr = Fm.RowPtr; var fColInd = Fm.ColInd;
                for (int i = 0; i <= nb; i++) fRowPtr[i] = A.RowPtr[i];
                for (int k = 0; k < A.Nnzb; k++) fColInd[k] = A.ColInd[k];
