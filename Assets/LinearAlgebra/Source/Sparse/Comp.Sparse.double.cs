// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/Sparse/Comp.Sparse.fProxy.cs
...
namespace LinearAlgebra
{
    ...
    public static partial class doubleComp
    {
        ...
        public static void mulInPlace(this in doubleBSR A, double s)
        {
        ...
        /// <summary>A = |A| over the stored entries (pattern-preserving).</summary>
        public static void absInPlace(this in doubleBSR A)
        {
        ...
        /// </summary>
        public static void addScaledInPlace(this in doubleBSR y, double a, in doubleBSR x)
        {
...
namespace LinearAlgebra.Sparse
{
    public static partial class BSR
    {
        ...
        /// </summary>
        public static bool samePattern(in doubleBSR A, in doubleBSR B)
        {
