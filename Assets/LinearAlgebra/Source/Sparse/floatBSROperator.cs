...
namespace LinearAlgebra.Sparse
{
    ...
    /// over a precomputed transpose AT (two-arg ctor -- see <see cref="floatBSR.Transpose(Unity.Collections.Allocator)"/>),
    ...
    public readonly struct floatBSROperator : IfloatLinearOperator
    {
        ...
        /// <summary>
        /// Optional precomputed transpose of A (see <see cref="floatBSR.Transpose(Unity.Collections.Allocator)"/>).
