...
namespace LinearAlgebra
{
    ...
    public partial struct floatN : IDisposable, IUnsafefloatArray {
        ...
        /// including views); false for default(floatN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<floatVecRecord>.IsAliveFast(_rec)) return false;
#endif
        ...
        {
            return _rec != null ? OwnerArena.floatVec(in this) : new floatN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.floatTempVec(in this) : new floatN(in this, Allocator.Temp);   // temp pool
        }
