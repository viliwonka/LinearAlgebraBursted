...
namespace LinearAlgebra
{
    ...
    public partial struct floatMxN : IDisposable, IUnsafefloatArray {
        ...
        /// including views); false for default(floatMxN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<floatMatRecord>.IsAliveFast(_rec) || ChunkedRecordTable<floatMatRecord>.GenerationFast(_rec) != _gen)
                    return false;
#endif
        ...
        {
            return _rec != null ? OwnerArena.floatMat(in this) : new floatMxN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.floatTempMat(in this) : new floatMxN(in this, Allocator.Temp);
        }
