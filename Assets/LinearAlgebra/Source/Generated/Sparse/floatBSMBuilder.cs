...
namespace LinearAlgebra.Sparse
{
    ...
    public partial struct floatBSMBuilder : IDisposable
    {
        ...
        /// </summary>
        public unsafe floatBSM ToBSM(ref Arena arena) => ToBSMCore(ref arena, symmetric: false);

        /// <summary>
        /// Same as ToBSM, but builds SYMMETRIC upper-block storage (see floatBSM.Symmetric / spec
        ...
        /// </summary>
        public unsafe floatBSM ToBSMSymmetric(ref Arena arena)
        {
        ...
        private unsafe floatBSM ToBSMCore(ref Arena arena, bool symmetric)
        {
            int n = TripletCount;
            int blockLen = BR * BC;
            ...
            var bsm = arena.floatBSM(BlockRows, BlockCols, BR, BC, nnzb, true, symmetric);
