...
namespace LinearAlgebra.Sparse
{
    ...
    ///
    /// MUTABLE-STATE INDIRECTION (fixes a use-after-free): the arena's floatBSRBuilder(...)
    ...
    /// floatBSRBuilder shares (the pointer VALUE is copied around; there is exactly one
    ...
    public partial struct floatBSRBuilder : IDisposable
    {
        ...
        private unsafe floatBSR ToBSRCore(ref Arena arena, bool symmetric)
        {
            ...
            // dual-mode PROPERTIES (floatBSR.cs, record-table migration), and a property's
        ...
        /// value returned by arena.floatBSRBuilder(...) themselves, same as floatMxN/
        /// floatBSR/etc).
        /// </summary>
