...
namespace LinearAlgebra.Sparse
{
    ...
    /// construction (<see cref="Arena.floatBSRMirrorToFull"/>) -- the sweeps need row-ordered
    ...
    /// ScaledD/scratch vectors below are all floatN/floatBSR/floatBlockJacobi) -- no record
