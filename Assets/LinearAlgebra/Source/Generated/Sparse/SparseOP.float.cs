...
{
    /// <summary>
    /// Sparse matvec kernels over floatBSR (block-CSR). The shape mirrors Linear_OP.dot's
    ...
    public static partial class Sparse_OP
    {
        ...
        /// (see <see cref="floatColScaledOperator{TInner}"/> / <c>Linear_OP.buildJacobiScale</c>).
        ///
