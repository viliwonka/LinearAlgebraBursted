...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP
    {
        ...
        // 2x double4 dense reductions made. This is a DIFFERENT split axis than the dense
        // reductions (those pack 4 contiguous elements into one SIMD register; a BSR row's stored
        // blocks are not contiguous in x/y, so there is nothing to reinterpret-load as double4 --
                                        ...
                                        [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                double acc0_0 = default, acc0_1 = default;
                double acc1_0 = default, acc1_1 = default;

                int k = rowStart;
                for (; k < kPairEnd; k += 2)
                {
                    int xBase0 = colInd[k] * 2;
                    double* block0 = values + k * 4;
                    double x00 = x[xBase0 + 0];
                    double x01 = x[xBase0 + 1];
                    acc0_0 += block0[0] * x00 + block0[1] * x01;
                    acc0_1 += block0[2] * x00 + block0[3] * x01;

                    int xBase1 = colInd[k + 1] * 2;
                    double* block1 = values + (k + 1) * 4;
                    double x10 = x[xBase1 + 0];
                    double x11 = x[xBase1 + 1];
                    acc1_0 += block1[0] * x10 + block1[1] * x11;
                    acc1_1 += block1[2] * x10 + block1[3] * x11;
                }

                double s0 = acc0_0 + acc1_0;
                double s1 = acc0_1 + acc1_1;
                if (k < rowEnd)
                {
                                        ...
                                        [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                double acc0_0 = default, acc0_1 = default, acc0_2 = default;
                double acc1_0 = default, acc1_1 = default, acc1_2 = default;

                int k = rowStart;
                for (; k < kPairEnd; k += 2)
                {
                    int xBase0 = colInd[k] * 3;
                    double* block0 = values + k * 9;
                    double x00 = x[xBase0 + 0];
                    double x01 = x[xBase0 + 1];
                    double x02 = x[xBase0 + 2];
                    ...
                    double* block1 = values + (k + 1) * 9;
                    double x10 = x[xBase1 + 0];
                    double x11 = x[xBase1 + 1];
                    double x12 = x[xBase1 + 2];
                                        ...
                                        [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                double acc0_0 = default, acc0_1 = default, acc0_2 = default, acc0_3 = default;
                double acc1_0 = default, acc1_1 = default, acc1_2 = default, acc1_3 = default;

                int k = rowStart;
                for (; k < kPairEnd; k += 2)
                {
                    int xBase0 = colInd[k] * 4;
                    double* block0 = values + k * 16;
                    double x00 = x[xBase0 + 0];
                    double x01 = x[xBase0 + 1];
                    double x02 = x[xBase0 + 2];
                    double x03 = x[xBase0 + 3];
                    ...
                    double* block1 = values + (k + 1) * 16;
                    double x10 = x[xBase1 + 0];
                    double x11 = x[xBase1 + 1];
                    double x12 = x[xBase1 + 2];
                    double x13 = x[xBase1 + 3];
                                        ...
                                        [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                double acc0_0 = default, acc0_1 = default, acc0_2 = default, acc0_3 = default, acc0_4 = default, acc0_5 = default;
                double acc1_0 = default, acc1_1 = default, acc1_2 = default, acc1_3 = default, acc1_4 = default, acc1_5 = default;

                int k = rowStart;
                for (; k < kPairEnd; k += 2)
                {
                    int xBase0 = colInd[k] * 6;
                    double* block0 = values + k * 36;
                    double x00 = x[xBase0 + 0];
                    double x01 = x[xBase0 + 1];
                    double x02 = x[xBase0 + 2];
                    double x03 = x[xBase0 + 3];
                    double x04 = x[xBase0 + 4];
                    double x05 = x[xBase0 + 5];
                    ...
                    double* block1 = values + (k + 1) * 36;
                    double x10 = x[xBase1 + 0];
                    double x11 = x[xBase1 + 1];
                    double x12 = x[xBase1 + 2];
                    double x13 = x[xBase1 + 3];
                    double x14 = x[xBase1 + 4];
                    double x15 = x[xBase1 + 5];
                ...
                double s2 = acc0_2 + acc1_2;
                double s3 = acc0_3 + acc1_3;
                double s4 = acc0_4 + acc1_4;
                double s5 = acc0_5 + acc1_5;
                if (k < rowEnd)
                {
                                         ...
                                         [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    double* block0 = values + k * 4;
                    double y00 = block0[0] * x0 + block0[2] * x1;
                    double y01 = block0[1] * x0 + block0[3] * x1;

                    double* block1 = values + (k + 1) * 4;
                    double y10 = block1[0] * x0 + block1[2] * x1;
                    double y11 = block1[1] * x0 + block1[3] * x1;
                                         ...
                                         [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    double* block0 = values + k * 9;
                    double y00 = block0[0] * x0 + block0[3] * x1 + block0[6] * x2;
                    double y01 = block0[1] * x0 + block0[4] * x1 + block0[7] * x2;
                    double y02 = block0[2] * x0 + block0[5] * x1 + block0[8] * x2;

                    double* block1 = values + (k + 1) * 9;
                    double y10 = block1[0] * x0 + block1[3] * x1 + block1[6] * x2;
                    double y11 = block1[1] * x0 + block1[4] * x1 + block1[7] * x2;
                    double y12 = block1[2] * x0 + block1[5] * x1 + block1[8] * x2;
                                         ...
                                         [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    double* block0 = values + k * 16;
                    double y00 = block0[0] * x0 + block0[4]  * x1 + block0[8]  * x2 + block0[12] * x3;
                    double y01 = block0[1] * x0 + block0[5]  * x1 + block0[9]  * x2 + block0[13] * x3;
                    double y02 = block0[2] * x0 + block0[6]  * x1 + block0[10] * x2 + block0[14] * x3;
                    double y03 = block0[3] * x0 + block0[7]  * x1 + block0[11] * x2 + block0[15] * x3;

                    double* block1 = values + (k + 1) * 16;
                    double y10 = block1[0] * x0 + block1[4]  * x1 + block1[8]  * x2 + block1[12] * x3;
                    double y11 = block1[1] * x0 + block1[5]  * x1 + block1[9]  * x2 + block1[13] * x3;
                    double y12 = block1[2] * x0 + block1[6]  * x1 + block1[10] * x2 + block1[14] * x3;
                    double y13 = block1[3] * x0 + block1[7]  * x1 + block1[11] * x2 + block1[15] * x3;
                                         ...
                                         [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    double* block0 = values + k * 36;
                    double y00 = block0[0] * x0 + block0[6]  * x1 + block0[12] * x2 + block0[18] * x3 + block0[24] * x4 + block0[30] * x5;
                    double y01 = block0[1] * x0 + block0[7]  * x1 + block0[13] * x2 + block0[19] * x3 + block0[25] * x4 + block0[31] * x5;
                    double y02 = block0[2] * x0 + block0[8]  * x1 + block0[14] * x2 + block0[20] * x3 + block0[26] * x4 + block0[32] * x5;
                    double y03 = block0[3] * x0 + block0[9]  * x1 + block0[15] * x2 + block0[21] * x3 + block0[27] * x4 + block0[33] * x5;
                    double y04 = block0[4] * x0 + block0[10] * x1 + block0[16] * x2 + block0[22] * x3 + block0[28] * x4 + block0[34] * x5;
                    double y05 = block0[5] * x0 + block0[11] * x1 + block0[17] * x2 + block0[23] * x3 + block0[29] * x4 + block0[35] * x5;

                    double* block1 = values + (k + 1) * 36;
                    double y10 = block1[0] * x0 + block1[6]  * x1 + block1[12] * x2 + block1[18] * x3 + block1[24] * x4 + block1[30] * x5;
                    double y11 = block1[1] * x0 + block1[7]  * x1 + block1[13] * x2 + block1[19] * x3 + block1[25] * x4 + block1[31] * x5;
                    double y12 = block1[2] * x0 + block1[8]  * x1 + block1[14] * x2 + block1[20] * x3 + block1[26] * x4 + block1[32] * x5;
                    double y13 = block1[3] * x0 + block1[9]  * x1 + block1[15] * x2 + block1[21] * x3 + block1[27] * x4 + block1[33] * x5;
                    double y14 = block1[4] * x0 + block1[10] * x1 + block1[16] * x2 + block1[22] * x3 + block1[28] * x4 + block1[34] * x5;
                    double y15 = block1[5] * x0 + block1[11] * x1 + block1[17] * x2 + block1[23] * x3 + block1[29] * x4 + block1[35] * x5;
                                           ...
                                           [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
                ...
                for (; k < kPairEnd; k += 2)
                {
                    ...
                    int xBaseJ0 = bj0 * 2;
                    double* block0 = values + k * 4;
                    double xj00 = x[xBaseJ0 + 0];
                    double xj01 = x[xBaseJ0 + 1];
                    ...
                    int xBaseJ1 = bj1 * 2;
                    double* block1 = values + (k + 1) * 4;
                    double xj10 = x[xBaseJ1 + 0];
                    double xj11 = x[xBaseJ1 + 1];
                                           ...
                                           [NoAlias] double* x, [NoAlias] double* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
                ...
                for (; k < kPairEnd; k += 2)
                {
                    ...
                    double xj02 = x[xBaseJ0 + 2];
                    double xj03 = x[xBaseJ0 + 3];
                    double xj04 = x[xBaseJ0 + 4];
                    double xj05 = x[xBaseJ0 + 5];
                    ...
                    double xj12 = x[xBaseJ1 + 2];
                    double xj13 = x[xBaseJ1 + 3];
                    double xj14 = x[xBaseJ1 + 4];
                    double xj15 = x[xBaseJ1 + 5];
