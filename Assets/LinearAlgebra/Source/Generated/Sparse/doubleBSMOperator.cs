...
namespace LinearAlgebra.Sparse
{
    ...
    /// over a precomputed transpose AT (two-arg ctor -- see <see cref="Arena.doubleBSMTranspose"/>),
    ...
    /// Readonly: a value copy of this struct only copies the doubleBSM/AT headers (a handful of
    ...
    public readonly struct doubleBSMOperator : IdoubleLinearOperator
    {
        ...
        /// <summary>
        /// Carries a precomputed transpose aT (typically <c>arena.doubleBSMTranspose(in a)</c>,
        /// built ONCE per solve). ApplyT then forwards to <see cref="Sparse_OP.spMV(in doubleBSM,
        ...
        /// </summary>
        public doubleBSMOperator(in doubleBSM a, in doubleBSM aT)
        {
            A = a;
            AT = aT;
            _hasT = true;
