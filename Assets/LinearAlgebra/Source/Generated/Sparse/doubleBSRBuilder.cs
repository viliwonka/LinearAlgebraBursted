...
namespace LinearAlgebra.Sparse
{
    ...
    public partial struct doubleBSRBuilder : IDisposable
    {
            ...
            for (int row = 0; row < BlockRows; row++)
            {
                ...
                for (int k = rs; k < re; k++)
                {
                    ...
                    for (int r = 0; r < BR; r++)
                        ...
                        {
                            double a = bsm.Values[off + r * BC + c];
        ...
        private unsafe doubleBSR ToBSRCore(ref Arena arena, bool symmetric)
        {
            ...
            // properties (doubleBSR.cs), and a local UnsafeList<T> copy is addressable and shares
        ...
        /// to dispose the value returned by arena.doubleBSRBuilder(...) themselves.
        /// </summary>
