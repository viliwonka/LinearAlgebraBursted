...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP
    {
        ...
        // 2x float4 dense reductions made. This is a DIFFERENT split axis than the dense
        // reductions (those pack 4 contiguous elements into one SIMD register; a BSR row's stored
        // blocks are not contiguous in x/y, so there is nothing to reinterpret-load as float4 --
                                         ...
                                         [NoAlias] float* x, [NoAlias] float* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    float* block0 = values + k * 4;
                    float y00 = block0[0] * x0 + block0[2] * x1;
                    float y01 = block0[1] * x0 + block0[3] * x1;

                    float* block1 = values + (k + 1) * 4;
                    float y10 = block1[0] * x0 + block1[2] * x1;
                    float y11 = block1[1] * x0 + block1[3] * x1;
                                         ...
                                         [NoAlias] float* x, [NoAlias] float* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    float* block0 = values + k * 9;
                    float y00 = block0[0] * x0 + block0[3] * x1 + block0[6] * x2;
                    float y01 = block0[1] * x0 + block0[4] * x1 + block0[7] * x2;
                    float y02 = block0[2] * x0 + block0[5] * x1 + block0[8] * x2;

                    float* block1 = values + (k + 1) * 9;
                    float y10 = block1[0] * x0 + block1[3] * x1 + block1[6] * x2;
                    float y11 = block1[1] * x0 + block1[4] * x1 + block1[7] * x2;
                    float y12 = block1[2] * x0 + block1[5] * x1 + block1[8] * x2;
                                         ...
                                         [NoAlias] float* x, [NoAlias] float* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    float* block0 = values + k * 16;
                    float y00 = block0[0] * x0 + block0[4]  * x1 + block0[8]  * x2 + block0[12] * x3;
                    float y01 = block0[1] * x0 + block0[5]  * x1 + block0[9]  * x2 + block0[13] * x3;
                    float y02 = block0[2] * x0 + block0[6]  * x1 + block0[10] * x2 + block0[14] * x3;
                    float y03 = block0[3] * x0 + block0[7]  * x1 + block0[11] * x2 + block0[15] * x3;

                    float* block1 = values + (k + 1) * 16;
                    float y10 = block1[0] * x0 + block1[4]  * x1 + block1[8]  * x2 + block1[12] * x3;
                    float y11 = block1[1] * x0 + block1[5]  * x1 + block1[9]  * x2 + block1[13] * x3;
                    float y12 = block1[2] * x0 + block1[6]  * x1 + block1[10] * x2 + block1[14] * x3;
                    float y13 = block1[3] * x0 + block1[7]  * x1 + block1[11] * x2 + block1[15] * x3;
                                         ...
                                         [NoAlias] float* x, [NoAlias] float* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
                ...
                {
                    float* block0 = values + k * 36;
                    float y00 = block0[0] * x0 + block0[6]  * x1 + block0[12] * x2 + block0[18] * x3 + block0[24] * x4 + block0[30] * x5;
                    float y01 = block0[1] * x0 + block0[7]  * x1 + block0[13] * x2 + block0[19] * x3 + block0[25] * x4 + block0[31] * x5;
                    float y02 = block0[2] * x0 + block0[8]  * x1 + block0[14] * x2 + block0[20] * x3 + block0[26] * x4 + block0[32] * x5;
                    float y03 = block0[3] * x0 + block0[9]  * x1 + block0[15] * x2 + block0[21] * x3 + block0[27] * x4 + block0[33] * x5;
                    float y04 = block0[4] * x0 + block0[10] * x1 + block0[16] * x2 + block0[22] * x3 + block0[28] * x4 + block0[34] * x5;
                    float y05 = block0[5] * x0 + block0[11] * x1 + block0[17] * x2 + block0[23] * x3 + block0[29] * x4 + block0[35] * x5;

                    float* block1 = values + (k + 1) * 36;
                    float y10 = block1[0] * x0 + block1[6]  * x1 + block1[12] * x2 + block1[18] * x3 + block1[24] * x4 + block1[30] * x5;
                    float y11 = block1[1] * x0 + block1[7]  * x1 + block1[13] * x2 + block1[19] * x3 + block1[25] * x4 + block1[31] * x5;
                    float y12 = block1[2] * x0 + block1[8]  * x1 + block1[14] * x2 + block1[20] * x3 + block1[26] * x4 + block1[32] * x5;
                    float y13 = block1[3] * x0 + block1[9]  * x1 + block1[15] * x2 + block1[21] * x3 + block1[27] * x4 + block1[33] * x5;
                    float y14 = block1[4] * x0 + block1[10] * x1 + block1[16] * x2 + block1[22] * x3 + block1[28] * x4 + block1[34] * x5;
                    float y15 = block1[5] * x0 + block1[11] * x1 + block1[17] * x2 + block1[23] * x3 + block1[29] * x4 + block1[35] * x5;
        ...
        // comment (SparseOP.float.cs) for the root cause and the full writeup. Composing wins
        // because it reuses the already 2x-float4-SIMD-tuned vecDot kernel instead of a bespoke
        // scalar cross-row fold. Kept out per the spec's own instruction: measure, and if it
        // doesn't win, don't ship it.

        // =====================================================================================
        // Krylov R2, floatBlockJacobi.Apply specialization (docs/draft-spec-krylov-optimization.md,
        ...
        // fallback, not just rounding-equivalent. Dispatch lives in floatBlockJacobi.Apply.
        // =====================================================================================
