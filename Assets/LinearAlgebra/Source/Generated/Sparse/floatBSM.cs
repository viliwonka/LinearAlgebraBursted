...
namespace LinearAlgebra.Sparse
{
    ...
    public partial struct floatBSM : IDisposable
    {
        ...
        /// </summary>
        public unsafe floatBSM(int blockRows, int blockCols, int BR, int BC, int nnzb, Allocator allocator, bool uninit = false, bool symmetric = false)
        {
            _arena = default;
            BlockRows = blockRows;
            BlockCols = blockCols;
            ...
            if (symmetric && (BR != BC || blockRows != blockCols))
                throw new ArgumentException("floatBSM: symmetric storage requires BR==BC and blockRows==blockCols");
            Symmetric = symmetric;
        ...
        /// </summary>
        public unsafe floatBSM(int blockRows, int blockCols, int BR, int BC, int nnzb, in Arena arena, bool uninit = false, bool symmetric = false)
        {
            _arena = arena;
