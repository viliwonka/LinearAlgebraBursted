...
namespace LinearAlgebra
{
    ...
    public partial struct uintN : IDisposable, IUnsafeuintArray {
        ...
        // Value handle, not a pointer: copying an uintN (including compiler-inserted defensive
        ...
        /// </summary>
        public unsafe uintN(int n, in Arena arena, bool uninit = false) {

            _arena = arena;

            var allocator = arena.Allocator;

            var data = new UnsafeList<uint>(n, allocator, uninit? NativeArrayOptions.UninitializedMemory : NativeArrayOptions.ClearMemory);
        ...
        public unsafe uintN TempCopy()
        {
            ...
            return _arena.uintTempVec(in this);   // temp pool (was wrongly the persistent Copy path)
        }
