...
namespace LinearAlgebra.Gallery
{
    ...
    public static partial class floatGallery
    {
        ...
        /// |ρ| ≥ 1 or negative ρ can be used as test inputs (same convention as <see cref="floatHilbert"/>).
        /// </summary>
        ...
        /// SPD is the caller's responsibility — the generator is intentionally permissive, so
        /// degenerate/indefinite α can be used as test inputs (same convention as <see cref="floatHilbert"/>).
        /// </summary>
        ...
        /// <see cref="floatHilbert"/>. Default α = −1.
        /// </summary>
