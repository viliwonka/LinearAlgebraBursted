...
{
    /// <summary>
    /// Arena-owned, pointer-stable allocation record backing a doubleN
    ...
    /// <see cref="Table"/>) and is addressed by doubleN's private <c>doubleVecRecord*</c> field.
    /// Never copied by user code: a struct copy of doubleN just copies the pointer to this SAME
