...
namespace LinearAlgebra.Gallery
{
    ...
    /// Same partial class as Batch A (Gallery.SPD.float.cs) and Batch B (Gallery.Special.float.cs).
    /// Opt in via <c>using LinearAlgebra.Gallery;</c> then call e.g. <c>arena.floatCauchy(x, y)</c>.
    /// </summary>
