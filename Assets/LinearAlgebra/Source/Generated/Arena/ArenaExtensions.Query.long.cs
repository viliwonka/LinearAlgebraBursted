...
namespace LinearAlgebra
{
    ...
    public static partial class ArenaExtensions
    {
        ...
        /// <summary>Allocates a fresh longN (length A.M_Rows) from A's arena with row distances/similarities to q under metric m. See class doc for supported metrics and overflow limits.</summary>
        ...
        /// <summary>Allocates a fresh longN (length A.N_Cols) from A's arena with column distances/similarities to q under metric m. See class doc for supported metrics and overflow limits.</summary>
        ...
        /// <summary>Allocates clamped-k Indices + longN scores from arena, filled via kNearestRows; count = min(k, A.M_Rows).</summary>
        ...
        /// <summary>Allocates clamped-k Indices + longN scores from arena, filled via kNearestColumns; count = min(k, A.N_Cols).</summary>
        ...
        /// <summary>Allocates clamped-k Indices + longN scores from arena, filled via kFarthestRows; count = min(k, A.M_Rows).</summary>
        ...
        /// <summary>Allocates clamped-k Indices + longN scores from arena, filled via kFarthestColumns; count = min(k, A.N_Cols).</summary>
