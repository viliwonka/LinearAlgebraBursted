...
{
    // Allocating (arena) wrappers for the single-output doubleFFT_OP spectrum reductions. The transforms
    ...
    public static partial class ArenaExtensions
    {
        ...
        public static doubleN doubleMagnitude(this ref Arena arena, in doubleN re, in doubleN im)
        {
            ...
            doubleFFT_OP.magnitude(in re, in im, ref dest);
            return dest;
        }
        ...
        {
            var dest = arena.doubleVec(re.N);
            doubleFFT_OP.powerSpectrum(in re, in im, ref dest);
            return dest;
        }
