...
namespace LinearAlgebra {
    ...
    public partial struct floatN : IArenaShortcuts
    {
        ...
        // `b.floatBSRTranspose(in A)` without direct access to floatN's private _arena field.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe floatBSR floatBSRTranspose(in floatBSR A) => _arena.floatBSRTranspose(in A);
