...
namespace LinearAlgebra
{
    ...
    public partial struct floatMxN
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator <(float lhs, in floatMxN rhs) => rhs > lhs;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator >(in floatMxN lhs, float rhs)
        {
            boolMxN res = lhs.tempBoolMat(lhs.M_Rows, lhs.N_Cols, true);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator <(in floatMxN lhs, in floatMxN rhs)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator >(in floatMxN a, in floatMxN b) => b < a;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator <=(in floatMxN lhs, in floatMxN rhs)
        {
            Assume.SameDim(in lhs, in rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator >=(in floatMxN lhs, in floatMxN rhs) => rhs <= lhs;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static boolMxN operator ==(in floatMxN lhs, in floatMxN rhs)
        {
            Assume.SameDim(in lhs, in rhs);
