...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeBitsOP
    {
        ...
        public static void countbits([NoAlias] long* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                long v = x[i];
                x[i] = (long)(math.countbits(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void tzcnt([NoAlias] long* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                long v = x[i];
                x[i] = (long)(math.tzcnt(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void lzcnt([NoAlias] long* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                long v = x[i];
                x[i] = (long)(math.lzcnt(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void reversebits([NoAlias] long* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                long v = x[i];
                x[i] = (long)(math.reversebits(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void rol([NoAlias] long* x, int n, int shift)
        {
            ...
            {
                long v = x[i];
                x[i] = (long)(math.rol(v, shift));
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ror([NoAlias] long* x, int n, int shift)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ceilpow2([NoAlias] long* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                long v = x[i];
                x[i] = (long)(math.ceilpow2(v));
            }
        }
    }
}
