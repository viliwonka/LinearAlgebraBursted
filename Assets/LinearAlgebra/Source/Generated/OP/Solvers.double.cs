...
namespace LinearAlgebra
{
    ...
    public static partial class Solvers {
        ...
        public static void SolveLowerTriangularLU(ref doubleMxN L, ref doubleN x) {
            if (L.IsSquare == false)
                throw new System.Exception("Solvers.SolveLowerTriangular: Matrix must be square");
        ...
        // Solve Ly = b for, where y = Ux
        // RP = Row Pivot
        public static void SolveLowerTriangularLU(ref doubleMxN L, ref Pivot RP, ref doubleN x) {
            if (L.IsSquare == false)
                throw new System.Exception("Solvers.SolveLowerTriangular: Matrix must be square");
        ...
        public static void SolveUpperTriangularLU(ref doubleMxN U, ref Pivot RP, ref doubleN x) {
            //if(U.IsSquare == false)
            //throw new System.Exception("Solvers.SolveUpperTriangular: Matrix must be square");
