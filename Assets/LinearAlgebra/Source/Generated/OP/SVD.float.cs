...
#pragma warning restore 618
        ...
        /// <summary>svdGolubKahan with default eps (Consts.floatZeroThreshold).</summary>
        public static bool svdGolubKahan(in floatMxN A, ref floatMxN U, ref floatN S, ref floatMxN V,
                                         int maxIter)
            => svdGolubKahan(in A, ref U, ref S, ref V, maxIter, Consts.floatZeroThreshold);

        /// <summary>svdGolubKahan with default maxIter (75) and eps (Consts.floatZeroThreshold).</summary>
        public static bool svdGolubKahan(in floatMxN A, ref floatMxN U, ref floatN S, ref floatMxN V)
            => svdGolubKahan(in A, ref U, ref S, ref V, 75, Consts.floatZeroThreshold);
