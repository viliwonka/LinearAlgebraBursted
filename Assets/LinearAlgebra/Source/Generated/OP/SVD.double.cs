...
namespace LinearAlgebra
{
    ...
    public static partial class SVD {
        ...
        /// </summary>
        /// <remarks>DEPRECATED: prefer <see cref="svdGolubKahan(in doubleMxN, ref doubleMxN, ref doubleN, ref doubleMxN)"/>
        /// (Golub-Kahan bidiagonal SVD, ~3x faster and does not modify its input) for the full SVD, or
        /// <see cref="svdValues(in doubleMxN, ref doubleN)"/> for singular values only. Retained for reference.</remarks>
