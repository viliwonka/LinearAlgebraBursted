...
namespace LinearAlgebra
{
    ...
    // substitution (SolveTranspose below) over the SAME compact doubleMxN + Pivot factor LU.decompInPlace
    ...
    public static partial class LP
    {
        ...
        internal static void SolveTranspose(doubleMxN LU, in Pivot P, doubleN v, int m)
        {
        ...
        internal static void ApplyEtaForward(doubleMxN etaAlpha, int row, int slot, doubleN v, int m)
        {
        ...
        internal static void ApplyEtaTransposed(doubleMxN etaAlpha, int row, int slot, doubleN v, int m)
        {
            double t = (double)0;
            for (int i = 0; i < m; i++)
        ...
        internal static int SelectEntering(doubleMxN M, doubleN y, doubleN cost, bool phase1,
                                           ...
                                           int N, int m, bool useBland, double tol, out int sigma, out double dj)
        {
            sigma = 0; dj = (double)0;
                                       ...
                                       doubleMxN B, in Pivot P, int m, int N, doubleN xB)
        {
            ...
            {
                if (status[j] == STATUS_BASIC) continue;
                double val = status[j] == STATUS_AT_LOWER ? lower[j] : upper[j];
                if (val == (double)0) continue;
