...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        // (docs/draft-spec-krylov-optimization.md; see floatDenseOperator.ApplyDot, the sole
        ...
        // already uses vecDot's float4 SIMD pattern; there was nothing left to widen the OUTER
        ...
        public static void householderInPlace(ref floatMxN matrix, in floatN u)
        {
            ...
            float vTv = dot(u, u); // Inline dot product calculation
