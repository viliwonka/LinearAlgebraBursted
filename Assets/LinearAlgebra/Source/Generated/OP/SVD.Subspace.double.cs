...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        /// </summary>
        public static int nullspaceBasis(in doubleMxN A, ref doubleMxN basis, ref doubleSvdFullWorkspace ws,
        ...
        /// is full-SVD scratch reused across calls; size it with Arena.doubleSvdFullWorkspace(m, n).
        /// </summary>
        public static int rangeBasis(in doubleMxN A, ref doubleMxN basis, ref doubleSvdFullWorkspace ws,
                                     out bool converged, double relTol, int maxIter)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
