...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        ///
        /// relativeTolerance &lt; 0 selects the auto tolerance max(m, n) * Consts.doubleZeroThreshold; a singular
        ...
        public static RankInfo nullspaceBasis(in doubleMxN A, ref doubleMxN basis, ref doubleSVDFullCache ws,
                                         double relativeTolerance, int maxIter)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            double tol = relativeTolerance * ws.S[0];
        ...
        public static RankInfo nullspaceBasis(in doubleMxN A, ref doubleMxN basis, double relativeTolerance)
        ...
        public static RankInfo nullspaceBasis(in doubleMxN A, ref doubleMxN basis)
            => nullspaceBasis(in A, ref basis, (double)(-1), Consts.sweepBudget(A.N_Cols));
        ...
        public static RankInfo rangeBasis(in doubleMxN A, ref doubleMxN basis, double relativeTolerance)
        ...
        public static RankInfo rangeBasis(in doubleMxN A, ref doubleMxN basis)
            => rangeBasis(in A, ref basis, (double)(-1), Consts.sweepBudget(A.N_Cols));
    }
}
