...
namespace LinearAlgebra
{
    public static partial class Bidiag
    {
        ...
        /// </summary>
        static void RequireBidiagWorkspace(in floatBidiag_WS ws, int m, int n, bool needLeftU, string who)
        {
            bool ok =
            ...
            if (!ok)
                throw new ArgumentException(who + ": workspace must be sized for m x n (use Arena.floatBidiag_WS(m, n))");
        }
    }
