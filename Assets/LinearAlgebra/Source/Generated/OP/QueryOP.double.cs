...
namespace LinearAlgebra
{
    ...
    public static partial class Query
    {
        ...
        /// </summary>
        public static int nonzero<T>(in T x, double tolerance, ref Indices idx)
            where T : unmanaged, IUnsafedoubleArray
        {
        ...
        /// </summary>
        public static int findValue<T>(in T x, double target, double tolerance)
            where T : unmanaged, IUnsafedoubleArray
        {
            for (int i = 0; i < x.Data.Length; i++)
            {
        ...
        /// </summary>
        public static int countNonzero<T>(in T x, double tolerance)
            where T : unmanaged, IUnsafedoubleArray
        {
            int count = 0;
            for (int i = 0; i < x.Data.Length; i++)
