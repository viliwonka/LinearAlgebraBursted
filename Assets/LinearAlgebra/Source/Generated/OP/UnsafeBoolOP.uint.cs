...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeBoolOP
    {
        ...
        // rather than among the elementwise math kernels in UnsafeMathOP.uint.cs/UnsafeBitsOP.
        // uint.cs - see uintN.Comparators.cs/uintMxN.Comparators.cs for its public surface.
        ...
        //     (countbits/tzcnt/lzcnt/reversebits/ror/rol - see UnsafeBitsOP.uint.cs), ispow2 tests
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ispow2([NoAlias] uint* a, [NoAlias] bool* target, int n)
        {
            for (int i = 0; i < n; i++)
            {
                uint v = a[i];
