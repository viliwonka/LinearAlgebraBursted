...
namespace LinearAlgebra
{
    ...
    public static partial class LQRP {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo solveInPlace(ref doubleMxN A, ref doubleN b, ref doubleN x, double relTol)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo minNormSolveInPlace(ref doubleMxN A, ref doubleN b, ref doubleN x, double relTol)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
