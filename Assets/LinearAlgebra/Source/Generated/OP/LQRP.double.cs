...
namespace LinearAlgebra
{
    ...
    public static partial class LQRP {
        ...
        private static unsafe double rowSumSq(ref doubleMxN W, int row, int colStart, int n)
        {
            double* p = W.Data.Ptr + (long)row * n + colStart;
            int len = n - colStart;
        ...
        static unsafe void lqrpKernel(ref doubleMxN W, ref doubleMxN L, ref doubleMxN Q, ref Pivot P, ref doubleN v,
                                      double zeroThreshold, bool reconstructQ)
        {
            ...
            var vn1 = new doubleN(m, Allocator.Temp, false);
            var vn2 = new doubleN(m, Allocator.Temp, false);
            ...
            for (int i = 0; i < m; i++)
            {
                double nrm = math.sqrt(rowSumSq(ref W, i, 0, n));
                vn1p[i] = nrm;
                vn2p[i] = nrm;
            }
            ...
            double pivotRelTol = (double)(8 * n) * Consts.doubleEpsilon;
            ...
            for (int d = 0; d < m; d++)
            {
                ...
                if (pivotRow != d && maxNorm1 > diagNorm1 * pivotRelTolRoot)
                {
                    ...
                    P.Swap(d, pivotRow);
                    double tv1 = vn1p[d]; vn1p[d] = vn1p[pivotRow]; vn1p[pivotRow] = tv1;
                    double tv2 = vn2p[d]; vn2p[d] = vn2p[pivotRow]; vn2p[pivotRow] = tv2;
                }
                ...
                for (int i = d + 1; i < m; i++)
                {
                    ...
                    double ratio = math.abs(W[i, d]) / v1;
                ...
                if (anyExact)
                {
                    ...
                    for (int i = d + 1; i < m; i++)
                    {
                        double nrm = math.sqrt(rowSumSq(ref W, i, d + 1, n));
                        vn1p[i] = nrm;
                        vn2p[i] = nrm;
                    }
                }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in doubleMxN A, ref doubleMxN L, ref doubleMxN Q, ref Pivot P)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <summary>
        /// decomp using a reusable workspace (Arena.doubleLQRPCache(m, n)) — zero-alloc.
        /// Semantics identical to the allocating overload; see that one for full documentation.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in doubleMxN A, ref doubleMxN L, ref doubleMxN Q, ref Pivot P, ref doubleLQRPCache ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <see cref="QRCP.decompInPlace(ref doubleMxN, ref doubleMxN, ref Pivot, ref doubleN)"/>; use it
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref doubleMxN A_to_Q, ref doubleMxN L, ref Pivot P, ref doubleN v)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
        ...
        /// <summary>
        /// decompInPlace using a reusable workspace (Arena.doubleLQRPCache(m, n)) — the internal scratch
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref doubleMxN A_to_Q, ref doubleMxN L, ref Pivot P, ref doubleLQRPCache ws)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref doubleMxN A_to_Q, ref doubleMxN L, ref Pivot P)
        {
            if (A_to_Q.M_Rows > A_to_Q.N_Cols)
                throw new ArgumentException("LQRP.decompInPlace: A_to_Q must be wide or square (M_Rows <= N_Cols)");

            var v = new doubleN(A_to_Q.N_Cols, Allocator.Temp, false);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo solveInPlace(ref doubleMxN A, ref doubleN b, ref doubleN x,
                                            ref doubleMxN L, ref Pivot P, ref doubleN v, double relativeTolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            double tol = relativeTolerance * math.abs(L[0, 0]);
            int rank = 0;
            for (int i = 0; i < m; i++)
            {
        ...
        /// <summary>
        /// solveInPlace with the default rank tolerance (max(m,n) · Consts.doubleZeroThreshold,
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo solveInPlace(ref doubleMxN A, ref doubleN b, ref doubleN x, double relativeTolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        static unsafe void minNormCodFinish(ref doubleMxN A, in doubleN b, ref doubleN x,
                                            ref doubleMxN L, in Pivot P, int r)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            for (int i = r; i < n; i++) w[i] = (double)0;
        ...
        /// auto-selects max(m,n)·Consts.doubleZeroThreshold, matching SVD.pinvSolve / MatrixMetrics.rank).
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo minNormSolveInPlace(ref doubleMxN A, ref doubleN b, ref doubleN x,
                                                   ref doubleMxN L, ref Pivot P, ref doubleN v, double relativeTolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo minNormSolveInPlace(ref doubleMxN A, ref doubleN b, ref doubleN x, double relativeTolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        public static RankInfo solveInPlace(ref doubleMxN A, ref doubleMxN B, ref doubleMxN X, double relativeTolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// Allocator.Temp. DESTROYS A (B preserved). Use the scratch overload in hot loops.</summary>
        public static RankInfo minNormSolveInPlace(ref doubleMxN A, ref doubleMxN B, ref doubleMxN X, double relativeTolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        static unsafe void basicReducedBlock(in doubleMxN L, in Pivot P, in doubleMxN B, int r, ref doubleMxN W)
        {
            int m = L.M_Rows;      // L is m×m
            int k = B.N_Cols;
        ...
        /// use <see cref="minNormDecompSolve(ref doubleMxN, ref doubleMxN, in Pivot, ref doubleMxN, ref doubleMxN, double)"/>).
        ...
        /// <param name="B">Right-hand sides (m x k). Preserved. Must not alias X.</param>
        /// <param name="X">Output only; prior contents ignored. Solution (n x k).</param>
        public static unsafe RankInfo decompSolve(ref doubleMxN L, ref doubleMxN Q, in Pivot P,
                                                  ref doubleMxN B, ref doubleMxN X, double relativeTolerance)
        {
            int m = Q.M_Rows;
            int n = Q.N_Cols;
        ...
        public static RankInfo decompSolve(ref doubleMxN L, ref doubleMxN Q, in Pivot P,
                                           ref doubleMxN B, ref doubleMxN X)
        {
            return decompSolve(ref L, ref Q, in P, ref B, ref X, (double)(-1));
        }
