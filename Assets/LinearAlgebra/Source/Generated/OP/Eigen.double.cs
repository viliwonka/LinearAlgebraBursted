...
namespace LinearAlgebra
{
    public static partial class Eigen {
        ...
        /// <see cref="IdoubleLinearOperator"/>. This is the single implementation of the
        /// power-iteration loop — the concrete dense (<c>powerIteration(in doubleMxN, ...)</c>) and BSR
        ...
        /// <see cref="IdoubleLinearOperator"/> -- same shape as <see cref="powerIteration{TOp}"/>.
        ...
        /// any <see cref="IdoubleLinearOperator"/> -- same shape as <see cref="powerIteration{TOp}"/> /
                                                 ...
                                                 ref doubleEigenSymCache ws)
        {
            ...
            unsafe
            {
                ...
                for (int k = 0; k < n - 2; k++)
                {
                    ...
                    double vp = UnsafeOP.vecDotRange(v, p, m0, n);
            ...
            unsafe
            {
                ...
                for (int k = 0; k < n - 2; k++)
                {
                    ...
                    for (int r = 0; r < n; r++)
                    {
                        ...
                        double s = UnsafeOP.vecDotRange(qrow, v, m0, n);
