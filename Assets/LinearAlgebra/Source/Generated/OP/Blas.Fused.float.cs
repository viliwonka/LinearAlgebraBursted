...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        public static float axpyNormSq(float a, in floatN x, ref floatN y)
        {
            if (x.N != y.N)
        ...
        public static float xpayNormSq(float a, in floatN x, ref floatN y)
        {
            if (x.N != y.N)
        ...
        public static float updateXR(float a, in floatN p, ref floatN x, in floatN q, ref floatN r)
        {
            if (p.N != x.N)
        ...
        public static void scaledCopy(float a, in floatN x, ref floatN y)
        {
            if (x.N != y.N)
        ...
        public static void combine3(ref floatN w, in floatN v, float a, in floatN w1, float b, in floatN w2, float s)
        {
