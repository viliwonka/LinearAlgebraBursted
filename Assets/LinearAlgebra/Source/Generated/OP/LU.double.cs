...
namespace LinearAlgebra
{
    ...
    public static partial class LU {
        ...
        /// </summary>
        public static bool luDecompositionNoPivot(ref doubleMxN U, ref doubleMxN L)
        {
            if (!U.IsSquare)
        ...
        /// </summary>
        public static bool luDecomposition(ref doubleMxN U, ref doubleMxN L, ref Pivot P) {
            if (!U.IsSquare)
                throw new System.ArgumentException("luDecomposition: U (A) needs to be square");
