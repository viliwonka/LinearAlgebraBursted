...
namespace LinearAlgebra
{
    public static partial class LU {
        ...
        /// </summary>
        public static DirectSolveInfo luDecompositionNoPivot(ref doubleMxN U, ref doubleMxN L)
        {
            if (!U.IsSquare)
        ...
        /// </summary>
        public static DirectSolveInfo luDecomposition(ref doubleMxN U, ref doubleMxN L, ref Pivot P) {
            if (!U.IsSquare)
                throw new System.ArgumentException("luDecomposition: U (A) needs to be square");
        ...
        /// On Singular: no NaN/Inf is written, P remains a valid permutation.
        /// </summary>
        public static DirectSolveInfo luDecompositionInPlace(ref doubleMxN LU, ref Pivot P) {
            ...
            for (int k = 0; k < m - 1; k++) {
                ...
                int pivotIndex = k;
                double pivotValue = math.abs(LU[P[k], k]);

                // Find largest pivot in rows
                for (int r = k + 1; r < m; r++) {
                    double absValue = math.abs(LU[P[r], k]);
                    if (absValue > pivotValue) {
                        pivotIndex = r;
                        pivotValue = absValue;
                    }
        ...
        /// </summary>
        public static DirectSolveInfo luSolve(ref doubleMxN LU, in Pivot pivot, ref doubleN b) {
        ...
        /// Throws ArgumentException if dimensions are inconsistent.
        /// </summary>
        public static DirectSolveInfo luSolve(ref doubleMxN L, ref doubleMxN U, in Pivot pivot, ref doubleN b) {
