...
namespace LinearAlgebra
{
    ...
    public static partial class Cholesky {
        ...
        /// </summary>
        public static DirectSolveInfo choleskyDecomposition(in doubleMxN A, ref doubleMxN L) {
            if (!A.IsSquare)
        ...
        /// always check Solved.
        /// </summary>
        public static DirectSolveInfo choleskySolve(ref doubleMxN L, ref doubleN b) {
            if (!L.IsSquare)
        ...
        /// </summary>
        public static DirectSolveInfo choleskySolve(in doubleMxN A, ref doubleMxN L, ref doubleN b) {
