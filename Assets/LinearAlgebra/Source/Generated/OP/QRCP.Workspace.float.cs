...
namespace LinearAlgebra
{
    ...
    /// the blocked buffers in here for a fully zero-alloc blocked path (as floatQRCache does for QR)
    /// is a candidate follow-up. Allocate ONCE via Arena.floatQRCPCache(n) and reuse across
