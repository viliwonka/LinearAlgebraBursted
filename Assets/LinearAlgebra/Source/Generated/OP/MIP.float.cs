...
namespace LinearAlgebra
{
    ...
    internal struct floatMIPNode
    {
        public int marker;         // bound-change stack length before this frame's own changes
        public int branchVar;
        public float floorV;      // down child's new UB
        public float ceilV;       // up child's new LB
    ...
    public static partial class MIP
    {
        ...
        internal static void ApplyChild(ref UnsafeList<floatBoundChange> boundStack, floatMIPNode node, bool isFirstChild,
                                           ...
                                           floatN xOut)
        {
            ...
            var nodeStack = new UnsafeList<floatMIPNode>(64, Allocator.Temp);
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    floatMIPNode top = nodeStack[topIdx];
                    if (top.state == 0)
                    {
