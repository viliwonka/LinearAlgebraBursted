...
namespace LinearAlgebra
{
    ...
    // branching (MIP.Pseudocost.float.cs) picks the branching variable; search order is best-bound-
    ...
    // node is domain-propagated to a fixpoint before its LP solve (MIP.Domain.float.cs's
    ...
    public static partial class MIP
    {
                                           ...
                                           floatN xOut)
        {
            ...
            // MIP.Domain.float.cs); rhs-only bound updates (the common plunge/strong-branch case) leave
