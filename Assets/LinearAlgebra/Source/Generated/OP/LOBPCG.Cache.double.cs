...
namespace LinearAlgebra
{
    public static partial class LOBPCG
    {
        ...
        static void RequireLOBPCGWorkspace(in doubleLOBPCGCache ws, int n, int k)
        {
            ...
            if (ws.AXnext.M_Rows != k || ws.AXnext.N_Cols != n)
                throw new ArgumentException("LOBPCG: workspace AXnext must be k x n (use Arena.doubleLOBPCGCache(n, k))");
            ...
            if (ws.APnext.M_Rows != k || ws.APnext.N_Cols != n)
                throw new ArgumentException("LOBPCG: workspace APnext must be k x n (use Arena.doubleLOBPCGCache(n, k))");
            ...
            if (ws.rowAux.N != n)
                throw new ArgumentException("LOBPCG: workspace rowAux must have length n (use Arena.doubleLOBPCGCache(n, k))");
    ...
    /// vectors internally, exactly like <see cref="Eigen.eigenSymmetric(ref doubleMxN, ref doubleN, ref doubleMxN)"/>
    ...
    public struct doubleLOBPCGCache
    {
        ...
        public doubleMxN Xnext, AXnext, Pnext, APnext;
    ...
    public static partial class ArenaExtensions
    {
        ...
        public static doubleLOBPCGCache doubleLOBPCGCache(this ref Arena arena, int n, int k)
        {
            ...
            return new doubleLOBPCGCache
            {
                ...
                AXnext = arena.doubleMat(k, n),
                Pnext = arena.doubleMat(k, n),
                APnext = arena.doubleMat(k, n),
