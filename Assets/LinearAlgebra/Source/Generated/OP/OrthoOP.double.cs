...
namespace LinearAlgebra
{
    ...
    public static partial class OrthoOP {
        ...
        private static void genHouseholder(ref doubleMxN Q, ref doubleN u, int k) {
            ...
            doubleNormsOP.NormalizeL2(u, k, u.N);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void genHouseholderPete(ref doubleMxN Q, ref doubleN u, int k) {
            ...
            if (math.abs(xNorm) > Consts.doubleZeroTreshold) {
