...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        public static uint dot(uintN a, uintN b)
        {
            if (a.N != b.N)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void outerDot(in uintN a, in uintN b, ref uintMxN result)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uintMxN outerDot(uintN a, uintN b)
        {
            uintMxN result = a.uintTempMat(a.N, b.N, true);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in uintMxN A, in uintN x, ref uintN result)
        {
            ...
            unsafe {
                ...
                UnsafeUtility.MemClear(result.Data.Ptr, (long)result.Data.Length * UnsafeUtility.SizeOf<uint>());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uintN dot(uintMxN A, uintN x)
        {
            uintN result = x.uintTempVec(A.M_Rows);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in uintN y, in uintMxN A, ref uintN result)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uintN dot(uintN y, uintMxN A)
        {
            uintN result = y.uintTempVec(A.N_Cols);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in uintMxN a, in uintMxN b, ref uintMxN c, bool transposeA = false)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uintMxN dot(uintMxN a, uintMxN b, bool transposeA = false)
        {
            int m = transposeA ? a.N_Cols : a.M_Rows;
            int k = b.N_Cols;

            uintMxN c = a.uintTempMat(m, k);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void trans(in uintMxN A, ref uintMxN T)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uintMxN trans(uintMxN A)
        {
            var T = A.uintTempMat(A.N_Cols, A.M_Rows, true);
            trans(in A, ref T);
            return T;
        }
    }
