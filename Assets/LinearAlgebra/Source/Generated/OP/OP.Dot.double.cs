...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        // (docs/draft-spec-krylov-optimization.md; see doubleDenseOperator.ApplyDot, the sole
        ...
        // already uses vecDot's double4 SIMD pattern; there was nothing left to widen the OUTER
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double dotSelf(in doubleMxN A, in doubleN x, ref doubleN y)
        {
            Assume.SameDim(A.N_Cols, x.N);
