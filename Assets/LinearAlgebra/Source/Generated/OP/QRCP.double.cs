...
namespace LinearAlgebra
{
    ...
    public static partial class QRCP {
        ...
        public static RankInfo solveInPlace(ref doubleMxN A_to_Q, ref doubleN b, ref doubleN x,
                                           ...
                                           ref doubleN u, double relativeTolerance)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
        ...
        public static RankInfo solveInPlace(ref doubleMxN A_to_Q, ref doubleN b, ref doubleN x,
                                           ref doubleMxN R, ref Pivot P,
                                           ref doubleN u, ref doubleQRCPCache cache, double relativeTolerance)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
        ...
        static unsafe RankInfo solveInPlaceFusedDispatch(ref doubleMxN A_to_Q, ref doubleN b, ref doubleN x,
                                                         ...
                                                         ref doubleN vn1, ref doubleN vn2, double relativeTolerance)
        {
            // See decompInPlaceBlockedCore for why this is a method-local const, not a class field.
            const int QRCP_BLOCK = 32;
        ...
        static RankInfo solveInPlaceFinish(ref doubleMxN A_to_Q, ref doubleN b, ref doubleN x,
                                            ref doubleMxN R, ref Pivot P, ref doubleN u, double relativeTolerance)
        {
            int n = A_to_Q.N_Cols;
            ...
            double tol = relativeTolerance * math.abs(R[0, 0]);
            int rank = 0;
            for (int i = 0; i < n; i++)
            {
        ...
        /// max(m,n)·Consts.doubleZeroThreshold, matching SVD.pinvSolve / MatrixMetrics.rank).
        /// </summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RankInfo minNormSolveInPlace(ref doubleMxN A_to_Q, ref doubleN b, ref doubleN x, double relativeTolerance)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
        ...
        static unsafe RankInfo finishFromQtB(ref doubleMxN X, ref doubleMxN R, in Pivot P, double relativeTolerance, int n, int k)
        {
            double tol = relativeTolerance * math.abs(R[0, 0]);
            int rank = 0;
            for (int i = 0; i < n; i++)
        ...
        /// (tol = relativeTolerance·|R[0,0]|; relativeTolerance &lt; 0 auto-selects max(m,n)·Consts.doubleZeroThreshold). Only
        ...
        public static RankInfo decompSolve(ref doubleMxN Q, ref doubleMxN R, in Pivot P,
                                           ref doubleMxN B, ref doubleMxN X, double relativeTolerance)
        {
            int m = Q.M_Rows;
            int n = Q.N_Cols;
            int k = B.N_Cols;
        ...
        public static RankInfo decompSolve(ref doubleMxN Q, ref doubleMxN R, in Pivot P,
                                           ref doubleN b, ref doubleN x, double relativeTolerance)
        {
            int m = Q.M_Rows;
            int n = Q.N_Cols;
        ...
        public static RankInfo solveInPlace(ref doubleMxN A_to_Q, ref doubleMxN B, ref doubleMxN X, double relativeTolerance)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
        ...
        static unsafe RankInfo minNormFinishFromQtB(ref doubleMxN X, ref doubleMxN R, in Pivot P, double relativeTolerance, int n, int k)
        {
            double tol = relativeTolerance * math.abs(R[0, 0]);
            int rank = 0;
            for (int i = 0; i < n; i++)
        ...
        public static RankInfo minNormSolveInPlace(ref doubleMxN A_to_Q, ref doubleMxN B, ref doubleMxN X, double relativeTolerance)
        {
            int m = A_to_Q.M_Rows;
            int n = A_to_Q.N_Cols;
