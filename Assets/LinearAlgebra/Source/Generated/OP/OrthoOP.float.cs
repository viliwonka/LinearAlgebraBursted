...
namespace LinearAlgebra
{
    ...
    public static partial class OrthoOP {
        ...
        public static void householderInpl(ref floatMxN matrix, in floatN u)
        {
            ...
            if (!(vTv > Consts.floatZeroTreshold))
                return;
        ...
        // pass a SCALE-RELATIVE value (Consts.floatZeroTreshold * matrix magnitude) so QR is
        ...
        public static void qrDecomposition(ref floatMxN Q, ref floatMxN R, ref floatN u, ref floatN w)
        {
            ...
            float zeroThreshold = Consts.floatZeroTreshold * floatNormsOP.LInf(in Q);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void qrDecompositionColumnPivot(ref floatMxN Q, ref floatMxN R, ref Pivot P)
        {
            var u = new floatN(Q.M_Rows, Allocator.Temp, false);
        ...
        //     tol = relTol * |R[0,0]|
        // and relTol defaults to max(m,n) * Consts.floatZeroTreshold (matching SVD.pinvSolve /
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void qrcpDirectSolve(ref floatMxN A, ref floatN b, ref floatN x,
                                           ref floatMxN Q, ref floatMxN R, ref Pivot P,
                                           ref floatN u, out int rank, float relTol)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        // uses max(m,n) * Consts.floatZeroTreshold (consistent with SVD.pinvSolve / MatrixMetrics.rank).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void qrcpDirectSolve(ref floatMxN A, ref floatN b, ref floatN x,
                                           ref floatMxN Q, ref floatMxN R, ref Pivot P,
                                           ref floatN u, out int rank)
        {
            qrcpDirectSolve(ref A, ref b, ref x, ref Q, ref R, ref P, ref u, out rank, (float)(-1));
        }
        ...
        /// <summary>
        /// Allocating convenience wrapper with default tolerance (max(m,n) * Consts.floatZeroTreshold,
        ...
        public static void qrcpDirectSolve(ref floatMxN A, ref floatN b, ref floatN x,
                                           out int rank)
        {
            qrcpDirectSolve(ref A, ref b, ref x, out rank, (float)(-1));
        }
    }
