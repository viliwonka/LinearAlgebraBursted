...
namespace LinearAlgebra
{
    public static partial class LP
    {
        ...
        // floatNormalOperator (M is never formed) preconditioned by a floatNormalJacobi (diagonal of
        // M, computed matrix-free). The constraint operator Aₛ = [A|−A|−I|I] is floatLadOperator, which
        ...
        public static LPInfo lad(in floatBSR A, in floatN b, ref floatN x, out double objective, int maxIter = 0)
        {
            ...
            var cvec = new floatN(nv, Allocator.Temp); var normNV = new floatN(nv, Allocator.Temp);
            // length-m scratch
            ...
            var Mop = new floatNormalOperator<floatLadOperator>(in lad, in d, in normNV, reg);
            ...
            var bestZ = new floatN(nv, Allocator.Temp, false);
