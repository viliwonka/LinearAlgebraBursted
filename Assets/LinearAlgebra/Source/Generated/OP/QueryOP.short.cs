...
namespace LinearAlgebra
{
    ...
    public static partial class Query
    {
        ...
        //
        // P3 overflow: SqEuclidean accumulates (diff*diff) in short; Dot accumulates
        ...
        /// </summary>
        public static int nonzero<T>(in T x, short tol, ref Indices idx)
            where T : unmanaged, IUnsafeshortArray
        {
        ...
        /// </para>
        /// </summary>
        public static int findValue<T>(in T x, short target, short tol)
            where T : unmanaged, IUnsafeshortArray
        {
            for (int i = 0; i < x.Data.Length; i++)
            {
        ...
        /// </summary>
        public static int countNonzero<T>(in T x, short tol)
            where T : unmanaged, IUnsafeshortArray
        {
            int count = 0;
            for (int i = 0; i < x.Data.Length; i++)
