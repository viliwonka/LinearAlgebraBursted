...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeBitsOP
    {
        ...
        public static void countbits([NoAlias] short* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                short v = x[i];
                x[i] = (short)(math.countbits((uint)(ushort)v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void tzcnt([NoAlias] short* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                short v = x[i];
                x[i] = (short)(math.min(16, math.tzcnt((uint)(ushort)v)));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void lzcnt([NoAlias] short* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                short v = x[i];
                x[i] = (short)(math.lzcnt((uint)(ushort)v) - 16);
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void reversebits([NoAlias] short* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                short v = x[i];
                x[i] = (short)(math.reversebits((uint)(ushort)v) >> 16);
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void rol([NoAlias] short* x, int n, int shift)
        {
            ...
            {
                short v = x[i];
                x[i] = (short)(((uint)(ushort)v << shiftMod16) + ((uint)(ushort)v >> (16 - shiftMod16)) & 0xFFFFu);
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ror([NoAlias] short* x, int n, int shift)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ceilpow2([NoAlias] short* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                short v = x[i];
                x[i] = (short)(1u << (32 - math.lzcnt((uint)(ushort)(v - 1))));
            }
        }
    }
}
