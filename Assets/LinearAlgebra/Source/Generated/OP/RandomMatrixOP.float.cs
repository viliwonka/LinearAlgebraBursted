...
namespace LinearAlgebra
{
    ...
    /// float-only.
    /// </summary>
    public static partial class floatRandomMatrix_OP
    {
        // =========================================================================
        ...
        public static void multivariateNormalInpl(ref Random rng, in floatMxN cholL, in floatN mean,
                                                  ref floatN dest, ref floatN zScratch)
        {
            ...
            floatRandom_OP.randomInpl(ref rng, ref zScratch, ref gauss);

            // dest = cholL · zScratch
            float_OP.dot(in cholL, in zScratch, ref dest);
        ...
        /// </summary>
        public static void multivariateNormalRowsInpl(ref Random rng, in floatMxN cholL, in floatN mean,
                                                      ref floatMxN destRows)
        {
            ...
            {
                floatRandom_OP.randomInpl(ref rng, ref z, ref gauss);
                float_OP.dot(in cholL, in z, ref row);
                for (int c = 0; c < n; c++)
        ...
        /// </summary>
        public static void randomOrthogonalInpl(ref Random rng, ref floatMxN dest)
        {
            if (!dest.IsSquare)
        ...
        /// </summary>
        public static void randomSpdInpl(ref Random rng, ref floatMxN dest, float minEig, float maxEig)
        {
            if (!dest.IsSquare)
            ...
            float_OP.dot(in Q, in Qt, ref dest);
        ...
        /// </summary>
        public static void randomMatrixWithConditionInpl(ref Random rng, ref floatMxN dest, float cond)
        {
            ...
            // dest = UΣ · Vᵀ
            float_OP.dot(in US, in Vt, ref dest);
        ...
        /// </summary>
        public static void randomMatrixWithRankInpl(ref Random rng, ref floatMxN dest, int rank)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
            ...
            var gauss = new floatGaussian((float)0, (float)1);
            floatRandom_OP.randomInpl(ref rng, ref A, ref gauss);
            floatRandom_OP.randomInpl(ref rng, ref B, ref gauss);

            // dest = A·B   (dot clears dest before accumulating)
            float_OP.dot(in A, in B, ref dest);
        ...
        /// </summary>
        public static void randomStochasticInpl(ref Random rng, ref floatMxN dest)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
            if (m == 0 || n == 0) return;
            ...
            floatRandom_OP.nextUniformInpl(ref rng, ref dest);
