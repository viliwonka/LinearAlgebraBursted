...
namespace LinearAlgebra
{
    ...
    public static partial class Rand
    {
        ...
        /// </summary>
        public static void randomOrthogonalInPlace(ref Random rng, ref floatMxN dest)
        {
            if (!dest.IsSquare)
        ...
        /// </summary>
        public static void randomSpdInPlace(ref Random rng, ref floatMxN dest, float minEig, float maxEig)
        {
            if (!dest.IsSquare)
        ...
        /// </summary>
        public static void randomMatrixWithConditionInPlace(ref Random rng, ref floatMxN dest, float cond)
        {
        ...
        /// </summary>
        public static void randomMatrixWithRankInPlace(ref Random rng, ref floatMxN dest, int rank)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
        ...
        /// </summary>
        public static void randomStochasticInPlace(ref Random rng, ref floatMxN dest)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
            if (m == 0 || n == 0) return;
