...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeBitsOP
    {
        ...
        public static void countbits([NoAlias] int* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                int v = x[i];
                x[i] = (int)(math.countbits(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void tzcnt([NoAlias] int* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                int v = x[i];
                x[i] = (int)(math.tzcnt(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void lzcnt([NoAlias] int* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                int v = x[i];
                x[i] = (int)(math.lzcnt(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void reversebits([NoAlias] int* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                int v = x[i];
                x[i] = (int)(math.reversebits(v));
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void rol([NoAlias] int* x, int n, int shift)
        {
            ...
            {
                int v = x[i];
                x[i] = (int)(math.rol(v, shift));
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ror([NoAlias] int* x, int n, int shift)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ceilpow2([NoAlias] int* x, int n)
        {
            for (int i = 0; i < n; i++)
            {
                int v = x[i];
                x[i] = (int)(math.ceilpow2(v));
            }
        }
    }
}
