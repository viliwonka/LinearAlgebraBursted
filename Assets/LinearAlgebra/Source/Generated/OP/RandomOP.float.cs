...
namespace LinearAlgebra
{
    ...
    /// evolving RNG stream.
    /// Generic fill: <c>randomInPlace&lt;S&gt;</c> — works with any <see cref="IfloatSampler"/>
    ...
    public static partial class Rand
    {
        ...
        public static void nextUniformInPlace(ref Random rng, ref floatN dest)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void nextUniformInPlace(ref Random rng, ref floatN dest, float min, float max)
        {
            if (!(min <= max))
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void nextUniformInPlace(ref Random rng, ref floatMxN dest)
        {
            int len = dest.Data.Length;
            for (int i = 0; i < len; i++)
                dest[i] = rng.NextFloat();
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void nextUniformInPlace(ref Random rng, ref floatMxN dest, float min, float max)
        {
            if (!(min <= max))
                throw new ArgumentException("nextUniformInPlace: min must be <= max");
            int len = dest.Data.Length;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void randomInPlace<S>(ref Random rng, ref floatN dest, ref S s)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void randomInPlace<S>(ref Random rng, ref floatMxN dest, ref S s)
            where S : struct, IfloatSampler
        {
            int len = dest.Data.Length;
            for (int i = 0; i < len; i++)
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void weightedPickInPlace(in floatN weights, ref Indices dest, ref Random rng)
        {
            float total = weightedPickValidateAndSum(in weights);
            int k = dest.N;
            for (int i = 0; i < k; i++)
