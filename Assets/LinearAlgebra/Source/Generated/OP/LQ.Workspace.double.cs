...
namespace LinearAlgebra
{
    public static partial class LQ
    {
        ...
        /// Rqr m x m, qrU length n, qrW length m) — the layout produced by Arena.doubleLQ_WS(m, n).
        /// </summary>
    ...
    public static partial class ArenaExtensions
    {
        ...
        public static doubleLQ_WS doubleLQ_WS(this ref Arena arena, int m, int n)
        {
            ...
            {
                T = arena.doubleMat(n, m),
                Rqr = arena.doubleMat(m, m),
                qrU = arena.doubleVec(n),
                qrW = arena.doubleVec(m)
            };
        }
    }
}
