...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        public static void svdTruncated(in floatMxN A, ref floatMxN Uk, ref floatN Sk, ref floatMxN Vk,
                                        ...
                                        bool partialReorth, ref floatSvdTruncatedWorkspace ws, out bool converged)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            unsafe
            {
                ...
                if (partialReorth)
                {
                    ...
                    // FUTURE: float eta = math.pow(eps, (float)0.75f) / math.sqrt((float)p);
                                        ...
                                        int k, int oversample, uint seed, int maxIter, bool partialReorth, out bool converged)
        {
            ...
            var ws = new floatSvdTruncatedWorkspace
            {
                ...
                mu    = A.tempfloatVec(p + 1),
                nu    = A.tempfloatVec(p + 1)
            };
