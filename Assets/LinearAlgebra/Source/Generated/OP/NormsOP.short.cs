...
namespace LinearAlgebra
{
    ...
    public static partial class Norms {
        ...
        // to `long`. See shortNormsCore.L1 for the abs-overflow care this takes.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1(in shortN   a) => shortNormsCore.L1(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1(in shortMxN a) => shortNormsCore.L1(a);

        // L-infinity (max-abs) norm: the largest absolute element, max_i |xᵢ|, widened to `long`.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf(in shortN   a) => shortNormsCore.LInf(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf(in shortMxN a) => shortNormsCore.LInf(a);

        // Euclidean (L2) norm: sqrt(Σxᵢ²), as a `double` (see shortNormsCore.L2 for the
        // accumulation-precision note).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2(in shortN   a) => shortNormsCore.L2(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2(in shortMxN a) => shortNormsCore.L2(a);
    }
    ...
    internal static class shortNormsCore
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1<T>(in T a) where T : unmanaged, IUnsafeshortArray
        {
            long sum = 0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf<T>(in T a) where T : unmanaged, IUnsafeshortArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2<T>(in T a) where T : unmanaged, IUnsafeshortArray
        {
            double sum = 0.0;
            for (int i = 0; i < a.Data.Length; i++)
            {
