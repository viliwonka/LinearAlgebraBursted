...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void syrkUpperSub([NoAlias] double* Wp, int n, int rStart, int j0, int jb, [NoAlias] double* QT)
        {
            int ntrail = n - rStart;
            for (int ip = 0; ip < ntrail; ip++)
            {
                int i = rStart + ip;
                double* Wrow = Wp + (long)i * n;
                double* Qi = QT + (long)ip * jb;
                for (int p = 0; p < jb; p++)
                {
                    double temp = Qi[p];
                    double* Up = Wp + (long)(j0 + p) * n + rStart;
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void scaledCopy([NoAlias] double* y, [NoAlias] double* x, double a, int n) {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void combine3([NoAlias] double* w, [NoAlias] double* v, double a, [NoAlias] double* w1, double b, [NoAlias] double* w2, double s, int n) {
