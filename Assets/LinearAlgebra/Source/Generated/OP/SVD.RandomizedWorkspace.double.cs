...
namespace LinearAlgebra
{
    public static partial class SVD
    {
        ...
        /// Arena.doubleSvdRandomizedWorkspace(m, n, k, oversample).
        /// </summary>
        static void RequireSvdRandomizedWorkspace(in doubleSvdRandomizedWorkspace ws, int m, int n, int l)
        {
            bool ok =
            ...
            if (!ok)
                throw new ArgumentException(
                    ...
                    "Arena.doubleSvdRandomizedWorkspace(m, n, k, oversample) with the SAME k and oversample");
        }
    }
    ...
    /// Arena.doubleSvdRandomizedWorkspace(m, n, k, oversample) and reuse it across same-shape calls
    ...
    /// </summary>
    public struct doubleSvdRandomizedWorkspace
    {
    ...
    public partial struct Arena
    {
        ...
        /// </summary>
        public doubleSvdRandomizedWorkspace doubleSvdRandomizedWorkspace(int m, int n, int k, int oversample)
        {
            int l = math.min(k + oversample, n);
            return new doubleSvdRandomizedWorkspace
            {
                Omega = doubleMat(n, l),
                Y = doubleMat(m, l),
                R = doubleMat(l, l),
        ...
        /// </summary>
        public doubleSvdRandomizedWorkspace doubleSvdRandomizedWorkspace(int m, int n, int k)
            => doubleSvdRandomizedWorkspace(m, n, k, 10);
    }
}
