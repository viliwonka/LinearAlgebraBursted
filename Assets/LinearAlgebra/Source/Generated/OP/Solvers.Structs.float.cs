namespace LinearAlgebra
{
    ...
    public struct floatLstsqInfo
    {
        ...
        public static implicit operator bool(floatLstsqInfo info) => info.status == SolveStatus.Converged;
    }

    /// <summary>
    /// Result of a square-system Krylov solve (<c>cg</c> / <c>conjugateGradient</c> / <c>pcg</c> /
    /// <c>minres</c> / <c>biCGStab</c> / <c>cgne</c>). Same contract as <see cref="floatLstsqInfo"/>
    ...
    public struct floatSolveInfo
    {
        ...
        public static implicit operator bool(floatSolveInfo info) => info.status == SolveStatus.Converged;
    }
}
