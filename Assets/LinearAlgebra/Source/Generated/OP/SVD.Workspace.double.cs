namespace LinearAlgebra
{
    ...
    {
        /// <summary>Allocates an SVD-solver workspace sized for an m x n system — see <see cref="doubleSVD_WS"/> for layout. Persistent in this arena; create once outside a hot loop.</summary>
