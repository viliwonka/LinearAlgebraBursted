...
namespace LinearAlgebra
{
    ...
    public static partial class Norms {
        ...
        // to `long`. See longNormsCore.L1 for the abs-overflow care this takes.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1(in longN   a) => longNormsCore.L1(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1(in longMxN a) => longNormsCore.L1(a);

        // L-infinity (max-abs) norm: the largest absolute element, max_i |xᵢ|, widened to `long`.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf(in longN   a) => longNormsCore.LInf(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf(in longMxN a) => longNormsCore.LInf(a);

        // Euclidean (L2) norm: sqrt(Σxᵢ²), as a `double` (see longNormsCore.L2 for the
        // accumulation-precision note).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2(in longN   a) => longNormsCore.L2(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2(in longMxN a) => longNormsCore.L2(a);
    }
    ...
    internal static class longNormsCore
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1<T>(in T a) where T : unmanaged, IUnsafelongArray
        {
            long sum = 0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf<T>(in T a) where T : unmanaged, IUnsafelongArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2<T>(in T a) where T : unmanaged, IUnsafelongArray
        {
            double sum = 0.0;
            for (int i = 0; i < a.Data.Length; i++)
            {
