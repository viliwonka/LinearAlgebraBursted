...
namespace LinearAlgebra
{
    ...
    internal static partial class longQueryCore
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static long WorstScoreForNearest(Metric m)
            => IsSimilarityMetric(m) ? long.MinValue : long.MaxValue;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static long WorstScoreForFarthest(Metric m)
            => IsSimilarityMetric(m) ? long.MaxValue : long.MinValue;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool IsBetterForNearest(long a, long b, Metric m)
            => IsSimilarityMetric(m) ? a > b : a < b;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool IsBetterForFarthest(long a, long b, Metric m)
            => IsSimilarityMetric(m) ? a < b : a > b;
    }
}
