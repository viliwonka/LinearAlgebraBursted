...
namespace LinearAlgebra
{
    ...
    public static partial class LOBPCG
    {
        ...
        /// </summary>
        public static LOBPCGInfo lobpcg<TOp, TPre>(in TOp A, in TPre M, ref floatLOBPCGCache ws,
            ...
            where TPre : struct, IfloatPreconditioner
        {
            ...
            for (int iter = 0; iter < maxIter; iter++)
            {
                ...
                for (int i = numActive - 1; i >= 0; i--)
                {
                    ...
                    for (int c = 0; c < n; c++)
                    {
                        float rv = ws.AX[i, c] - ws.lambda[i] * ws.X[i, c];
                        ws.R[i, c] = rv;
                        rn2 += rv * rv;
                    }
        ...
        static void Deflate(ref floatMxN V, ref floatMxN AV, int activeCount,
                             in floatMxN Against, in floatMxN AgainstA, int againstCount, int n)
        {
        ...
        static void BuildProjected(ref floatMxN Gram, ref floatMxN H, int numActive, bool useP,
                                    in floatMxN X, in floatMxN AX, in floatMxN W, in floatMxN AW,
                                    in floatMxN P, in floatMxN AP, int n)
        {
