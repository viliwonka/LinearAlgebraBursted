...
namespace LinearAlgebra
{
    ...
    public static partial class Query
    {
        ...
        /// </summary>
        public static int nonzero<T>(in T x, float tolerance, ref Indices idx)
            where T : unmanaged, IUnsafefloatArray
        {
        ...
        /// </summary>
        public static int findValue<T>(in T x, float target, float tolerance)
            where T : unmanaged, IUnsafefloatArray
        {
            for (int i = 0; i < x.Data.Length; i++)
            {
        ...
        /// </summary>
        public static int countNonzero<T>(in T x, float tolerance)
            where T : unmanaged, IUnsafefloatArray
        {
            int count = 0;
            for (int i = 0; i < x.Data.Length; i++)
