...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void outerDot(in shortN a, in shortN b, ref shortMxN result)
        {
        ...
        {
            shortMxN result = a.shortTempMat(a.N, b.N, true);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in shortMxN A, in shortN x, ref shortN result)
        {
        ...
        {
            shortN result = x.shortTempVec(A.M_Rows);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in shortN y, in shortMxN A, ref shortN result)
        {
        ...
        {
            shortN result = y.shortTempVec(A.N_Cols);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in shortMxN a, in shortMxN b, ref shortMxN c, bool transposeA = false)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void trans(in shortMxN A, ref shortMxN T)
        {
        ...
        {
            var T = A.shortTempMat(A.N_Cols, A.M_Rows, true);
            trans(in A, ref T);
            return T;
        }
    }
