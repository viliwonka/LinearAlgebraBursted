...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        /// relativeTolerance &lt; 0 selects auto tolerance: relativeTolerance = max(m, n) * Consts.floatZeroThreshold.
                                    ...
                                    ref floatN S, ref floatMxN M, ref floatMxN U, ref floatMxN At)
        {
            ...
            if (m >= n) {
                ...
                float tol = relativeTolerance * S[0];
                int rank = 0;
        ...
        /// </summary>
        public static RankInfo pinvSolve(ref floatMxN A, in floatN b, ref floatN x,
                                    ref floatSVDCache ws, float relativeTolerance, int maxSweeps)
        ...
        public static RankInfo pinvSolve(ref floatMxN A, in floatN b, ref floatN x,
                                    ref floatSVDCache ws, float relativeTolerance)
