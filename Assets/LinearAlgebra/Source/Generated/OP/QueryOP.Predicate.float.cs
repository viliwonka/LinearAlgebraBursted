...
namespace LinearAlgebra
{
    ...
    // IsBetterForNearest, and WorstScoreForNearest from QueryOP.float.cs.
    //
    // Groups:
    ...
    //   score = floatQueryCore.WorstScoreForNearest(m) (float.MaxValue for distance metrics,
    //   float.MinValue for similarity metrics). Callers must check index == -1 before use.
    ...
    public static partial class Query
    {
        ...
        /// Generic over floatN and floatMxN (row-major flat index for matrices).
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int findFirst<P>(in floatN   x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.findFirst(in x, ref pred);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int findFirst<P>(in floatMxN x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.findFirst(in x, ref pred);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int count<P>(in floatN   x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.count(in x, ref pred);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int count<P>(in floatMxN x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.count(in x, ref pred);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool any<P>(in floatN   x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.any(in x, ref pred);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool any<P>(in floatMxN x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.any(in x, ref pred);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool all<P>(in floatN   x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.all(in x, ref pred);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool all<P>(in floatMxN x, ref P pred) where P : struct, IfloatPredicate => floatQueryCore.all(in x, ref pred);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int findAll<P>(in floatN   x, ref P pred, ref Indices idx) where P : struct, IfloatPredicate => floatQueryCore.findAll(in x, ref pred, ref idx);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int findAll<P>(in floatMxN x, ref P pred, ref Indices idx) where P : struct, IfloatPredicate => floatQueryCore.findAll(in x, ref pred, ref idx);
        ...
        /// </summary>
        public static int countRows<P>(in floatMxN A, ref P pred)
            where P : struct, IfloatRowPredicate
        {
            int c = 0;
        ...
        /// </summary>
        public static int whichRows<P>(in floatMxN A, ref P pred, ref Indices idx)
            where P : struct, IfloatRowPredicate
        {
            if (idx.N < A.M_Rows)
        ...
        /// </summary>
        public static int countColumns<P>(in floatMxN A, ref P pred)
            where P : struct, IfloatColPredicate
        {
            int c = 0;
        ...
        /// Empty matrix returns 0.
        /// </summary>
        public static int whichColumns<P>(in floatMxN A, ref P pred, ref Indices idx)
            where P : struct, IfloatColPredicate
        {
            if (idx.N < A.N_Cols)
        ...
        ///   score = float.MaxValue for distance metrics, float.MinValue for similarity.
        ...
        /// </summary>
        public static void nearestRowWhere<P>(in floatMxN A, in floatN q, Metric m, ref P pred,
            out int index, out float score)
            where P : struct, IfloatRowPredicate
        {
            if (A.M_Rows == 0)
            ...
            for (int r = 0; r < A.M_Rows; r++)
            {
                ...
                if (bestIdx == -1 || floatQueryCore.IsBetterForNearest(s, best, m)) { best = s; bestIdx = r; }
            }
            index = bestIdx;
            score = best;
        }
        ...
        /// </summary>
        public static int kNearestRowsWhere<P>(in floatMxN A, in floatN q, int k, Metric m,
            ref P pred, ref Indices idx, ref floatN scores)
            where P : struct, IfloatRowPredicate
        {
        ...
        /// </summary>
        public static void nearestColumnWhere<P>(in floatMxN A, in floatN q, Metric m, ref P pred,
            out int index, out float score)
            where P : struct, IfloatColPredicate
        {
            if (A.N_Cols == 0)
            ...
            for (int c = 0; c < A.N_Cols; c++)
            {
                ...
                if (bestIdx == -1 || floatQueryCore.IsBetterForNearest(s, best, m)) { best = s; bestIdx = c; }
            }
            index = bestIdx;
            score = best;
        }
        ...
        /// idx and scores must have length >= k.
        /// </summary>
        public static int kNearestColumnsWhere<P>(in floatMxN A, in floatN q, int k, Metric m,
            ref P pred, ref Indices idx, ref floatN scores)
            where P : struct, IfloatColPredicate
        {
        ...
        /// </summary>
        public static void argMaxRowBy<S>(in floatMxN A, ref S scorer, out int index, out float score)
            where S : struct, IfloatRowScore
        {
            if (A.M_Rows == 0)
        ...
        /// On ties the first occurrence wins. Throws if A has 0 rows.
        /// </summary>
        public static void argMinRowBy<S>(in floatMxN A, ref S scorer, out int index, out float score)
            where S : struct, IfloatRowScore
        {
            if (A.M_Rows == 0)
        ...
        /// </summary>
        public static int topKRowsBy<S>(in floatMxN A, ref S scorer, int k,
            ref Indices idx, ref floatN scores)
            where S : struct, IfloatRowScore
        {
            if (A.M_Rows == 0 || k <= 0) return 0;
            if (idx.N < k)
        ...
        /// </summary>
        public static void argMaxColBy<S>(in floatMxN A, ref S scorer, out int index, out float score)
            where S : struct, IfloatColScore
        {
            if (A.N_Cols == 0)
        ...
        /// On ties the first occurrence wins. Throws if A has 0 columns.
        /// </summary>
        public static void argMinColBy<S>(in floatMxN A, ref S scorer, out int index, out float score)
            where S : struct, IfloatColScore
        {
            if (A.N_Cols == 0)
        ...
        /// </summary>
        public static int topKColsBy<S>(in floatMxN A, ref S scorer, int k,
            ref Indices idx, ref floatN scores)
            where S : struct, IfloatColScore
        {
            if (A.N_Cols == 0 || k <= 0) return 0;
