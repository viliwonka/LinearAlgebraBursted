...
namespace LinearAlgebra
{
    ...
    public static partial class floatComp {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mulInPlace<T>(this T place, float s) where T : unmanaged, IUnsafefloatArray
        {
            unsafe {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void clampInPlace<T>(this T x, float lo, float hi) where T : unmanaged, IUnsafefloatArray
        {
            if (lo > hi)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void absInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.abs(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void signInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.sign(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sqrtInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.sqrt(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void rsqrtInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.rsqrt(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void acosInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.acos(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void asinInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.asin(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void atanInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.atan(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ceilInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.ceil(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void floorInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.floor(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void roundInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.round(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void cosInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.cos(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void coshInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.cosh(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sinInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.sin(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sinhInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.sinh(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void tanInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.tan(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void tanhInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.tanh(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void expInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.exp(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void exp2InPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.exp2(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void exp10InPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.exp10(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void logInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.log(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void log2InPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.log2(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void log10InPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void acoshInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void reluInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.relu(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void powInPlace<T>(this T x, int exponent) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.pow(x.Data.Ptr, x.Data.Length, exponent); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void lerpInPlace<T>(this T a, T b, float t) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.lerp(a.Data.Ptr, b.Data.Ptr, a.Data.Length, t); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void unlerpInPlace<T>(this T a, T b, float t) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.unlerp(a.Data.Ptr, b.Data.Ptr, a.Data.Length, t); }
        }

        // (T a, T b, float t) form: a[i] = smoothstep(a[i], b[i], t) - both edges are buffers.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void smoothstepInPlace<T>(this T a, T b, float t) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.smoothstep(a.Data.Ptr, b.Data.Ptr, a.Data.Length, t); }
        }

        // (T x, float edge0, float edge1) form: x[i] = smoothstep(edge0, edge1, x[i]) - scalar edges.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void smoothstepInPlace<T>(this T x, float edge0, float edge1) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.smoothstep(x.Data.Ptr, x.Data.Length, edge0, edge1); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void stepInPlace<T>(this T x, float edge) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.step(x.Data.Ptr, x.Data.Length, edge); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void saturateInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.saturate(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void fracInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.frac(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void rcpInPlace<T>(this T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.rcp(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void madInPlace<T>(this T a, T b, T c) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.mad(a.Data.Ptr, b.Data.Ptr, c.Data.Ptr, a.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void remapInPlace<T>(this T x, float oldMin, float oldMax, float newMin, float newMax) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.remap(x.Data.Ptr, x.Data.Length, oldMin, oldMax, newMin, newMax); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void degreesInPlace<T>(this T radians) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.degrees(radians.Data.Ptr, radians.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void radiansInPlace<T>(this T degrees) where T : unmanaged, IUnsafefloatArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sincos<T>(this T x, T sin, T cos) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.sincos(x.Data.Ptr, x.Data.Length, sin.Data.Ptr, cos.Data.Ptr); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void atan2InPlace<T>(this T y, T x) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.atan2(y.Data.Ptr, x.Data.Ptr, y.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void minInPlace<T>(this T x, T y) where T : unmanaged, IUnsafefloatArray
        {
            unsafe { UnsafeMathOP.min(x.Data.Ptr, y.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void maxInPlace<T>(this T x, T y) where T : unmanaged, IUnsafefloatArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void absDiffInPlace<T>(this T x, T y) where T : unmanaged, IUnsafefloatArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void sqrDiffInPlace<T>(this T x, T y) where T : unmanaged, IUnsafefloatArray
        {
