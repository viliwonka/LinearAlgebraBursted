...
namespace LinearAlgebra
{
    ...
    public static partial class Bidiag
    {
        ...
        private static void genHouseholderCol(ref floatMxN M, ref floatN u, int k, float zeroThreshold)
        {
            ...
            float xNorm = floatNormsOP.L2Range(u, k, M.M_Rows);
        ...
        private static void genHouseholderRow(ref floatMxN M, ref floatN v, int row, int colStart, float zeroThreshold)
        {
            ...
            float xNorm = floatNormsOP.L2Range(v, colStart, n);
        ...
        public static void bidiagonalize(in floatMxN A, ref floatMxN U, ref floatMxN B, ref floatMxN V)
        {
            ...
            var W = new floatMxN(m, n, Allocator.Temp, true);
            ...
            var leftU = new floatMxN(m, n, Allocator.Temp, false);

            // scratch vectors
            var uVec    = new floatN(m, Allocator.Temp, false);
