...
namespace LinearAlgebra
{
    public static partial class QR {
        ...
        internal static void genHouseholder(ref floatMxN Q, ref floatN u, int k, float zeroThreshold) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void applyReflectorRightCols(ref floatMxN Q, ref floatN u, ref floatN w, int d, int colEnd)
        {
            int M = Q.M_Rows;
            int N = Q.N_Cols;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void applyReflectorRight(ref floatMxN Q, ref floatN u, ref floatN w, int d)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void reconstructQBlocked(ref floatMxN Q,
            ref floatN Vpanel, ref floatN Tbuf, ref floatN Wbuf, ref floatN tcolBuf, ref floatN VfullBuf)
        {
        ...
        /// <param name="A_to_Q">On entry A; on exit the orthogonal factor Q.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref floatMxN A_to_Q, ref floatMxN R, ref floatN u)
        {
            var w = new floatN(A_to_Q.N_Cols, Allocator.Temp, false);
        ...
        /// <param name="A_to_Q">On entry A; on exit the orthogonal factor Q.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref floatMxN A_to_Q, ref floatMxN R)
        {
            // See qrDecompositionBlockedCore for why this is a method-local const, not a class field.
            const int QR_BLOCK = 32;
            ...
            {
                var uSmall = new floatN(A_to_Q.M_Rows, Allocator.Temp, false);
                var wSmall = new floatN(A_to_Q.N_Cols, Allocator.Temp, false);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in floatMxN A, ref floatMxN Q, ref floatMxN R, ref floatN u, ref floatN w)
        {
        ...
        /// <param name="Q">Output only; prior contents ignored; safe to allocate with uninit: true. Receives the orthogonal factor.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in floatMxN A, ref floatMxN Q, ref floatMxN R, ref floatN u)
        {
            if (Q.M_Rows != A.M_Rows || Q.N_Cols != A.N_Cols)
                throw new ArgumentException("QR.decomp: Q must have the same dimensions as A");
        ...
        /// <param name="Q">Output only; prior contents ignored; safe to allocate with uninit: true. Receives the orthogonal factor.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in floatMxN A, ref floatMxN Q, ref floatMxN R)
        {
            if (Q.M_Rows != A.M_Rows || Q.N_Cols != A.N_Cols)
                throw new ArgumentException("QR.decomp: Q must have the same dimensions as A");
        ...
        public static DirectSolveInfo decompSolve(ref floatMxN Q, ref floatMxN R, ref floatN b, ref floatN x) {
            // Solve Ax = b for x
            // A = QR
            // QRx = b
            // Rx = Q^T b
        ...
        /// <param name="x">Output only; prior contents ignored; safe to allocate with uninit: true.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo solveInPlace(ref floatMxN A, ref floatN b, ref floatN x) {
