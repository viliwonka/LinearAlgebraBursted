...
namespace LinearAlgebra
{
    ...
    // node is domain-propagated to a fixpoint before its LP solve (MIP.Domain.double.cs's
    ...
    public static partial class MIP
    {
                                           ...
                                           doubleN xOut)
        {
            ...
            // MIP.Domain.double.cs); rhs-only bound updates (the common plunge/strong-branch case) leave
