...
namespace LinearAlgebra
{
    ...
    public static partial class Solvers {
        ...
        public static void SolveLowerTriangularLU(ref floatMxN L, ref floatN x) {
            if (L.IsSquare == false)
                throw new System.Exception("Solvers.SolveLowerTriangular: Matrix must be square");
        ...
        // Solve Ly = b for, where y = Ux
        // RP = Row Pivot
        public static void SolveLowerTriangularLU(ref floatMxN L, ref Pivot RP, ref floatN x) {
            if (L.IsSquare == false)
                throw new System.Exception("Solvers.SolveLowerTriangular: Matrix must be square");
        ...
        public static void SolveUpperTriangularLU(ref floatMxN U, ref Pivot RP, ref floatN x) {
            //if(U.IsSquare == false)
            //throw new System.Exception("Solvers.SolveUpperTriangular: Matrix must be square");
        ...
        public static void SolveQR(ref floatMxN Q, ref floatMxN R, ref floatN b, out floatN x) {
            // Solve Ax = b for x
            // A = QR
            // QRx = b
            // Rx = Q^T b
