...
namespace LinearAlgebra
{
    ...
    public static partial class Norms {
        ...
        // to `long`. See intNormsCore.L1 for the abs-overflow care this takes.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1(in intN   a) => intNormsCore.L1(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1(in intMxN a) => intNormsCore.L1(a);

        // L-infinity (max-abs) norm: the largest absolute element, max_i |xᵢ|, widened to `long`.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf(in intN   a) => intNormsCore.LInf(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf(in intMxN a) => intNormsCore.LInf(a);

        // Euclidean (L2) norm: sqrt(Σxᵢ²), as a `double` (see intNormsCore.L2 for the
        // accumulation-precision note).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2(in intN   a) => intNormsCore.L2(a);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2(in intMxN a) => intNormsCore.L2(a);
    }
    ...
    internal static class intNormsCore
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long L1<T>(in T a) where T : unmanaged, IUnsafeintArray
        {
            long sum = 0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long LInf<T>(in T a) where T : unmanaged, IUnsafeintArray
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double L2<T>(in T a) where T : unmanaged, IUnsafeintArray
        {
            double sum = 0.0;
            for (int i = 0; i < a.Data.Length; i++)
            {
