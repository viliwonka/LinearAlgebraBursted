...
namespace LinearAlgebra
{
    ...
    internal static partial class intQueryCore
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int WorstScoreForNearest(Metric m)
            => IsSimilarityMetric(m) ? int.MinValue : int.MaxValue;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int WorstScoreForFarthest(Metric m)
            => IsSimilarityMetric(m) ? int.MaxValue : int.MinValue;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool IsBetterForNearest(int a, int b, Metric m)
            => IsSimilarityMetric(m) ? a > b : a < b;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool IsBetterForFarthest(int a, int b, Metric m)
            => IsSimilarityMetric(m) ? a < b : a > b;
    }
}
