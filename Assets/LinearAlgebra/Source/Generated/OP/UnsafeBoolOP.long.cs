...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeBoolOP
    {
        ...
        // rather than among the elementwise math kernels in UnsafeMathOP.long.cs/UnsafeBitsOP.
        // long.cs - see longN.Comparators.cs/longMxN.Comparators.cs for its public surface.
        ...
        //     (countbits/tzcnt/lzcnt/reversebits/ror/rol - see UnsafeBitsOP.long.cs), ispow2 tests
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void ispow2([NoAlias] long* a, [NoAlias] bool* target, int n)
        {
            for (int i = 0; i < n; i++)
            {
                long v = a[i];
                target[i] = v > 0L && (v & (v - 1L)) == 0L;
            }
        }
        #endregion
    }
