namespace LinearAlgebra
{
    ...
    public struct doubleLstsqInfo
    {
        ...
        public static implicit operator bool(doubleLstsqInfo info) => info.status == SolveStatus.Converged;
    }

    /// <summary>
    /// Result of a square-system Krylov solve (<c>cg</c> / <c>conjugateGradient</c> / <c>pcg</c> /
    /// <c>minres</c> / <c>biCGStab</c> / <c>cgne</c>). Same contract as <see cref="doubleLstsqInfo"/>
    ...
    public struct doubleSolveInfo
    {
        ...
        public static implicit operator bool(doubleSolveInfo info) => info.status == SolveStatus.Converged;
    }
}
