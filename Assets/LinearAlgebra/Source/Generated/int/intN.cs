...
namespace LinearAlgebra
{
    ...
    public partial struct intN : IDisposable, IUnsafeintArray {
        ...
        // Value handle, not a pointer: copying an intN (including compiler-inserted defensive
        ...
        public unsafe intN TempCopy()
        {
            ...
            return _arena.intTempVec(in this);   // temp pool (was wrongly the persistent Copy path)
        }
