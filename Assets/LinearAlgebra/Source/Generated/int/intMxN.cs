...
namespace LinearAlgebra
{
    ...
    public partial struct intMxN : IDisposable, IUnsafeintArray {
        ...
        /// arena's record table by the caller (Arena.intMat/intTempMat) -- this ctor only
        /// fills in the record's Data, it does not allocate or own the slot itself.
        /// </summary>
        internal unsafe intMxN(int M_rows, int N_cols, intMatRecord* rec, Allocator allocator, bool uninit = false)
        {
            _rec = rec;
            _inlineData = default;
        ...
        internal unsafe intMxN(in intMxN orig, intMatRecord* rec, Allocator allocator)
        {
            _rec = rec;
            _inlineData = default;
        ...
        private unsafe void AssertRecordValid()
        {
            if (_rec != null && (!ChunkedRecordTable<intMatRecord>.IsAliveFast(_rec) || ChunkedRecordTable<intMatRecord>.GenerationFast(_rec) != _gen))
                throw new InvalidOperationException("intMxN.Data: use of disposed/cleared arena allocation");
        }
#endif
        ...
        public unsafe intMxN Copy()
        {
            ...
            return OwnerArena.intMat(in this);
        }
        ...
        public unsafe intMxN TempCopy()
        {
            ...
            return OwnerArena.intTempMat(in this);
        }
