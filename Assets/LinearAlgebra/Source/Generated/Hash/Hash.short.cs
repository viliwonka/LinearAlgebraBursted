...
namespace LinearAlgebra
{
    public static partial class Hash
    {
        ...
        public static uint hash(in shortN v, uint seed = 0)
        {
            unsafe { return hash((byte*)v.Data.Ptr, v.Data.Length * sizeof(short), seed); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(in shortMxN v, uint seed = 0)
        {
            unsafe { return hash((byte*)v.Data.Ptr, v.Data.Length * sizeof(short), seed); }
        }
        ...
        // always spelled via the real `shortN` placeholder token but immediately CHOSEN to the fixed
        ...
        /// </summary>
        public static void rowHashes(in shortMxN A, ref uintN dest, uint seed = 0)
        {
            if (dest.N != A.M_Rows)
            ...
            unsafe
            {
                int rowBytes = A.N_Cols * sizeof(short);
        ...
        public static uintN rowHashes(in shortMxN A, uint seed = 0)
        {
        ...
        /// </summary>
        public static void colHashes(in shortMxN A, ref uintN dest, uint seed = 0)
        {
            if (dest.N != A.N_Cols)
            ...
            var col = A.shortTempVec(A.M_Rows);
            unsafe
            {
                int byteLen = A.M_Rows * sizeof(short);
                uint* destPtr = (uint*)dest.Data.Ptr;
        ...
        /// fresh arena-backed uint buffer (a uintN) instead of writing into a caller-provided one.</summary>
        public static uintN colHashes(in shortMxN A, uint seed = 0)
        {
