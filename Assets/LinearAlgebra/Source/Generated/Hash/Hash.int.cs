...
namespace LinearAlgebra
{
    public static partial class Hash
    {
        ...
        public static uint hash(in intN v, uint seed = 0)
        {
            unsafe { return hash((byte*)v.Data.Ptr, v.Data.Length * sizeof(int), seed); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(in intMxN v, uint seed = 0)
        {
            unsafe { return hash((byte*)v.Data.Ptr, v.Data.Length * sizeof(int), seed); }
        }
        ...
        /// </summary>
        public static void rowHashes(in intMxN A, ref uintN dest, uint seed = 0)
        {
            if (dest.N != A.M_Rows)
            ...
            unsafe
            {
                int rowBytes = A.N_Cols * sizeof(int);
        ...
        public static uintN rowHashes(in intMxN A, uint seed = 0)
        {
        ...
        /// </summary>
        public static void colHashes(in intMxN A, ref uintN dest, uint seed = 0)
        {
            if (dest.N != A.N_Cols)
            ...
            var col = A.intTempVec(A.M_Rows);
            unsafe
            {
                int byteLen = A.M_Rows * sizeof(int);
                uint* destPtr = (uint*)dest.Data.Ptr;
        ...
        /// fresh arena-backed uint buffer (a uintN) instead of writing into a caller-provided one.</summary>
        public static uintN colHashes(in intMxN A, uint seed = 0)
        {
