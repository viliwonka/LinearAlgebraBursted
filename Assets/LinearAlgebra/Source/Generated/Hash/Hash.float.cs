...
namespace LinearAlgebra
{
    ...
    public static partial class Hash
    {
        ...
        public static uint hash(in floatN v, uint seed = 0)
        {
            unsafe { return hash((byte*)v.Data.Ptr, v.Data.Length * sizeof(float), seed); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(in floatMxN v, uint seed = 0)
        {
            unsafe { return hash((byte*)v.Data.Ptr, v.Data.Length * sizeof(float), seed); }
        }
        ...
        // shortcut call (floatMxN's cross-shortcut to uintVec, widened via
        // floatMxN.Shortcuts.cs's own alsoExpand[uint]).
        ...
        /// </summary>
        public static void rowHashes(in floatMxN A, ref uintN dest, uint seed = 0)
        {
            if (dest.N != A.M_Rows)
            ...
            unsafe
            {
                int rowBytes = A.N_Cols * sizeof(float);
        ...
        public static uintN rowHashes(in floatMxN A, uint seed = 0)
        {
        ...
        /// </summary>
        public static void colHashes(in floatMxN A, ref uintN dest, uint seed = 0)
        {
            if (dest.N != A.N_Cols)
            ...
            var col = A.floatTempVec(A.M_Rows);
            unsafe
            {
                int byteLen = A.M_Rows * sizeof(float);
                uint* destPtr = (uint*)dest.Data.Ptr;
        ...
        /// fresh arena-backed uint buffer (a uintN) instead of writing into a caller-provided one.</summary>
        public static uintN colHashes(in floatMxN A, uint seed = 0)
        {
