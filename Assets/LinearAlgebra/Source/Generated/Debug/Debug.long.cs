...
namespace LinearAlgebra
{
    ...
    public static partial class Print {
        ...
        public static void Log(in longN a, int start = 0, int end = -1)
        {
            ...
            {
                // widen short/int/long to long so the FixedString interpolation compiles for every long type
                long element = a[i];
        ...
        public static void Log(in longMxN m)
        {
            FixedString4096Bytes str = new FixedString4096Bytes();
