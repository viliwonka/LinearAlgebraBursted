...
namespace LinearAlgebra
{
    ...
    public static partial class Print {
        ...
        public static void Log(in intN a, int start = 0, int end = -1)
        {
            ...
            {
                // widen short/int/long to long so the FixedString interpolation compiles for every int type
                long element = a[i];
        ...
        public static void Log(in intMxN m)
        {
            FixedString4096Bytes str = new FixedString4096Bytes();
