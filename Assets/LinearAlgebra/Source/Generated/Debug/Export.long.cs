...
namespace LinearAlgebra
{
    ...
    // only the cast off the long PROXY struct (which -- like fProxy, see proxyStructs.cs -- only
    ...
    // at the proxy-compile stage (long defines an implicit conversion to int, so the int choice
