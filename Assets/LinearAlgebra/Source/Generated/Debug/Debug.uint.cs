...
namespace LinearAlgebra
{
    ...
    public static partial class Print {
        ...
        public static void Log(in uintN a, int start = 0, int end = -1)
        {
            ...
            {
                // widen short/int/long to long so the FixedString interpolation compiles for every uint type
                long element = a[i];
        ...
        public static void Log(in uintMxN m)
        {
            FixedString4096Bytes str = new FixedString4096Bytes();
