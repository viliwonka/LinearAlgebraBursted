...
namespace LinearAlgebra
{
    ...
    //
    // This used to be hand-authored per type (see git history) because the raw float PROXY struct
    ...
    // stage (float defines an implicit conversion to float, so the float choice is a direct
