...
namespace LinearAlgebra
{
    ...
    {
        public static bool isZero(in intN a)
        {
            for (int i = 0; i < a.N; i++) {
                if (a[i] != 0)
                    return false;
        ...
        public static bool isZero(in intMxN m)
        {
        ...
        public static bool isIdentity(in intMxN A)
        {
        ...
        public static bool isSymmetric(in intMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isDiagonal(in intMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isUpperTriangular(in intMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isLowerTriangular(in intMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
