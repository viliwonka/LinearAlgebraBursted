...
namespace LinearAlgebra.Realtime
{
    ...
    /// <see cref="AsMatrix(ref floatMxN)"/> materializes the window time-ordered into a contiguous
    ...
    /// </summary>
    public struct floatRollingWindow
    {
        private floatMxN _buffer;   // Capacity rows × Features cols, ring storage
        ...
        /// </summary>
        public void Push(in floatN sample)
        {
        ...
        public void GetSample(int i, ref floatN dest)
        {
            if (dest.N != _features)
        ...
        /// </summary>
        public void AsMatrix(ref floatMxN dest)
        {
        ...
        /// </summary>
        public void Mean(ref floatN dest)
        {
            if (_count == 0)
        ...
        public floatN Mean()
        {
            var v = _buffer.tempfloatVec(_features);
            Mean(ref v);
            return v;
        }
        ...
        /// </summary>
        public void Covariance(ref floatMxN dest)
        {
            if (_count < 2)
        ...
        {
            var c = _buffer.tempfloatMat(_features, _features);
            Covariance(ref c);
            return c;
        }
    }
    ...
    public static partial class floatRealtimeArena
    {
        /// <summary>
