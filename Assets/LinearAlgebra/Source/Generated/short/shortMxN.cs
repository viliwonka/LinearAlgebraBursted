...
namespace LinearAlgebra
{
    ...
    public partial struct shortMxN : IDisposable, IUnsafeshortArray {
        ...
        // Value handle, not a pointer: copying an shortMxN (including compiler-inserted
        ...
        public unsafe shortMxN(int M_rows, int N_cols, in Arena arena, bool uninit = false)
        {
            ...
            N_Cols = N_cols;
            Length = M_Rows * N_Cols;
            var data = new UnsafeList<short>(Length, _arena.Allocator, uninit? NativeArrayOptions.UninitializedMemory : NativeArrayOptions.ClearMemory );
            data.Resize(Length, NativeArrayOptions.UninitializedMemory);
            Data = data;
        }
        ...
        public unsafe shortMxN Copy()
        {
            ...
            return _arena.shortMat(in this);
        }
        ...
        public unsafe shortMxN TempCopy()
        {
            ...
            return _arena.shortTempMat(in this);
        }
