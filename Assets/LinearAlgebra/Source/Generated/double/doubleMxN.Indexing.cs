...
namespace LinearAlgebra
{
    ...
    public partial struct doubleMxN : IDisposable, IUnsafedoubleArray {
        ...
        /// <returns></returns>
        public ref double this[int r, int c]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
        ...
        /// <returns></returns>
        public ref double this[int r, System.Index indexC]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
        ...
        /// <param name="indexC">col, where n = cols</param>
        /// <returns></returns>
        public ref double this[System.Index indexR, int c]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
        ...
        /// <param name="indexC">col, where n = cols</param>
        /// <returns></returns>
        public ref double this[System.Index indexR, System.Index indexC]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
