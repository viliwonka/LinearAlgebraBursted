...
namespace LinearAlgebra
{
    ...
    // n = cols
    //
    // [StructLayout(Sequential)]: pins field order/packing explicitly (matches doubleN's existing
    ...
    public partial struct doubleMxN : IDisposable, IUnsafedoubleArray {
        ...
        // doubleN's option, cannot tell "still the same allocation" from "a new one that reused this
        // slot number").
        ...
        // doc comment). Unlike doubleN (Alive-only), doubleMxN also has
