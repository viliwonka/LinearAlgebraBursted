...
namespace LinearAlgebra
{
    ...
    public partial struct doubleMxN : IDisposable, IUnsafedoubleArray {
        ...
        // Value handle, not a pointer: copying a doubleMxN (including compiler-inserted
        ...
        public unsafe doubleMxN(int M_rows, int N_cols, in Arena arena, bool uninit = false)
        {
            ...
            N_Cols = N_cols;
            Length = M_Rows * N_Cols;
            var data = new UnsafeList<double>(Length, _arena.Allocator, uninit? NativeArrayOptions.UninitializedMemory : NativeArrayOptions.ClearMemory );
            data.Resize(Length, NativeArrayOptions.UninitializedMemory);
            Data = data;
        }
        ...
        public unsafe doubleMxN Copy()
        {
            ...
            return _arena.doubleMat(in this);
        }
