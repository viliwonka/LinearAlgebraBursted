...
namespace LinearAlgebra.ML
{
    ...
    ///
    /// No floatPCACache: PCA fits once (no per-frame restart loop like k-means), so each method allocates
    ...
    public static partial class PCA
    {
        ...
        /// Returns true iff the underlying <see cref="Eigen.symmetric(ref floatMxN, ref floatN, ref floatMxN)"/>
