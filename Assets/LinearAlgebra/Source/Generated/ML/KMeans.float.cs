...
namespace LinearAlgebra.ML
{
    ...
    public static partial class KMeans
    {
        ...
        /// <summary>
        /// Calls <see cref="fit(in floatMxN,int,uint,int,KMeansInit,ref floatMxN,ref Indices,out float,out int,ref floatKMeansCache)"/>
        ...
        /// <summary>
        /// Calls <see cref="fit(ref Arena,in floatMxN,int,uint,int,KMeansInit,out floatMxN,out Indices,out float,out int)"/>
        /// with <c>init = KMeansInit.KMeansPlusPlus</c>.
        /// </summary>
        public static void fit(
            ref Arena arena,
