...
namespace BULA.Gallery
{
    ...
    public static partial class doubleGallery
    {
        ...
        /// about 0); trace = 0.
        /// </summary>
        public static doubleMxN doubleClement(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleWilkinsonPlus(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 3 || (n & 1) == 0)
        ...
        /// det = (−1)^(n−1) · (n−1) · 2^(n−2).
        /// </summary>
        public static doubleMxN doubleFiedler(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// zero can occur.
        /// </summary>
        public static doubleMxN doubleDingDong(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleFrank(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleVandermonde(in doubleN nodes, Allocator allocator = Allocator.Temp)
        {
            if (nodes.N < 1)
        ...
        /// </summary>
        public static doubleMxN doubleCompanion(in doubleN coeffs, Allocator allocator = Allocator.Temp)
        {
            if (coeffs.N < 1)
        ...
        /// </summary>
        public static doubleMxN doubleHadamard(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1 || (n & (n - 1)) != 0)
        ...
        /// </summary>
        public static doubleMxN doubleCirculant(in doubleN c, Allocator allocator = Allocator.Temp)
        {
            if (c.N < 1)
        ...
        /// </summary>
        public static doubleMxN doubleKahan(int n, double c, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// |alpha| or alpha ≪ 0.
        /// </summary>
        public static doubleMxN doubleTriw(int n, double alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleLauchli(int n, double eps, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("doubleLauchli: n must be >= 1");

            var mat = new doubleMxN(n + 1, n, allocator, true);
        ...
        /// </summary>
        public static doubleMxN doubleCauchy(in doubleN x, in doubleN y, Allocator allocator = Allocator.Temp)
        {
            if (x.N != y.N)
            ...
            int n = x.N;
            var A = new doubleMxN(n, n, allocator, true);
        ...
        /// </summary>
        public static doubleMxN doubleGCD(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleRedheffer(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleMagic(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1 || (n & 1) == 0)
        ...
        /// </summary>
        public static doubleMxN doubleRosser(Allocator allocator = Allocator.Temp)
        {
            var A = new doubleMxN(8, 8, allocator, true);
        ...
        /// </summary>
        public static doubleMxN doubleParter(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleProlate(int n, double w, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleGrcar(int n, int k = 3, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleLotkin(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
