// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/Gallery/GalleryDense.SPD.fProxy.cs
...
namespace BULA.Gallery
{
    ...
    public static partial class doubleGallery
    {
        ...
        /// </summary>
        public static doubleMxN doubleHilbert(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doublePascal(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleLehmer(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleMinIJ(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// |ρ| ≥ 1 or negative ρ can be used as test inputs (same convention as doubleHilbert).
        /// </summary>
        public static doubleMxN doubleKMS(int n, double rho, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// SPD is the caller's responsibility — the generator is intentionally permissive, so
        /// degenerate/indefinite α can be used as test inputs (same convention as doubleHilbert).
        /// </summary>
        public static doubleMxN doublePei(int n, double alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// doubleHilbert. Default α = −1.
        /// </summary>
        public static doubleMxN doubleMoler(int n, double alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static doubleMxN doubleMoler(int n, Allocator allocator = Allocator.Temp)
            => doubleMoler(n, (double)(-1), allocator);
        ...
        /// </summary>
        public static doubleMxN doubleLaplacian1D(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
