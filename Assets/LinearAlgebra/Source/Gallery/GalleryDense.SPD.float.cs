...
namespace LinearAlgebra.Gallery
{
    ...
    public static partial class floatGallery
    {
        ...
        /// </summary>
        public static floatMxN floatHilbert(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatPascal(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatLehmer(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatMinIJ(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// |ρ| ≥ 1 or negative ρ can be used as test inputs (same convention as floatHilbert).
        /// </summary>
        public static floatMxN floatKMS(int n, float rho, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// SPD is the caller's responsibility — the generator is intentionally permissive, so
        /// degenerate/indefinite α can be used as test inputs (same convention as floatHilbert).
        /// </summary>
        public static floatMxN floatPei(int n, float alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// floatHilbert. Default α = −1.
        /// </summary>
        public static floatMxN floatMoler(int n, float alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatMoler(int n, Allocator allocator = Allocator.Temp)
            => floatMoler(n, (float)(-1), allocator);
        ...
        /// </summary>
        public static floatMxN floatLaplacian1D(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
