// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/Gallery/GalleryDense.Special.fProxy.cs
...
namespace BULA.Gallery
{
    ...
    /// Opt in via <c>using BULA.Gallery;</c> then call e.g. <c>floatGallery.floatFrank(n)</c>.
    /// </summary>
    public static partial class floatGallery
    {
        ...
        /// about 0); trace = 0.
        /// </summary>
        public static floatMxN floatClement(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("floatClement: n must be >= 1");

            var mat = new floatMxN(n, n, allocator, true);
        ...
        /// </summary>
        public static floatMxN floatWilkinsonPlus(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 3 || (n & 1) == 0)
        ...
        /// <see cref="floatWilkinsonPlus"/>. At n = 3 the spectrum is {−√3, 0, √3}.
        /// </summary>
        public static floatMxN floatWilkinsonMinus(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 3 || (n & 1) == 0)
                throw new ArgumentException("floatWilkinsonMinus: n must be an odd integer >= 3");
        ...
        /// det = (−1)^(n−1) · (n−1) · 2^(n−2).
        /// </summary>
        public static floatMxN floatFiedler(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// zero can occur.
        /// </summary>
        public static floatMxN floatDingDong(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatFrank(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatVandermonde(in floatN nodes, Allocator allocator = Allocator.Temp)
        {
            if (nodes.N < 1)
        ...
        /// </summary>
        public static floatMxN floatCompanion(in floatN coeffs, Allocator allocator = Allocator.Temp)
        {
            if (coeffs.N < 1)
        ...
        /// </summary>
        public static floatMxN floatHadamard(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1 || (n & (n - 1)) != 0)
        ...
        /// </summary>
        public static floatMxN floatCirculant(in floatN c, Allocator allocator = Allocator.Temp)
        {
            if (c.N < 1)
        ...
        /// </summary>
        public static floatMxN floatKahan(int n, float c, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("floatKahan: n must be >= 1");

            float cc = c;
            float s  = math.sqrt((float)1 - c * c);
            var mat = new floatMxN(n, n, allocator, true);
        ...
        /// |alpha| or alpha ≪ 0.
        /// </summary>
        public static floatMxN floatTriw(int n, float alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatLauchli(int n, float eps, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("floatLauchli: n must be >= 1");

            var mat = new floatMxN(n + 1, n, allocator, true);
        ...
        /// </summary>
        public static floatMxN floatCauchy(in floatN x, in floatN y, Allocator allocator = Allocator.Temp)
        {
            if (x.N != y.N)
            ...
            int n = x.N;
            var A = new floatMxN(n, n, allocator, true);
        ...
        /// </summary>
        public static floatMxN floatGCD(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatRedheffer(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatMagic(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1 || (n & 1) == 0)
        ...
        /// </summary>
        public static floatMxN floatRosser(Allocator allocator = Allocator.Temp)
        {
            var A = new floatMxN(8, 8, allocator, true);
        ...
        /// </summary>
        public static floatMxN floatParter(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatProlate(int n, float w, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
            ...
            for (int i = 0; i < n; i++)
                for (int j = 0; j < n; j++)
                {
                    ...
                    if (k == 0)
                        ...
                        A[i, j] = DetMath.Sin((float)(2.0 * Math.PI) * w * (float)k)
        ...
        /// </summary>
        public static floatMxN floatGrcar(int n, int k = 3, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static floatMxN floatLotkin(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
