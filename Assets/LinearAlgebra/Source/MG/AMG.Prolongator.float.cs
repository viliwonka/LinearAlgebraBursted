...
namespace BULA.Sparse
{
    public static partial class AMG
    {
            ...
            in floatMxN B, out floatMxN Bcoarse, Allocator allocator = Allocator.Temp)
        {
            ...
            Bcoarse = new floatMxN(numAgg * m, m, allocator);   // fresh alloc clears (uninit=false default)

            var builder = new floatBSRBuilder(nb, numAgg, BR, m, Allocator.Temp, math.max(1, nb));
