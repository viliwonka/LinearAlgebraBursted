...
namespace LinearAlgebra.Sparse
{
    public static partial class AMG
    {
        ...
        /// </summary>
        public static doubleBSR galerkinRAP(in doubleBSR A, in doubleBSR T, in Indices aggId, int numAgg, ref Arena arena)
        {
            if (A.Symmetric)
            ...
            var builder = arena.doubleBSRBuilder(numAgg, numAgg, m, m, math.max(1, A.Nnzb));
