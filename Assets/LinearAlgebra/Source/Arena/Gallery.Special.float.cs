// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/Arena/Gallery.Special.fProxy.cs
...
namespace LinearAlgebra.Gallery
{
    ...
    public static partial class floatGallery
    {
        ...
        /// </summary>
        public static floatMxN floatKahan(this ref Arena arena, int n, float c)
        {
            if (n < 1)
