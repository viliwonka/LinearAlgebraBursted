...
namespace LinearAlgebra
{
    public static partial class Krylov
    {
            ...
            where TPre : struct, IfloatPreconditioner
        {
            ...
            unsafe
            {
                float* rPtr = r.Data.Ptr, pPtr = p.Data.Ptr, ApPtr = Ap.Data.Ptr, zPtr = z.Data.Ptr,
            ...
            where TPre : struct, IfloatPreconditioner
        {
            ...
            floatN rOld = b.floatTempVec(A.Rows);
            return fcg(in A, in M, in b, ref x, ref r, ref p, ref Ap, ref z, ref rOld, maxIter, tol);
        }

        /// <summary>
        /// Flexible CG with default maxIter (A.Rows) and tol (Consts.floatSqrtEps).
        /// </summary>
        public static SolveInfo fcg<TOp, TPre>(in TOp A, in TPre M, in floatN b, ref floatN x)
            where TOp : struct, IfloatLinearOperator
            where TPre : struct, IfloatPreconditioner
        {
            return fcg(in A, in M, in b, ref x, A.Rows, Consts.floatSqrtEps);
        }
    }
}
