...
namespace BULA
{
    public static partial class SVD {
        ...
        /// Allocates temporaries from Allocator.Temp via floatTempVec/floatTempMat (not an InPlace op).
        ...
        /// <summary>
        /// pinvSolve using a reusable workspace (the floatSVDCache(m, n, allocator) ctor) — zero-alloc.
        ...
        /// <summary>
        /// pseudoInverse using a reusable workspace (the floatSVDCache(m, n, allocator) ctor) — zero-alloc.
        ...
        /// <summary>pinvSolve (multi-RHS) using a reusable workspace (the floatSVDCache(m, n, allocator) ctor) — zero-alloc.</summary>
        public static RankInfo pinvSolve(ref floatMxN A, in floatMxN B, ref floatMxN X,
                                    ref floatSVDCache ws, float relTol, int maxSweeps)
            => pinvSolve(ref A, in B, ref X, relTol, maxSweeps, ref ws.S, ref ws.M, ref ws.U, ref ws.At);
