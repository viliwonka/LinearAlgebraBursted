...
namespace LinearAlgebra
{
    public static partial class LP
    {
        ...
        /// block-sparse <see cref="floatBSR"/>. The sparse counterpart of the dense
        /// <see cref="lad(in floatMxN, in floatN, ref floatN, out double, int)"/>; forwards to
        /// <see cref="ladFN(in floatBSR, in floatN, ref floatN, out double, int)"/>. There is no
        ...
        /// </summary>
        public static LPInfo lad(in floatBSR A, in floatN b, ref floatN x, out double objective,
                                 int maxIter = 0)
            ...
            where TDesign : struct, IfloatLadDesign
        {
            ...
            while (status != LPStatus.Optimal && iters < budget)
            {
                ...
                {
                    float dj = M[j, j];
                    dscale[j] = dj > (float)0 ? (float)1 / math.sqrt(dj) : (float)1;
                }
                for (int r = 0; r < n; r++)
                    for (int c = 0; c < n; c++)
        ...
        static double ComplementarityGap(floatN z, floatN a, floatN w, floatN s, int m)
        {
            double g = 0;
