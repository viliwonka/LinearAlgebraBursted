...
namespace LinearAlgebra
{
    ...
    public static partial class Control
    {
        ...
        /// through the LQR/KF duality mapping (see Kalman.float.cs's file header). The separation
        ...
        public static LQGInfo lqg(in floatMxN A, in floatMxN B, in floatMxN H,
                                  in floatMxN Qlqr, in floatMxN Rlqr,
                                  in floatMxN Qkf, in floatMxN Rkf,
                                  ref floatMxN Klqr, ref floatMxN Kkf, int maxIterations = 0)
        {
