...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        /// <see cref="IfloatPreconditioner"/> (ILU0/SPAI/restricted-Schwarz) -- forwards into
        /// <see cref="biCGStab{TOp,TPre}"/> via <c>floatBSROperator</c>.
        /// </summary>
        public static SolveInfo biCGStab<TPre>(in floatBSR A, in TPre M, in floatN b, ref floatN x,
                               int maxIter, float tol)
            where TPre : struct, IfloatPreconditioner
        {
            floatN r     = b.floatTempVec(A.M_Rows);
