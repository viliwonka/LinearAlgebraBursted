...
namespace BULA
{
    public static partial class LQ {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo minNormSolve(in doubleMxN A, in doubleN b, ref doubleN x)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo minNormSolve(in doubleMxN A, in doubleN b, ref doubleN x, ref doubleLQMinNormCache ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        public static DirectSolveInfo minNormSolve(in doubleMxN A, in doubleMxN B, ref doubleMxN X)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            int k = B.N_Cols;
