...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        /// generic over <see cref="IdoubleLinearOperator"/>. Block generalization of <see
        ...
        /// </summary>
        public static BlockSolveInfo bcraigmr<TOp>(in TOp A, in doubleMxN B, ref doubleMxN X, int maxIter, double tol)
            where TOp : struct, IdoubleLinearOperator
        {
            ...
            var LA      = new doubleMxN(s, s, Allocator.Temp, true);   // current block bidiag diagonal
            var U       = new doubleMxN(s, m, Allocator.Temp, true);
            var V       = new doubleMxN(s, n, Allocator.Temp, true);
            var RhoBar  = new doubleMxN(s, s, Allocator.Temp, true);   // running (unfinalized) R-factor pivot
            var ZetaBar = new doubleMxN(s, s, Allocator.Temp, true);   // running RHS carry
            var Theta   = new doubleMxN(s, s, Allocator.Temp, false);  // 0s -- R-factor super-diagonal block
            var D       = new doubleMxN(s, n, Allocator.Temp, false);  // 0s -- running x-direction block

            // ---- per-round scratch (s x s) ----
            var LBnew       = new doubleMxN(s, s, Allocator.Temp, true);
            var LBnewT      = new doubleMxN(s, s, Allocator.Temp, true);
            var Rho         = new doubleMxN(s, s, Allocator.Temp, true);
            var RhoT        = new doubleMxN(s, s, Allocator.Temp, true);
            ...
            var ThetaT      = new doubleMxN(s, s, Allocator.Temp, true);
            var ThetaNew    = new doubleMxN(s, s, Allocator.Temp, true);
            var RhoBarNew   = new doubleMxN(s, s, Allocator.Temp, true);
            var ZetaBarNew  = new doubleMxN(s, s, Allocator.Temp, true);
            var Zeta        = new doubleMxN(s, s, Allocator.Temp, true);
            ...
            var ThetaTD  = new doubleMxN(s, n, Allocator.Temp, true);
            var RHSD     = new doubleMxN(s, n, Allocator.Temp, true);
            var Dnew     = new doubleMxN(s, n, Allocator.Temp, true);
            var XTerm    = new doubleMxN(s, n, Allocator.Temp, true);
            var BackTerm = new doubleMxN(s, n, Allocator.Temp, true);
            ...
            for (int k = 0; k < maxIter; k++)
            {
                ...
                BlockAdd(ref RHSD, in ThetaTD, (double)(-1));
                ...
                BlockAdd(ref X, in XTerm, (double)1);
                iters = k + 1;
                ...
                BlockAdd(ref Sbar, in BackTerm, (double)(-1));
        ...
        /// <summary>Block CRAIGMR over a dense <see cref="doubleMxN"/> A (wide or square, full row
        /// rank). Forwards into <see cref="bcraigmr{TOp}"/> via <see cref="doubleDenseOperator"/>.</summary>
        public static BlockSolveInfo bcraigmr(in doubleMxN A, in doubleMxN B, ref doubleMxN X, int maxIter, double tol)
            => bcraigmr(new doubleDenseOperator(in A), in B, ref X, maxIter, tol);

        /// <summary>Block CRAIGMR over a dense A with default maxIter (A.M_Rows) and tol
        /// (Consts.doubleSqrtEps).</summary>
        public static BlockSolveInfo bcraigmr(in doubleMxN A, in doubleMxN B, ref doubleMxN X)
            => bcraigmr(in A, in B, ref X, A.M_Rows, Consts.doubleSqrtEps);
    }
}
