...
namespace BULA
{
    public static partial class SVD {
        ...
        /// the doubleSVDTruncatedCache(m, n, k, oversample, allocator) ctor using the SAME k and oversample.
        /// </summary>
                                        ...
                                        bool partialReorth, ref doubleSVDTruncatedCache ws)
        {
            ...
            unsafe
            {
                ...
                for (int i = 0; i < n; i++)
                    v0[i] = (double)(rng.NextDouble() * 2.0 - 1.0);   // full-precision seed for the double variant
                ...
                if (partialReorth)
                {
                    ...
                    double epsFloor = (double)1.5 * eps;                          // reset level for orthogonalized ω
                    ...
                    for (int j = 0; j < p; j++)
                    {
                        ...
                        anorm = math.max(anorm, (double)1.01 * svdAnormBlock(ws.alpha[j], j > 0 ? ws.beta[j - 1] : (double)0));
                        ...
                        anorm = math.max(anorm, (double)1.01 * svdAnormBlock(ws.alpha[j], ws.beta[j]));
        ...
        /// Pass a workspace from the doubleSVDTruncatedCache(m, n, k, allocator) ctor (no oversample overload)
        ...
        /// the doubleSVDFullCache(m, n, allocator) ctor.
        /// </summary>
