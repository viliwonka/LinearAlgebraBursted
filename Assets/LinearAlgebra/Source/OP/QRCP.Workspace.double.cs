...
namespace LinearAlgebra
{
    public static partial class QRCP
    {
        ...
        /// reflector-apply accumulator w are NOT folded in. Matches the doubleQRCPCache(n, allocator)
        /// constructor.
        /// </summary>
        static void RequireQRCPWorkspace(in doubleQRCPCache cache, int n)
        {
            if (cache.vn1.N != n || cache.vn2.N != n)
                throw new ArgumentException("QRCP: cache must be sized for n columns (use new doubleQRCPCache(n, allocator))");
        }
    }
