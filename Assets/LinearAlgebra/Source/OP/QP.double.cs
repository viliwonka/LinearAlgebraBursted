...
namespace BULA
{
    ...
    public static partial class QP
    {
        ...
        /// scratch: reaches a feasible point via <see cref="LQ.minNormSolve(in doubleMxN, in doubleN, ref doubleN)"/>
        ...
        /// QPEqpTests.double.cs and LP.ladFrischNewtonCore use.
        /// </summary>
                                               ...
                                               bool useIncrementalReduced = true)
        {
            ...
            var red = useIncrementalReduced ? doubleQPReducedState.Create(n) : default;
        ...
        internal static QPInfo qpActiveSetCoreWarm(in doubleMxN Q, in doubleN c, in doubleMxN A, in doubleN b,
                                                   in NativeArray<ConstraintSense> senses,
                                                   in doubleN xl, in doubleN xu,
                                                   ref doubleN x, out double objective, int maxIter,
        ...
        /// </summary>
        internal static QPInfo qpActiveSetCoreWarmPersistent(in doubleMxN Q, in doubleN c, in doubleMxN A, in doubleN b,
                                                             in NativeArray<ConstraintSense> senses,
                                                             in doubleN xl, in doubleN xu,
                                                             ref doubleN x, out double objective, int maxIter,
                                                             NativeArray<byte> wstatusPersist, out int workingSetChanges,
                                                             ref doubleQPFactorState wsf, ref doubleQPReducedState red,
        ...
        internal static QPInfo qpActiveSetLoop(in doubleMxN Q, in doubleN c, in doubleMxN A,
                                               ...
                                               ref doubleQPReducedState red, bool useIncrementalReduced,
        ...
        //
        // The state struct (doubleQPReducedState, Create/Dispose) lives at namespace level below, next
        // to doubleQPFactorState, for the same dtype-collision reason.
        // ============================================================================================
        ...
        internal static void RebuildReduced(in doubleMxN Q, ref doubleQPFactorState s, ref doubleQPReducedState red)
        {
            ...
            var Zt = new doubleMxN(n, nz, Allocator.Temp, true);
            FormNullSpaceBasisFromFactor(ref s, ref Zt);
            var QZt = new doubleMxN(n, nz, Allocator.Temp, true);
            Blas.dot(in Q, in Zt, ref QZt);
            var Hzt = new doubleMxN(nz, nz, Allocator.Temp, true);
        ...
        // fully overwritten.
        internal static void FormNullSpaceColumn(ref doubleQPFactorState s, int seedRow, ref doubleN col)
        {
            int n = s.n;
            for (int i = 0; i < n; i++) col[i] = (double)0;
            col[seedRow] = (double)1;
        ...
        internal static void UpdateReducedOnAdd(ref doubleQPFactorState s, ref doubleQPReducedState red)
        {
            if (red.stale) return;
            int n = s.n;
            int kOld = s.k - 1;
            ...
            for (int i = 0; i < n; i++)
            {
                double acc1 = (double)0, acc2 = (double)0;
            ...
            for (int i = 0; i < nzOld; i++) red.zv[i] -= (double)0.5 * beta * red.u[i];
        ...
        internal static void UpdateReducedOnDrop(in doubleMxN Q, ref doubleQPFactorState s, ref doubleQPReducedState red)
        {
            if (red.stale) return;
            int n = s.n, kNew = s.k;
            int nzOld = n - kNew - 1;
        ...
        internal static DirectSolveInfo SolveReducedNewtonStepCached(ref doubleQPReducedState red, int nz,
                                                                     ref doubleN gz, ref doubleN y, double normInfQ, out bool regularized)
        {
            var Hs = new doubleMxN(nz, nz, Allocator.Temp, true);
            for (int i = 0; i < nz; i++)
    ...
    internal struct doubleQPFactorState
    {
        ...
        public static doubleQPFactorState Create(int n, Allocator alloc = Allocator.Temp)
        {
            ...
            {
                n = n,
                V = new doubleMxN(n, reflCap, alloc, true),
                R = new doubleMxN(n, n, alloc, true),
                ...
                rotC = new doubleN(rotCap, alloc, false),
                rotS = new doubleN(rotCap, alloc, false),
                vCol = new doubleN(n, alloc, false),
                uRefl = new doubleN(n, alloc, false),
                wApply = new doubleN(n, alloc, false),
            };
        }
    ...
    // the same dtype-collision reason as doubleQPFactorState (proxy-free-signature members cannot live
    // on the shared partial QP class).
    internal struct doubleQPReducedState
    {
        // Incremental changes allowed before a from-scratch rebuild (roundoff-drift bound).
        public const int RebuildCap = 16;

        public doubleMxN Z;          // null-space basis, live block n x nz
        public doubleMxN QZ;         // Q·Z, live block n x nz
        public doubleMxN Hz;         // ZᵀQZ, live block nz x nz
        public doubleN u, zv, qzv;   // scratch, length n (reflector tail / Z·û then H_Z·û,r / QZ·û)
        ...
        public static doubleQPReducedState Create(int n, Allocator alloc = Allocator.Temp)
        {
            return new doubleQPReducedState
            {
                ...
                Z = new doubleMxN(n, n, alloc, true),
                QZ = new doubleMxN(n, n, alloc, true),
                Hz = new doubleMxN(n, n, alloc, true),
                u = new doubleN(n, alloc, true),
                zv = new doubleN(n, alloc, true),
                qzv = new doubleN(n, alloc, true),
            };
        }
