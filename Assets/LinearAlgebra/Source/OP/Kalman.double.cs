...
namespace LinearAlgebra
{
    ...
    public static partial class Kalman
    {
        ...
        // is reported.
        static KFInfo UpdateCore(ref doubleKFState s, in doubleMxN H, in doubleN y, in doubleMxN R)
        {
            ...
            if (rinfo.Solved)
            {
                ...
                var Xt = new doubleMxN(m, n, Allocator.Temp);
        ...
        public static void predict(ref doubleKFState s, in doubleMxN A, in doubleMxN B, in doubleN u, in doubleMxN Q)
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.predict: state must be constructed via new doubleKFState(n, mMax, allocator)");
            ...
            s.xNext.addScaledInPlace((double)1, s.Bu);
        ...
        public static void predict(ref doubleKFState s, in doubleMxN A, in doubleMxN Q)
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.predict: state must be constructed via new doubleKFState(n, mMax, allocator)");
            if (!A.IsSquare || A.M_Rows != s.N)
        ...
        /// -- not bounded by <see cref="doubleKFState.MMax"/>; use
        ...
        public static KFInfo update(ref doubleKFState s, in doubleMxN H, in doubleMxN R, in doubleN z)
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.update: state must be constructed via new doubleKFState(n, mMax, allocator)");
            if (H.N_Cols != s.N)
        ...
        /// weights). Pair with <see cref="predictFixed(ref doubleKFState, in doubleMxN, in doubleN, in doubleMxN)"/> /
        ...
        public static LQRInfo steadyStateGain(in doubleMxN A, in doubleMxN H, in doubleMxN Q, in doubleMxN R,
                                              ref doubleMxN Kss, int maxIterations = 0)
        {
            if (!A.IsSquare)
            ...
            var Qs = new doubleMxN(n, n, Allocator.Temp);
            Qs.Data.CopyFrom(Q.Data);
            Qs.mulInPlace(scale);
            var Rs = new doubleMxN(m, m, Allocator.Temp);
        ...
        public static void predictFixed(ref doubleKFState s, in doubleMxN A, in doubleMxN B, in doubleN u)
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.predictFixed: state must be constructed via new doubleKFState(n, mMax, allocator)");
            if (!A.IsSquare || A.M_Rows != s.N)
        ...
        /// <summary>Autonomous overload of <see cref="predictFixed(ref doubleKFState, in doubleMxN, in doubleMxN, in doubleN)"/>: x = Ax.</summary>
        public static void predictFixed(ref doubleKFState s, in doubleMxN A)
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.predictFixed: state must be constructed via new doubleKFState(n, mMax, allocator)");
            if (!A.IsSquare || A.M_Rows != s.N)
        ...
        /// <see cref="doubleKFState.MMax"/> (the dimension <paramref name="s"/> was constructed for);
        ...
        public static void updateFixed(ref doubleKFState s, in doubleMxN Kss, in doubleMxN H, in doubleN z)
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.updateFixed: state must be constructed via new doubleKFState(n, mMax, allocator)");
            int n = s.N, m = s.MMax;
        ...
        /// </summary>
        public static void ekfPredict<TModel>(ref doubleKFState s, in TModel model, in doubleN u, in doubleMxN Q)
            where TModel : struct, IdoubleKFModel
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.ekfPredict: state must be constructed via new doubleKFState(n, mMax, allocator)");
            if (!Q.IsSquare || Q.M_Rows != s.N)
        ...
        public static KFInfo ekfUpdate<TMeas>(ref doubleKFState s, in TMeas meas, in doubleMxN R, in doubleN z)
            where TMeas : struct, IdoubleKFMeasurement
        {
            if (!s.IsCreated)
                throw new ArgumentException("Kalman.ekfUpdate: state must be constructed via new doubleKFState(n, mMax, allocator)");
            int m = z.N;
            if (!R.IsSquare || R.M_Rows != m)
            ...
            var Hjac = new doubleMxN(m, s.N, Allocator.Temp);
        ...
        /// <see cref="IdoubleKFModel.JacobianF"/> implementation. J must be n x n.</summary>
        public static void numericJacobianF<TModel>(in TModel model, in doubleN x, in doubleN u, ref doubleMxN J, double eps)
            where TModel : struct, IdoubleKFModel
        {
            int n = x.N;
            ...
            var fp = new doubleN(n, Allocator.Temp);
            var fm = new doubleN(n, Allocator.Temp);
            ...
            for (int k = 0; k < n; k++)
            {
                ...
                for (int i = 0; i < n; i++)
                    J[i, k] = (fp[i] - fm[i]) / ((double)2 * eps);
            }

            xp.Dispose(); xm.Dispose(); fp.Dispose(); fm.Dispose();
        }

        /// <summary>Overload of <see cref="numericJacobianF{TModel}(in TModel, in doubleN, in doubleN, ref doubleMxN, double)"/>
        /// using <see cref="Consts.doubleSqrtEps"/> as the finite-difference step.</summary>
        public static void numericJacobianF<TModel>(in TModel model, in doubleN x, in doubleN u, ref doubleMxN J)
            where TModel : struct, IdoubleKFModel
            => numericJacobianF(in model, in x, in u, ref J, Consts.doubleSqrtEps);

        /// <summary>Central-difference Jacobian of <paramref name="meas"/>.H at x: J[:,k] =
        /// (H(x+eps·e_k) - H(x-eps·e_k)) / (2·eps). Call from inside a
        /// <see cref="IdoubleKFMeasurement.JacobianH"/> implementation. J must be m x n (m = J.M_Rows).</summary>
        public static void numericJacobianH<TMeas>(in TMeas meas, in doubleN x, ref doubleMxN J, double eps)
            where TMeas : struct, IdoubleKFMeasurement
        {
            ...
            var xp = new doubleN(n, Allocator.Temp);
            var xm = new doubleN(n, Allocator.Temp);
            var hp = new doubleN(m, Allocator.Temp);
            var hm = new doubleN(m, Allocator.Temp);
            ...
            for (int k = 0; k < n; k++)
            {
                ...
                meas.H(in xm, ref hm);
                for (int i = 0; i < m; i++)
                    J[i, k] = (hp[i] - hm[i]) / ((double)2 * eps);
            }

            xp.Dispose(); xm.Dispose(); hp.Dispose(); hm.Dispose();
        }

        /// <summary>Overload of <see cref="numericJacobianH{TMeas}(in TMeas, in doubleN, ref doubleMxN, double)"/>
        /// using <see cref="Consts.doubleSqrtEps"/> as the finite-difference step.</summary>
        public static void numericJacobianH<TMeas>(in TMeas meas, in doubleN x, ref doubleMxN J)
            where TMeas : struct, IdoubleKFMeasurement
            => numericJacobianH(in meas, in x, ref J, Consts.doubleSqrtEps);
    }
}
