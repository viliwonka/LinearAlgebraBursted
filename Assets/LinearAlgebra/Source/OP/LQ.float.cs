...
namespace LinearAlgebra
{
    public static partial class LQ {
        ...
        internal static void genHouseholderRow(ref floatMxN M, ref floatN v, int row, int colStart, float zeroThreshold)
        {
            ...
            {
                // Exact sign-flip reflector (vᵀv must equal 2); Consts.floatSqrt2 is exact per dtype,
                // unlike math.SQRT2 (a float constant). See QR.float.cs for the full note.
                v[colStart] = Consts.floatSqrt2;
            }
        }
        ...
        /// <summary>
        /// decomp using a reusable workspace (the floatLQCache(m, n, Allocator) ctor) — zero-alloc.
        ...
        /// <summary>
        /// minNormSolve using a reusable workspace (the floatLQMinNormCache(m, n, Allocator) ctor) —
        ...
        public static DirectSolveInfo minNormSolveInPlace(ref floatMxN A, in floatN b, ref floatN x)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <summary>
        /// minNormSolveInPlace using a reusable workspace (the floatLQMinNormCache(m, n, Allocator)
        ...
        /// </summary>
        public static DirectSolveInfo minNormSolveInPlace(ref floatMxN A, in floatN b, ref floatN x, ref floatLQMinNormCache ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <param name="B">Right-hand sides (m x k). Not modified.</param>
        /// <param name="X">Output only; prior contents ignored. Solution (n x k). Must not alias B.</param>
        public static DirectSolveInfo minNormSolveInPlace(ref floatMxN A, in floatMxN B, ref floatMxN X)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            int k = B.N_Cols;
