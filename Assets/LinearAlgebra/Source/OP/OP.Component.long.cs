...
namespace LinearAlgebra
{
    ...
    public static partial class longComp {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mulInPlace<T>(this T target, T from) where T : unmanaged, IUnsafelongArray
        {
            unsafe {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void bitwiseLeftShiftInPlace<T>(long valueToBeShifted, T a) where T : unmanaged, IUnsafelongArray {
            unsafe {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void bitwiseRightShiftInPlace<T>(long valueToBeShifted, T a) where T : unmanaged, IUnsafelongArray {
            unsafe {
