...
namespace LinearAlgebra
{
    ...
    public static partial class Eigen
    {
        ...
        /// <summary>lobpcg (allocating) over a BSR matrix with ANY <see cref="IfloatPreconditioner"/>
        /// (block-Jacobi). See the dense overload's doc comment.</summary>
        public static floatN lobpcg<TPre>(ref Arena arena, in floatBSR A, in TPre M, int k,
        ...
        /// <summary>
        /// LOBPCG over a block-sparse pencil (A, B) with ANY <see cref="IfloatPreconditioner"/>
        /// (block-Jacobi) -- GENERALIZED eigenproblem, allocating. See the standard
        /// BSR+preconditioner overload's doc comment.
        /// </summary>
        public static floatN lobpcg<TPre>(ref Arena arena, in floatBSR A, in floatBSR B, in TPre M, int k,
                                      out floatMxN eigenvectors, out LOBPCGInfo info, float tol, int maxIter)
            where TPre : struct, IfloatPreconditioner
        {
            var ws = arena.floatLOBPCGCache(A.M_Rows, k);
