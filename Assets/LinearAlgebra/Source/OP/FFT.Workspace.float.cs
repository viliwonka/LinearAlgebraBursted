...
using BULA.Internal;   // floatW (8-lane AVX helper) for the wide radix-4 butterfly
...
namespace BULA
{
    ...
    public static partial class FFT
    {
        ...
        /// produced by the floatFFTCache(n, allocator) constructor: ws.n == n and table lengths == n/2.
        /// </summary>
        static void RequireFftWorkspace(in floatFFTCache ws, int n, string who)
        {
            if (ws.n != n ||
                ...
                throw new ArgumentException(
                    who + ": workspace must be sized for an n-point FFT (use new floatFFTCache(n, allocator))");
        }
        ...
        static void RequireRadix4Workspace(in floatFFTCache ws, int n, string who)
        {
            ...
            if (ws.twQuarter.N != (n >> 2) + 1)
                throw new ArgumentException(
                    who + ": workspace must have quarter-circle twiddle table (use new floatFFTCache(n, allocator))");
        }
        ...
        /// (build via new floatFFTCache(N, allocator)); it must contain the quarter-circle twiddle table required
