...
namespace LinearAlgebra
{
    ...
    public static partial class FFT
    {
        ...
        // Wide (floatW, 8 float / 4 double lanes) radix-4 DIT for a top-level power-of-4 transform
        // whose size equals the workspace size (ws.n). Digit-reversal, then per-stage butterflies:
        // stages with quarter-stride q >= floatW.Width vectorize across j (Width consecutive j give
