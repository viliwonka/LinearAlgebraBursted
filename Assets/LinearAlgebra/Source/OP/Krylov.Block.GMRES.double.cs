...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        /// right-hand sides, generic over BOTH the operator (<see cref="IdoubleLinearOperator"/>) and
        /// the preconditioner (<see cref="IdoublePreconditioner"/>). Builds ONE shared block Krylov
        ...
        /// </summary>
        public static BlockSolveInfo bgmres<TOp, TPre>(in TOp A, in TPre M, in doubleMxN B, ref doubleMxN X,
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            var V = new UnsafeList<doubleMxN>(m + 1, Allocator.Temp);
            for (int i = 0; i <= m; i++) V.Add(new doubleMxN(s, n, Allocator.Temp, true));
            ...
            var Wbuf   = new doubleMxN(s, n, Allocator.Temp, false);
            var Tbuf   = new doubleMxN(s, n, Allocator.Temp, true);
            var R0     = new doubleMxN(s, n, Allocator.Temp, true);
            var Wcombo = new doubleMxN(s, n, Allocator.Temp, true);

            doubleMxN Zt = default, Zcombo = default;
            doubleN rowIn = default, rowOut = default;
            if (!M.IsIdentity)
            {
                Zt     = new doubleMxN(s, n, Allocator.Temp, true);
                Zcombo = new doubleMxN(s, n, Allocator.Temp, true);
                rowIn  = new doubleN(n);
                rowOut = new doubleN(n);
            }

            var Hbuf = new doubleMxN((m + 1) * s, m * s, Allocator.Temp, true);
            var Gbuf = new doubleMxN((m + 1) * s, s, Allocator.Temp, true);
            ...
            var HQscratch  = new doubleMxN((m + 1) * s, m * s, Allocator.Temp, false);
            var Rscratch   = new doubleMxN(m * s, m * s, Allocator.Temp, true);
            var Yscratch   = new doubleMxN(m * s, s, Allocator.Temp, true);
            var QtGscratch = new doubleMxN(m * s, s, Allocator.Temp, true);

            var Lbuf   = new doubleMxN(s, s, Allocator.Temp, true);
            var HijBuf = new doubleMxN(s, s, Allocator.Temp, true);
            var YiBuf  = new doubleMxN(s, s, Allocator.Temp, true);
            ...
            while (total < maxIter)
            {
                ...
                // invariant: total < maxIter held at cycle entry, so the for-loop body runs at least once).
                {
                    ...
                    for (int i = 0; i < k; i++)
                    {
                        ...
                        BlockAdd(ref Wcombo, in Ti, (double)1);
                    }
                    if (M.IsIdentity)
                    {
                        BlockAdd(ref X, in Wcombo, (double)1);
                    }
                    else
                    {
                        BlockApplyPre(in M, in Wcombo, ref Zcombo, s, n, ref rowIn, ref rowOut);
                        BlockAdd(ref X, in Zcombo, (double)1);
                    }
                }
        ...
        public static BlockSolveInfo bgmres<TOp>(in TOp A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int maxIter, double tol)
            where TOp : struct, IdoubleLinearOperator
        {
            return bgmres(in A, default(doubleIdentityPreconditioner), in B, ref X, restart, maxIter, tol);
        }

        /// <summary>Block GMRES(m) over a dense NON-symmetric <see cref="doubleMxN"/> A, via
        ...
        public static BlockSolveInfo bgmres(in doubleMxN A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int maxIter, double tol)
            => bgmres(new doubleDenseOperatorGeneral(in A), in B, ref X, restart, maxIter, tol);
