...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        /// systems A x = b, generic over BOTH the operator (<see cref="IdoubleLinearOperator"/>)
        /// and the preconditioner (<see cref="IdoublePreconditioner"/>) -- the SINGLE body behind
        ...
        ///
        /// With <see cref="doubleIdentityPreconditioner"/> the IsIdentity fold makes uHat = u, so
        ...
        /// </summary>
        public static SolveInfo tfqmr<TOp, TPre>(in TOp A, in TPre M, in doubleN b, ref doubleN x,
                                         ref doubleN rHat0, ref doubleN u, ref doubleN w, ref doubleN v,
                                         ref doubleN au, ref doubleN d, ref doubleN uHat,
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            double thresh = tol * math.sqrt(bb);
            ...
            rHat0.CopyFrom(in b);
            rHat0.addScaledInPlace((double)(-1), v);

            double tau = math.sqrt(Blas.dot(rHat0, rHat0));
            if (tau <= thresh)
            ...
            v.CopyFrom(in au);
            for (int i = 0; i < A.Rows; i++) d[i] = (double)0;

            double theta = (double)0, eta = (double)0, alpha = (double)0;
            double rho = tau * tau;                        // <rHat0, rHat0> == tau^2 (shadow == r0)
            double rhoLast = rho;
            double bound = tau;
            ...
            for (int k = 0; k < maxIter; k++)
            {
                ...
                if (even)
                {
                    double vtrstar = Blas.dot(rHat0, v);
                    if (vtrstar == (double)0 || math.isnan(vtrstar))
                        return MakeSolveInfo(IterativeSolveStatus.Breakdown, k, bound); // r orthogonal to shadow

                    alpha = rho / vtrstar;
                    if (alpha == (double)0 || math.isnan(alpha))
                ...
                {
                    double rhoNew = Blas.dot(rHat0, w);
                    if (rhoLast == (double)0 || math.isnan(rhoLast))
                        return MakeSolveInfo(IterativeSolveStatus.Breakdown, k + 1, bound); // beta undefined
                    double beta = rhoNew / rhoLast;
                    if (math.isnan(beta))
        ...
        /// <see cref="tfqmr{TOp, TPre}(in TOp, in TPre, in doubleN, ref doubleN, ref doubleN, ref doubleN, ref doubleN, ref doubleN, ref doubleN, ref doubleN, ref doubleN, int, double)"/>
        /// with the identity preconditioner (whose IsIdentity fold strips the uHat traffic), so
        /// this needs no uHat buffer.
        /// </summary>
        public static SolveInfo tfqmr<TOp>(in TOp A, in doubleN b, ref doubleN x,
                                         ref doubleN rHat0, ref doubleN u, ref doubleN w, ref doubleN v,
                                         ref doubleN au, ref doubleN d,
                                         int maxIter, double tol)
            where TOp : struct, IdoubleLinearOperator
        {
            doubleN uHat = default;
            return tfqmr(in A, default(doubleIdentityPreconditioner), in b, ref x, ref rHat0, ref u, ref w, ref v, ref au, ref d, ref uHat, maxIter, tol);
        }

        /// <summary>
        /// TFQMR over a dense <see cref="doubleMxN"/> -- zero-alloc primitive. Forwards into
        /// <see cref="tfqmr{TOp}"/> via <see cref="doubleDenseOperator"/>.
        /// </summary>
        public static SolveInfo tfqmr(in doubleMxN A, in doubleN b, ref doubleN x,
                                    ref doubleN rHat0, ref doubleN u, ref doubleN w, ref doubleN v,
                                    ref doubleN au, ref doubleN d,
                                    int maxIter, double tol)
        {
            return tfqmr(new doubleDenseOperator(in A), in b, ref x, ref rHat0, ref u, ref w, ref v, ref au, ref d, maxIter, tol);
        }

        /// <summary>TFQMR over a dense matrix -- allocates six scratch vectors from the arena.</summary>
        public static SolveInfo tfqmr(in doubleMxN A, in doubleN b, ref doubleN x, int maxIter, double tol)
        {
            ...
            doubleN au    = b.doubleTempVec(A.M_Rows);
            doubleN d     = b.doubleTempVec(A.M_Rows);
            return tfqmr(in A, in b, ref x, ref rHat0, ref u, ref w, ref v, ref au, ref d, maxIter, tol);
        }

        /// <summary>TFQMR over a dense matrix with default maxIter (A.M_Rows) and tol (Consts.doubleSqrtEps).</summary>
        public static SolveInfo tfqmr(in doubleMxN A, in doubleN b, ref doubleN x)
        {
            return tfqmr(in A, in b, ref x, A.M_Rows, Consts.doubleSqrtEps);
        }

        /// <summary>
        /// TFQMR over a block-sparse (BSR) matrix -- zero-alloc primitive. Forwards into
        /// <see cref="tfqmr{TOp}"/> via <c>doubleBSROperator</c>.
        /// </summary>
        public static SolveInfo tfqmr(in doubleBSR A, in doubleN b, ref doubleN x,
                                    ref doubleN rHat0, ref doubleN u, ref doubleN w, ref doubleN v,
                                    ref doubleN au, ref doubleN d,
                                    int maxIter, double tol)
        {
            return tfqmr(new doubleBSROperator(in A), in b, ref x, ref rHat0, ref u, ref w, ref v, ref au, ref d, maxIter, tol);
        }

        /// <summary>TFQMR over a BSR matrix -- allocates six scratch vectors from the arena.</summary>
        public static SolveInfo tfqmr(in doubleBSR A, in doubleN b, ref doubleN x, int maxIter, double tol)
        {
            doubleN rHat0 = b.doubleTempVec(A.M_Rows);
            doubleN u     = b.doubleTempVec(A.M_Rows);
            doubleN w     = b.doubleTempVec(A.M_Rows);
        ...
        /// <summary>TFQMR over a BSR matrix with default maxIter (A.M_Rows) and tol (Consts.doubleSqrtEps).</summary>
        public static SolveInfo tfqmr(in doubleBSR A, in doubleN b, ref doubleN x)
        {
            return tfqmr(in A, in b, ref x, A.M_Rows, Consts.doubleSqrtEps);
        }
                               ...
                               int maxIter, double tol)
        {
            ...
            doubleN au    = b.doubleTempVec(A.M_Rows);
            doubleN d     = b.doubleTempVec(A.M_Rows);
            doubleN uHat  = b.doubleTempVec(A.M_Rows);
            return tfqmr(new doubleBSROperator(in A), in M, in b, ref x,
