...
namespace LinearAlgebra
{
    public static partial class Krylov
    {
        ...
        /// cref="IdoubleLinearOperator"/>) and an SPD preconditioner (<see
        /// cref="IdoublePreconditioner"/>). Same regime as <see cref="minres{TOp}"/> -- A need
        ...
        /// </summary>
        public static SolveInfo pminres<TOp, TPre>(in TOp A, in TPre M, in doubleN b, ref doubleN x,
        ...
        public static SolveInfo pminres<TOp, TPre>(in TOp A, in TPre M, in doubleN b, ref doubleN x)
            ...
            where TPre : struct, IdoublePreconditioner
        {
            return pminres(in A, in M, in b, ref x, A.Rows, Consts.doubleSqrtEps);
        }
        ...
        /// </summary>
        public static SolveInfo pminres(in doubleBSR A, in doubleBlockJacobi M, in doubleN b, ref doubleN x,
                               ref doubleN y, ref doubleN r1, ref doubleN r2, ref doubleN v,
                               ref doubleN w, ref doubleN w1, ref doubleN w2, ref doubleN z,
                               int maxIter, double tol)
        {
        ...
        /// overloads above.
        /// </summary>
        public static SolveInfo pminres(in doubleBSR A, in doubleSSOR M, in doubleN b, ref doubleN x,
                               ref doubleN y, ref doubleN r1, ref doubleN r2, ref doubleN v,
                               ref doubleN w, ref doubleN w1, ref doubleN w2, ref doubleN z,
                               int maxIter, double tol)
        {
        ...
        /// </summary>
        public static SolveInfo pminres(in doubleBSR A, in doubleIC0 M, in doubleN b, ref doubleN x,
                               ref doubleN y, ref doubleN r1, ref doubleN r2, ref doubleN v,
                               ref doubleN w, ref doubleN w1, ref doubleN w2, ref doubleN z,
                               int maxIter, double tol)
        {
        ...
        /// pminres).
        /// </summary>
        public static SolveInfo pminres(in doubleBSR A, in doubleFSAI M, in doubleN b, ref doubleN x,
                               ref doubleN y, ref doubleN r1, ref doubleN r2, ref doubleN v,
                               ref doubleN w, ref doubleN w1, ref doubleN w2, ref doubleN z,
                               int maxIter, double tol)
        {
