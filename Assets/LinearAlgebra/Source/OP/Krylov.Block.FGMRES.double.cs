...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        /// Allocator.Temp.
        ///
        /// With <see cref="doubleIdentityPreconditioner"/> the IsIdentity fold makes Z[j] == V[j]: no Z
        ...
        /// </summary>
        public static BlockSolveInfo bfgmres<TOp, TPre>(in TOp A, in TPre M, in doubleMxN B, ref doubleMxN X,
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            UnsafeList<doubleMxN> Z = default;
            doubleN rowIn = default, rowOut = default;
            if (!M.IsIdentity)
            {
                Z = new UnsafeList<doubleMxN>(m, Allocator.Temp);
                for (int i = 0; i < m; i++) Z.Add(new doubleMxN(s, n, Allocator.Temp, true));
                rowIn  = new doubleN(n);
        ...
        public static BlockSolveInfo bfgmres<TOp>(in TOp A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int maxIter, double tol)
            where TOp : struct, IdoubleLinearOperator
        {
            return bfgmres(in A, default(doubleIdentityPreconditioner), in B, ref X, restart, maxIter, tol);
        }

        /// <summary>Block flexible GMRES(m) over a dense NON-symmetric <see cref="doubleMxN"/> A, via
        ...
        public static BlockSolveInfo bfgmres(in doubleMxN A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int maxIter, double tol)
            => bfgmres(new doubleDenseOperatorGeneral(in A), in B, ref X, restart, maxIter, tol);
