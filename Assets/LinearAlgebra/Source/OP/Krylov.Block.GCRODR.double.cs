...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        static void AddScaledRowToRow(ref doubleMxN dst, int dstRow, double scale, in doubleMxN src, int srcRow, int n)
        {
        ...
        static void ResolveCombinedCol(int ai, int kcurAtEntry, bool flexible,
            in doubleMxN Ublk, in doubleMxN AUblk,
            in UnsafeList<doubleMxN> Vlist, in UnsafeList<doubleMxN> Zlist, in UnsafeList<doubleMxN> AVlist,
            in Indices off, int k,
            out doubleMxN Pmat, out int Prow, out doubleMxN APmat, out int AProw)
        {
            if (ai < kcurAtEntry)
            {
        ...
        static void BackSubUpperBlock(in doubleMxN Ru, int kcur, in doubleMxN Rhs, ref doubleMxN Zout, int s, double pivotGuard)
        {
        ...
        static double MaxAbsRuDiag(in doubleMxN Ru, int kcur)
        {
            double m = (double)0;
        ...
        /// (<see cref="IdoubleLinearOperator"/>) and the preconditioner (<see cref="IdoublePreconditioner"/>).
        ///
        ...
        /// </summary>
        public static BlockSolveInfo bgcrodr<TOp, TPre>(in TOp A, in TPre M, in doubleMxN B, ref doubleMxN X,
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            var CorrBuf = new doubleMxN(s, n, Allocator.Temp, true);

            UnsafeList<doubleMxN> Zv = default;
            doubleN rowIn = default, rowOut = default;
            if (flexible)
            {
                Zv = new UnsafeList<doubleMxN>(m, Allocator.Temp);
                for (int i = 0; i < m; i++) Zv.Add(new doubleMxN(s, n, Allocator.Temp, true));
                rowIn  = new doubleN(n);
            ...
            // instead of an UnsafeList<doubleN> so the projection/uncorrection steps below can use the
            // same GEMM-shaped block helpers bgmres's own machinery uses. ----
            UnsafeList<doubleMxN> AVlist = default;
            doubleMxN Ublk = default, Cblk = default, Ru = default, Bmat = default;
            doubleMxN BijBuf = default, CtrBuf = default, ZprojBuf = default;
            int kcur = 0;
            if (recycling)
            {
                AVlist = new UnsafeList<doubleMxN>(m, Allocator.Temp);
                for (int i = 0; i < m; i++) AVlist.Add(new doubleMxN(s, n, Allocator.Temp, true));

                Ublk = new doubleMxN(recycle, n, Allocator.Temp, true);
                Cblk = new doubleMxN(recycle, n, Allocator.Temp, true);
                Ru   = new doubleMxN(recycle, recycle, Allocator.Temp, true);
                Bmat = new doubleMxN(recycle, m * s, Allocator.Temp, true);
                BijBuf   = new doubleMxN(recycle, s, Allocator.Temp, true);
                CtrBuf   = new doubleMxN(recycle, s, Allocator.Temp, true);
                ZprojBuf = new doubleMxN(recycle, s, Allocator.Temp, true);
            }
            ...
            while (total < maxIter)
            {
                ...
                if (kcur > 0)
                {
                    ...
                    double ruGuard = Consts.doubleEpsilon * (double)100 * MaxAbsRuDiag(in Ru, kcur);
                    ...
                    BlockAdd(ref X, in corr, (double)1);
                ...
                // basis without a second M-apply.
                {
                    ...
                    if (kcur > 0 && totalColsFinal > 0)
                    {
                        ...
                        double ruGuard2 = Consts.doubleEpsilon * (double)100 * MaxAbsRuDiag(in Ru, kcur);
                        ...
                        BlockAdd(ref X, in corr2, (double)(-1));
                    }
                }
                ...
                if (recycling && totalColsFinal > 0)
                {
                    ...
                    doubleMxN AUblk = default;
                    if (hadOldU)
                    {
                        AUblk = new doubleMxN(kcurAtEntry, n, Allocator.Temp, false);   // cleared: AddScaledRowToRow ACCUMULATES (+=) into it
                        ...
                        for (int sIt = 0; sIt < kNew; sIt++)
                        {
                            ...
                            for (int l = 0; l < d; l++)
                            {
                                ...
                                ResolveCombinedCol(l, kcurAtEntry, flexible, in Ublk, in AUblk, in V, in Zv, in AVlist, in off, k,
                                                    out doubleMxN Pl, out int Prow, out doubleMxN APl, out int AProw);
        ...
        public static BlockSolveInfo bgcrodr<TOp>(in TOp A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int recycle, int maxIter, double tol)
            where TOp : struct, IdoubleLinearOperator
        {
            return bgcrodr(in A, default(doubleIdentityPreconditioner), in B, ref X, restart, recycle, maxIter, tol);
        }

        static int doubleBgcrodrDefaultRecycle(int restart, int s) => math.min(10, math.max(0, restart * s - 1));

        /// <summary>Block GCRO-DR over a dense NON-symmetric <see cref="doubleMxN"/> A, via
        /// <see cref="doubleDenseOperatorGeneral"/> (bgmres's own general block-apply route).</summary>
        public static BlockSolveInfo bgcrodr(in doubleMxN A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int recycle, int maxIter, double tol)
            => bgcrodr(new doubleDenseOperatorGeneral(in A), in B, ref X, restart, recycle, maxIter, tol);
        ...
        public static BlockSolveInfo bgcrodr(in doubleMxN A, in doubleMxN B, ref doubleMxN X)
        {
            ...
            return bgcrodr(new doubleDenseOperatorGeneral(in A), in B, ref X, r, doubleBgcrodrDefaultRecycle(r, B.M_Rows), A.M_Rows, Consts.doubleSqrtEps);
        }

        /// <summary>Block GCRO-DR over a block-sparse (BSR) non-symmetric A. Forwards via
        /// doubleBSROperator.</summary>
        public static BlockSolveInfo bgcrodr(in doubleBSR A, in doubleMxN B, ref doubleMxN X,
                                        int restart, int recycle, int maxIter, double tol)
            => bgcrodr(new doubleBSROperator(in A), in B, ref X, restart, recycle, maxIter, tol);
