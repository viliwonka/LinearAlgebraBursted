...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        public static void dot(in doubleMxN a, in doubleMxN b, ref doubleMxN c, bool transposeA = false)
        {
            ...
            unsafe
            {
                ...
                else if (a.Data.Ptr == b.Data.Ptr)
                {
                    ...
                    var bCopy = new doubleMxN(b.M_Rows, b.N_Cols, Unity.Collections.Allocator.Temp, true);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dotSym(in doubleMxN a, in doubleMxN b, ref doubleMxN c)
        {
            Assume.SameDim(a.M_Rows, b.M_Rows);
        ...
        public static void householderInPlace(ref doubleMxN matrix, in doubleN u)
        {
            ...
            for (int j = 0; j < matrix.N_Cols; j++)
            {
                ...
                double scaledProj = scaleFactor * proj;
                for (int i = 0; i < matrix.M_Rows; i++)
