...
namespace LinearAlgebra
{
    public static partial class Krylov
    {
        ...
        /// <see cref="pbiCGStab{TOp,TPre}"/> via <c>doubleBSROperator</c>. SPAI is NOT symmetric
        ...
        /// </summary>
        public static SolveInfo pbiCGStab(in doubleBSR A, in doubleSPAI M, in doubleN b, ref doubleN x,
                               int maxIter, double tol)
        {
            doubleN r     = b.doubleTempVec(A.M_Rows);
            doubleN rHat0 = b.doubleTempVec(A.M_Rows);
