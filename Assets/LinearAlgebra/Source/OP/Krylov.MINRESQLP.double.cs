...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        public static SolveInfo minresQLP<TOp, TPre>(in TOp A, in TPre M, in doubleN b, ref doubleN x,
                                       ...
                                       ref doubleN t1, int maxIter, double tol, double shift)
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            if (shift != (double)0) r2.addScaledInPlace(shift, x);   // r0 = b - (A - shift*I) x
            ...
            for (iters = 1; iters <= maxIter; iters++)
            {
                ...
                A.Apply(in v, ref r3);
                if (shift != (double)0) r3.addScaledInPlace(-shift, v);   // (A - shift*I) v
            ...
            if (shift != (double)0) r1.addScaledInPlace(shift, x);
                ...
                (status == IterativeSolveStatus.Breakdown && (flag == 6 || flag == 9)))
            {
                ...
                else
                {
                    ...
                    if (shift != (double)0) r3.addScaledInPlace(-shift, r1);   // (A - shift*I) r
        ...
        public static SolveInfo minresQLP<TOp, TPre>(in TOp A, in TPre M, in doubleN b, ref doubleN x,
            ...
            where TPre : struct, IdoublePreconditioner
        {
            return minresQLP(in A, in M, in b, ref x, ref v, ref r1, ref r2, ref r3, ref w, ref wl, ref wl2, ref xl2, ref t1, maxIter, tol, (double)0);
        }
        ...
        /// </summary>
        public static SolveInfo minresQLP<TOp, TPre>(in TOp A, in TPre M, in doubleN b, ref doubleN x,
                                          int maxIter, double tol, double shift)
            where TOp : struct, IdoubleLinearOperator
            where TPre : struct, IdoublePreconditioner
        {
            doubleN v   = b.doubleTempVec(A.Rows);
        ...
        /// </summary>
        public static SolveInfo minresQLP(in doubleMxN A, in doubleN b, ref doubleN x, int maxIter, double tol, double shift)
        {
            return minresQLP(new doubleDenseOperator(in A), default(doubleIdentityPreconditioner), in b, ref x, maxIter, tol, shift);
        }
        ...
        /// </summary>
        public static SolveInfo minresQLP(in doubleBSR A, in doubleN b, ref doubleN x, int maxIter, double tol, double shift)
        {
            return minresQLP(new doubleBSROperator(in A), default(doubleIdentityPreconditioner), in b, ref x, maxIter, tol, shift);
        }
    }
}
