...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        static bool AnyZeroOrNaN(in doubleN v, int s)
        {
            for (int i = 0; i < s; i++)
        ...
        static bool AnyNaN(in doubleN v, int s)
        {
            for (int i = 0; i < s; i++)
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            for (int k = 0; k < maxIter; k++)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < s; i++) RowAddScaled(ref V, i, (double)1, in AU, n);  // V += AU (now refreshed)
                }
            }
