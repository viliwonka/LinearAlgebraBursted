...
namespace LinearAlgebra
{
    public static partial class LP
    {
        ...
        // doubleSlackAugmentedOperator (Aₛ = [A | ±slack cols], one per inequality row) and runs the
        ...
        // conditioning for a regression. doubleLadOperator (Aₛ = [A | −A | −I | I]) remains as the
        ...
        /// <see cref="doubleBSR"/>. Forwards to <see cref="ladFN(in doubleBSR, in doubleN, ref doubleN,
