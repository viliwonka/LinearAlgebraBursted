// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/OP/QR.fProxy.cs
    ...
    public static partial class QR {
        ...
        internal static void genHouseholder(ref floatMxN Q, ref floatN u, int k, float zeroThreshold) {
            ...
            if (math.abs(xNorm) > zeroThreshold) {
                ...
                // Consts.floatSqrt2, NOT math.SQRT2 (a FLOAT constant that leaves uᵀu = 2 - 7e-8 in
                // the double build -- an off-by-1e-7 reflector). Float build is bit-identical.
                u[k] = Consts.floatSqrt2;
            }
        }
