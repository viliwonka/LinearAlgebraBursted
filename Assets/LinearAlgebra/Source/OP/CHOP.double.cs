// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/OP/CHOP.fProxy.cs
    ...
    public static partial class CHOP {
        ...
        public static RankInfo decomp(in doubleMxN A, ref doubleMxN L, ref Pivot P,
            ...
            unsafe {
                ...
                var diagBuf = new doubleN(n, Allocator.Temp, false);
                double* diagp = diagBuf.Data.Ptr;
                ...
                for (int j0 = 0; j0 < n; j0 += CHOLP_BLOCK) {
                    ...
                    for (int k = j0; k < panelEnd; k++) {
                        ...
                        int q = k;
                        double maxDiag = diagp[k] - dotp[k];
                        double minDiag = maxDiag;
                        for (int i = k + 1; i < n; i++) {
                            double d = diagp[i] - dotp[i];
                        ...
                        if (q != k) {
                            ...
                            { double t = diagp[k]; diagp[k] = diagp[q]; diagp[q] = t; }
