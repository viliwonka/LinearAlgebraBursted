// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/OP/GenOP.fProxy.cs
...
namespace LinearAlgebra
{
    ...
    public static partial class Generate
    {
        ...
        public static void gaussianKernel(ref doubleN dest, double sigma)
        {
            ...
            {
                double d = (double)i - c;
                double w = DetMath.Exp(-d * d * inv2s2);
                dest[i] = w;
                sum += w;
            }
            ...
            for (int i = 0; i < N; i++)
            {
                ...
                switch (type)
                {
                    case WindowType.Hann:
                        w = (double)0.5 * ((double)1 - DetMath.Cos(twoPiOverNm1 * i));
                        break;
                    case WindowType.Hamming:
                        w = (double)0.54 - (double)0.46 * DetMath.Cos(twoPiOverNm1 * i);
                        break;
                    case WindowType.Blackman:
                        w = (double)0.42
                            - (double)0.5 * DetMath.Cos(twoPiOverNm1 * i)
                            + (double)0.08 * DetMath.Cos(fourPiOverNm1 * i);
                        break;
                    default:
                        w = (double)1;
                        break;
