    ...
    public static partial class QR {
        ...
        internal static void genHouseholder(ref doubleMxN Q, ref doubleN u, int k, double zeroThreshold) {
            ...
            if (math.abs(xNorm) > zeroThreshold) {
                ...
                // Consts.doubleSqrt2, NOT math.SQRT2 (a FLOAT constant that leaves uᵀu = 2 - 7e-8 in
        ...
        // Cache overload: zero-alloc (caller-owned doubleQRCache, see its (m, n, allocator) ctor) AND
        ...
        // Cache overload: zero-alloc (caller-owned doubleQRCache, see its (m, n, allocator) ctor) — routes
