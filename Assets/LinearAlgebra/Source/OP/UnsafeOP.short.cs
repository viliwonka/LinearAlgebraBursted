...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP {
        ...
        public static void vecMatDot([NoAlias] short* y, [NoAlias] short* mat, [NoAlias] short* x, int m, int n)
        {
            ...
            UnsafeUtility.MemClear(x, (long)n * UnsafeUtility.SizeOf<short>());
            for (int r = 0; r < m; r++)
            {
                short yr = y[r];
                int baseIdx = r * n;
        ...
        static void matMatDotTransACore(short* matA, short* matB, short* matC, int m, int n, int k, bool symUpper)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void signFlipInPlace([NoAlias] short* target, int n) {
        ...
        // target[i] = s
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void fill([NoAlias] short* target, int n, short s)
        {
            for (int i = 0; i < n; i++)
                target[i] = s;
        }
