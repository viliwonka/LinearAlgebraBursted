    ...
    public static partial class Kalman
    {
        ...
        static KFInfo UpdateCore(ref floatKFState s, in floatMxN H, in floatN y, in floatMxN R)
        {
            ...
            if (rinfo.Solved)
            {
                ...
                var IKHt = new floatMxN(n, n, Allocator.Temp);
        ...
        public static LQRInfo steadyStateGain(in floatMxN A, in floatMxN H, in floatMxN Q, in floatMxN R,
                                              ref floatMxN Kss, int maxIterations = 0)
        {
            if (!A.IsSquare)
