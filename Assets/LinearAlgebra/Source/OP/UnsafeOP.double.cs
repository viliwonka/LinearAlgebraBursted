// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSource/OP/UnsafeOP.fProxy.cs
...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP {
        ...
        public static double sumAbs([NoAlias] double* a, int n)
        {
            ...
            for (; i + 8 <= n; i += 8)
            {
                qacc0 += math.abs(*(double4*)(a + i));
                qacc1 += math.abs(*(double4*)(a + i + 4));
            }
            if (i + 4 <= n)
            {
                qacc0 += math.abs(*(double4*)(a + i));
        ...
        public static double maxAbs([NoAlias] double* a, int n)
        {
            ...
            for (; i + 8 <= n; i += 8)
            {
                qacc0 = math.max(qacc0, math.abs(*(double4*)(a + i)));
                qacc1 = math.max(qacc1, math.abs(*(double4*)(a + i + 4)));
            }
            if (i + 4 <= n)
            {
                qacc0 = math.max(qacc0, math.abs(*(double4*)(a + i)));
        ...
        public static void matTrans([NoAlias] double* matA, [NoAlias] double* matB, int m, int n)
        {
            ...
            // matB = n x m, out
            const int TB = 16;
            double* buf = stackalloc double[TB * TB];
            ...
            for (int rb = 0; rb < m; rb += TB)
            {
                ...
                for (int cb = 0; cb < n; cb += TB)
                {
                    ...
                    {
                        double* Arow = matA + (long)r * n;
                        for (int c = cb; c < cEnd; c++)
                            buf[(c - cb) * TB + (r - rb)] = Arow[c];
                    }
                    for (int c = cb; c < cEnd; c++)
                    {
                        double* Brow = matB + (long)c * m + rb;
                        double* bufRow = buf + (c - cb) * TB;
        ...
        public static void matMatDot([NoAlias] double* matA, [NoAlias] double* matB, [NoAlias] double* matC, int m, int n, int k)
        {
            ...
            if (((long)m * n + (long)n * k + (long)m * k) * sizeof(double) >= (24L << 20)
                && m >= 8 && k >= 16)
            {
        ...
        public static void matMatDotPacked([NoAlias] double* matA, [NoAlias] double* matB, [NoAlias] double* matC, int m, int n, int k)
        {
            ...
            double* Apack = (double*)UnsafeUtility.Malloc((long)MC * KC * sizeof(double), 64, Allocator.Temp);
            double* Bpack = bStrips > 0
                ? (double*)UnsafeUtility.Malloc((long)KC * kTiles * sizeof(double), 64, Allocator.Temp)
                : null;
            ...
            for (int pc = 0; pc < n; pc += KC)
            {
                ...
                {
                    double* dst = Bpack + (long)u * kcLen * NR;
                    double* src = matB + (long)pc * k + u * NR;
                    for (int p = 0; p < kcLen; p++)
                    {
                        double* srow = src + (long)p * k;
                        double* drow = dst + p * NR;
                ...
                for (int ic = 0; ic < mTiles; ic += MC)
                {
                    ...
                    {
                        double* dst = Apack + (long)s * kcLen * MR;
                        for (int t = 0; t < MR; t++)
                        {
                            double* arow = matA + (long)(ic + s * MR + t) * n + pc;
                            for (int p = 0; p < kcLen; p++)
                                dst[p * MR + t] = arow[p];
                        }
                    }
                    ...
                    for (int u = 0; u < bStrips; u++)
                    {
                        double* bStrip = Bpack + (long)u * kcLen * NR;
                        for (int s = 0; s < aStrips; s++)
                        {
                            double* aStrip = Apack + (long)s * kcLen * MR;
                            double* cTile = matC + (long)(ic + s * MR) * k + u * NR;
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        static void gemmMicroKernel([NoAlias] double* aStrip, [NoAlias] double* bStrip, [NoAlias] double* cTile, int ldc, int kcLen)
        {
            double* Crow0 = cTile + 0L * ldc;
            double* Crow1 = cTile + 1L * ldc;
            double* Crow2 = cTile + 2L * ldc;
            double* Crow3 = cTile + 3L * ldc;
            double* Crow4 = cTile + 4L * ldc;
            double* Crow5 = cTile + 5L * ldc;
            double* Crow6 = cTile + 6L * ldc;
            double* Crow7 = cTile + 7L * ldc;

            double c000 = Crow0[0], c001 = Crow0[1], c002 = Crow0[2], c003 = Crow0[3], c004 = Crow0[4], c005 = Crow0[5], c006 = Crow0[6], c007 = Crow0[7], c008 = Crow0[8], c009 = Crow0[9], c010 = Crow0[10], c011 = Crow0[11], c012 = Crow0[12], c013 = Crow0[13], c014 = Crow0[14], c015 = Crow0[15];
            double c100 = Crow1[0], c101 = Crow1[1], c102 = Crow1[2], c103 = Crow1[3], c104 = Crow1[4], c105 = Crow1[5], c106 = Crow1[6], c107 = Crow1[7], c108 = Crow1[8], c109 = Crow1[9], c110 = Crow1[10], c111 = Crow1[11], c112 = Crow1[12], c113 = Crow1[13], c114 = Crow1[14], c115 = Crow1[15];
            double c200 = Crow2[0], c201 = Crow2[1], c202 = Crow2[2], c203 = Crow2[3], c204 = Crow2[4], c205 = Crow2[5], c206 = Crow2[6], c207 = Crow2[7], c208 = Crow2[8], c209 = Crow2[9], c210 = Crow2[10], c211 = Crow2[11], c212 = Crow2[12], c213 = Crow2[13], c214 = Crow2[14], c215 = Crow2[15];
            double c300 = Crow3[0], c301 = Crow3[1], c302 = Crow3[2], c303 = Crow3[3], c304 = Crow3[4], c305 = Crow3[5], c306 = Crow3[6], c307 = Crow3[7], c308 = Crow3[8], c309 = Crow3[9], c310 = Crow3[10], c311 = Crow3[11], c312 = Crow3[12], c313 = Crow3[13], c314 = Crow3[14], c315 = Crow3[15];
            double c400 = Crow4[0], c401 = Crow4[1], c402 = Crow4[2], c403 = Crow4[3], c404 = Crow4[4], c405 = Crow4[5], c406 = Crow4[6], c407 = Crow4[7], c408 = Crow4[8], c409 = Crow4[9], c410 = Crow4[10], c411 = Crow4[11], c412 = Crow4[12], c413 = Crow4[13], c414 = Crow4[14], c415 = Crow4[15];
            double c500 = Crow5[0], c501 = Crow5[1], c502 = Crow5[2], c503 = Crow5[3], c504 = Crow5[4], c505 = Crow5[5], c506 = Crow5[6], c507 = Crow5[7], c508 = Crow5[8], c509 = Crow5[9], c510 = Crow5[10], c511 = Crow5[11], c512 = Crow5[12], c513 = Crow5[13], c514 = Crow5[14], c515 = Crow5[15];
            double c600 = Crow6[0], c601 = Crow6[1], c602 = Crow6[2], c603 = Crow6[3], c604 = Crow6[4], c605 = Crow6[5], c606 = Crow6[6], c607 = Crow6[7], c608 = Crow6[8], c609 = Crow6[9], c610 = Crow6[10], c611 = Crow6[11], c612 = Crow6[12], c613 = Crow6[13], c614 = Crow6[14], c615 = Crow6[15];
            double c700 = Crow7[0], c701 = Crow7[1], c702 = Crow7[2], c703 = Crow7[3], c704 = Crow7[4], c705 = Crow7[5], c706 = Crow7[6], c707 = Crow7[7], c708 = Crow7[8], c709 = Crow7[9], c710 = Crow7[10], c711 = Crow7[11], c712 = Crow7[12], c713 = Crow7[13], c714 = Crow7[14], c715 = Crow7[15];

            for (int p = 0; p < kcLen; p++)
            {
                double* ap = aStrip + p * 8;
                double a0 = ap[0];
                double a1 = ap[1];
                double a2 = ap[2];
                double a3 = ap[3];
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void matAtA([NoAlias] double* matA, [NoAlias] double* matC, int m, int n)
        ...
        static void matMatDotTransACore(double* matA, double* matB, double* matC, int m, int n, int k, bool symUpper)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        static void matMatDotTransARange(double* matA, double* matB, [NoAlias] double* matC,
        ...
        // gets ONE double4 accumulator chain (fixed horizontal-sum order, ascending scalar tail),
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void matMatDotTransB([NoAlias] double* matA, [NoAlias] double* matB, [NoAlias] double* matC, int m, int n, int k)
        ...
        // Exploits symmetry: computes the upper triangle, mirrors the lower (~2x fewer FLOPs).
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void matAAt([NoAlias] double* matA, [NoAlias] double* matC, int m, int n)
        ...
        // computed — skipped tiles satisfy c <= j+NR-1 < i <= r, i.e. strictly lower).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void matMatDotTransBCore(double* matA, double* matB, double* matC, int m, int n, int k, bool symUpper)
        {
            // matA = m x n
            ...
            for (int i = 0; i < mTiles; i += MR)
            {
                double* Arow0 = matA + (long)(i + 0) * n;
                double* Arow1 = matA + (long)(i + 1) * n;
                var pa0 = (double4*)Arow0;
                var pa1 = (double4*)Arow1;

                for (int j = 0; j < kTiles; j += NR)
                {
                    if (symUpper && j + NR <= i) continue;   // tile strictly below the diagonal

                    double* Brow0 = matB + (long)(j + 0) * n;
                    double* Brow1 = matB + (long)(j + 1) * n;
                    double* Brow2 = matB + (long)(j + 2) * n;
                    double* Brow3 = matB + (long)(j + 3) * n;
                    var pb0 = (double4*)Brow0;
                    var pb1 = (double4*)Brow1;
                    var pb2 = (double4*)Brow2;
                    var pb3 = (double4*)Brow3;

                    double4 c00 = default, c01 = default, c02 = default, c03 = default;
                    double4 c10 = default, c11 = default, c12 = default, c13 = default;
        ...
        // [n & ~3, n) ascending.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static double rowDotFinish(double4 acc, double* rowA, double* rowB, int n)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        static void matMatDotTransBRange(double* matA, double* matB, [NoAlias] double* matC,
                                          int rowStart, int rowEnd, int n, int k, int colStart, int colEnd)
        {
            int nQ = n >> 2;
            for (int r = rowStart; r < rowEnd; r++)
        ...
        public static void syrkLowerSub([NoAlias] double* Lp, int n, int rStart, int j0, int jb, [NoAlias] double* PT)
        {
            ...
            {
                int i = rStart + ip;
                double* Lrow = Lp + (long)i * n + rStart; // write cols [rStart, i], relative [0, ip]
        ...
        public static void syrkUpperSub([NoAlias] double* Wp, int n, int rStart, int j0, int jb, [NoAlias] double* QT)
        {
            ...
            {
                int i = rStart + ip;
                double* Wrow = Wp + (long)i * n + i;     // write cols [i, n)
                double* Qi = QT + (long)ip * jb;
                int len = n - i;
                int p = 0;
                for (; p + 4 <= jb; p += 4)              // one Wrow pass per FOUR panel rows
                {
                    double* u0 = Wp + (long)(j0 + p) * n + rStart + ip;
        ...
        public static void wyVtC([NoAlias] double* Vp, int Vld, [NoAlias] double* Cp, int Cld, int rows, int pb, int cw, [NoAlias] double* W)
        {
            ...
            {
                double* V0 = Vp + (long)t * Vld;
                double* C0 = Cp + (long)t * Cld;
                for (int i = 0; i < pb; i++)
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void signFlipInPlace([NoAlias] double* target, int n) {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void axpy4([NoAlias] double* y,
            [NoAlias] double* x0, [NoAlias] double* x1, [NoAlias] double* x2, [NoAlias] double* x3,
            double a0, double a1, double a2, double a3, int n) {
        ...
        // target[i] = s
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void fill([NoAlias] double* target, int n, double s)
        {
            for (int i = 0; i < n; i++)
                target[i] = s;
        }
