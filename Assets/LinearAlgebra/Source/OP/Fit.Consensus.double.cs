...
namespace BULA
{
    ...
    public static partial class Fit
    {
        ...
        /// <summary>2D <see cref="MsacScore{TModel}(NativeArray{double3}, in TModel, double, out int)"/>.</summary>
        static double MsacScore<TModel>(NativeArray<double2> points, in TModel model, double t2,
                                        out int inliers)
            where TModel : struct, IdoubleShape2
        {
            var s = model;
            ...
            where TLoss : struct, IdoubleRobustLoss
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                double d0 = model.Distance(points[i]);
