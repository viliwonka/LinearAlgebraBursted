...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP {
        ...
        public static int maxAbs([NoAlias] int* a, int n)
        {
            ...
            for (int i = 0; i < n; i++) {
                int abs = (int)math.abs(a[i]);
                max = (int)math.max(max, abs);
            }
            return max;
        }
        ...
        public static void vecMatDot([NoAlias] int* y, [NoAlias] int* mat, [NoAlias] int* x, int m, int n)
        {
            ...
            UnsafeUtility.MemClear(x, (long)n * UnsafeUtility.SizeOf<int>());
            for (int r = 0; r < m; r++)
            {
                int yr = y[r];
                int baseIdx = r * n;
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void matAtA([NoAlias] int* matA, [NoAlias] int* matC, int m, int n)
        ...
        static void matMatDotTransACore(int* matA, int* matB, int* matC, int m, int n, int k, bool symUpper)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void signFlipInPlace([NoAlias] int* target, int n) {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void compMul([NoAlias] int* target, [NoAlias] int* from, int n)
        {
            for (int i = 0; i < n; i++)
                target[i] *= from[i];
        }
        ...
        // target[i] = s
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void fill([NoAlias] int* target, int n, int s)
        {
            for (int i = 0; i < n; i++)
                target[i] = s;
        }
