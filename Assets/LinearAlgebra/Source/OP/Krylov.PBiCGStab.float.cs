...
namespace LinearAlgebra
{
    public static partial class Krylov
    {
        ...
        /// matrix -- forwards into <see cref="pbiCGStab{TOp,TPre}"/> via <c>floatBSROperator</c>.
        ...
        /// </summary>
        public static SolveInfo pbiCGStab(in floatBSR A, in floatRestrictedSchwarz M, in floatN b, ref floatN x,
                               int maxIter, float tol)
        {
            floatN r     = b.floatTempVec(A.M_Rows);
            floatN rHat0 = b.floatTempVec(A.M_Rows);
