...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        static void ArnoldiMGSStep(floatN w, in UnsafeList<floatN> V, ref floatMxN H, int j, int n)
        {
            for (int i = 0; i <= j; i++)
            {
                floatN vi = V[i];
        ...
        static void HessenbergBackSolve(in floatMxN H, in floatN g, ref floatN y, int k)
        {
            for (int i = k - 1; i >= 0; i--)
            {
                float sum = g[i];
