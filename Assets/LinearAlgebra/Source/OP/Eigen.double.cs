...
namespace LinearAlgebra
{
    public static partial class Eigen {
        ...
        public static EigenSolveInfo inversePowerIteration(in doubleMxN A, ref doubleN v, ref doubleN y,
                                                 ...
                                                 double tol, int maxIter, int cgMaxIterations, double cgTolerance)
        {
            return inversePowerIteration(new doubleDenseOperator(in A), ref v, ref y, ref r, ref p, ref Ap, out lambda, tol, maxIter, cgMaxIterations, cgTolerance);
        }
        ...
        /// maxIter (1000), cgMaxIterations (A.M_Rows) and cgTolerance (Consts.doubleSqrtEps). tol defaults to
        ...
        public static EigenSolveInfo inversePowerIteration(in doubleBSR A, ref doubleN v, ref doubleN y,
                                                 ...
                                                 double tol, int maxIter, int cgMaxIterations, double cgTolerance)
        {
            return inversePowerIteration(new doubleBSROperator(in A), ref v, ref y, ref r, ref p, ref Ap, out lambda, tol, maxIter, cgMaxIterations, cgTolerance);
        }
        ...
        /// (10 * Consts.doubleSqrtEps), maxIter (1000), cgMaxIterations (A.M_Rows) and cgTolerance
        ...
        /// <c>new doubleLanczosCache(A.Rows, steps, allocator)</c>): <c>ws.V</c> (steps x n) accumulates the
        ...
        /// <see cref="doubleLanczosCache"/>) as Temp scratch (disposed before returning) and the
        ...
        /// </summary>
        public static doubleN lanczos(in doubleMxN A, int steps, out LanczosInfo info,
                                      double breakdownTol, Allocator allocator = Allocator.Temp)
        {
            var ws = new doubleLanczosCache(A.M_Rows, steps, Allocator.Temp);
            var eigenvalues = new doubleN(steps, allocator);
            info = lanczos(in A, ref ws, ref eigenvalues, steps, breakdownTol);
            ws.Dispose();
            return eigenvalues;
        }

        /// <summary>lanczos (allocating, Allocator) over a dense matrix with default breakdownTol (Consts.doubleZeroThreshold).</summary>
        public static doubleN lanczos(in doubleMxN A, int steps, out LanczosInfo info, Allocator allocator = Allocator.Temp)
            => lanczos(in A, steps, out info, Consts.doubleZeroThreshold, allocator);
        ...
        /// </summary>
        public static doubleN lanczos(in doubleBSR A, int steps, out LanczosInfo info,
                                      double breakdownTol, Allocator allocator = Allocator.Temp)
        {
            var ws = new doubleLanczosCache(A.M_Rows, steps, Allocator.Temp);
            var eigenvalues = new doubleN(steps, allocator);
        ...
        /// <summary>lanczos (allocating, Allocator) over a BSR matrix with default breakdownTol (Consts.doubleZeroThreshold).</summary>
        public static doubleN lanczos(in doubleBSR A, int steps, out LanczosInfo info, Allocator allocator = Allocator.Temp)
            => lanczos(in A, steps, out info, Consts.doubleZeroThreshold, allocator);
        ...
        /// </summary>
        public static doubleN lanczosVectors(in doubleMxN A, int steps,
                                             ...
                                             double breakdownTol, Allocator allocator = Allocator.Temp)
        {
            ...
            var eigenvalues = new doubleN(steps, allocator);
            ritz = new doubleMxN(steps, A.M_Rows, allocator);
        ...
        public static doubleN lanczosVectors(in doubleMxN A, int steps, out doubleMxN ritz, out LanczosInfo info, Allocator allocator = Allocator.Temp)
            => lanczosVectors(in A, steps, out ritz, out info, Consts.doubleZeroThreshold, allocator);
        ...
        /// </summary>
        public static doubleN lanczosVectors(in doubleBSR A, int steps,
                                             out doubleMxN ritz, out LanczosInfo info,
                                             double breakdownTol, Allocator allocator = Allocator.Temp)
        {
            var ws = new doubleLanczosCache(A.M_Rows, steps, Allocator.Temp);
        ...
        public static doubleN lanczosVectors(in doubleBSR A, int steps, out doubleMxN ritz, out LanczosInfo info, Allocator allocator = Allocator.Temp)
            => lanczosVectors(in A, steps, out ritz, out info, Consts.doubleZeroThreshold, allocator);
        ...
        public static EigenInfo decompInPlace(ref doubleMxN A, ref doubleN eigenvalues,
                                              ref doubleMxN V, int maxSweeps, double tol)
        {
            if (!A.IsSquare)
            ...
            for (int sweep = 0; sweep < maxSweeps; sweep++) {
                ...
                for (int p = 0; p < n - 1; p++) {
                    for (int q = p + 1; q < n; q++) {
                        ...
                        if (math.abs(apq) <= tol * (double)0.5 * (math.abs(A[p, p]) + math.abs(A[q, q])))
                            continue;
...
#pragma warning disable 618
        /// <summary>decompInPlace with default tol (Consts.doubleZeroThreshold).</summary>
        [System.Obsolete("Prefer Eigen.symmetricInPlace (Householder tridiagonal + QL) for symmetric eigenpairs, or Eigen.valuesSymmetricInPlace for eigenvalues only. This cyclic-Jacobi solver is retained for reference.", false)]
        public static EigenInfo decompInPlace(ref doubleMxN A, ref doubleN eigenvalues,
                                              ref doubleMxN V, int maxSweeps)
            => decompInPlace(ref A, ref eigenvalues, ref V, maxSweeps, Consts.doubleZeroThreshold);

        /// <summary>decompInPlace with default maxSweeps (30) and tol (Consts.doubleZeroThreshold). NOTE:
...
#pragma warning restore 618
        ...
        /// </summary>
        public static EigenInfo valuesSymmetricInPlace(ref doubleMxN A, ref doubleN eigenvalues, int maxIterPerEig, double tol,
        ...
        /// <summary>valuesSymmetricInPlace (ref workspace) with default maxIterPerEig (Consts.sweepBudget(A.M_Rows)) and tol (Consts.doubleZeroThreshold).</summary>
        ...
        /// <summary>valuesSymmetricInPlace with default maxIterPerEig (Consts.sweepBudget(A.M_Rows)) and tol (Consts.doubleZeroThreshold).</summary>
        ...
        /// <summary>symmetric with default maxIterPerEig (Consts.sweepBudget(A.M_Rows)) and tol (Consts.doubleZeroThreshold).</summary>
        public static EigenInfo symmetricInPlace(ref doubleMxN A, ref doubleN eigenvalues, ref doubleMxN V)
        ...
        /// </summary>
        public static unsafe EigenInfo valuesQRInPlace(ref doubleMxN A, ref doubleN eigenvaluesReal,
        ...
        public static EigenInfo valuesQRInPlace(ref doubleMxN A, ref doubleN eigenvaluesReal,
