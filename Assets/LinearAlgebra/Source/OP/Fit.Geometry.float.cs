...
namespace BULA
{
    ...
    public static partial class Fit
    {
        ...
        internal static bool SubspaceFitWeighted(NativeArray<float> X, int n, int d, in floatN w,
                                                 ref floatN mean, ref floatMxN C,
                                                 ref floatN eig, ref floatMxN V)
        {
            float sw = (float)0;
