...
namespace BULA
{
    public static partial class Krylov {
        ...
        static void BlockResidualSolve(in doubleMxN W, in doubleMxN Beta, in Pivot P, int rank,
                                        ref doubleMxN Uout, int s, int n)
        {
            for (int i = 0; i < s; i++)
                for (int c = 0; c < n; c++)
                    Uout[i, c] = (double)0;
        ...
        static bool BuildOmega(in doubleMxN Gbar, in doubleMxN Beta, ref doubleMxN Omega, ref doubleMxN Gamma, int s,
                               ref doubleMxN Y, ref doubleMxN Qy, ref doubleMxN Z0, ref doubleMxN T,
                               ref doubleMxN QyT, ref doubleMxN Z1, ref doubleMxN Qperp, ref doubleMxN Rz)
        {
            int s2 = 2 * s;
            ...
            where TPre : struct, IdoublePreconditioner
        {
            ...
            var omY     = new doubleMxN(s2, s, Allocator.Temp, true);
            var omQy    = new doubleMxN(s2, s, Allocator.Temp, true);
            var omZ0    = new doubleMxN(s2, s, Allocator.Temp, true);
            var omT     = new doubleMxN(s,  s, Allocator.Temp, true);
            var omQyT   = new doubleMxN(s2, s, Allocator.Temp, true);
            var omZ1    = new doubleMxN(s2, s, Allocator.Temp, true);
            var omQperp = new doubleMxN(s2, s, Allocator.Temp, true);
            var omRz    = new doubleMxN(s,  s, Allocator.Temp, true);
            ...
            doubleMxN Ucur = default, Uprev = default, Wres = default;
            if (!M.IsIdentity)
            {
                Gnorm = new doubleMxN(s, s, Allocator.Temp, true);
                rowIn = new doubleN(n);
                rowOut = new doubleN(n);
                Ucur = new doubleMxN(s, n, Allocator.Temp);
                Uprev = new doubleMxN(s, n, Allocator.Temp);
                Wres = new doubleMxN(s, n, Allocator.Temp, true);
            }
