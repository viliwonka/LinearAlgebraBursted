...
namespace BULA
{
    public static partial class LQ
    {
        ...
        /// buffer) — the layout produced by the doubleLQMinNormCache(m, n, allocator) constructor.
        /// </summary>
        static void RequireLQMinNormSolveWorkspace(in doubleLQMinNormCache ws, int m, int n)
        {
            ...
            if (!ok)
                throw new ArgumentException("LQ: workspace must be sized for m x n (use new doubleLQMinNormCache(m, n, allocator))");
