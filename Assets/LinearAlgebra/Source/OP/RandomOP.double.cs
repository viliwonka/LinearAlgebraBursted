...
namespace BULA
{
    ...
    /// allocating helpers in <c>GenerateOP</c> (e.g. <c>doubleRandomVec</c>/<c>doubleRandomMat</c>,
    ...
    public struct doubleRayleigh : IdoubleSampler
    {
        ...
        {
            double uc = (double)1 - u;
            return sigma * math.sqrt((double)(-2) * DetMath.Log(uc));
        }
    ...
    public struct doubleWeibull : IdoubleSampler
    {
        ...
        {
            double uc = (double)1 - u;
            return lambda * DetMath.Pow(-DetMath.Log(uc), (double)1 / k);
        }
    ...
    public struct doubleCauchy : IdoubleSampler
    {
        ...
        public static double CauchyICDF(double u, double x0, double gamma)
        {
            ...
            return x0 + gamma * DetMath.Tan((double)System.Math.PI * (uSafe - (double)0.5));
        }
    ...
    public struct doublePareto : IdoubleSampler
    {
        ...
        {
            double uc = (double)1 - u;
            return xm / DetMath.Pow(uc, (double)1 / alpha);
        }
    ...
    public struct doubleGaussian : IdoubleSampler
    {
        ...
        public double Next(ref Random rng)
        {
            ...
            double r = math.sqrt((double)(-2) * DetMath.Log(u1));
            double angle = (double)(2.0 * System.Math.PI) * u2;

            double sinVal = DetMath.Sin(angle);
            double cosVal = DetMath.Cos(angle);
