...
namespace BULA
{
    ...
    public static partial class LQRP {
        ...
        /// <summary>
        /// decomp using a reusable workspace (the doubleLQRPCache(m, n, Allocator) ctor) — zero-alloc.
        ...
        /// <summary>
        /// decompInPlace using a reusable workspace (the doubleLQRPCache(m, n, Allocator) ctor) — the internal scratch
        ...
        /// auto-selects max(m,n)·Consts.doubleZeroThreshold, matching SVD.pinvSolve / Analysis.rank).
        /// </summary>
