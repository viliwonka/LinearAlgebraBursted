...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        static float MaxAbsRuDiag(in floatMxN Ru, int kcur)
        {
            float m = (float)0;
            ...
            where TPre : struct, IfloatPreconditioner
        {
            ...
            while (total < maxIter)
            {
                ...
                if (kcur > 0)
                {
                    ...
                    float ruGuard = Consts.floatEpsilon * (float)100 * MaxAbsRuDiag(in Ru, kcur);
                ...
                // basis without a second M-apply.
                {
                    ...
                    if (kcur > 0 && totalColsFinal > 0)
                    {
                        ...
                        float ruGuard2 = Consts.floatEpsilon * (float)100 * MaxAbsRuDiag(in Ru, kcur);
