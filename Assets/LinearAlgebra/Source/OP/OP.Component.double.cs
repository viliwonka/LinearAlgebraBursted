...
namespace BULA
{
    ...
    public static partial class doubleComp {
        ...
        public static void zeroInPlace<T>(this T place) where T : unmanaged, IUnsafedoubleArray {

            unsafe {
                UnsafeUtility.MemClear(place.Data.Ptr, (long)place.Data.Length * sizeof(double));
            }
        }

        /// <summary>Sets every component to <paramref name="s"/>.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void fillInPlace<T>(this T place, double s) where T : unmanaged, IUnsafedoubleArray {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mulInPlace<T>(this T target, T from) where T : unmanaged, IUnsafedoubleArray
        {
            unsafe {
