...
namespace BULA
{
    ...
    public interface IfloatPreconditioner
    {
        ...
        /// <summary>Compile-time literal: true ONLY for <see cref="floatIdentityPreconditioner"/>,
    ...
    /// The natural <see cref="IfloatPreconditioner"/> for least-squares right (column)
    /// preconditioning via <see cref="floatRightPreconditionedOperator{TInner,TPre}"/> (d built
    ...
    /// </summary>
    public readonly struct floatDiagonalPreconditioner : IfloatPreconditioner
    {
        public readonly floatN D;   // length n: the diagonal of N

        public floatDiagonalPreconditioner(in floatN d)
        {
            D = d;
        }
        ...
        {
            if (z.N != r.N || D.N != r.N)
                throw new System.ArgumentException("floatDiagonalPreconditioner.Apply: r, z and D lengths must match");
    ...
    public readonly struct floatIdentityOperator : IfloatLinearOperator
    {
        ...
        public void Apply(in floatN x, ref floatN y) => y.CopyFrom(in x);
        public void ApplyT(in floatN x, ref floatN y) => y.CopyFrom(in x);
    ...
    /// </summary>
    public readonly struct floatRightPreconditionedOperator<TInner, TPre> : IfloatLinearOperator
        where TInner : struct, IfloatLinearOperator
        where TPre : struct, IfloatPreconditioner
    {
        public readonly TInner Inner;
        public readonly TPre N;           // symmetric right preconditioner
        public readonly floatN Scratch;  // length Inner.Cols: workspace (holds N·x / Aᵀx)

        public floatRightPreconditionedOperator(in TInner inner, in TPre n, in floatN scratch)
        {
            if (scratch.N != inner.Cols)
                throw new System.ArgumentException("floatRightPreconditionedOperator: scratch.N must equal inner.Cols");
    ...
    /// preconditioner N (n×n, n = Inner.Cols) supplied as an <see cref="IfloatLinearOperator"/>,
    ...
    /// <see cref="floatRightPreconditionedOperator{TInner,TPre}"/> which requires N = Nᵀ. Solve
    ...
    /// </summary>
    public readonly struct floatGeneralRightPreconditionedOperator<TInner, TPreN> : IfloatLinearOperator
        where TInner : struct, IfloatLinearOperator
        where TPreN : struct, IfloatLinearOperator
    {
        ...
        public floatGeneralRightPreconditionedOperator(in TInner inner, in TPreN n, in floatN scratch)
        {
            if (n.Rows != inner.Cols || n.Cols != inner.Cols)
                throw new System.ArgumentException("floatGeneralRightPreconditionedOperator: N must be square with N.Rows == N.Cols == inner.Cols");
            if (scratch.N != inner.Cols)
                throw new System.ArgumentException("floatGeneralRightPreconditionedOperator: scratch.N must equal inner.Cols");
