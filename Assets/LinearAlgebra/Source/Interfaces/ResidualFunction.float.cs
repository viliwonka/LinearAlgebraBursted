...
namespace BULA
{
    ...
    /// indefinite and stall the step. For Gauss-Newton prefer <see cref="floatHuberLoss"/> or
    /// <see cref="floatCauchyLoss"/>, or raise the floor to the data's real noise scale.
    /// </summary>
