...
namespace LinearAlgebra
{
    ...
    public partial struct shortN : IDisposable, IUnsafeshortArray {
        ...
        /// including views); false for default(shortN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<shortVecRecord>.IsAliveFast(_rec)) return false;
#endif
        ...
        {
            return _rec != null ? OwnerArena.shortVec(in this) : new shortN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.shortTempVec(in this) : new shortN(in this, Allocator.Temp);   // temp pool
        }
