...
namespace BULA
{
    ...
    public partial struct intMxN : IDisposable, IUnsafeintArray {
        ...
        /// default(intMxN) and after Dispose().</summary>
        ...
        public unsafe intMxN(int M_rows, int N_cols, Allocator allocator = Allocator.Temp, bool uninit = false)
        {
            _data = default;
            M_Rows = M_rows;
            N_Cols = N_cols;
        ...
        /// </summary>
        public unsafe intMxN(in intMxN orig, Allocator allocator = Allocator.Temp)
        {
            _data = default;
        ...
        {
            return new intMxN(in this, Allocator.Temp);
        }
