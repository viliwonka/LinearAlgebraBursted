...
namespace LinearAlgebra
{
    ...
    public partial struct intMxN : IDisposable, IUnsafeintArray {
        ...
        /// including views); false for default(intMxN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<intMatRecord>.IsAliveFast(_rec) || ChunkedRecordTable<intMatRecord>.GenerationFast(_rec) != _gen)
                    return false;
#endif
        ...
        /// </summary>
        public unsafe intMxN(int M_rows, int N_cols, NativeArray<int> viewOf)
        {
            if (M_rows * N_cols != viewOf.Length)
                throw new ArgumentException("intMxN view: viewOf.Length must equal M_rows * N_cols");
            ...
            _inlineData = new UnsafeList<int>((int*)viewOf.GetUnsafePtr(), viewOf.Length);
        }
        ...
        {
            return _rec != null ? OwnerArena.intMat(in this) : new intMxN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.intTempMat(in this) : new intMxN(in this, Allocator.Temp);
        }
        ...
        public unsafe void CopyTo(NativeArray<int> dst)
        {
            ...
            UnsafeUtility.MemCpy(dst.GetUnsafePtr(), Data.Ptr, (long)Length * sizeof(int));
        }
        ...
        public unsafe void CopyFrom(NativeArray<int> src)
        {
            ...
            UnsafeUtility.MemCpy(Data.Ptr, src.GetUnsafeReadOnlyPtr(), (long)Length * sizeof(int));
        }
