...
namespace LinearAlgebra
{
    ...
    public partial struct intN : IDisposable, IUnsafeintArray {
        ...
        /// including views); false for default(intN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<intVecRecord>.IsAliveFast(_rec)) return false;
#endif
        ...
        {
            return _rec != null ? OwnerArena.intVec(in this) : new intN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.intTempVec(in this) : new intN(in this, Allocator.Temp);   // temp pool
        }
