...
namespace LinearAlgebra
{
    ...
    public partial struct uintMxN : IDisposable, IUnsafeuintArray {
        ...
        /// including views); false for default(uintMxN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<uintMatRecord>.IsAliveFast(_rec) || ChunkedRecordTable<uintMatRecord>.GenerationFast(_rec) != _gen)
                    return false;
#endif
        ...
        /// </summary>
        public unsafe uintMxN(int M_rows, int N_cols, NativeArray<uint> viewOf)
        {
            if (M_rows * N_cols != viewOf.Length)
                throw new ArgumentException("uintMxN view: viewOf.Length must equal M_rows * N_cols");
        ...
        {
            return _rec != null ? OwnerArena.uintMat(in this) : new uintMxN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.uintTempMat(in this) : new uintMxN(in this, Allocator.Temp);
        }
        ...
        public unsafe void CopyTo(NativeArray<uint> dst)
        {
            ...
            UnsafeUtility.MemCpy(dst.GetUnsafePtr(), Data.Ptr, (long)Length * sizeof(uint));
        }
        ...
        public unsafe void CopyFrom(NativeArray<uint> src)
        {
            ...
            UnsafeUtility.MemCpy(Data.Ptr, src.GetUnsafeReadOnlyPtr(), (long)Length * sizeof(uint));
        }
