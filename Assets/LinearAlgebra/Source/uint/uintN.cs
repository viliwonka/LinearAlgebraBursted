...
namespace LinearAlgebra
{
    ...
    public partial struct uintN : IDisposable, IUnsafeuintArray {
        ...
        /// including views); false for default(uintN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<uintVecRecord>.IsAliveFast(_rec)) return false;
#endif
        ...
        {
            _rec = null;
            _inlineData = new UnsafeList<uint>((uint*)viewOf.GetUnsafePtr(), viewOf.Length);
        }
        ...
        {
            return _rec != null ? OwnerArena.uintVec(in this) : new uintN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.uintTempVec(in this) : new uintN(in this, Allocator.Temp);   // temp pool
        }
