...
namespace LinearAlgebra
{
    ...
    public partial struct longN : IDisposable, IUnsafelongArray {
        ...
        /// including views); false for default(longN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<longVecRecord>.IsAliveFast(_rec)) return false;
#endif
        ...
        {
            return _rec != null ? OwnerArena.longVec(in this) : new longN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.longTempVec(in this) : new longN(in this, Allocator.Temp);   // temp pool
        }
