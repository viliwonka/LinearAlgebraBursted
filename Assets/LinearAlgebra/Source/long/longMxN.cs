...
namespace LinearAlgebra
{
    ...
    public partial struct longMxN : IDisposable, IUnsafelongArray {
        ...
        /// default(longMxN) and after Dispose().</summary>
        ...
        public unsafe longMxN(int M_rows, int N_cols, Allocator allocator = Allocator.Temp, bool uninit = false)
        {
            _data = default;
            M_Rows = M_rows;
            N_Cols = N_cols;
        ...
        /// </summary>
        public unsafe longMxN(in longMxN orig, Allocator allocator = Allocator.Temp)
        {
            _data = default;
        ...
        {
            return new longMxN(in this, Allocator.Temp);
        }
