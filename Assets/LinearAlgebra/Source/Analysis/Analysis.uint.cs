...
namespace LinearAlgebra
{
    ...
    {
        public static bool isZero(in uintN a)
        {
            for (int i = 0; i < a.N; i++) {
                if (a[i] != 0)
                    return false;
        ...
        public static bool isZero(in uintMxN m)
        {
        ...
        public static bool isIdentity(in uintMxN A)
        {
        ...
        public static bool isSymmetric(in uintMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isDiagonal(in uintMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isUpperTriangular(in uintMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isLowerTriangular(in uintMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
