...
namespace LinearAlgebra
{
    ...
    public partial struct doubleMxN : IDisposable, IUnsafedoubleArray {
        ...
        /// </summary>
        public unsafe doubleMxN(int M_rows, int N_cols, NativeArray<double> viewOf)
        {
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            if (!source.IsCreated)
                throw new InvalidOperationException("doubleMxN view: source is not created / has been disposed");
#endif
        ...
        public unsafe void CopyTo(NativeArray<double> dst)
        {
            ...
            UnsafeUtility.MemCpy(dst.GetUnsafePtr(), Data.Ptr, (long)Length * sizeof(double));
        }
        ...
        public unsafe void CopyFrom(NativeArray<double> src)
        {
            ...
            UnsafeUtility.MemCpy(Data.Ptr, src.GetUnsafeReadOnlyPtr(), (long)Length * sizeof(double));
        }
