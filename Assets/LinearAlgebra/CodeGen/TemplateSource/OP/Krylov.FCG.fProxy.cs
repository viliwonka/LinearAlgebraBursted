...
namespace LinearAlgebra
{
    public static partial class Krylov
    {
        ...
        /// <see cref="pcg{TOp,TPre}(in TOp, in TPre, in fProxyN, ref fProxyN, ref fProxyN, ref fProxyN, ref fProxyN, ref fProxyN, int, fProxy)"/>
        ...
        /// </summary>
        public static SolveInfo fcg<TOp, TPre>(in TOp A, in TPre M, in fProxyN b, ref fProxyN x,
            ...
            where TPre : struct, IfProxyPreconditioner
        {
            ...
            unsafe
            {
                fProxy* rPtr = r.Data.Ptr, pPtr = p.Data.Ptr, ApPtr = Ap.Data.Ptr, zPtr = z.Data.Ptr,
            ...
            for (int k = 0; k < maxIter; k++)
            {
                ...
                fProxy beta = (rznew - Blas.dot(z, rOld)) / rzold;
        ...
        /// inner-iterative M); prefer <see cref="pcg{TOp,TPre}(in TOp, in TPre, in fProxyN, ref fProxyN, int, fProxy)"/>
            ...
            where TPre : struct, IfProxyPreconditioner
        {
            ...
            fProxyN rOld = b.fProxyTempVec(A.Rows);
            return fcg(in A, in M, in b, ref x, ref r, ref p, ref Ap, ref z, ref rOld, maxIter, tol);
        }

        /// <summary>
        /// Flexible CG with default maxIter (A.Rows) and tol (Consts.fProxySqrtEps).
        /// </summary>
        public static SolveInfo fcg<TOp, TPre>(in TOp A, in TPre M, in fProxyN b, ref fProxyN x)
            where TOp : struct, IfProxyLinearOperator
            where TPre : struct, IfProxyPreconditioner
        {
            return fcg(in A, in M, in b, ref x, A.Rows, Consts.fProxySqrtEps);
        }
    }
}
