...
namespace LinearAlgebra
{
    public static partial class Krylov {
        ...
        // Shared by cg, fcg, minres (two sites), minresQLP, biCGStab (one of its two sites), and
        // idr (two sites): recompute a FRESH true residual from A and x rather than trust a
        // tracked/estimated residual. Callers own the convergence decision -- some fall through
        // and keep iterating on a failed verify, others use it unconditionally as a final report
        // -- so this returns the squared norm and bakes in no return/branch of its own.
        //
