...
namespace LinearAlgebra
{
    ...
    public static partial class CHO {
        ...
        /// </summary>
        public static DirectSolveInfo decomp(in fProxyMxN A, ref fProxyMxN L) {
            if (!A.IsSquare)
        ...
        public static DirectSolveInfo decompSolve(ref fProxyMxN L, ref fProxyN b_to_x) {
            if (!L.IsSquare)
        ...
        public static DirectSolveInfo decompInPlace(ref fProxyMxN A_to_L) => decomp(in A_to_L, ref A_to_L);
        ...
        /// <param name="A_to_L">On entry A; on exit the lower-triangular factor L.</param>
        /// <param name="b_to_x">On entry b; on exit the solution x.</param>
        public static DirectSolveInfo solveInPlace(ref fProxyMxN A_to_L, ref fProxyN b_to_x) {
        ...
        static unsafe void SolveUpperTriangularTransposed(ref fProxyMxN L, ref fProxyMxN X) {
            int n = L.M_Rows;
            int k = X.N_Cols;
        ...
        public static DirectSolveInfo decompSolve(ref fProxyMxN L, ref fProxyMxN B_to_X) {
            if (!L.IsSquare)
                throw new ArgumentException("decompSolve: L must be square");
        ...
        /// <param name="A_to_L">On entry A; on exit the lower-triangular factor L.</param>
        /// <param name="B_to_X">On entry B (n rows x k cols); on exit the solution X.</param>
        public static DirectSolveInfo solveInPlace(ref fProxyMxN A_to_L, ref fProxyMxN B_to_X) {
            if (!A_to_L.IsSquare)
                throw new ArgumentException("solveInPlace: A_to_L needs to be square");
