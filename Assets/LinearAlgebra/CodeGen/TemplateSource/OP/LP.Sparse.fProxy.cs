...
namespace LinearAlgebra
{
    public static partial class LP
    {
        ...
        // fProxyNormalOperator (M is never formed) preconditioned by a fProxyNormalJacobi (diagonal of
        // M, computed matrix-free). The constraint operator Aₛ = [A|−A|−I|I] is fProxyLadOperator, which
        ...
        public static LPInfo lad(in fProxyBSR A, in fProxyN b, ref fProxyN x, out double objective, int maxIter = 0)
        {
            ...
            var cvec = new fProxyN(nv, Allocator.Temp); var normNV = new fProxyN(nv, Allocator.Temp);
            // length-m scratch
            ...
            var Mop = new fProxyNormalOperator<fProxyLadOperator>(in lad, in d, in normNV, reg);
            ...
            var bestZ = new fProxyN(nv, Allocator.Temp, false);
