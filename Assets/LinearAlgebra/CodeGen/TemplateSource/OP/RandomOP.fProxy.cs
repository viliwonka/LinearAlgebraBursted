...
namespace LinearAlgebra
{
    ...
    /// evolving RNG stream.
    /// Generic fill: <c>randomInPlace&lt;S&gt;</c> — works with any <see cref="IfProxySampler"/>
    ...
    public static partial class Rand
    {
        ...
        public static void nextUniformInPlace(ref Random rng, ref fProxyN dest)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void nextUniformInPlace(ref Random rng, ref fProxyN dest, fProxy min, fProxy max)
        {
            if (!(min <= max))
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void nextUniformInPlace(ref Random rng, ref fProxyMxN dest)
        {
            int len = dest.Data.Length;
            for (int i = 0; i < len; i++)
                dest[i] = rng.NextFProxy();
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void nextUniformInPlace(ref Random rng, ref fProxyMxN dest, fProxy min, fProxy max)
        {
            if (!(min <= max))
                throw new ArgumentException("nextUniformInPlace: min must be <= max");
            int len = dest.Data.Length;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void randomInPlace<S>(ref Random rng, ref fProxyN dest, ref S s)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void randomInPlace<S>(ref Random rng, ref fProxyMxN dest, ref S s)
            where S : struct, IfProxySampler
        {
            int len = dest.Data.Length;
            for (int i = 0; i < len; i++)
    ...
    public struct fProxyLogistic : IfProxySampler
    {
        ...
        /// <para>Guard: same epsilon clamp as <see cref="fProxyCauchy.CauchyICDF"/>, here
