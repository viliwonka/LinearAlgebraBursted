    ...
    public static partial class QP
    {
                                                             ...
                                                             NativeArray<int> qpMeta)
        {
            ...
            bool incremental = factorValid
                               && wsf.deadCount + numDrops < fProxyQPFactorState.DeadCap
                               && numDrops + numAdds <= fProxyQPFactorState.DeadCap;
        ...
        internal static void ComputeTargetStatus(in fProxyN L, in fProxyN U, int m, int n, int T,
                                                 in fProxyN x0, in fProxyN Ax0, NativeArray<byte> wstatusPrev,
                                                 NativeArray<byte> wstatus, fProxy feasTol)
        {
