                                               ...
                                               ref fProxyN x, out double objective, int maxIter)
        {
            ...
            while (true)
            {
                ...
                if (exitStatus == null && !small)
                {
                    ...
                    RatioTest(in L, in U, m, n, T, wstatus, excluded, in Ax, in Ap, in x, in p, pScale, thetaSelf, feasTol, pivTol, out fProxy alphaHat, out int winnerRow, out bool winnerUpper);
                ...
                else if (exitStatus == null && doMultiplierCheck)
                {
                    ...
                    int worstCol = -1; fProxy worstLam = -dualTol; int worstRowForBland = int.MaxValue;
