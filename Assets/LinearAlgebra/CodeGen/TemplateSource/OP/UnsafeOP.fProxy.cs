...
namespace LinearAlgebra
{
    public static unsafe partial class UnsafeOP {
        ...
        public static void swapRows([NoAlias] fProxy* target, int rowA, int rowB, int nCols) {
        ...
        public static void swapColumns([NoAlias] fProxy* target, int colA, int colB, int nRows, int nCols) {
            int startA = colA;
            int startB = colB;
