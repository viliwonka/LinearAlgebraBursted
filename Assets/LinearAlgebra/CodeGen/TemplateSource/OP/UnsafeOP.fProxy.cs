...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP {
        ...
        public static void matVecDot([NoAlias] fProxy* mat, [NoAlias] fProxy* x, [NoAlias] fProxy* y, int m, int n)
        {
            ...
            // reassociation). We give it an EXPLICIT width-4 SIMD accumulator (fProxy4 -> float4/double4):
            ...
            // handled scalar.)
            // TWO fProxy4 accumulators (8 lane-chains): ~2x over a single 4-lane accumulator in-cache
        ...
        // (LP.BarrodaleRoberts.fProxy.cs): that scan used to repeatedly linear-scan the REMAINING
        ...
        // path for everything else -- see LP.BarrodaleRoberts.fProxy.cs's own gate for the rationale.
        //
