...
namespace LinearAlgebra
{
    public static partial class LQ
    {
        ...
        /// Rqr m x m, qrU length n, qrW length m) — the layout produced by Arena.fProxyLQ_WS(m, n).
        /// </summary>
    ...
    public static partial class ArenaExtensions
    {
        ...
        public static fProxyLQ_WS fProxyLQ_WS(this ref Arena arena, int m, int n)
        {
            ...
            {
                T = arena.fProxyMat(n, m),
                Rqr = arena.fProxyMat(m, m),
                qrU = arena.fProxyVec(n),
                qrW = arena.fProxyVec(m)
            };
        }
    }
}
