...
namespace LinearAlgebra
{
    public static partial class LQ {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void lqDecomposition(ref fProxyMxN A, ref fProxyMxN L, ref fProxyMxN Q, ref fProxyLQ_WS ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void lqMinNormSolve(ref fProxyMxN A, ref fProxyN b, ref fProxyN x, ref fProxyLQMinNormSolve_WS ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
