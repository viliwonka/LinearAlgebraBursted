...
namespace LinearAlgebra
{
    public static partial class LQ {
        ...
        // rejected).
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(ref fProxyMxN A, ref fProxyMxN L, ref fProxyMxN Q)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(ref fProxyMxN A, ref fProxyMxN L, ref fProxyMxN Q, ref fProxyLQCache ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
