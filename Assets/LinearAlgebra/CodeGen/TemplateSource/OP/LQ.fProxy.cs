...
namespace LinearAlgebra
{
    public static partial class LQ {
        ...
        // UnsafeOP.vecDot (two width-4 fProxy4 accumulators): a running-sum reduction can't auto-vectorize
        // under strict FloatMode, so it needs explicit SIMD lanes (see docs/dev/perf-vectorization-lessons.md
        // and the fProxy4 reductions in UnsafeOP). a (matrix row) and b (reflector v) never alias.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo minNormSolve(ref fProxyMxN A, ref fProxyN b, ref fProxyN x)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo minNormSolve(ref fProxyMxN A, ref fProxyN b, ref fProxyN x, ref fProxyLQMinNormCache ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        public static DirectSolveInfo minNormSolve(ref fProxyMxN A, ref fProxyMxN B, ref fProxyMxN X)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            int k = B.N_Cols;
