...
namespace LinearAlgebra
{
    ...
    public static partial class Rand
    {
        ...
        public static void multivariateNormalInPlace(ref Random rng, in fProxyMxN cholL, in fProxyN mean,
        ...
        /// </summary>
        public static void multivariateNormalRowsInPlace(ref Random rng, in fProxyMxN cholL, in fProxyN mean,
        ...
        /// </summary>
        public static void randomOrthogonalInPlace(ref Random rng, ref fProxyMxN dest)
        {
            if (!dest.IsSquare)
        ...
        /// </summary>
        public static void randomSpdInPlace(ref Random rng, ref fProxyMxN dest, fProxy minEig, fProxy maxEig)
        {
            if (!dest.IsSquare)
        ...
        /// </summary>
        public static void randomMatrixWithConditionInPlace(ref Random rng, ref fProxyMxN dest, fProxy cond)
        {
        ...
        /// </summary>
        public static void randomMatrixWithRankInPlace(ref Random rng, ref fProxyMxN dest, int rank)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
        ...
        /// </summary>
        public static void randomStochasticInPlace(ref Random rng, ref fProxyMxN dest)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
            if (m == 0 || n == 0) return;
