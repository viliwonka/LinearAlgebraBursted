...
namespace BULA
{
    ...
    public static partial class Rand
    {
        ...
        /// </summary>
        public static void spdInPlace(ref Random rng, ref fProxyMxN dest, fProxy minEig, fProxy maxEig)
        {
            if (!dest.IsSquare)
            ...
            var QL = new fProxyMxN(n, n, Allocator.Temp);
        ...
        /// </summary>
        public static void conditionedInPlace(ref Random rng, ref fProxyMxN dest, fProxy cond)
        {
            ...
            for (int i = 0; i < k; i++)
            {
                ...
                else
                {
                    ...
                    sigma = DetMath.Pow(cond, (fProxy)1 - t);
                }
                for (int r = 0; r < m; r++)
                    US[r, i] = U[r, i] * sigma;
            }
        ...
        /// </summary>
        public static void withRankInPlace(ref Random rng, ref fProxyMxN dest, int rank)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
        ...
        /// </summary>
        public static void stochasticInPlace(ref Random rng, ref fProxyMxN dest)
        {
            int m = dest.M_Rows;
            int n = dest.N_Cols;
            if (m == 0 || n == 0) return;
