    ...
    public static partial class Krylov {
            ...
            where TOp : struct, IfProxyLinearOperator
        {
            ...
            for (int k = 0; k < maxIterations; k++)
            {
                ...
                // two (see IfProxyLinearOperator.ApplyDot's doc comment for why every operator
        ...
        /// Forwards into <see cref="pcg{TOp,TPre}"/> via <c>fProxyBSROperator</c> -- same
        ...
        /// <see cref="IfProxyLinearOperator"/>.
            ...
            where TOp : struct, IfProxyLinearOperator
        {
            ...
            for (int k = 0; k < maxIterations; k++)
            {
                ...
                A.Apply(in p, ref q);                       // q = A p
                fProxy rrNew = Blas.updateXR(alpha, p, ref x, q, ref r);
