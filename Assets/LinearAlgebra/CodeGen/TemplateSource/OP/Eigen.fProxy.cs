...
namespace BULA
{
    public static partial class Eigen {
        ...
        /// <see cref="IfProxyLinearOperator"/>. Each outer iteration solves A y = v with the
        ...
        ///
        /// Workspace: <c>new fProxyLanczosCache(A.Rows, steps, allocator)</c>. On input, row 0 of
