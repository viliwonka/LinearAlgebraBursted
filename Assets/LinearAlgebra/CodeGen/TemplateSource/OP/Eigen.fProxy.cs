...
namespace LinearAlgebra
{
    ...
    public static partial class Eigen {
        ...
        /// </summary>
        public static bool lanczosVectors<TOp>(in TOp A, ref fProxyLanczos_WS ws, ref fProxyMxN Yt,
        ...
        public static bool lanczosVectors<TOp>(in TOp A, ref fProxyLanczos_WS ws, ref fProxyMxN Yt,
                                               ...
                                               out int produced, int steps)
            where TOp : struct, IfProxyLinearOperator
            => lanczosVectors(in A, ref ws, ref Yt, ref eigenvalues, ref ritz, out produced, steps, Consts.fProxyZeroThreshold);
        ...
        public static fProxyN lanczosVectors(ref Arena arena, in fProxyMxN A, int steps,
                                             out fProxyMxN ritz, out int produced, out bool converged,
                                             fProxy breakdownTol)
        {
            var ws = arena.fProxyLanczos_WS(A.M_Rows, steps);
            ...
            converged = lanczosVectors(new fProxyDenseOperator(in A), ref ws, ref Yt, ref eigenvalues, ref ritz, out produced, steps, breakdownTol);
            return eigenvalues;
        }

        /// <summary>lanczosVectors (allocating) over a dense matrix with default breakdownTol.</summary>
        public static fProxyN lanczosVectors(ref Arena arena, in fProxyMxN A, int steps, out fProxyMxN ritz, out int produced, out bool converged)
            => lanczosVectors(ref arena, in A, steps, out ritz, out produced, out converged, Consts.fProxyZeroThreshold);
                                             ...
                                             fProxy breakdownTol)
        {
            ...
            var eigenvalues = arena.fProxyVec(steps);
            ritz = arena.fProxyMat(steps, A.M_Rows);
            converged = lanczosVectors(new fProxyBSMOperator(in A), ref ws, ref Yt, ref eigenvalues, ref ritz, out produced, steps, breakdownTol);
            return eigenvalues;
        }

        /// <summary>lanczosVectors (allocating) over a BSR matrix with default breakdownTol.</summary>
        public static fProxyN lanczosVectors(ref Arena arena, in fProxyBSM A, int steps, out fProxyMxN ritz, out int produced, out bool converged)
            => lanczosVectors(ref arena, in A, steps, out ritz, out produced, out converged, Consts.fProxyZeroThreshold);
