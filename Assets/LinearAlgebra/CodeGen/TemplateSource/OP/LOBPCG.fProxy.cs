...
namespace LinearAlgebra
{
    ...
    /// <see cref="Eigen.symmetric(ref fProxyMxN, ref fProxyN, ref fProxyMxN)"/> solver for the
    /// small (&lt;= 3k) Rayleigh-Ritz sub-problem and <see cref="CHO.decomp(in fProxyMxN, ref fProxyMxN)"/>
    ...
    /// relative pivot -- mirrors <see cref="CHOP.decompSolve(ref fProxyMxN, in Pivot, int, ref fProxyN, ref fProxyCHOPCache)"/>'s
    ...
    /// solves it with <see cref="Eigen.symmetric(ref fProxyMxN, ref fProxyN, ref fProxyMxN)"/>,
    ...
    /// allocation). The one exception: <see cref="Eigen.symmetric(ref fProxyMxN, ref fProxyN, ref fProxyMxN)"/>
    ...
    /// AX/AW/AP) -- see <see cref="fProxyLOBPCGCache"/>'s BX/BW/BP fields. The safeguard-3
    ...
    /// generalized core with B played by <see cref="fProxyIdentityOperator"/> (Apply is an exact
    ...
    public static partial class LOBPCG
    {
        ...
        static void Deflate(ref fProxyMxN V, ref fProxyMxN AV, ref fProxyMxN BV, int activeCount,
                             in fProxyMxN Against, in fProxyMxN AgainstA, in fProxyMxN AgainstB, int againstCount, int n)
        {
