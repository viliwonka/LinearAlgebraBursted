...
namespace LinearAlgebra
{
    public static partial class QR {
        ...
        private static void genHouseholder(ref fProxyMxN Q, ref fProxyN u, int k, fProxy zeroThreshold) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe void applyReflectorRightCols(ref fProxyMxN Q, ref fProxyN u, ref fProxyN w, int d, int colEnd)
        {
            int M = Q.M_Rows;
            int N = Q.N_Cols;
