...
namespace LinearAlgebra
{
    public static partial class QR {
        ...
        //   ref fProxyQRCache cache — caller-provided scratch, BLOCKED (same kernel, same gate as
        ...
        internal static fProxy sign(fProxy x) {
            return x < 0 ? -1 : 1;
        }
        ...
        internal static void genHouseholder(ref fProxyMxN Q, ref fProxyN u, int k, fProxy zeroThreshold) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void applyReflectorRightCols(ref fProxyMxN Q, ref fProxyN u, ref fProxyN w, int d, int colEnd)
        {
            int M = Q.M_Rows;
            int N = Q.N_Cols;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void applyReflectorRight(ref fProxyMxN Q, ref fProxyN u, ref fProxyN w, int d)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref fProxyMxN A_to_Q, ref fProxyMxN R, ref fProxyN u, ref fProxyN w)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe void qrDecompositionBlockedCore(ref fProxyMxN Q, ref fProxyMxN R,
            ref fProxyN u, ref fProxyN w,
            ref fProxyN Vpanel, ref fProxyN Tbuf, ref fProxyN Wbuf, ref fProxyN tcolBuf, ref fProxyN VfullBuf)
        {
            ...
            fProxy* T = Tbuf.Data.Ptr;
            fProxy* Wmat = Wbuf.Data.Ptr;
            fProxy* tcol = tcolBuf.Data.Ptr;
            ...
            for (int p0 = 0; p0 < n; p0 += QR_BLOCK)
            {
                ...
                {
                    int r = p0 + t;
                    fProxy* Vrow = Vp + (long)t * pb;
                    for (int i = 0; i < pb; i++)
                        Vrow[i] = (t >= i) ? Qp[(long)r * n + (p0 + i)] : (fProxy)0;
                }
                ...
                if (cw > 0)
                {
                    fProxy* Cp = Qp + (long)p0 * n + cStart;
                    UnsafeUtility.MemClear(Wmat, (long)pb * cw * UnsafeUtility.SizeOf<fProxy>());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe void reconstructQBlocked(ref fProxyMxN Q,
            ref fProxyN Vpanel, ref fProxyN Tbuf, ref fProxyN Wbuf, ref fProxyN tcolBuf, ref fProxyN VfullBuf)
        {
            ...
            fProxy* Vfull = VfullBuf.Data.Ptr;
            for (int r = 0; r < m; r++)
            {
                fProxy* qrow = Qp + (long)r * n;
                fProxy* vrow = Vfull + (long)r * n;
                for (int c = 0; c < n; c++)
                    vrow[c] = (r >= c) ? qrow[c] : (fProxy)0;
            }

            // Seed Q = [I_n; 0] (m x n).
            UnsafeUtility.MemClear(Qp, (long)m * n * UnsafeUtility.SizeOf<fProxy>());
            for (int i = 0; i < n; i++)
                Q[i, i] = 1;
        ...
        /// <param name="A_to_Q">On entry A; on exit the orthogonal factor Q.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref fProxyMxN A_to_Q, ref fProxyMxN R, ref fProxyN u)
        {
            var w = new fProxyN(A_to_Q.N_Cols, Allocator.Temp, false);
        ...
        /// <param name="A_to_Q">On entry A; on exit the orthogonal factor Q.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref fProxyMxN A_to_Q, ref fProxyMxN R)
        {
            // See qrDecompositionBlockedCore for why this is a method-local const, not a class field.
            const int QR_BLOCK = 32;
            ...
            if (A_to_Q.N_Cols < Consts.fProxyQrBlockMinN)   // float/double split (see Consts); default 2*QR_BLOCK
            {
                var uSmall = new fProxyN(A_to_Q.M_Rows, Allocator.Temp, false);
                var wSmall = new fProxyN(A_to_Q.N_Cols, Allocator.Temp, false);
            ...
            var u = new fProxyN(m, Allocator.Temp, true);
            var w = new fProxyN(n, Allocator.Temp, true);
            var Vpanel = new fProxyN(m * QR_BLOCK, Allocator.Temp, true);
            var Tbuf = new fProxyN(QR_BLOCK * QR_BLOCK, Allocator.Temp, true);
            var Wbuf = new fProxyN(QR_BLOCK * n, Allocator.Temp, true);
            var tcolBuf = new fProxyN(QR_BLOCK, Allocator.Temp, true);
        ...
        // Cache overload: zero-alloc (caller-owned fProxyQRCache, see Arena.fProxyQRCache) AND
        ...
        /// <param name="A_to_Q">On entry A; on exit the orthogonal factor Q.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decompInPlace(ref fProxyMxN A_to_Q, ref fProxyMxN R, ref fProxyQRCache cache)
        {
            // See qrDecompositionBlockedCore for why this is a method-local const, not a class field.
            const int QR_BLOCK = 32;
            ...
            bool blocked = A_to_Q.N_Cols >= Consts.fProxyQrBlockMinN;   // float/double split (see Consts)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in fProxyMxN A, ref fProxyMxN Q, ref fProxyMxN R, ref fProxyN u, ref fProxyN w)
        {
        ...
        /// <param name="Q">Output only; prior contents ignored; safe to allocate with uninit: true. Receives the orthogonal factor.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in fProxyMxN A, ref fProxyMxN Q, ref fProxyMxN R, ref fProxyN u)
        {
            if (Q.M_Rows != A.M_Rows || Q.N_Cols != A.N_Cols)
                throw new ArgumentException("QR.decomp: Q must have the same dimensions as A");
        ...
        /// <param name="Q">Output only; prior contents ignored; safe to allocate with uninit: true. Receives the orthogonal factor.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in fProxyMxN A, ref fProxyMxN Q, ref fProxyMxN R)
        {
            if (Q.M_Rows != A.M_Rows || Q.N_Cols != A.N_Cols)
                throw new ArgumentException("QR.decomp: Q must have the same dimensions as A");
        ...
        /// <summary>
        /// decomp routed through caller-owned <see cref="fProxyQRCache"/> scratch: A is copied into Q
        ...
        /// <param name="Q">Output only; prior contents ignored; safe to allocate with uninit: true. Receives the orthogonal factor.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo decomp(in fProxyMxN A, ref fProxyMxN Q, ref fProxyMxN R, ref fProxyQRCache cache)
        {
            if (Q.M_Rows != A.M_Rows || Q.N_Cols != A.N_Cols)
                throw new ArgumentException("QR.decomp: Q must have the same dimensions as A");
        ...
        public static DirectSolveInfo decompSolve(ref fProxyMxN Q, ref fProxyMxN R, ref fProxyN b, ref fProxyN x) {
            // Solve Ax = b for x
            // A = QR
            // QRx = b
            // Rx = Q^T b
        ...
        /// </summary>
        public static fProxyN decompSolve(ref fProxyMxN Q, ref fProxyMxN R, ref fProxyN b) {
            fProxyN x = b.fProxyTempVec(Q.N_Cols);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo solveInPlace(ref fProxyMxN A, ref fProxyN b, ref fProxyN x, ref fProxyN u, ref fProxyN w) {
        ...
        /// <param name="x">Output only; prior contents ignored; safe to allocate with uninit: true.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo solveInPlace(ref fProxyMxN A, ref fProxyN b, ref fProxyN x, ref fProxyN u) {
        ...
        /// <param name="x">Output only; prior contents ignored; safe to allocate with uninit: true.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo solveInPlace(ref fProxyMxN A, ref fProxyN b, ref fProxyN x) {
        ...
        // Cache overload: zero-alloc (caller-owned fProxyQRCache, see Arena.fProxyQRCache) — routes
        ...
        /// <param name="x">Output only; prior contents ignored; safe to allocate with uninit: true.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectSolveInfo solveInPlace(ref fProxyMxN A, ref fProxyN b, ref fProxyN x, ref fProxyQRCache cache) {
        ...
        public static DirectSolveInfo decompSolve(ref fProxyMxN Q, ref fProxyMxN R, ref fProxyMxN B, ref fProxyMxN X) {
        ...
        public static unsafe DirectSolveInfo solveInPlace(ref fProxyMxN A, ref fProxyMxN B, ref fProxyMxN X) {
            if (A.M_Rows < A.N_Cols)
                throw new ArgumentException("QR.solveInPlace: Matrix A must be square or tall (more or equal rows than cols)");
            ...
            for (int d = 0; d < n; d++) {
                ...
                UnsafeUtility.MemClear(accp, (long)k * UnsafeUtility.SizeOf<fProxy>());
                for (int r = d; r < m; r++)
            ...
            for (int r = 0; r < n; r++) {
                fProxy* Xr = X.Data.Ptr + (long)r * k;
                fProxy* Br = Bp + (long)r * k;
                for (int j = 0; j < k; j++)
                    Xr[j] = Br[j];
            }
