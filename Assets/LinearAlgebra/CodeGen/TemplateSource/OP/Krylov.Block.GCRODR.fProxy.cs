...
namespace LinearAlgebra
{
    public static partial class Krylov {
            ...
            where TPre : struct, IfProxyPreconditioner
        {
            ...
            while (total < maxIter)
            {
                ...
                if (recycling && totalColsFinal > 0)
                {
                    ...
                    var Pgathered = new fProxyMxN(n, d, Allocator.Temp, false);
                    var APgathered = new fProxyMxN(n, d, Allocator.Temp, false);
        ...
        public static BlockSolveInfo bgcrodr<TPre>(in fProxyBSR A, in TPre M, in fProxyMxN B, ref fProxyMxN X,
                                        int restart, int recycle, int maxIter, fProxy tol)
            where TPre : struct, IfProxyPreconditioner
