...
namespace LinearAlgebra
{
    public static partial class Eigen
    {
        ...
        /// </summary>
        static void RequireEigenSymWorkspace(in fProxyEigenSym_WS ws, int n, string who = "eigenvaluesSymmetric")
        {
            if (ws.eVec.N != n || ws.vVec.N != n || ws.pVec.N != n)
                throw new ArgumentException(who + ": workspace must be sized for n (use Arena.fProxyEigenSym_WS(n))");
        }
    }
