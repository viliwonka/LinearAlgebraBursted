...
namespace LinearAlgebra
{
    ...
    public static partial class iProxyComp {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mulInPlace<T>(this T place, iProxy s) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void countbitsInPlace<T>(this T x) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe { UnsafeBitsOP.countbits(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void tzcntInPlace<T>(this T x) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe { UnsafeBitsOP.tzcnt(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void lzcntInPlace<T>(this T x) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe { UnsafeBitsOP.lzcnt(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void reversebitsInPlace<T>(this T x) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe { UnsafeBitsOP.reversebits(x.Data.Ptr, x.Data.Length); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void rorInPlace<T>(this T x, int n) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe { UnsafeBitsOP.ror(x.Data.Ptr, x.Data.Length, n); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void rolInPlace<T>(this T x, int n) where T : unmanaged, IUnsafeiProxyArray
        {
            unsafe { UnsafeBitsOP.rol(x.Data.Ptr, x.Data.Length, n); }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ceilpow2InPlace<T>(this T x) where T : unmanaged, IUnsafeiProxyArray
        {
