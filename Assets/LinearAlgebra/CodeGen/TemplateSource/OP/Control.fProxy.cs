...
namespace LinearAlgebra.Control
{
    ...
    // the relative Frobenius change ‖S_new-S_old‖_F / max(1,‖S_new‖_F) <= Consts.fProxySqrtEps.
    //
    ...
    public static partial class LQR
    {
        ...
        static RiccatiInfo SolveCold(in fProxyMxN A, in fProxyMxN B, in fProxyMxN Q, in fProxyMxN R,
        ...
        internal static RiccatiInfo RiccatiIterate(in fProxyMxN A, in fProxyMxN B, in fProxyMxN Q, in fProxyMxN R,
        ...
        public static RiccatiInfo lqr(in fProxyMxN A, in fProxyMxN B, in fProxyMxN Q, in fProxyMxN R,
        ...
        public static RiccatiInfo lqrSchedule(in fProxyMxN A, in fProxyMxN B, in fProxyMxN Q, in fProxyMxN R,
