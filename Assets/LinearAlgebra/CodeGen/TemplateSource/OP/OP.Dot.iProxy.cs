...
namespace LinearAlgebra
{
    ...
    public static partial class Blas {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void outerDot(in iProxyN a, in iProxyN b, ref iProxyMxN result)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in iProxyMxN A, in iProxyN x, ref iProxyN result)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in iProxyN y, in iProxyMxN A, ref iProxyN result)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void dot(in iProxyMxN a, in iProxyMxN b, ref iProxyMxN c, bool transposeA = false)
        {
            ...
            unsafe
            {
                ...
                UnsafeUtility.MemClear(c.Data.Ptr, (long)c.Data.Length * UnsafeUtility.SizeOf<iProxy>());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void trans(in iProxyMxN A, ref iProxyMxN T)
        {
