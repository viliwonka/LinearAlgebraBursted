...
namespace LinearAlgebra
{
    public static partial class LP
    {
        ...
        // (LP.ladFN, LP.FrischNewton.fProxy.cs) -- see docs/spec-lad-barrodale-roberts.md.
        //
        // ---- Source + verification ----
        ...
        // worked for LP.FrischNewton.fProxy.cs's source). Cross-checked against the R wrapper
        ...
        //    simplex's own ratio test (LP.fProxy.cs's RatioTest: max(Consts.fProxyZeroThreshold,
