...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        /// </summary>
        public static SVDInfo values(in fProxyMxN A, ref fProxyN S, int maxIter, fProxy tol)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <summary>values with default maxIter (Consts.sweepBudget(A.N_Cols)) and tol (Consts.fProxyZeroThreshold).</summary>
        ...
        /// <summary>values (workspace) with default maxIter (Consts.sweepBudget(A.N_Cols)) and tol (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo values(in fProxyMxN A, ref fProxyN S, ref fProxySVDValuesCache ws)
        ...
        /// <summary>thin with default tol (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
                                   int maxIter)
            => thin(in A, ref U, ref S, ref V, maxIter, Consts.fProxyZeroThreshold);

        /// <summary>thin with default maxIter (Consts.sweepBudget(A.N_Cols)) and tol (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V)
        ...
        /// </summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
                                   ref fProxySVDThinCache ws, int maxIter, fProxy tol)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <summary>thin (workspace) with default tol (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
                                   ref fProxySVDThinCache ws, int maxIter)
            => thin(in A, ref U, ref S, ref V, ref ws, maxIter, Consts.fProxyZeroThreshold);

        /// <summary>thin (workspace) with default maxIter (Consts.sweepBudget(A.N_Cols)) and tol (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
        ...
        static unsafe bool bidiagonalQR(ref fProxyMxN Ut, ref fProxyN d, ref fProxyN e, ref fProxyMxN Vt,
                                        int m, int n, int maxIter, fProxy tol, out int sweeps, out int convergedCount)
        {
                                        ...
                                        out int sweeps, out int convergedCount)
        {
            ...
            bool ok = bidiagonalQR(ref Ut, ref d, ref e, ref Vt, p, p, maxIter, Consts.fProxyEpsilon, out sweeps, out convergedCount);
            if (!ok) return false;
        ...
        static bool bidiagonalQRValues(ref fProxyN d, ref fProxyN e, int n, int maxIter, fProxy tol,
                                       out int sweeps, out int convergedCount)
        {
            fProxy anorm = (fProxy)0;
            for (int i = 0; i < n; i++)
