...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        /// </summary>
        public static SVDInfo values(in fProxyMxN A, ref fProxyN S, int maxIterations, fProxy tolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <summary>values with default maxIterations (Consts.sweepBudget(A.N_Cols)) and tolerance (Consts.fProxyZeroThreshold).</summary>
        ...
        /// <summary>values (workspace) with default maxIterations (Consts.sweepBudget(A.N_Cols)) and tolerance (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo values(in fProxyMxN A, ref fProxyN S, ref fProxySVDValuesCache ws)
        ...
        static fProxy svdAnormBlock(fProxy a, fProxy b)
        {
            fProxy aa = math.abs(a), ab = math.abs(b);
            fProxy mx = math.max(aa, ab);
            if (mx == (fProxy)0) return (fProxy)0;
            fProxy ra = aa / mx, rb = ab / mx;
        ...
        /// <summary>thin with default tolerance (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
                                   int maxIterations)
            => thin(in A, ref U, ref S, ref V, maxIterations, Consts.fProxyZeroThreshold);

        /// <summary>thin with default maxIterations (Consts.sweepBudget(A.N_Cols)) and tolerance (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V)
        ...
        /// </summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
                                   ref fProxySVDThinCache ws, int maxIterations, fProxy tolerance)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
        ...
        /// <summary>thin (workspace) with default tolerance (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
                                   ref fProxySVDThinCache ws, int maxIterations)
            => thin(in A, ref U, ref S, ref V, ref ws, maxIterations, Consts.fProxyZeroThreshold);

        /// <summary>thin (workspace) with default maxIterations (Consts.sweepBudget(A.N_Cols)) and tolerance (Consts.fProxyZeroThreshold).</summary>
        public static SVDInfo thin(in fProxyMxN A, ref fProxyMxN U, ref fProxyN S, ref fProxyMxN V,
        ...
        static unsafe bool bidiagonalQR(ref fProxyMxN Ut, ref fProxyN d, ref fProxyN e, ref fProxyMxN Vt,
                                        int m, int n, int maxIterations, fProxy tolerance, out int sweeps, out int convergedCount)
        {
        ...
        static bool bidiagonalSvdFromDE(ref fProxyN d, ref fProxyN e, ref fProxyMxN Ut, ref fProxyMxN Vt,
                                        ref fProxyMxN P, ref fProxyN S, ref fProxyMxN Q, int p, int maxIterations,
                                        out int sweeps, out int convergedCount)
        {
            ...
            bool ok = bidiagonalQR(ref Ut, ref d, ref e, ref Vt, p, p, maxIterations, Consts.fProxyEpsilon, out sweeps, out convergedCount);
            if (!ok) return false;
        ...
        static bool bidiagonalQRValues(ref fProxyN d, ref fProxyN e, int n, int maxIterations, fProxy tolerance,
                                       out int sweeps, out int convergedCount)
        {
            fProxy anorm = (fProxy)0;
            for (int i = 0; i < n; i++)
