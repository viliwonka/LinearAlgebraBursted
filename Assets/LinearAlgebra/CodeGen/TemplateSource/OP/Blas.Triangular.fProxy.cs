    ...
    public static partial class Blas {
        ...
        public static unsafe DirectSolveInfo triUpper(ref fProxyMxN U, ref fProxyN b_to_x)
        {
            ...
            for (int r = n - 1; r >= 0 && ok; r--)
            {
                ...
                if (!(math.abs(Ur[r]) > (fProxy)0) || !math.isfinite(Ur[r])) { ok = false; break; }
        ...
        public static unsafe DirectSolveInfo triLower(ref fProxyMxN L, ref fProxyN b_to_x)
        {
            ...
            for (int r = 0; r < n; r++)
            {
                ...
                if (!(math.abs(Lr[r]) > (fProxy)0) || !math.isfinite(Lr[r])) { ok = false; break; }
        ...
        public static unsafe DirectSolveInfo triUpperLUTransA(ref fProxyMxN U, in Pivot RP, ref fProxyN b_to_x)
        {
            if (U.IsSquare == false)
        ...
        public static unsafe DirectSolveInfo triLowerLUTransA(ref fProxyMxN L, in Pivot RP, ref fProxyN b_to_x)
        {
            if (L.IsSquare == false)
        ...
        public static unsafe DirectSolveInfo triUpperLUTransA(ref fProxyMxN U, in Pivot RP, ref fProxyMxN B_to_X)
        {
            if (U.IsSquare == false)
                throw new ArgumentException("Blas.triUpperLUTransA: Matrix must be square");
        ...
        public static unsafe DirectSolveInfo triLowerLUTransA(ref fProxyMxN L, in Pivot RP, ref fProxyMxN B_to_X)
        {
            if (L.IsSquare == false)
                throw new ArgumentException("Blas.triLowerLUTransA: Matrix must be square");
