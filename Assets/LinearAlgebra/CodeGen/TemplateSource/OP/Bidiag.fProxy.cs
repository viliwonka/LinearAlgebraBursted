...
namespace BULA
{
    ...
    public static partial class Bidiag
    {
        ...
        private static void genHouseholderCol(ref fProxyMxN M, ref fProxyN u, int k, fProxy zeroThreshold)
        {
            ...
            fProxy xNorm = Norms.L2Range(u, k, M.M_Rows);
            ...
            {
                // Exact sign-flip reflector (uᵀu must equal 2); Consts.fProxySqrt2 is exact per dtype,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void decomp(in fProxyMxN A, ref fProxyMxN U, ref fProxyMxN B, ref fProxyMxN V,
        ...
        public static void decomp(in fProxyMxN A, ref fProxyMxN U, ref fProxyMxN B, ref fProxyMxN V)
        {
            ...
            var ws = new fProxyBidiagCache
            {
                ...
                wScratch = new fProxyN(n, Allocator.Temp, false)
            };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void values(in fProxyMxN A, ref fProxyN d, ref fProxyN e,
                                               ref fProxyBidiagCache ws)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
