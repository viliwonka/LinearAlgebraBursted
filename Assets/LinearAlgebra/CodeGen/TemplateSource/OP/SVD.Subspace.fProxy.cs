...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        // fProxySvdFullWorkspace (Arena.fProxySvdFullWorkspace(m, n)) for zero-alloc repeated calls.
        ...
        /// with Arena.fProxySvdFullWorkspace(m, n).
        /// </summary>
        public static int nullspaceBasis(in fProxyMxN A, ref fProxyMxN basis, ref fProxySvdFullWorkspace ws,
        ...
        /// is full-SVD scratch reused across calls; size it with Arena.fProxySvdFullWorkspace(m, n).
        /// </summary>
        public static int rangeBasis(in fProxyMxN A, ref fProxyMxN basis, ref fProxySvdFullWorkspace ws,
                                     out bool converged, fProxy relTol, int maxIter)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
