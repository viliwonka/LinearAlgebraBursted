...
namespace LinearAlgebra
{
    public static partial class SVD {
        ...
        // fProxySVDFull_WS (Arena.fProxySVDFull_WS(m, n)) for zero-alloc repeated calls.
        ...
        /// with Arena.fProxySVDFull_WS(m, n).
        /// </summary>
        public static int nullspaceBasis(in fProxyMxN A, ref fProxyMxN basis, ref fProxySVDFull_WS ws,
        ...
        /// is full-SVD scratch reused across calls; size it with Arena.fProxySVDFull_WS(m, n).
        /// </summary>
        public static int rangeBasis(in fProxyMxN A, ref fProxyMxN basis, ref fProxySVDFull_WS ws,
                                     out bool converged, fProxy relTol, int maxIter)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
