...
namespace LinearAlgebra
{
    public static partial class Bidiag
    {
        ...
        /// </summary>
        static void RequireBidiagWorkspace(in fProxyBidiag_WS ws, int m, int n, bool needLeftU)
        {
            bool ok =
            ...
            if (!ok)
                throw new ArgumentException("Bidiag: workspace must be sized for m x n (use Arena.fProxyBidiag_WS(m, n))");
        }
    }
    ...
    public static partial class ArenaExtensions
    {
        ...
        /// <see cref="fProxyBidiag_WS"/> for reuse guidance.
        /// </summary>
        public static fProxyBidiag_WS fProxyBidiag_WS(this ref Arena arena, int m, int n)
        {
