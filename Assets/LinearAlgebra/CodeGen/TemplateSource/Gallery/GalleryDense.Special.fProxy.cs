...
namespace BULA.Gallery
{
    ...
    /// Opt in via <c>using BULA.Gallery;</c> then call e.g. <c>fProxyGallery.fProxyFrank(n)</c>.
    /// </summary>
    public static partial class fProxyGallery
    {
        ...
        /// about 0); trace = 0.
        /// </summary>
        public static fProxyMxN fProxyClement(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("fProxyClement: n must be >= 1");

            var mat = new fProxyMxN(n, n, allocator, true);
        ...
        /// </summary>
        public static fProxyMxN fProxyWilkinsonPlus(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 3 || (n & 1) == 0)
        ...
        /// <see cref="fProxyWilkinsonPlus"/>. At n = 3 the spectrum is {−√3, 0, √3}.
        /// </summary>
        public static fProxyMxN fProxyWilkinsonMinus(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 3 || (n & 1) == 0)
                throw new ArgumentException("fProxyWilkinsonMinus: n must be an odd integer >= 3");
        ...
        /// det = (−1)^(n−1) · (n−1) · 2^(n−2).
        /// </summary>
        public static fProxyMxN fProxyFiedler(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// zero can occur.
        /// </summary>
        public static fProxyMxN fProxyDingDong(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyFrank(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyVandermonde(in fProxyN nodes, Allocator allocator = Allocator.Temp)
        {
            if (nodes.N < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyCompanion(in fProxyN coeffs, Allocator allocator = Allocator.Temp)
        {
            if (coeffs.N < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyHadamard(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1 || (n & (n - 1)) != 0)
        ...
        /// </summary>
        public static fProxyMxN fProxyCirculant(in fProxyN c, Allocator allocator = Allocator.Temp)
        {
            if (c.N < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyKahan(int n, fProxy c, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("fProxyKahan: n must be >= 1");

            fProxy cc = c;
            fProxy s  = math.sqrt((fProxy)1 - c * c);
            var mat = new fProxyMxN(n, n, allocator, true);
        ...
        /// |alpha| or alpha ≪ 0.
        /// </summary>
        public static fProxyMxN fProxyTriw(int n, fProxy alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyLauchli(int n, fProxy eps, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
                throw new ArgumentException("fProxyLauchli: n must be >= 1");

            var mat = new fProxyMxN(n + 1, n, allocator, true);
        ...
        /// </summary>
        public static fProxyMxN fProxyCauchy(in fProxyN x, in fProxyN y, Allocator allocator = Allocator.Temp)
        {
            if (x.N != y.N)
            ...
            int n = x.N;
            var A = new fProxyMxN(n, n, allocator, true);
        ...
        /// </summary>
        public static fProxyMxN fProxyGCD(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyRedheffer(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyMagic(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1 || (n & 1) == 0)
                throw new ArgumentException("fProxyMagic: n must be a positive odd integer");

            // Zero-cleared alloc (uninit=false): the Siamese occupancy check below relies on
            // zero == empty, and the values placed are 1…n² which are always nonzero.
        ...
        /// </summary>
        public static fProxyMxN fProxyRosser(Allocator allocator = Allocator.Temp)
        {
            var A = new fProxyMxN(8, 8, allocator, true);
        ...
        /// </summary>
        public static fProxyMxN fProxyParter(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyProlate(int n, fProxy w, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
            ...
            for (int i = 0; i < n; i++)
                for (int j = 0; j < n; j++)
                {
                    ...
                    if (k == 0)
                        ...
                        A[i, j] = DetMath.Sin((fProxy)(2.0 * Math.PI) * w * (fProxy)k)
        ...
        /// </summary>
        public static fProxyMxN fProxyGrcar(int n, int k = 3, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyLotkin(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
