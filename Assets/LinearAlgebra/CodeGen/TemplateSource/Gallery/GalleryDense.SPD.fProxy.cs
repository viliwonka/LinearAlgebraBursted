...
namespace BULA.Gallery
{
    ...
    public static partial class fProxyGallery
    {
        ...
        /// </summary>
        public static fProxyMxN fProxyHilbert(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyPascal(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyLehmer(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyMinIJ(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// |ρ| ≥ 1 or negative ρ can be used as test inputs (same convention as fProxyHilbert).
        /// </summary>
        public static fProxyMxN fProxyKMS(int n, fProxy rho, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// SPD is the caller's responsibility — the generator is intentionally permissive, so
        /// degenerate/indefinite α can be used as test inputs (same convention as fProxyHilbert).
        /// </summary>
        public static fProxyMxN fProxyPei(int n, fProxy alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// fProxyHilbert. Default α = −1.
        /// </summary>
        public static fProxyMxN fProxyMoler(int n, fProxy alpha, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
        ...
        /// </summary>
        public static fProxyMxN fProxyMoler(int n, Allocator allocator = Allocator.Temp)
            => fProxyMoler(n, (fProxy)(-1), allocator);
        ...
        /// </summary>
        public static fProxyMxN fProxyLaplacian1D(int n, Allocator allocator = Allocator.Temp)
        {
            if (n < 1)
