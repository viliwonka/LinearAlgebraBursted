...
namespace LinearAlgebra.ML
{
    ...
    public static partial class PCA
    {
        ...
        /// </summary>
        public static bool fitCov(in fProxyMxN X, ref fProxyPCAModel model, PCAScaling scaling, out EigenInfo info)
        {
        ...
        public static bool fitCov(in fProxyMxN X, ref fProxyPCAModel model, out EigenInfo info)
        ...
        public static fProxyPCAModel fitCov(in fProxyMxN X, PCAScaling scaling, Allocator allocator = Allocator.Temp)
        {
            const string method = "PCA.fitCov";
            RequireBasicShape(in X, method);

            int p = X.N_Cols;
            var model = new fProxyPCAModel(p, p, allocator);
            fitCov(in X, ref model, scaling, out _);
            return model;
        }

        /// <summary>fitCov (allocating, Allocator) with scaling = PCAScaling.Covariance.</summary>
        public static fProxyPCAModel fitCov(in fProxyMxN X, Allocator allocator = Allocator.Temp)
        ...
        /// <see cref="SVD.thin(in fProxyMxN, ref fProxyMxN, ref fProxyN, ref fProxyMxN, int)"/>
        /// converged; <paramref name="info"/> carries its full <see cref="SVDInfo"/> diagnostics
        /// (discard with <c>out _</c> if unneeded).
        /// </summary>
        public static bool fitSvd(in fProxyMxN X, ref fProxyPCAModel model, PCAScaling scaling, int maxIter, out SVDInfo info)
        {
        ...
        public static bool fitSvd(in fProxyMxN X, ref fProxyPCAModel model, PCAScaling scaling, int maxIter)
        ...
        public static bool fitSvd(in fProxyMxN X, ref fProxyPCAModel model, PCAScaling scaling, out SVDInfo info)
        ...
        public static bool fitSvd(in fProxyMxN X, ref fProxyPCAModel model, PCAScaling scaling)
        ...
        public static bool fitSvd(in fProxyMxN X, ref fProxyPCAModel model, out SVDInfo info)
        ...
        /// name="allocator"/> (default Temp; caller owns disposal), then delegates to the
        /// ref-model overload. Guards fire before any allocation.</summary>
        public static fProxyPCAModel fitSvd(in fProxyMxN X, PCAScaling scaling, Allocator allocator = Allocator.Temp)
        {
            const string method = "PCA.fitSvd";
            RequireBasicShape(in X, method);
            RequireTallShape(in X, method);
        ...
        public static fProxyPCAModel fitSvd(in fProxyMxN X, Allocator allocator = Allocator.Temp)
        ...
        /// <see cref="SVD.truncated(in fProxyMxN, ref fProxyMxN, ref fProxyN, ref fProxyMxN, int, int, uint, int, bool, ref fProxySVDTruncatedCache)"/>
        /// converged; <paramref name="info"/> carries its full <see cref="SVDInfo"/> diagnostics
        /// (discard with <c>out _</c> if unneeded).
        /// </summary>
        ...
        /// </summary>
        public static bool fitSvdTruncated(in fProxyMxN X, ref fProxyPCAModel model, int k, PCAScaling scaling, out SVDInfo info)
        {
        ...
        public static bool fitSvdTruncated(in fProxyMxN X, ref fProxyPCAModel model, int k, PCAScaling scaling)
            => fitSvdTruncated(in X, ref model, k, scaling, out _);

        /// <summary>fitSvdTruncated with scaling = PCAScaling.Covariance.</summary>
        public static bool fitSvdTruncated(in fProxyMxN X, ref fProxyPCAModel model, int k, out SVDInfo info)
        ...
        /// name="allocator"/> (default Temp; caller owns disposal), then delegates to the
        /// ref-model overload. Guards fire before any allocation.</summary>
        public static fProxyPCAModel fitSvdTruncated(in fProxyMxN X, int k, PCAScaling scaling, Allocator allocator = Allocator.Temp)
        {
            const string method = "PCA.fitSvdTruncated";
            RequireBasicShape(in X, method);
            RequireTallShape(in X, method);
            ...
            var model = new fProxyPCAModel(p, k, allocator);
            fitSvdTruncated(in X, ref model, k, scaling, out _);
            return model;
        }

        /// <summary>fitSvdTruncated (allocating, Allocator) with scaling = PCAScaling.Covariance.</summary>
        public static fProxyPCAModel fitSvdTruncated(in fProxyMxN X, int k, Allocator allocator = Allocator.Temp)
        ...
        /// <see cref="SVD.randomized(in fProxyMxN, ref fProxyMxN, ref fProxyN, ref fProxyMxN, int, int, int, uint, int)"/>
        /// converged; <paramref name="info"/> carries its full <see cref="SVDInfo"/> diagnostics
        /// (discard with <c>out _</c> if unneeded).
        /// </summary>
        ...
        public static bool fitRandomized(in fProxyMxN X, ref fProxyPCAModel model, int k, PCAScaling scaling, out SVDInfo info)
        ...
        public static bool fitRandomized(in fProxyMxN X, ref fProxyPCAModel model, int k, PCAScaling scaling)
            => fitRandomized(in X, ref model, k, scaling, out _);

        /// <summary>fitRandomized with scaling = PCAScaling.Covariance.</summary>
        public static bool fitRandomized(in fProxyMxN X, ref fProxyPCAModel model, int k, out SVDInfo info)
        ...
        /// name="allocator"/> (default Temp; caller owns disposal), then delegates to the
        /// ref-model overload. Guards fire before any allocation.</summary>
        public static fProxyPCAModel fitRandomized(in fProxyMxN X, int k, PCAScaling scaling, Allocator allocator = Allocator.Temp)
        {
            const string method = "PCA.fitRandomized";
            RequireBasicShape(in X, method);
            RequireTallShape(in X, method);
        ...
        public static fProxyPCAModel fitRandomized(in fProxyMxN X, int k, Allocator allocator = Allocator.Temp)
        ...
        /// </summary>
        public static void transform(in fProxyMxN X, in fProxyPCAModel model, ref fProxyMxN scores)
        {
        ...
        /// disposal).</summary>
        public static fProxyMxN transform(in fProxyMxN X, in fProxyPCAModel model, Allocator allocator = Allocator.Temp)
        {
            const string method = "PCA.transform";
            int p = X.N_Cols;
            ...
            var scores = new fProxyMxN(X.M_Rows, model.k, allocator);
            transform(in X, in model, ref scores);
            return scores;
        }
    }
