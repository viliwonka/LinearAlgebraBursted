...
namespace LinearAlgebra.ML
{
    ...
    public static partial class KMeans
    {
            ...
            ref fProxyKMeansCache ws)
        {
            ...
            iters = 0;
            inertia = (fProxy)0; // overwritten in the converged branch below or in the final sync
        ...
        /// <summary>
        /// Calls <see cref="fit(in fProxyMxN,int,uint,int,KMeansInit,ref fProxyMxN,ref Indices,out fProxy,out int,ref fProxyKMeansCache)"/>
        ...
        /// <summary>
        /// Calls <see cref="fit(ref Arena,in fProxyMxN,int,uint,int,KMeansInit,out fProxyMxN,out Indices,out fProxy,out int)"/>
        /// with <c>init = KMeansInit.KMeansPlusPlus</c>.
        /// </summary>
        public static void fit(
            ref Arena arena,
