...
namespace LinearAlgebra.Stats
{
    ...
    public static partial class fProxyStats_OP  {
        ...
        public static void rowMean(in fProxyMxN A, ref fProxyN dest)
        {
            ...
            fProxy_OP.divInpl(dest, A.N_Cols);
        }
        ...
        public static void colMean(in fProxyMxN A, ref fProxyN dest)
        {
            ...
            fProxy_OP.divInpl(dest, A.M_Rows);
        }
        ...
        public static void colVariance(in fProxyMxN A, ref fProxyN dest)
        {
            ...
            for (int r = 0; r < A.M_Rows; r++)
                for (int c = 0; c < A.N_Cols; c++)
                    means[c] += A[r, c];
            fProxy_OP.divInpl(means, A.M_Rows);
        ...
        public static void covarianceInto(in fProxyMxN A, ref fProxyMxN C)
        {
            ...
            var centered = A.tempfProxyMat(M, N);
            for (int r = 0; r < M; r++)
                for (int c = 0; c < N; c++)
            ...
            fProxy_OP.dot(in centered, in centered, ref C, transposeA: true);
