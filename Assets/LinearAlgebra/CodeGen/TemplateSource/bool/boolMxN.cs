...
namespace LinearAlgebra
{
    ...
    public partial struct boolMxN : IDisposable, IUnsafeBoolArray
    {
        ...
        // Value handle, not a pointer: copying a boolMxN (including compiler-inserted defensive
        ...
        public unsafe boolMxN(int M_rows, int N_cols, in Arena arena, bool uninit = false)
        {
            ...
            N_Cols = N_cols;
            Length = M_Rows * N_Cols;
            var data = new UnsafeList<bool>(Length, _arena.Allocator, uninit ? NativeArrayOptions.UninitializedMemory : NativeArrayOptions.ClearMemory);
            data.Resize(Length, NativeArrayOptions.UninitializedMemory);
            Data = data;
        }
        ...
        public unsafe boolMxN TempCopy()
        {
            ...
            return _arena.boolTempMat(in this);
        }
