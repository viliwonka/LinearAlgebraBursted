namespace LinearAlgebra
{
    ...
    /// (<c>LinearAlgebra.Sparse.fProxyBSMOperator</c>) matrices without duplicating the solver
    /// loop.
    ...
    /// the concrete <c>Solvers.cg(in fProxyMxN, ...)</c> overloads wrap
    ...
    /// <c>TOp</c>), so passing <c>fProxyColScaledOperator&lt;fProxyDenseOperator&gt;</c> (or the BSM
