...
namespace LinearAlgebra
{
    ...
    public partial struct iProxyMxN : IDisposable, IUnsafeiProxyArray {
        ...
        // Arena-tracked path: a stable pointer into the arena's ChunkedRecordTable<iProxyMatRecord>.
        ...
        /// including views); false for default(iProxyMxN) and after Dispose().</summary>
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                if (!ChunkedRecordTable<iProxyMatRecord>.IsAliveFast(_rec) || ChunkedRecordTable<iProxyMatRecord>.GenerationFast(_rec) != _gen)
                    return false;
#endif
        ...
        {
            return _rec != null ? OwnerArena.iProxyMat(in this) : new iProxyMxN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.iProxyTempMat(in this) : new iProxyMxN(in this, Allocator.Temp);
        }
