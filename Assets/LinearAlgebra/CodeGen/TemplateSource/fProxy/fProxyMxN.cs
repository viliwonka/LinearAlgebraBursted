...
namespace LinearAlgebra
{
    ...
    public partial struct fProxyMxN : IDisposable, IUnsafefProxyArray {
        ...
        // Arena-tracked path: a stable pointer into the arena's ChunkedRecordTable<fProxyMatRecord>.
        // null for a standalone (non-arena) matrix, in which case Data resolves to _inlineData
        // instead -- see the Data property.
        [NativeDisableUnsafePtrRestriction] private unsafe fProxyMatRecord* _rec;
        ...
        /// arena's record table by the caller (Arena.fProxyMat/fProxyTempMat) -- this ctor only
        /// fills in the record's Data, it does not allocate or own the slot itself.
        /// </summary>
        internal unsafe fProxyMxN(int M_rows, int N_cols, fProxyMatRecord* rec, Allocator allocator, bool uninit = false)
        {
            _rec = rec;
            _inlineData = default;
        ...
        internal unsafe fProxyMxN(in fProxyMxN orig, fProxyMatRecord* rec, Allocator allocator)
        {
            _rec = rec;
            _inlineData = default;
        ...
        {
            return _rec != null ? OwnerArena.fProxyMat(in this) : new fProxyMxN(in this, Allocator.Temp);
        }
        ...
        {
            return _rec != null ? OwnerArena.fProxyTempMat(in this) : new fProxyMxN(in this, Allocator.Temp);
        }
