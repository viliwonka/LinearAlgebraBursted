...
namespace LinearAlgebra
{
    ...
    public partial struct fProxyMxN : IDisposable, IUnsafefProxyArray {
        ...
        // Arena-tracked path -- see fProxyN.cs's `_rec` doc comment for the full rationale (same
        ...
        // TempCopy() and the cross-type allocation shortcuts (fProxyMxN.Shortcuts.cs) that used to
