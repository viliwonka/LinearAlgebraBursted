...
namespace LinearAlgebra
{
    ...
    public partial struct fProxyMxN : IDisposable, IUnsafefProxyArray {
        ...
        /// default(fProxyMxN) and after Dispose().</summary>
        ...
        public unsafe fProxyMxN(in fProxyMxN source, int rows, int cols)
        {
            ...
            N_Cols = cols;
            Length = rows * cols;
            _data = new UnsafeList<fProxy>(source.Data.Ptr, Length);
        }

        public unsafe fProxyMxN(int M_rows, int N_cols, Allocator allocator = Allocator.Temp, bool uninit = false)
        {
            _data = default;
            M_Rows = M_rows;
            N_Cols = N_cols;
        ...
        /// </summary>
        public unsafe fProxyMxN(in fProxyMxN orig, Allocator allocator = Allocator.Temp)
        {
            _data = default;
        ...
        {
            return new fProxyMxN(in this, Allocator.Temp);
        }
