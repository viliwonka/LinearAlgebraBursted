...
namespace BULA
{
    ...
    public static partial class Analysis
    {
        ...
        public static bool isZero(in iProxyMxN m)
        {
        ...
        public static bool isIdentity(in iProxyMxN A)
        {
        ...
        public static bool isSymmetric(in iProxyMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isDiagonal(in iProxyMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isUpperTriangular(in iProxyMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
        ...
        public static bool isLowerTriangular(in iProxyMxN A)
        {
            if (A.M_Rows != A.N_Cols)
                return false;
