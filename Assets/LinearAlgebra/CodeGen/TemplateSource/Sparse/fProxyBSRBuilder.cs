...
namespace LinearAlgebra.Sparse
{
    ...
    public partial struct fProxyBSRBuilder : IDisposable
    {
        ...
        // fProxyBSRBuilder value-copy (this instance, the arena's tracked copy, the caller's
        ...
        private struct State
        {
            ...
            public UnsafeList<fProxy> triValues;
        }
        ...
        public unsafe fProxyBSRBuilder(int blockRows, int blockCols, int BR, int BC, Allocator allocator, int capacityHint = 8)
        {
            ...
            _state->triValues = new UnsafeList<fProxy>(capacityHint * BR * BC, allocator);
        }

        public unsafe fProxyBSRBuilder(int blockRows, int blockCols, int BR, int BC, in Arena arena, int capacityHint = 8)
        {
            _arena = arena;
        ...
        /// </summary>
        public unsafe void AddBlock(int br, int bc, [NoAlias] fProxy* block)
        {
        ...
        /// </summary>
        public unsafe void AddBlock(int br, int bc, in fProxyMxN block)
        {
        ...
        /// </summary>
        public unsafe void AddValue(int globalRow, int globalCol, fProxy v)
        {
            ...
            int blockLen = BR * BC;
            for (int i = 0; i < blockLen; i++)
                _state->triValues.Add(i == targetIdx ? v : (fProxy)0);
        }
        ...
        public unsafe fProxyBSR ToBSR(Allocator allocator) => ToBSRCore(allocator, symmetric: false);
        ...
        public unsafe fProxyBSR ToBSRSymmetric(Allocator allocator)
        {
            if (BR != BC || BlockRows != BlockCols)
                throw new ArgumentException("ToBSRSymmetric: requires BR==BC and BlockRows==BlockCols (square blocks on a square block grid)");
        ...
        // the final fProxyBSR allocation source differs (allocator instead of an arena record).
        private unsafe fProxyBSR ToBSRCore(Allocator allocator, bool symmetric)
        {
            int n = TripletCount;
            int blockLen = BR * BC;
            ...
            var bsm = new fProxyBSR(BlockRows, BlockCols, BR, BC, nnzb, allocator, true, symmetric);
        ...
        private unsafe fProxyBSR ToBSRCore(ref Arena arena, bool symmetric)
        {
            int n = TripletCount;
            int blockLen = BR * BC;
