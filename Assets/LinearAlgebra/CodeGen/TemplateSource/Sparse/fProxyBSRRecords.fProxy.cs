...
{
    /// <summary>
    /// Arena-owned, pointer-stable allocation record backing a fProxyBSR (mirrors
    /// fProxyVecRecord/fProxyMatRecord, see Arena/fProxyRecords.fProxy.cs). Lives inside
