...
{
    /// <summary>
    /// COO-of-blocks assembly builder for fProxyBSM. Accumulates (blockRow, blockCol, BR x BC
    ...
    ///
    /// MUTABLE-STATE INDIRECTION (fixes a use-after-free): the arena's fProxyBSMBuilder(...)
    ...
    /// the arena's.
    /// </summary>
    public partial struct fProxyBSMBuilder : IDisposable
    {
        // Heap-owned, single-identity mutable state -- see the type doc above. Every
        // fProxyBSMBuilder value-copy (this instance, the arena's tracked copy, the caller's
        ...
        /// blockCol), and builds the compressed fProxyBSM (RowPtr/ColInd/Values). Counting-sort
        ...
        /// value returned by arena.fProxyBSMBuilder(...) themselves, same as fProxyMxN/
        /// fProxyBSM/etc).
        /// </summary>
