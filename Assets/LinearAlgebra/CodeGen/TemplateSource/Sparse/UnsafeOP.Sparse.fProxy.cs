...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP
    {
        ...
        // between calls. Dispatch lives in BSR.spMM (SparseOP.fProxy.cs); sole caller is
        ...
        // BSR.sweepLower/sweepUpper dispatch -- see fProxyBSRMirrorToFull for the one-time
