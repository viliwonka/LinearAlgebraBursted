...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class UnsafeOP
    {
        ...
        // once per Apply call. Dispatch lives in BSR.spMM (SparseOP.fProxy.cs); sole caller is
        // fProxyBSROperator.ApplyBlock.
        // =====================================================================================

        // ---- bsrMatMat: AV[rv,:] += A * V[rv,:], general BR x BC block, square-block fallback --

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMat([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                      [NoAlias] fProxy* V, [NoAlias] fProxy* AV,
                                      int blockRows, int BR, int BC, int rows, int ldV, int ldAV)
        {
            ...
            for (int br = 0; br < blockRows; br++)
            {
                ...
                for (int k = rowStart; k < rowEnd; k++)
                {
                    int bc = colInd[k];
                    int xBase = bc * BC;
                    fProxy* block = values + (long)k * blockLen;
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int br = 0; br < blockRows; br++)
            {
                int rowStart = rowPtr[br];
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatSymB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatSymB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatSymB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatSymB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsrMatMatSymB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* V, [NoAlias] fProxy* AV, int blockRows, int rows, int ldV, int ldAV)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        // (SparseOP.fProxy.cs) and the Sparse DEVLOG.

        // =====================================================================================
        // fProxyBlockJacobi.Apply specialization: z = DInv * r, one dense b x b matvec per
        ...
        // lives in fProxyBlockJacobi.Apply.
        // =====================================================================================
        ...
        // DIAGONAL solved via the existing fProxyBlockJacobi explicit block inverses (dInv, the
        ...
        // Dispatch lives in BSR.sweepLower / BSR.sweepUpper (SparseOP.fProxy.cs).
        // =====================================================================================

        // ---- sweepLower: (D/diagScale + L) y = r, square block b ---------------------------

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepLowerB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = 0; i < blockRows; i++)
            {
                fProxy acc = r[i];
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepLowerB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = 0; i < blockRows; i++)
            {
                int rowBase = i * 2;
                fProxy acc0 = r[rowBase + 0];
                fProxy acc1 = r[rowBase + 1];
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepLowerB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = 0; i < blockRows; i++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepLowerB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = 0; i < blockRows; i++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepLowerB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = 0; i < blockRows; i++)
            {
                ...
                fProxy acc2 = r[rowBase + 2];
                fProxy acc3 = r[rowBase + 3];
                fProxy acc4 = r[rowBase + 4];
                fProxy acc5 = r[rowBase + 5];
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepLower([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                       fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows, int BR)
        {
            int blockLen = BR * BR;
            fProxy* acc = stackalloc fProxy[BR];
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepUpperB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepUpperB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = blockRows - 1; i >= 0; i--)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepUpperB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = blockRows - 1; i >= 0; i--)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepUpperB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = blockRows - 1; i >= 0; i--)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepUpperB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                         fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows)
        {
            for (int i = blockRows - 1; i >= 0; i--)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void sweepUpper([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values, [NoAlias] fProxy* dInv,
                                       fProxy diagScale, [NoAlias] fProxy* r, [NoAlias] fProxy* y, int blockRows, int BR)
        {
            int blockLen = BR * BR;
            fProxy* acc = stackalloc fProxy[BR];
