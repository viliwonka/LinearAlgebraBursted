...
namespace LinearAlgebra.Internal
{
    public static unsafe partial class Unsafe_OP
    {
        ...
        public static void bsmMatVec([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecT([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                       [NoAlias] fProxy* x, [NoAlias] fProxy* y,
                                       int blockRows, int BR, int BC)
        {
            int blockLen = BR * BC;
        ...
        // Sparse_OP.spMV / spMVT (SparseOP.fProxy.cs).
        // =====================================================================================

        // ---- bsmMatVec: y = A * x, square block b -----------------------------------------

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                        [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecTB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                         [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecTB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                         [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecTB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                         [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecTB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                         [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecTB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                         [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int br = 0; br < blockRows; br++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecSymB1([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecSymB2([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecSymB3([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecSymB4([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        public static void bsmMatVecSymB6([NoAlias] int* rowPtr, [NoAlias] int* colInd, [NoAlias] fProxy* values,
                                           [NoAlias] fProxy* x, [NoAlias] fProxy* y, int blockRows)
        {
            for (int bi = 0; bi < blockRows; bi++)
            {
