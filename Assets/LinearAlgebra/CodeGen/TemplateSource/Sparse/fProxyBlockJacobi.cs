...
namespace LinearAlgebra.Sparse
{
    ...
    public readonly partial struct fProxyBlockJacobi : IfProxyPreconditioner, IDisposable
    {
        ...
        internal unsafe fProxyBlockJacobi(in fProxyBSR A, fProxyBlockJacobiRecord* rec, Allocator allocator, out PreconditionerInfo info) : this(in A, allocator, out info)
        {
            if (!info.Solved)
                return;
            rec->DInv = _inlineDInv;
