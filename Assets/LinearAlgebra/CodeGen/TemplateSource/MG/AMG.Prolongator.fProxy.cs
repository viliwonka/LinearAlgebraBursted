...
namespace LinearAlgebra.Sparse
{
    public static partial class AMG
    {
        ...
        public static fProxyBSR tentativeProlongator(in fProxyBSR A, in Indices aggId, int numAgg,
            in fProxyMxN B, ref Arena arena, out fProxyMxN Bcoarse)
        {
            int nb = A.BlockRows;
            int BR = A.BR;
            int m = B.N_Cols;
        ...
        /// <summary>Standalone twin of <see cref="tentativeProlongator(in fProxyBSR, in Indices, int, in fProxyMxN, ref Arena, out fProxyMxN)"/>:
        ...
        /// </summary>
        public static fProxyBSR tentativeProlongator(in fProxyBSR A, in Indices aggId, int numAgg,
            ref Arena arena, out fProxyMxN Bcoarse)
        {
            int n = A.M_Rows;
            var ones = arena.fProxyMat(n, 1);
