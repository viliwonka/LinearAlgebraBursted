...
namespace BULA.Sparse
{
    public static partial class AMG
    {
        ...
        /// Allocates the coarse operator from <paramref name="allocator"/>; caller owns disposing the
        /// returned <see cref="fProxyBSR"/>. Internal assembly scratch is Temp and disposed before
        /// returning.
        /// </summary>
