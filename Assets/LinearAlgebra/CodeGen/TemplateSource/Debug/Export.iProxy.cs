...
namespace LinearAlgebra
{
    ...
    // only the cast off the iProxy PROXY struct (which -- like fProxy, see proxyStructs.cs -- only
    ...
    // at the proxy-compile stage (iProxy defines an implicit conversion to int, so the int choice
