...
public class iProxyStatsTests
{
    ...
    public struct StatsTestJob : IJob
    {
        ...
        void SumVector()
        {
            ...
            var w = new iProxyN(3, Allocator.Temp);
        ...
        void AllEqual()
        {
            var v = GenerateOP.iProxyVec(3, (iProxy)7);
        ...
        void WidenedSumNoOverflow()
        {
            ...
            var v = GenerateOP.iProxyVec(n, (iProxy)iProxy.MaxValue);
        ...
        {
            var v = GenerateOP.iProxyVec(2, (iProxy)iProxy.MaxValue);
    ...
    public void EmptyMatrixReductionsThrow()
    {
        ...
        var A = new iProxyMxN(0, 3, Allocator.Temp);
