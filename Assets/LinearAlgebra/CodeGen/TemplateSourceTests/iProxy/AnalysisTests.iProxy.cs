...
public class iProxyAnalysisTests
{
    ...
    public struct AnalysisTestJob : IJob
    {
        ...
        void ZeroVector()
        {
            var v = GenerateOP.iProxyVec(5, (iProxy)0);
        ...
        void ZeroMatrix()
        {
            var A = GenerateOP.iProxyMat(3, 3, (iProxy)0);
        ...
        void Identity()
        {
            var A = GenerateOP.iProxyIdentityMat(4);
        ...
        void IdentityNegatives()
        {
            ...
            var B = GenerateOP.iProxyIdentityMat(4);
        ...
        void NonSquare()
        {
            var A = GenerateOP.iProxyMat(2, 3, (iProxy)0);
            ...
            var Z = GenerateOP.iProxyMat(2, 3, (iProxy)0);
