...
public class iProxyNormsTests
{
    ...
    public struct NormsTestJob : IJob
    {
        ...
        // ABS-OVERFLOW EDGE: single element == iProxy.MinValue. The kernel widens each element to
        ...
        //     WRONG answer; see NormsOP.iProxy.cs's LInf doc comment), so it also surfaces ->
        ...
        void MinValueAbsOverflow()
        {
            ...
            long expectedLInf = /*+choose[2147483648L|32768L|long.MinValue]*/2147483648L/*-choose*/;

            Assert.IsTrue(Norms.L1(in v) == expectedL1);
            Assert.IsTrue(Norms.LInf(in v) == expectedLInf);
        }

        // MIXED-INPUT contrast (see NormsOP.iProxy.cs's L1/LInf doc comments for the full
        ...
        void MinValueMixedInput()
        {
            ...
            long expectedL1 = /*+choose[2147483653L|32773L|long.MinValue + 5]*/2147483653L/*-choose*/;
            long expectedLInf = /*+choose[2147483648L|32768L|5L]*/2147483648L/*-choose*/;
