...
public class iProxyClampTests
{
    ...
    public struct ClampTestJob : IJob
    {
        ...
        void ClampVector()
        {
            ...
            iProxyComp.clampInpl(in v, (iProxy)(-2), (iProxy)5);
        ...
        void ClampMatrix()
        {
            ...
            iProxyComp.clampInpl(in A, (iProxy)0, (iProxy)10);
        ...
        void ClampNoOpInRange()
        {
            ...
            iProxyComp.clampInpl(in v, (iProxy)0, (iProxy)5);
            for (int i = 0; i < 4; i++)
    ...
    public void ClampLoGreaterThanHiThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => iProxyComp.clampInpl(in v, (iProxy)6, (iProxy)(-1)));
        arena.Dispose();
    }
}
