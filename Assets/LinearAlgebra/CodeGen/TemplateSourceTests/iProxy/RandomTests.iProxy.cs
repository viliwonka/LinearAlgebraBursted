...
public class iProxyRandomTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void EmptyAndSingle()
        {
            ...
            Rand.nextUniformInpl(ref rng, ref empty, (iProxy)(-2), (iProxy)2);
    ...
    public void NextUniformInplMinGreaterMaxThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => Rand.nextUniformInpl(ref rng, ref v, (iProxy)5, (iProxy)1));

        var M = arena.iProxyMat(3, 3);
        Assert.Throws<ArgumentException>(() => Rand.nextUniformInpl(ref rng, ref M, (iProxy)5, (iProxy)1));
