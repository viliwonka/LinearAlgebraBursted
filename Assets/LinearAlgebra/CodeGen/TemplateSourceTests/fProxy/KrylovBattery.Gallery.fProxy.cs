...
namespace LinearAlgebra
{
    ...
    {
        public static fProxyMxN Build(GalleryDenseMatrix m)
        {
            switch (m)
            {
                case GalleryDenseMatrix.Laplacian1D_8: return fProxyGallery.fProxyLaplacian1D(8);
                case GalleryDenseMatrix.MinIJ_5:        return fProxyGallery.fProxyMinIJ(5);
                case GalleryDenseMatrix.Pei5_2:          return fProxyGallery.fProxyPei(5, (fProxy)2);
                case GalleryDenseMatrix.Hilbert4:        return fProxyGallery.fProxyHilbert(4);
                case GalleryDenseMatrix.Pascal5:         return fProxyGallery.fProxyPascal(5);
                case GalleryDenseMatrix.Lehmer5:         return fProxyGallery.fProxyLehmer(5);

                case GalleryDenseMatrix.Fiedler5:  return fProxyGallery.fProxyFiedler(5);
                case GalleryDenseMatrix.Clement4:  return fProxyGallery.fProxyClement(4);
                case GalleryDenseMatrix.Rosser8:   return fProxyGallery.fProxyRosser();
                ...
                case GalleryDenseMatrix.Grcar8:          return fProxyGallery.fProxyGrcar(8);

                case GalleryDenseMatrix.Lauchli3_05:  return fProxyGallery.fProxyLauchli(3, (fProxy)0.5);
                case GalleryDenseMatrix.Lauchli3_1e3: return fProxyGallery.fProxyLauchli(3, (fProxy)1E-3);
                ...
                case GalleryDenseMatrix.RandSPDWellCond20: return RandSPD(20, (fProxy)1, (fProxy)10, 0x5EED4u);
                case GalleryDenseMatrix.RandSPDIllCond20:  return RandSPD(20, (fProxy)1E-3, (fProxy)1, 0x5EED5u);

                case GalleryDenseMatrix.TallRandom24x8: return GenerateOP.fProxyRandomMat(24, 8, (fProxy)(-1), (fProxy)1, 0x5EED6u);

                default: throw new System.ArgumentException("fProxyKrylovBatteryGallery.Build: unhandled GalleryDenseMatrix");
            }
        }

        public static fProxyBSR Build(GalleryBSRMatrix m)
        {
            switch (m)
            {
                case GalleryBSRMatrix.Poisson2D_20x20:       return Poisson2D(20, 20);
                case GalleryBSRMatrix.Laplacian2D_16x16:     return fProxyGallery.fProxyLaplacian2D(16, 16);
                case GalleryBSRMatrix.RandomSparseSPD_120_2: return fProxyGallery.fProxyRandomSparseSPD(120, 2, (fProxy)0.2, 0x5EED0u);
                case GalleryBSRMatrix.RandomSparseNonsym_80: return fProxyGallery.fProxyRandomSparse(80, 80, 1, (fProxy)0.1, 0x5EED1u);
        ...
        {
            var A = GenerateOP.fProxyRandomMat(n, n, (fProxy)(-1), (fProxy)1, seed);
        ...
        static fProxyMxN ConvDiffDense(int n)
        {
            var A = new fProxyMxN(n, n, Allocator.Temp);   // zero-initialized
            for (int i = 0; i < n; i++)
            {
                A[i, i] = (fProxy)6;
        ...
        static fProxyMxN WideRandom(int m, int n, int rank, uint seed)
        {
        ...
        static fProxyMxN RandSPD(int n, fProxy minEig, fProxy maxEig, uint seed)
        {
    ...
    internal static class fProxyKrylovBatteryOracles
    {
        ...
        public static fProxyMxN BuildDenseSpd(int n, uint seed, fProxy invScale)
        {
            var W = GenerateOP.fProxyRandomMat(n, n, (fProxy)(-1), (fProxy)1, seed);
        ...
        public static fProxyMxN BuildDenseSpdSystem(int n, uint seed)
        {
            var M = GenerateOP.fProxyRandomMat(n, n, (fProxy)(-1f), (fProxy)1f, seed);
        ...
        public static fProxyBSR DenseToBSR1x1(in fProxyMxN A)
        {
            var builder = new fProxyBSRBuilder(A.M_Rows, A.N_Cols, 1, 1, Allocator.Temp, math.max(A.M_Rows * A.N_Cols, 1));
        ...
        public static fProxyN Row(in fProxyMxN B, int j, int n)
        {
