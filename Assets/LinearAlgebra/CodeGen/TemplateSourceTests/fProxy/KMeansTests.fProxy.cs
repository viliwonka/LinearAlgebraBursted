...
public class fProxyKMeansTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void SeparableBlobs()
        {
            ...
            KMeans.kmeans(in X, k, 1u, 20, ref centroids, ref assign, out fProxy inertia, out int iters, ref ws);
        ...
        void InertiaRecompute()
        {
            ...
            var X = TwoSpreadClusters(ref arena);
            {
                ...
                var assign    = arena.Indices(N);
                var ws        = arena.fProxyKMeansCache(N, D, k);
                KMeans.kmeans(in X, k, 3u, 20, ref centroids, ref assign, out fProxy inertia, out _, ref ws);
            ...
            var B = Blobs3(ref arena);
            {
                ...
                var assign    = arena.Indices(N);
                var ws        = arena.fProxyKMeansCache(N, D, k);
                KMeans.kmeans(in B, k, 9u, 20, ref centroids, ref assign, out fProxy inertia, out _, ref ws);
        ...
        void Determinism(KMeansInit init)
        {
            ...
            KMeans.kmeans(in X, k, seed, 20, init, ref c1, ref a1, out fProxy in1, out int it1, ref w1);
            KMeans.kmeans(in X, k, seed, 20, init, ref c2, ref a2, out fProxy in2, out int it2, ref w2);
        ...
        void WorkspaceVsAllocating()
        {
            ...
            KMeans.kmeans(in X, k, seed, 20, KMeansInit.KMeansPlusPlus, ref cP, ref aP, out fProxy inP, out int itP, ref ws);
        ...
        void EmptyClusterReseed()
        {
            ...
            var assign    = arena.Indices(N);
            var ws        = arena.fProxyKMeansCache(N, D, k);
            KMeans.kmeans(in X, k, 2u, 20, ref centroids, ref assign, out fProxy inertia, out _, ref ws);
        ...
        void CheckZeroInertia(ref Arena arena, in fProxyMxN X, int k, uint seed, KMeansInit init)
        {
            ...
            var assign    = arena.Indices(N);
            var ws        = arena.fProxyKMeansCache(N, D, k);
            KMeans.kmeans(in X, k, seed, 30, init, ref centroids, ref assign, out fProxy inertia, out _, ref ws);
    ...
    public void CentroidShapeMismatchThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            KMeans.kmeans(in X, k, 1u, 10, ref badCentroids, ref assign, out fProxy inertia, out int iters, ref ws));
        arena.Dispose();
    }
    ...
    public void AssignmentSizeMismatchThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            KMeans.kmeans(in X, k, 1u, 10, ref centroids, ref badAssign, out fProxy inertia, out int iters, ref ws));
        arena.Dispose();
    }
    ...
    public void WorkspaceShapeMismatchThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            KMeans.kmeans(in X, k, 1u, 10, ref centroids, ref assign, out fProxy inertia, out int iters, ref badWs));
        arena.Dispose();
    }
}
