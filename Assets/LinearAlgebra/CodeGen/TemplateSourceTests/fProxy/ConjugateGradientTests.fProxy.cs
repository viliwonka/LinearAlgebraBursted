...
public class fProxyConjugateGradientTests
{
    ...
    public struct ConjugateGradientTestJob : IJob
    {
        ...
        {
            var M = arena.fProxyRandomMatrix(dim, dim, -1f, 1f, seed);

            // dot(M, M, transposeA:true) == Mᵀ·M
            var A = fProxyOP.dot(M, M, true);
        ...
        void AddScaledInpl()
        {
            ...
            var y = arena.fProxyRandomVector(n, -1f, 1f, 11111);
            var x = arena.fProxyRandomVector(n, -1f, 1f, 22222);
        ...
        void ScaleAddInpl()
        {
            ...
            var y = arena.fProxyRandomVector(n, -1f, 1f, 33333);
        ...
        void OverloadsAgree()
        {
            ...
            var b = arena.fProxyRandomVector(dim, -1f, 1f, 5151);
            ...
            bool okExpl = Solvers.conjugateGradient(in A, in b, ref xExpl, dim, Consts.fProxySqrtEps);
        ...
        void ZeroRhs()
        {
            ...
            var x = arena.fProxyRandomVector(dim, -1f, 1f, 9999);
        ...
        void NotSPD()
        {
            ...
            var b = arena.fProxyRandomVector(2, -1f, 1f, 13);
        ...
        void AlreadyConverged()
        {
            ...
            var b = arena.fProxyRandomVector(dim, -1f, 1f, 6363);
        ...
        void Tiny()
        {
            ...
            var b = arena.fProxyRandomVector(1, -1f, 1f, 77);
