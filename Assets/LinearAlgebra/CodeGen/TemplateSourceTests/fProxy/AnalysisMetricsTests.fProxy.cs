...
public class fProxyAnalysisMetricsTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void CondIdentity()
        {
            var A = GenerateOP.fProxyIdentityMat(3);
        ...
        void CondZero()
        {
            var A = new fProxyMxN(2, 2, Allocator.Temp);   // all zeros
        ...
        void RankCase(RankShape shape)
        {
            ...
            {
                // diag(2, 3, 5) -> rank 3
                A = new fProxyMxN(3, 3, Allocator.Temp);
            ...
            else if (shape == RankShape.Deficient)
            {
                ...
                A = new fProxyMxN(4, 2, Allocator.Temp);
            ...
            {
                // zero 3x2 -> rank 0
                A = new fProxyMxN(3, 2, Allocator.Temp);
                expected = 0;
            }
