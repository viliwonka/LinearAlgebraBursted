...
public class fProxyInPlaceOpTests
{
    ...
    {
        var a = new fProxyN(3, Allocator.Temp); a[0] = (fProxy)1; a[1] = (fProxy)2; a[2] = (fProxy)3;
        var b = new fProxyN(3, Allocator.Temp); b[0] = (fProxy)10; b[1] = (fProxy)20; b[2] = (fProxy)30;
    ...
    {
        var a = new fProxyN(2, Allocator.Temp); a[0] = (fProxy)10; a[1] = (fProxy)20;
        var b = new fProxyN(2, Allocator.Temp); b[0] = (fProxy)3;  b[1] = (fProxy)5;
    ...
    {
        var a = new fProxyN(3, Allocator.Temp); a[0] = (fProxy)2; a[1] = (fProxy)3; a[2] = (fProxy)4;
        var b = new fProxyN(3, Allocator.Temp); b[0] = (fProxy)10; b[1] = (fProxy)20; b[2] = (fProxy)30;
    ...
    public void OperatorMul_ComponentWise_Values_OperandsUntouched()
    {
        ...
        var am = new fProxyMxN(2, 2, Allocator.Temp);
        am[0, 0] = (fProxy)1; am[0, 1] = (fProxy)2; am[1, 0] = (fProxy)3; am[1, 1] = (fProxy)4;
        var bm = new fProxyMxN(2, 2, Allocator.Temp);
        bm[0, 0] = (fProxy)5; bm[0, 1] = (fProxy)6; bm[1, 0] = (fProxy)7; bm[1, 1] = (fProxy)8;

        var cm = new fProxyMxN(in am, Allocator.Temp);
        fProxyComp.mulInPlace(cm, bm);
