...
public class fProxyQueryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RowColArgMinMax()
        {
            ...
            var valR = new fProxyN(3, Allocator.Temp);
            ...
            var valC = new fProxyN(3, Allocator.Temp);
        ...
        void ColArgStrided()
        {
            ...
            var valC = new fProxyN(2, Allocator.Temp);
        ...
        void ArgMaxRowNorm()
        {
            ...
            var T = new fProxyMxN(2, 2, Allocator.Temp);
        ...
        void DistancesToRowAllMetrics()
        {
            ...
            var d = new fProxyN(2, Allocator.Temp);
            ...
            // r1=(1,0) -> cos = 3/5 = 0.6.
            var q2 = new fProxyN(2, Allocator.Temp);
        ...
        void NearestFarthestSimilarity()
        {
            ...
            var q3 = new fProxyN(3, Allocator.Temp);
        ...
        void KNearestBruteForce()
        {
            ...
            var scores = new fProxyN(k, Allocator.Temp);
            ...
            var all = new fProxyN(M, Allocator.Temp);
            ...
            var scores2 = new fProxyN(k, Allocator.Temp);
            int cnt2 = Query.kNearestRows(in A, in q, k, Metric.Dot, ref idx2, ref scores2);
            AssertEqI(cnt2, k);
            var allDot = new fProxyN(M, Allocator.Temp);
        ...
        {
            int M = 5, N = 2;
            var A = GenerateOP.fProxyRandomMat(M, N, -2f, 2f, 99887, allocator: Allocator.Temp);
            var q = new fProxyN(N, Allocator.Temp);
        ...
        void WithinRadiusBoundary()
        {
            ...
            var qcol = new fProxyN(3, Allocator.Temp);
        ...
        {
            int M = 5, N = 4;
            var A = GenerateOP.fProxyRandomMat(M, N, -3f, 3f, 20240625, allocator: Allocator.Temp);
            ...
            var dc = new fProxyN(N, Allocator.Temp);
            var dr = new fProxyN(N, Allocator.Temp);
            ...
            int kk = 3;
            var ncIdx = new Indices(kk, Allocator.Temp); var ncVal = new fProxyN(kk, Allocator.Temp);
            var nrIdx = new Indices(kk, Allocator.Temp); var nrVal = new fProxyN(kk, Allocator.Temp);
            ...
            var fcIdx = new Indices(kk, Allocator.Temp); var fcVal = new fProxyN(kk, Allocator.Temp);
            var frIdx = new Indices(kk, Allocator.Temp); var frVal = new fProxyN(kk, Allocator.Temp);
        ...
        {
            int M = 4, N = 3;
            var A = GenerateOP.fProxyRandomMat(M, N, -3f, 3f, 13572468, allocator: Allocator.Temp);
            var q = new fProxyN(N, Allocator.Temp);
            ...
            var nrIdx = Query.fProxyKNearestRows(in A, in q, kRows, Metric.SqEuclidean, out fProxyN nrScore, out int nrCnt, Allocator.Temp);
            AssertEqI(nrCnt, M);
            AssertEqI(nrIdx.N, M);
            var allR = new fProxyN(M, Allocator.Temp);
            ...
            var frIdx = Query.fProxyKFarthestRows(in A, in q, kRows, Metric.SqEuclidean, out fProxyN frScore, out int frCnt, Allocator.Temp);
            AssertEqI(frCnt, M);
            ...
            var ncIdx = Query.fProxyKNearestColumns(in A, in qc, kCols, Metric.SqEuclidean, out fProxyN ncScore, out int ncCnt, Allocator.Temp);
            AssertEqI(ncCnt, N);
            var allC = new fProxyN(N, Allocator.Temp);
            ...
            var fcIdx = Query.fProxyKFarthestColumns(in A, in qc, kCols, Metric.SqEuclidean, out fProxyN fcScore, out int fcCnt, Allocator.Temp);
            AssertEqI(fcCnt, N);
        ...
        {
            int M = 6, N = 4;
            var A = GenerateOP.fProxyRandomMat(M, N, -2f, 2f, 7777, allocator: Allocator.Temp);
            var q = new fProxyN(N, Allocator.Temp);
            ...
            var idxNz = Query.fProxyNonzeroIndices(in A, (fProxy)0.5, allocator: Allocator.Temp);
            ...
            var idxRR = Query.fProxyRowsWithinRadius(in A, in q, radius, Metric.SqEuclidean, allocator: Allocator.Temp);
            ...
            var idxCR = Query.fProxyColumnsWithinRadius(in A, in qc, (fProxy)8, Metric.SqEuclidean, allocator: Allocator.Temp);
            ...
            int k = 3;
            var idxK = Query.fProxyKNearestRows(in A, in q, k, Metric.SqEuclidean, out fProxyN scoresK, out int cntK, Allocator.Temp);
            var refIdxK = new Indices(k, Allocator.Temp);
            var refScoresK = new fProxyN(k, Allocator.Temp);
            ...
            var idxKC = Query.fProxyKNearestColumns(in A, in qc, k, Metric.SqEuclidean, out fProxyN scoresKC, out int cntKC, Allocator.Temp);
            var refIdxKC = new Indices(k, Allocator.Temp);
            var refScoresKC = new fProxyN(k, Allocator.Temp);
    ...
    {
        var A = new fProxyMxN(3, 4, Allocator.Temp);          // row ops need q.N == A.N_Cols == 4
        var qBad = new fProxyN(3, Allocator.Temp);          // wrong length
    ...
    {
        var A = new fProxyMxN(3, 4, Allocator.Temp);          // col ops need q.N == A.M_Rows == 3
        var qBad = new fProxyN(4, Allocator.Temp);          // wrong length
