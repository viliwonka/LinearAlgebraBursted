...
public class fProxyEigenQRTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void SymmetricCrossCheckJacobi()
        {
            ...
            {
                int n = 6;
                var A = GenerateOP.fProxyRandomMat(n, n, -3f, 3f, 30000 + t * 13);
                for (int i = 0; i < n; i++)
                    for (int j = i + 1; j < n; j++)
                    {
                ...
                var Aqr = new fProxyMxN(in A, Allocator.Temp);
                var Ajac = new fProxyMxN(in A, Allocator.Temp);
                ...
                var jac = new fProxyN(n, Allocator.Temp);
        ...
        void TraceInvariant()
        {
            ...
            {
                int n = 7;
                var A = GenerateOP.fProxyRandomMat(n, n, -2f, 2f, 40000 + t * 17);
                fProxy trace = 0;
        ...
        {
            int n = 5;
            var A = fProxyGallery.fProxyFrank(n);
        ...
        {
            int n = 4;
            var coeffs = new fProxyN(n, Allocator.Temp);
            coeffs[0] = 24f; coeffs[1] = -50f; coeffs[2] = 35f; coeffs[3] = -10f;

            var A = fProxyGallery.fProxyCompanion(in coeffs);
