...
// (ML/PCA.Model.fProxy.cs), the sparse block-structure printers Print.Spy / Print.Log(in fProxyBSM)
...
//   * Print.Spy / Print.Log(in fProxyBSM) are Burst-void log-only -> DoesNotThrow smoke coverage
...
public class fProxyDebugPrintTests
{
    ...
    public void PcaModelUnconverged_ToStringIsExact()
    {
        ...
        var model = arena.fProxyPCAModel(8, 3);   // p = 8 features, k = 3 components
    ...
    public void PcaModelConvergedFlagFlipsInSummary()
    {
        ...
        var model = arena.fProxyPCAModel(5, 2);
    ...
    //   [1 2]
    //   [0 4]
    static fProxyBSM BuildNonSymmetric(ref Arena arena)
    {
        var b = arena.fProxyBSMBuilder(2, 2, 1, 1);
    ...
    static fProxyBSM BuildSymmetric(ref Arena arena)
    {
        var b = arena.fProxyBSMBuilder(2, 2, 1, 1);
        b.AddValue(0, 0, (fProxy)5);
        b.AddValue(0, 1, (fProxy)3);
    ...
    public void SparseSpyAndLogEmptyDoNotThrow()
    {
        ...
        var builder = arena.fProxyBSMBuilder(3, 3, 2, 2);   // 6x6 dense, zero triplets
