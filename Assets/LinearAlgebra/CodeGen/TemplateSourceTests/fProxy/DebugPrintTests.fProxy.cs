...
public class fProxyDebugPrintTests
{
    ...
    //   [1 2]
    //   [0 4]
    static fProxyBSR BuildNonSymmetric(ref Arena arena)
    {
        var b = arena.fProxyBSRBuilder(2, 2, 1, 1);
    ...
    static fProxyBSR BuildSymmetric(ref Arena arena)
    {
        var b = arena.fProxyBSRBuilder(2, 2, 1, 1);
    ...
    public void SparseSpyAndLogEmptyDoNotThrow()
    {
        ...
        var builder = arena.fProxyBSRBuilder(3, 3, 2, 2);   // 6x6 dense, zero triplets
