...
public class fProxySVDLowRankTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void CheckAtK(in fProxyMxN A, in fProxyN fullS, int k, fProxy normA2)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            var Ak = new fProxyMxN(m, n, Allocator.Temp);
        ...
        fProxyN Spectrum(in fProxyMxN A, out fProxy normA2)
        {
            int n = A.N_Cols;
        ...
        void RandomTall12x5()
        {
            var A = GenerateOP.fProxyRandomMat(12, 5, (fProxy)(-2f), (fProxy)2f, 555111, allocator: Allocator.Temp);
            var fullS = Spectrum(in A, out fProxy normA2);
            CheckAtK(in A, in fullS, 1, normA2);
            CheckAtK(in A, in fullS, 2, normA2);
            CheckAtK(in A, in fullS, 3, normA2);
            CheckAtK(in A, in fullS, 5, normA2);
        }

        void RandomSquare8()
        {
            var A = GenerateOP.fProxyRandomMat(8, 8, (fProxy)(-3f), (fProxy)3f, 909090, allocator: Allocator.Temp);
            var fullS = Spectrum(in A, out fProxy normA2);
            CheckAtK(in A, in fullS, 1, normA2);
            CheckAtK(in A, in fullS, 4, normA2);
            CheckAtK(in A, in fullS, 8, normA2);
        }

        void LowRank10x6r3()
        {
            int m = 10, n = 6, r = 3;
            var B = GenerateOP.fProxyRandomMat(m, r, (fProxy)(-2f), (fProxy)2f, 121212, allocator: Allocator.Temp);
            var C = GenerateOP.fProxyRandomMat(r, n, (fProxy)(-2f), (fProxy)2f, 343434, allocator: Allocator.Temp);
        ...
        {
            int m = 40, n = 12;
            var A = GenerateOP.fProxyRandomMat(m, n, (fProxy)(-2f), (fProxy)2f, 777111, allocator: Allocator.Temp);

            // Full thin SVD as oracle
            var Ufull = new fProxyMxN(m, n, Allocator.Temp);
            var Sfull = new fProxyN(n, Allocator.Temp);
            var Vfull = new fProxyMxN(n, n, Allocator.Temp);
            ...
            CheckGklVsThin(in A, in Ufull, in Sfull, in Vfull, 3, 9, 0x1234ABCDu, m, n);
            // k=5 with oversample=7 → p=12 (full Krylov)
            CheckGklVsThin(in A, in Ufull, in Sfull, in Vfull, 5, 7, 0xDEADBEEFu, m, n);
        }

        void CheckGklVsThin(in fProxyMxN A, in fProxyMxN Ufull, in fProxyN Sfull, in fProxyMxN Vfull,
                             int k, int oversample, uint seed, int m, int n)
        {
            var Uk = new fProxyMxN(m, k, Allocator.Temp);
            var Sk = new fProxyN(k, Allocator.Temp);
            var Vk = new fProxyMxN(n, k, Allocator.Temp);
            ...
            fProxy svTol = (fProxy)8 * Consts.fProxySqrtEps * (Sfull[0] + (fProxy)1);
            ...
            for (int t = 0; t < k; t++)
            {
                ...
                fProxy dotU = (fProxy)0;
                for (int i = 0; i < m; i++) dotU += Uk[i, t] * Ufull[i, t];
                fProxy absDotU = math.abs(dotU);
                AssertClose(absDotU, (fProxy)1, (fProxy)1E-2f);

                // Right singular vector agreement (sign-insensitive)
                fProxy dotV = (fProxy)0;
                for (int i = 0; i < n; i++) dotV += Vk[i, t] * Vfull[i, t];
                fProxy absDotV = math.abs(dotV);
                AssertClose(absDotV, (fProxy)1, (fProxy)1E-2f);
            }
        }
        ...
        {
            int m = 24, n = 8, r = 4;
            var B = GenerateOP.fProxyRandomMat(m, r, (fProxy)(-2f), (fProxy)2f, 8881, allocator: Allocator.Temp);
            var C = GenerateOP.fProxyRandomMat(r, n, (fProxy)(-2f), (fProxy)2f, 9992, allocator: Allocator.Temp);
        ...
        {
            int m = 30, n = 10;
            var A = GenerateOP.fProxyRandomMat(m, n, (fProxy)(-3f), (fProxy)3f, 313131, allocator: Allocator.Temp);
            ...
            fProxy tol = (fProxy)1E-2f * (tail + (fProxy)1);
        ...
        {
            int m = 20, n = 7;
            var A = GenerateOP.fProxyRandomMat(m, n, (fProxy)(-4f), (fProxy)4f, 202020, allocator: Allocator.Temp);
            ...
            for (int t = 0; t < k; t++)
            {
                ...
                if (t > 0)
                {
                    bool desc = Sk[t] <= Sk[t-1] + (fProxy)1E-6f;
        ...
        void BuildOrthoBases(ref Unity.Mathematics.Random rng, int m, int n,
                             out fProxyMxN Ularge, out fProxyMxN Vmat)
        {
        ...
        void CheckTruncVsThin(in fProxyMxN A, int k, int oversample, uint seed, int m, int n,
                              fProxy svTol, fProxy vecTol, fProxy orthoTol)
        {
            var Ufull = new fProxyMxN(m, n, Allocator.Temp);
            var Sfull = new fProxyN(n, Allocator.Temp);
            var Vfull = new fProxyMxN(n, n, Allocator.Temp);
            ...
            {
                AssertClose(Sk[t], Sfull[t], svTol);
                fProxy dU = (fProxy)0; for (int i = 0; i < m; i++) dU += Uk[i,t]*Ufull[i,t];
                AssertClose(math.abs(dU), (fProxy)1, vecTol);
                fProxy dV = (fProxy)0; for (int i = 0; i < n; i++) dV += Vk[i,t]*Vfull[i,t];
                AssertClose(math.abs(dV), (fProxy)1, vecTol);
            }
        ...
        void GklTruncated_80x40_k3()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0x11223344u, m, n,
                             (fProxy)1f, (fProxy)0.01f, (fProxy)1E-3f);
        }
        ...
        void GklClusteredSpectrum_50x30()
        {
            ...
            var Uf = new fProxyMxN(m, n, Allocator.Temp);
            var Sf = new fProxyN(n, Allocator.Temp);
            var Vf = new fProxyMxN(n, n, Allocator.Temp);
            Assert.IsTrue(SVD.thin(in A, ref Uf, ref Sf, ref Vf));
            for (int t = 0; t < k; t++)
                AssertClose(Sk[t], Sf[t], (fProxy)0.05f);
        }
        ...
        void GklIllConditioned_60x20()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0xFEEDC0DEu, m, n,
                             (fProxy)5f, (fProxy)0.01f, (fProxy)1E-3f);
        }
        ...
        void GklConvergedFalse_RankDeficient()
        {
            ...
            var B = GenerateOP.fProxyRandomMat(m, r, (fProxy)(-2f), (fProxy)2f, 0xBADC0DE0u, allocator: Allocator.Temp);
            var C = GenerateOP.fProxyRandomMat(r, n, (fProxy)(-2f), (fProxy)2f, 0xBADC0DE1u, allocator: Allocator.Temp);
        ...
        void GklConvergedFalse_TooFewSteps()
        {
            ...
            var A = GenerateOP.fProxyRandomMat(m, n, (fProxy)(-2f), (fProxy)2f, 0x55AA77BBu, allocator: Allocator.Temp);
        ...
        void GklConvergedFalse_MaxIter1()
        {
            ...
            var A = GenerateOP.fProxyRandomMat(m, n, (fProxy)(-3f), (fProxy)3f, 0xDEADBEEFu, allocator: Allocator.Temp);
        ...
        // whose singular values are prescribed. svTol scales with the type via Consts.fProxySqrtEps
        ...
        void GklGeometricTrunc_80x30()
        {
            ...
            double s = 1.0;
            for (int i = 0; i < n; i++) { sigma[i] = (fProxy)s; s *= 0.5; }   // 1, 0.5, 0.25, ...
        ...
        void GklFlatCliffTrunc_70x25()
        {
            ...
            CheckTruncVsThin(in A, 3, 6, 0x2222BBBBu, m, n,
                             (fProxy)8 * Consts.fProxySqrtEps * (sigma[0] + (fProxy)1),
                             (fProxy)0.01f, (fProxy)1E-3f);
        }
        ...
        void GklOneSmallTrunc_50x20()
        {
            ...
            var sigma = new fProxyN(n, Allocator.Temp);
            for (int i = 0; i < n; i++) sigma[i] = (i == n - 1) ? (fProxy)1E-4f : (fProxy)1;
            ...
            fProxy svTol = (fProxy)8 * Consts.fProxySqrtEps * (sigma[0] + (fProxy)1);
            for (int t = 0; t < k; t++) AssertClose(Sk[t], (fProxy)1, svTol);
            AssertOrthoCols(in Uk, m, k, (fProxy)1E-3f);
            AssertOrthoCols(in Vk, n, k, (fProxy)1E-3f);
        }
        ...
        void GklClusterProjector_50x24()
        {
            ...
            for (int t = 0; t < k; t++) AssertClose(Sk[t], (fProxy)10, (fProxy)0.05f);
            ...
            AssertProjectorMatch(in Uk, in Uf, m, k, (fProxy)1E-2f);
            AssertProjectorMatch(in Vk, in Vf, n, k, (fProxy)1E-2f);
        }

        // ‖B Bᵀ (first k cols) − Ref Refᵀ (first k cols)‖_max over the rank-k projectors.
        void AssertProjectorMatch(in fProxyMxN B, in fProxyMxN Ref, int rows, int k, fProxy tol)
        {
            for (int i = 0; i < rows; i++)
                for (int j = 0; j < rows; j++)
                {
                    fProxy pb = (fProxy)0, pr = (fProxy)0;
        ...
        void PartialVsFull_Geometric_80x30()
        {
            ...
            var SkP = new fProxyN(k, Allocator.Temp);
            var SkF = new fProxyN(k, Allocator.Temp);
            RunTruncWithReorth(in A, in sigma, k, 20, 0xA11CE001u, true,  ref SkP, m, n, svTol);
            RunTruncWithReorth(in A, in sigma, k, 20, 0xA11CE001u, false, ref SkF, m, n, svTol);
        ...
        void PartialVsFull_FlatCliff_70x25()
        {
            ...
            var SkP = new fProxyN(k, Allocator.Temp);
            var SkF = new fProxyN(k, Allocator.Temp);
            RunTruncWithReorth(in A, in sigma, k, 6, 0xB22DEEF1u, true,  ref SkP, m, n, svTol);
            RunTruncWithReorth(in A, in sigma, k, 6, 0xB22DEEF1u, false, ref SkF, m, n, svTol);
        ...
        void NoGhost_Geometric_80x30()
        {
            ...
            fProxy svTol = (fProxy)8 * Consts.fProxySqrtEps * (sigma[0] + (fProxy)1);
            CheckPartialReorth(in A, in sigma, 3, 20, 0x0BADF00Du, m, n, svTol);
            CheckPartialReorth(in A, in sigma, 4, 20, 0x0BADF00Eu, m, n, svTol);
            CheckPartialReorth(in A, in sigma, 5, 20, 0x0BADF00Fu, m, n, svTol);
        }
        ...
        void PartialClustered_50x30()
        {
            ...
            CheckPartialReorth(in A, in sigma, k, 12, 0xC1057E12u, m, n, (fProxy)0.05f);
        }
        ...
        void PartialIllConditioned_60x20()
        {
            ...
            CheckPartialReorth(in A, in sigma, k, 4, 0x111C0AD3u, m, n, (fProxy)5f);
        }
        ...
        void PartialLargeP_120x60()
        {
            ...
            fProxy svTol = (fProxy)8 * Consts.fProxySqrtEps * (sigma[0] + (fProxy)1);
            CheckPartialReorth(in A, in sigma, k, 20, 0x1A36E099u, m, n, svTol);
        }
        ...
        void PartialCloseClusterSeeds_64x24()
        {
            ...
            for (uint g = 0; g < 8; g++)
            {
                ...
                BuildRandSvd(ref rng, m, n, in sigma, ref A);
                CheckPartialReorth(in A, in sigma, k, 12, 0x57A27000u + g, m, n, svTol);
            }
        }
    }
    ...
    {
        var A = new fProxyMxN(6, 4, Allocator.Temp);
        var Ak = new fProxyMxN(4, 6, Allocator.Temp);   // must be m x n = 6 x 4
