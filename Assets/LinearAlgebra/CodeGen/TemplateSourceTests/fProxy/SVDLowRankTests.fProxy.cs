...
public class fProxySVDLowRankTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RandomTall12x5()
        {
            ...
            var A = arena.fProxyRandomMat(12, 5, (fProxy)(-2f), (fProxy)2f, 555111);
        ...
        {
            var arena = new Arena(Allocator.Persistent);
            var A = arena.fProxyRandomMat(8, 8, (fProxy)(-3f), (fProxy)3f, 909090);
            var fullS = Spectrum(in A, ref arena, out fProxy normA2);
            CheckAtK(in A, in fullS, 1, normA2, ref arena);
        ...
        void GklVsThin_40x12()
        {
            var arena = new Arena(Allocator.Persistent);
            int m = 40, n = 12;
            var A = arena.fProxyRandomMat(m, n, (fProxy)(-2f), (fProxy)2f, 777111);

            // Full thin SVD as oracle
            var Ufull = arena.fProxyMat(m, n);
            var Sfull = arena.fProxyVec(n);
            var Vfull = arena.fProxyMat(n, n);
        ...
        void GklReconBound_30x10()
        {
            var arena = new Arena(Allocator.Persistent);
            int m = 30, n = 10;
            var A = arena.fProxyRandomMat(m, n, (fProxy)(-3f), (fProxy)3f, 313131);
        ...
        void GklOrthonormal_20x7()
        {
            var arena = new Arena(Allocator.Persistent);
            int m = 20, n = 7;
            var A = arena.fProxyRandomMat(m, n, (fProxy)(-4f), (fProxy)4f, 202020);
        ...
        void CheckTruncVsThin(in fProxyMxN A, int k, int oversample, uint seed, int m, int n,
                              fProxy svTol, fProxy vecTol, fProxy orthoTol, ref Arena arena)
        {
            var Ufull = arena.fProxyMat(m, n);
            var Sfull = arena.fProxyVec(n);
            var Vfull = arena.fProxyMat(n, n);
        ...
        void GklTruncated_80x40_k3()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0x11223344u, m, n,
                             (fProxy)1f, (fProxy)0.01f, (fProxy)1E-3f, ref arena);
            arena.Dispose();
        }
        ...
        void GklClusteredSpectrum_50x30()
        {
            ...
            var Uf = arena.fProxyMat(m, n);
            var Sf = arena.fProxyVec(n);
            var Vf = arena.fProxyMat(n, n);
        ...
        void GklIllConditioned_60x20()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0xFEEDC0DEu, m, n,
                             (fProxy)5f, (fProxy)0.01f, (fProxy)1E-3f, ref arena);
            arena.Dispose();
        }
        ...
        void GklConvergedFalse_TooFewSteps()
        {
            ...
            var A = arena.fProxyRandomMat(m, n, (fProxy)(-2f), (fProxy)2f, 0x55AA77BBu);
        ...
        void GklConvergedFalse_MaxIter1()
        {
            ...
            var A = arena.fProxyRandomMat(m, n, (fProxy)(-3f), (fProxy)3f, 0xDEADBEEFu);
        ...
        void GklFlatCliffTrunc_70x25()
        {
            ...
            CheckTruncVsThin(in A, 3, 6, 0x2222BBBBu, m, n,
                             ...
                             (fProxy)0.01f, (fProxy)1E-3f, ref arena);
            arena.Dispose();
        }
