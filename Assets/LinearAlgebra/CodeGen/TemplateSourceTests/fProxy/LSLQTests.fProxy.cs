...
public class fProxyLSLQTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        static fProxyN ReferenceSolveLstsq(ref Arena arena, in fProxyMxN A, in fProxyN b)
        {
            ...
            var bLocal = arena.fProxyVec(A.M_Rows);
        ...
        void RectangularLeastSquares()
        {
            ...
            var b = arena.fProxyRandomVec(m, -3f, 3f, 71002);   // generally inconsistent
        ...
        void SquareFullRank()
        {
            ...
            var xTrue = arena.fProxyRandomVec(nn, -5f, 5f, 72002);
        ...
        void RankDeficientGraceful()
        {
            ...
            var b = arena.fProxyRandomVec(m, -3f, 3f, 75002);
        ...
        void BoundIsUpperBound()
        {
            ...
            var b = arena.fProxyRandomVec(m, -3f, 3f, 76002);   // inconsistent least-squares

            // σ_min(A) via SVD of the tall m×n A (n singular values = A's).
            var svals = arena.fProxyVec(n);
