...
public class fProxySparseCompNormsTests
{
    ...
    public struct SparseCompNormsTestJob : IJob
    {
        ...
        static fProxyBSR BuildTestBSR(fProxy scale)
        {
            const int BR = 2, BC = 2;
        ...
        void AddScaledSamePattern()
        {
            ...
            var y = BuildTestBSR((fProxy)1);
            var x = BuildTestBSR((fProxy)10);
    ...
    {
        const int BR = 2, BC = 2;
        var by = new fProxyBSRBuilder(2, 2, BR, BC, Allocator.Temp);
        var bx = new fProxyBSRBuilder(2, 2, BR, BC, Allocator.Temp);
