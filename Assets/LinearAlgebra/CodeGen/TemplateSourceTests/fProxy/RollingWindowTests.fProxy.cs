...
public class fProxyRollingWindowTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            if (expected != got && Fail[0] == (fProxy)0)
            {
                Fail[0] = (fProxy)1; Fail[1] = (fProxy)got; Fail[2] = (fProxy)expected; Fail[3] = (fProxy)(got - expected);
            }
        ...
        void AssertTrue(bool ok)
        {
            ...
            {
                Fail[0] = (fProxy)1; Fail[1] = (fProxy)(-1); Fail[2] = (fProxy)(-1); Fail[3] = (fProxy)(-1);
            }
            Assert.IsTrue(ok);
        }
    }
