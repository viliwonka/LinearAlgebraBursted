...
// One [BurstCompile] IJob with a TestType switch, mirroring BlockLSMRTests.fProxy.cs. Every assertion
...
// dtypes.
public class fProxyBlockCGLSTests
{
    ...
    public struct BlockCGLSTestJob : IJob
    {
        ...
        void NormalEquationsOptimalAndMatchesScalarLsmr()
        {
            ...
            var info = Krylov.bcgls(in A, in B, ref X, 20 * n, Consts.fProxySqrtEps);
        ...
        void NeverNaNOnTinyMaxIter()
        {
            ...
            var X = arena.fProxyMat(s, n);
            Krylov.bcgls(in A, in B, ref X, 1, Consts.fProxySqrtEps);
