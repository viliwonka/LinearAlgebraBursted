...
public class fProxyIDRTests
{
    ...
    public struct IdrTestJob : IJob
    {
        ...
        void SolvesDenseNonsym()
        {
            ...
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D02u);
        ...
        void KnownSolution()
        {
            ...
            var xTrue = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D12u);
        ...
        void MatchesGmres()
        {
            int n = 100;
            var A = ConvDiff1D(n);
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D22u);
        ...
        void IdentityFoldDense()
        {
            ...
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D32u);
        ...
        void IdentityFoldBSR()
        {
            int n = 120;
            var A = ConvDiff1D(n);
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D42u);
        ...
        void PreconditionedILU0()
        {
            int n = 150;
            var A = ConvDiff1D(n);
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D52u);
        ...
        void PreconditionedBlockJacobi()
        {
            int n = 150;
            var A = ConvDiff1D(n);
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D62u);
        ...
        void DeterminismExplicitSeed()
        {
            int n = 60;
            var A = ConvDiff1D(n);
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D72u);
        ...
        void DeterminismDefaultSeed()
        {
            int n = 60;
            var A = ConvDiff1D(n);
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D82u);
        ...
        void SEqualsOne()
        {
            ...
            var b = GenerateOP.fProxyRandomVec(n, -1f, 1f, 0x1D92u);
