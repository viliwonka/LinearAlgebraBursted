...
public class fProxyJacobiPrecondTests
{
    ...
    public struct JacobiPrecondTestJob : IJob
    {
        ...
        static fProxyBSR DenseToBSR(ref Arena arena, in fProxyMxN A, int BR, int BC, int nnzHint)
        {
            var builder = arena.fProxyBSRBuilder(A.M_Rows / BR, A.N_Cols / BC, BR, BC, math.max(nnzHint, 1));
    ...
    public void ColumnNormsSquaredBSRSymmetricThrows()
    {
        ...
        var s = arena.fProxyBSRBuilder(3, 3, 1, 1, 3);
