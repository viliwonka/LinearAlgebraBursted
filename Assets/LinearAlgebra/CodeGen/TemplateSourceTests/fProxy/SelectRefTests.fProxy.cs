...
public class fProxySelectRefTests
{
    ...
    public struct SelectRefTestJob : IJob
    {
        ...
        void VecCond()
        {
            ...
            var a = arena.fProxyRandomVec(N, -1f, 1f, 11111);
        ...
        void MatCond()
        {
            ...
            var a = arena.fProxyRandomMat(M, N, -1f, 1f, 44444);
        ...
        void VecScalarTrue()
        {
            ...
            var a = arena.fProxyRandomVec(N, -1f, 1f, 77777);
        ...
        void VecScalarFalse()
        {
            ...
            var a = arena.fProxyRandomVec(N, -1f, 1f, 99999);
        ...
        void MatScalarFalse()
        {
            ...
            var a = arena.fProxyRandomMat(M, N, -1f, 1f, 40404);
        ...
        void VecAliasDest()
        {
            ...
            var a = arena.fProxyRandomVec(N, -1f, 1f, 60606);
            var b = arena.fProxyRandomVec(N, -1f, 1f, 70707);
