...
public class fProxyCRAIGMRTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RectangularMinNorm()
        {
            ...
            var xTrue = GenerateOP.fProxyRandomVec(n, -5f, 5f, 61002, Allocator.Temp);
        ...
        void SquareFullRank()
        {
            ...
            var xTrue = GenerateOP.fProxyRandomVec(nn, -5f, 5f, 62002, Allocator.Temp);
        ...
        void ExplicitScratchInJob()
        {
            ...
            var xTrue = GenerateOP.fProxyRandomVec(n, -4f, 4f, 63002, Allocator.Temp);
            var b = new fProxyN(m, Allocator.Temp);
            Blas.dot(in A, in xTrue, ref b);
        ...
        {
            int m = 2, n = 4;
            var A = GenerateOP.fProxyRandomMat(m, n, -1f, 1f, 65001, Allocator.Temp);
            for (int j = 0; j < n; j++)
        ...
        void MonotonicResidual()
        {
            ...
            var xTrue = GenerateOP.fProxyRandomVec(n, -5f, 5f, 66002, Allocator.Temp);
            var b = new fProxyN(m, Allocator.Temp);
            Blas.dot(in A, in xTrue, ref b);
        ...
        void IterateZeroArnormMatchesAtb()
        {
            ...
            var xTrue = GenerateOP.fProxyRandomVec(n, -5f, 5f, 67002, Allocator.Temp);
            var b = new fProxyN(m, Allocator.Temp);
            Blas.dot(in A, in xTrue, ref b);
