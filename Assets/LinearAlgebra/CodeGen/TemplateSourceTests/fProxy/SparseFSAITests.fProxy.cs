...
// Factored sparse approximate inverse preconditioner (fProxyFSAI), valid for cg/pminres.
...
//   (3) CONVERGENCE: FSAI-cg reaches tol on fProxyLaplacian2D in STRICTLY fewer iterations than
...
public class fProxySparseFSAITests
{
    ...
    // EA=1,penalty=10) + fProxyFSAI + fProxyBlockJacobi + cg outside Unity, mirroring the
