...
// counterpart yet (bcraig/bcraigmr are not implemented -- see KrylovLstsqBatteryTests.fProxy.cs's own
// header note). Retires BlockLSMRTests.fProxy.cs / BlockCGLSTests.fProxy.cs -- every scenario those
