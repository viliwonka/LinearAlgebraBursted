...
// (Arena.fProxyCHOPCache(n)). W (n x n) is the destroyable symmetric working copy the
...
public class fProxyCholeskyPivotWorkspaceTests
{
    ...
    public struct WorkspaceJob : IJob
    {
        ...
        void ReuseFactorSolve()
        {
            ...
            var ws = arena.fProxyCHOPCache(n);   // allocated ONCE
    ...
    public void Decomp_BadWorkspaceW_Throws()
    {
        ...
        try
        {
            ...
            var L = arena.fProxyMat(n, n);
            var ws = arena.fProxyCHOPCache(n + 1);   // W wrong (needW)
    ...
    public void Solve_BadWorkspaceBt_Throws()
    {
        ...
        try
        {
            ...
            var badWs = new fProxyCHOPCache { W = arena.fProxyMat(n, n), bt = arena.fProxyVec(n + 1) };
            Assert.Throws<ArgumentException>(
    ...
    public void Decomp_BtLessWorkspace_DoesNotThrow_AndSolve_WLessWorkspace_DoesNotThrow()
    {
        ...
        try
        {
            ...
            var wsNoBt = new fProxyCHOPCache { W = arena.fProxyMat(n, n), bt = default };
            Assert.DoesNotThrow(
            ...
            var wsNoW = new fProxyCHOPCache { W = default, bt = arena.fProxyVec(n) };
            Assert.DoesNotThrow(
    ...
    public void CholeskyPivotWorkspace_Factory_SizesCorrectly()
    {
        ...
        try
        {
            var ws = arena.fProxyCHOPCache(7);
