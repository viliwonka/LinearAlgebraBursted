...
public class fProxyQPActiveSetTests
{
    ...
    public struct HS21Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new fProxyN(2, Allocator.Temp); x[0] = 5f; x[1] = 10f;
    ...
    public struct HS35Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new fProxyN(3, Allocator.Temp); x[0] = 0.5f; x[1] = 0.5f; x[2] = 0.5f;
    ...
    public struct HS52Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new fProxyN(5, Allocator.Temp);   // origin: all three equalities are homogeneous (RHS 0)
    ...
    public struct HS76Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new fProxyN(4, Allocator.Temp); for (int i = 0; i < 4; i++) x[i] = 0.5f;
    ...
    public struct BruteForceJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            var xEq = new fProxyN(n, Allocator.Temp, true);
            var Qcopy = new fProxyMxN(n, n, Allocator.Temp, true);
            var rhs = new fProxyN(n, Allocator.Temp, true);
    ...
    public struct LpLimitJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            var Q = new fProxyMxN(n, n, Allocator.Temp);   // zero
            var xl = new fProxyN(n, Allocator.Temp);
            var xu = new fProxyN(n, Allocator.Temp); for (int i = 0; i < n; i++) xu[i] = 1e30f;

            var xQp = new fProxyN(n, Allocator.Temp);
            ...
            var xLp = new fProxyN(n, Allocator.Temp);
    ...
    public struct DegenerateJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            for (int i = 0; i < n; i++) c[i] = rng.NextFProxy(-1f, 1f);
            var xl = new fProxyN(n, Allocator.Temp);
            var xu = new fProxyN(n, Allocator.Temp); for (int i = 0; i < n; i++) xu[i] = 5f;
            var x0 = new fProxyN(n, Allocator.Temp); x0[0] = 2f; x0[1] = 2f; x0[2] = 2f;   // sum = 6, tight below

            // single copy
            var A1 = new fProxyMxN(1, n, Allocator.Temp); A1[0, 0] = 1f; A1[0, 1] = 1f; A1[0, 2] = 1f;
            var b1 = new fProxyN(1, Allocator.Temp); b1[0] = 6f;
            var senses1 = new NativeArray<ConstraintSense>(1, Allocator.Temp); senses1[0] = ConstraintSense.LessEqual;
            var x1 = new fProxyN(n, Allocator.Temp); x1[0] = x0[0]; x1[1] = x0[1]; x1[2] = x0[2];
            ...
            var A2 = new fProxyMxN(2, n, Allocator.Temp);
            A2[0, 0] = 1f; A2[0, 1] = 1f; A2[0, 2] = 1f;
            A2[1, 0] = 1f; A2[1, 1] = 1f; A2[1, 2] = 1f;
            var b2 = new fProxyN(2, Allocator.Temp); b2[0] = 6f; b2[1] = 6f;
            ...
            var x2 = new fProxyN(n, Allocator.Temp); x2[0] = x0[0]; x2[1] = x0[1]; x2[2] = x0[2];
            ...
            senses1.Dispose(); senses2.Dispose();
        }
    }
    ...
    public struct UnboundedJob : IJob
    {
        ...
        public void Execute()
        {
            var Q = new fProxyMxN(2, 2, Allocator.Temp); Q[0, 0] = 1f; Q[1, 1] = 0f;
            var c = new fProxyN(2, Allocator.Temp); c[1] = -1f;
            var A = new fProxyMxN(0, 2, Allocator.Temp);
            var b = new fProxyN(0, Allocator.Temp);
            var senses = new NativeArray<ConstraintSense>(0, Allocator.Temp);
            var xl = new fProxyN(2, Allocator.Temp); xl[0] = -1e30f; xl[1] = 0f;
            var xu = new fProxyN(2, Allocator.Temp); xu[0] = 1e30f; xu[1] = 1e30f;
            var x = new fProxyN(2, Allocator.Temp);   // (0,0), feasible
