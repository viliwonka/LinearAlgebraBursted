...
// (lqDecomposition(...,ref fProxyLQCache) / lqMinNormSolve(...,ref fProxyLQMinNormSolveCache)) must
...
public class fProxyLQWorkspaceTests
{
    ...
    public struct WorkspaceEquivJob : IJob
    {
        ...
        void WorkspaceReuse()
        {
            ...
            var solveWs = arena.fProxyLQMinNormSolveCache(m, n);      // allocated ONCE, reused below
    ...
    public void LqMinNormSolve_BadScratchL_Throws()
    {
        ...
        try
        {
            ...
            var ws = arena.fProxyLQMinNormSolveCache(4, 8);
    ...
    // Arena.fProxyLQCache(m, n) / fProxyLQMinNormSolveCache(m, n) must size every field for m x n.
    [Test]
    public void LQWorkspace_Factory_SizesCorrectly()
    {
        ...
        try
        {
            ...
            var solveWs = arena.fProxyLQMinNormSolveCache(4, 8);
