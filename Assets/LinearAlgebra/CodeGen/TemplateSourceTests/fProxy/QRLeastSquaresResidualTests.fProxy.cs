    ...
    public struct TestJob : IJob
    {
        ...
        void RandomOverdeterminedNormalEquations()
        {
            ...
            for (uint t = 0; t < 24; t++)
            {
                ...
                fProxy rNorm = fProxyNormsOP.L2(in r);
        ...
        void RandomOverdeterminedOptimality()
        {
            ...
            for (uint t = 0; t < 12; t++)
            {
                ...
                fProxy r0 = SumSq(b - fProxyOP.dot(A, x));
                ...
                for (int k = 0; k < n; k++)
                {
                    ...
                    x[k] = saved + delta;
                    fProxy rp = SumSq(b - fProxyOP.dot(A, x));
                    x[k] = saved - delta;
                    fProxy rm = SumSq(b - fProxyOP.dot(A, x));
                    x[k] = saved;
