...
public class fProxyOptimizeTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        public void BisectionParabola()
        {
            ...
            bool ok = Optimize.bisection(ref fn, (fProxy)3, (fProxy)10, out fProxy root, (fProxy)1E-7f);
        ...
        public void BisectionCos()
        {
            ...
            bool ok = Optimize.bisection(ref fn, (fProxy)0, (fProxy)3, out fProxy root, (fProxy)1E-7f);
        ...
        public void GoldenParabolaMin()
        {
            ...
            Assert.IsTrue(ok);
            AssertFinite(xMin);
            AssertClose(xMin, (fProxy)2, 1E-4f);
        }
        ...
        public void GoldenCosMin()
        {
            ...
            Assert.IsTrue(ok);
            AssertFinite(xMin);
            AssertClose(xMin, (fProxy)Unity.Mathematics.math.PI, 1E-4f);
        }
