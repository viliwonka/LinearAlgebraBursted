...
// Workspace-overload tests for Eigen.eigenvaluesSymmetric and its workspace fProxyEigenSym_WS
// (Arena.fProxyEigenSym_WS(n)). eigenvaluesSymmetric DESTROYS its input matrix, so every call
...
public class fProxyEigenSymWorkspaceTests
{
    ...
    public struct WorkspaceJob : IJob
    {
        ...
        void Equiv(int n, uint seed)
        {
            ...
            var ws = arena.fProxyEigenSym_WS(n);
        ...
        void WorkspaceReuse()
        {
            ...
            var ws = arena.fProxyEigenSym_WS(n);   // allocated ONCE
    ...
    public void EigenSym_BadWorkspace_Throws()
    {
        ...
        try
        {
            ...
            var ws = arena.fProxyEigenSym_WS(n + 1);   // wrong n
    ...
    // Arena.fProxyEigenSym_WS(n): three length-n vectors.
    [Test]
    public void EigenSymWorkspace_Factory_SizesCorrectly()
    {
        ...
        try
        {
            var ws = arena.fProxyEigenSym_WS(7);
