...
public class fProxySVDSolverTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        public void PinvSquareFullRank()
        {
            ...
            var A = arena.fProxyRandomMatrix(dim, dim, -5f, 5f, 314221);
            ...
            var b = fProxyOP.dot(A_copy, xOrig);
        ...
        public void PinvOverdeterminedFullRank()
        {
            ...
            var A = arena.fProxyRandomMatrix(m, n, -5f, 5f, 778231);
            ...
            var xOrig = arena.fProxyRandomVector(n, -3f, 3f, 4242);
            var b = fProxyOP.dot(A_copy, xOrig);
        ...
        public void PinvOverdeterminedResidual()
        {
            ...
            var b = arena.fProxyRandomVector(m, -5f, 5f, 9090);
            var b_copy = b.Copy();
            ...
            Assert.IsTrue(maxAbs < (fProxy)1E-2f, $"||A^T(Ax-b)||inf = {maxAbs}");
        ...
        public void PinvRankDeficientMinNorm()
        {
            ...
            AssertClose(x[0], (fProxy)0.25f, 1E-4f);
            AssertClose(x[1], (fProxy)0.25f, 1E-4f);
        ...
        public void PseudoInverseSquareInvertible()
        {
            ...
            var prod = fProxyOP.dot(A_copy, Aplus);
        ...
        public void PseudoInverseMoorePenrose()
        {
            ...
            var AplusA = fProxyOP.dot(Aplus, A_copy);          // n x n
            var AplusAAplus = fProxyOP.dot(AplusA, Aplus);     // n x m
