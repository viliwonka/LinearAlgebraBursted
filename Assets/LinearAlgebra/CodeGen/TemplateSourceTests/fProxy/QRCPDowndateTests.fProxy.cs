    ...
    public struct TestJob : IJob
    {
        ...
        void CacheEquivalence(int m, int n, uint seed, bool rankDeficient)
        {
            ...
            try
            {
                ...
                var b = arena.fProxyRandomVec(m, -3f, 3f, seed + 1u);

                var As1 = A0.Copy(); var Rs1 = arena.fProxyMat(n); var Ps1 = new Pivot(n, Allocator.Temp); var us1 = arena.fProxyVec(m); var x1 = arena.fProxyVec(n);
                RankInfo info1 = QRCP.solveInPlace(ref As1, ref b, ref x1, ref Rs1, ref Ps1, ref us1);

                var As2 = A0.Copy(); var Rs2 = arena.fProxyMat(n); var Ps2 = new Pivot(n, Allocator.Temp); var us2 = arena.fProxyVec(m); var x2 = arena.fProxyVec(n);
