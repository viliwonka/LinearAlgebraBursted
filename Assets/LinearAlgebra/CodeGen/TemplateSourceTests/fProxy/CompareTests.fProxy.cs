...
public class fProxyCompareTests
{
    ...
    public struct TestsJob : IJob 
    {
        ...
        public void VecRandom(ref Arena arena)
        {
            ...
            fProxyN v = arena.fProxyRandomVec(dim, -1f, 1f, 1451);
        ...
        public void MatRandom(ref Arena arena)
        {
            ...
            fProxyMxN m = arena.fProxyRandomMat(dim, dim, -1f, 1f, 1451);
            // set first element to zero
            m[0,0] = 0f;
        ...
        public void MatDiagonal(ref Arena arena)
        {
            ...
            fProxyMxN m0 = arena.fProxyDiagonalMat(dim, 1f);
        ...
        public void VecVecEquals(ref Arena arena)
        {
            ...
            fProxyN v0 = arena.fProxyLinVec(dim, 0f, 1f);
            fProxyN v1 = arena.fProxyLinVec(dim, 0f, 1f);
        ...
        public void VecVecNotEquals(ref Arena arena)
        {
            ...
            fProxyN v0 = arena.fProxyLinVec(dim, 0f, 1f);
            fProxyN v1 = arena.fProxyLinVec(dim, 2f, 3f);
        ...
        public void VecVecLessOrEqual(ref Arena arena)
        {
            ...
            v0 = arena.fProxyLinVec(dim, 0f, 1f);
            v1 = arena.fProxyLinVec(dim, 1f, 0f);
        ...
        public void VecVecGreater(ref Arena arena)
        {
            ...
            v0 = arena.fProxyLinVec(dim, 1f, 0f);
            v1 = arena.fProxyLinVec(dim, 0f, 1f);
        ...
        public void VecVecRandom(ref Arena arena)
        {
            ...
            fProxyN v0 = arena.fProxyRandomVec(dim, -1f, 1f, 1451);
            fProxyN v1 = arena.fProxyRandomVec(dim, -1f, 1f, 6421);
        ...
        public void MatMatEquals(ref Arena arena)
        {
            ...
            fProxyMxN m0 = arena.fProxyRandomMat(dim, dim, 0f, 1f);
            fProxyMxN m1 = arena.fProxyRandomMat(dim, dim, 0f, 1f);
        ...
        public void MatMatNotEquals(ref Arena arena)
        {
            ...
            fProxyMxN m0 = arena.fProxyRandomMat(dim, dim, 0f, 1f, 2131);
            fProxyMxN m1 = arena.fProxyRandomMat(dim, dim, 0f, 1f, 2131);

            var boolMat = m0 != m1;
            Assert.IsTrue(BoolAnalysis_OP.IsAllEqualTo(boolMat, false));

            m1 = arena.fProxyRandomMat(dim, dim, 2f, 3f, 2131);
        ...
        public void MatMatLess(ref Arena arena)
        {
            ...
            fProxyMxN m0 = arena.fProxyRandomMat(dim, dim, 0f, 1f, 2131);
            fProxyMxN m1 = arena.fProxyRandomMat(dim, dim, 2f, 3f, 2131);
        ...
        public void MatMatLessOrEqual(ref Arena arena)
        {
            ...
            m0 = arena.fProxyRandomMat(dim, dim, 1f, 0f, 2131);
            m1 = arena.fProxyRandomMat(dim, dim, 0f, 1f, 2131);
        ...
        public void MatMatRandom(ref Arena arena)
        {
            ...
            fProxyMxN m0 = arena.fProxyRandomMat(dim, dim, -1f, 1f, 1451);
            fProxyMxN m1 = arena.fProxyRandomMat(dim, dim, -1f, 1f, 6421);
