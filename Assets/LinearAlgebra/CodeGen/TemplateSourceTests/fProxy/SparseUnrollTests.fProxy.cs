...
// property is already covered separately by fProxySparseSymmetricTests).
//
...
public class fProxySparseUnrollTests
{
    ...
    public struct SparseUnrollTestJob : IJob
    {
        ...
        static fProxyBSM BuildRandomSymmetric(ref Arena arena, int b, uint seedBase)
        {
            var builder = arena.fProxyBSMBuilder(4, 4, b, b);
            builder.AddBlock(0, 0, arena.fProxyRandomMat(b, b, (fProxy)(-1f), (fProxy)1f, seedBase + 1u));
            builder.AddBlock(1, 1, arena.fProxyRandomMat(b, b, (fProxy)(-1f), (fProxy)1f, seedBase + 2u));
            builder.AddBlock(2, 2, arena.fProxyRandomMat(b, b, (fProxy)(-1f), (fProxy)1f, seedBase + 3u));
            builder.AddBlock(3, 3, arena.fProxyRandomMat(b, b, (fProxy)(-1f), (fProxy)1f, seedBase + 4u));
