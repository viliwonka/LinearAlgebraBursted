...
public class fProxyMinresQLPShiftTests
{
    ...
    static fProxyMxN ExplicitShift(in fProxyMxN A, fProxy shift)
    {
        var S = new fProxyMxN(in A, Allocator.Temp);
    ...
    public void ShiftSolvesShiftedSystemDense()
    {
        ...
        var b = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0x51u);
    ...
    public void ShiftMatchesExplicitShiftDense()
    {
        ...
        var b = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0x77u);
        fProxy shift = (fProxy)(-0.75);
        fProxy tol = Consts.fProxySqrtEps;

        var xShift = new fProxyN(n, Allocator.Temp);
    ...
    public void ZeroShiftMatchesUnshifted()
    {
        ...
        var b = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0x9Au);

        var xNo = new fProxyN(n, Allocator.Temp);
    ...
    {
        var A = fProxyGallery.fProxyLaplacian2D(5, 5);   // SPD, 25x25
        int n = A.M_Rows;
        var b = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0x1234u);
        var x = new fProxyN(n, Allocator.Temp);
        for (int i = 0; i < n; i++) x[i] = (fProxy)0;
    ...
    public void ShiftWarmStartCertifiesResidual()
    {
        ...
        var b = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0x42u);
        fProxy shift = (fProxy)(-0.6);
        fProxy tol = Consts.fProxySqrtEps;

        var x = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0xA11u);   // nonzero warm start
        var info = Krylov.minresQLP(in A, in b, ref x, 4 * n, tol, shift);
    ...
    public void ShiftIndefiniteMatchesExplicitShift()
    {
        ...
        var b = GenerateOP.fProxyRandomVec(n, (fProxy)(-1f), (fProxy)1f, 0x7u);
