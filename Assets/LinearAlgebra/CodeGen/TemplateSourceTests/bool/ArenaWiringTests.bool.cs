...
// (docs/rfc-memory-model.md §4 Option A). Mirrors the floatN/intN wiring tests
...
public class boolArenaWiringTests
{
    ...
    // in AllocationsCount -- see this file's header -- so unlike the fProxy/iProxy mirror this can't
