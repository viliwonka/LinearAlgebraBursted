...
public class floatKrylovPMinresTests
{
    ...
    public struct PMinresTestJob : IJob
    {
        ...
        void SpdIdentityMatchesLU()
        {
            ...
            var info = Krylov.pminres(op, new floatIdentityPreconditioner(), in b, ref x, 4 * n, Consts.floatSqrtEps);
        ...
        // pminres(in floatBSR, in floatBlockJacobi, ...) rung end-to-end.
        void SpdBlockJacobiMatchesLU()
        {
            ...
            var info = Krylov.pminres(in bsm, in M, in b, ref x, 4 * dim, Consts.floatSqrtEps);
            Assert.IsTrue(info.Solved);
        ...
        void IndefiniteCgFailsPminresWins()
        {
            ...
            var infoP = Krylov.pminres(new floatDenseOperator(in A), new floatIdentityPreconditioner(),
    ...
    public void PminresMaxIterationsRnormIsTrueResidual()
    {
        ...
        var op = new floatDenseOperator(in A);
        var x = arena.floatVec(n);
        var info = Krylov.pminres(op, new floatIdentityPreconditioner(), in b, ref x, 1, (float)1e-30f);
    ...
    public void WrongLengthScratchThrows()
    {
        ...
        try
        {
            ...
            var w1 = arena.floatVec(n);
            var w2 = arena.floatVec(n);
            var z  = arena.floatVec(n + 1);   // wrong length
    ...
    public void NonSquareOperatorThrows()
    {
        ...
        try
        {
            ...
            Assert.Throws<ArgumentException>(() =>
                Krylov.pminres(op, M, in b, ref x, m, Consts.floatSqrtEps));
        }
        finally { arena.Dispose(); }
    }
}
