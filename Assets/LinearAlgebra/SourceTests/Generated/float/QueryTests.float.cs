...
public class floatQueryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void ArgMaxMinAbsVector()
        {
            ...
            floatQuery_OP.argMaxAbs(in v, out float maxVal, out int maxIdx);
            AssertEqI(maxIdx, 1);                  // first of the two |5| entries
            AssertClose(maxVal, (float)5, (float)0);

            floatQuery_OP.argMinAbs(in v, out float minVal, out int minIdx);
            ...
            one[0] = (float)(-7);
            floatQuery_OP.argMaxAbs(in one, out float ov, out int oi);
            AssertEqI(oi, 0);
        ...
        void ArgMaxMinAbsMatrix()
        {
            ...
            floatQuery_OP.argMaxAbs(in A, out float maxVal, out int maxIdx);
            AssertEqI(maxIdx, 4);
            AssertClose(maxVal, (float)4, (float)0);
            floatQuery_OP.decodeIndex(maxIdx, A.N_Cols, out int mr, out int mc);
            AssertEqI(mr, 1); AssertEqI(mc, 1);

            // minAbs is the 0 at flat 3 (r1,c0).
            floatQuery_OP.argMinAbs(in A, out float minVal, out int minIdx);
            AssertEqI(minIdx, 3);
            AssertClose(minVal, (float)0, (float)0);
            floatQuery_OP.decodeIndex(minIdx, A.N_Cols, out int nr, out int nc);
        ...
        void DecodeIndex()
        {
            floatQuery_OP.decodeIndex(0, 4, out int r, out int c);
            AssertEqI(r, 0); AssertEqI(c, 0);
            floatQuery_OP.decodeIndex(7, 4, out r, out c);   // 7 = 1*4 + 3
            AssertEqI(r, 1); AssertEqI(c, 3);
            floatQuery_OP.decodeIndex(11, 3, out r, out c);  // 11 = 3*3 + 2
            ...
            for (int rr = 0; rr < 4; rr++)
                ...
                {
                    floatQuery_OP.decodeIndex(rr * nCols + cc, nCols, out int gr, out int gc);
        ...
        void RowColArgMinMax()
        {
            ...
            int nr = floatQuery_OP.rowArgMin(in A, ref idxR, ref valR);
            AssertEqI(nr, 3);
            ...
            floatQuery_OP.rowArgMin(in A, ref idxR2);
            AssertEqI(idxR2[0], 1); AssertEqI(idxR2[1], 1); AssertEqI(idxR2[2], 0);

            floatQuery_OP.rowArgMax(in A, ref idxR, ref valR);
            ...
            floatQuery_OP.rowArgMax(in A, ref idxR3);
            ...
            int nc = floatQuery_OP.colArgMin(in A, ref idxC, ref valC);
            AssertEqI(nc, 3);
            ...
            floatQuery_OP.colArgMin(in A, ref idxC2);
            AssertEqI(idxC2[0], 2); AssertEqI(idxC2[1], 0); AssertEqI(idxC2[2], 0);

            floatQuery_OP.colArgMax(in A, ref idxC, ref valC);
            ...
            floatQuery_OP.colArgMax(in A, ref idxC3);
        ...
        void ColArgStrided()
        {
            ...
            floatQuery_OP.colArgMin(in A, ref idxC, ref valC);
        ...
        void ArgMaxRowNorm()
        {
            ...
            AssertEqI(floatQuery_OP.argMaxRowNorm(in A, Norm.L1), 2);
            AssertEqI(floatQuery_OP.argMaxRowNorm(in A, Norm.L2), 0);
            AssertEqI(floatQuery_OP.argMaxRowNorm(in A, Norm.Linf), 0);
            ...
            AssertEqI(floatQuery_OP.argMaxRowNorm(in T, Norm.L1), 0);
        ...
        void ArgMaxColNorm()
        {
            ...
            AssertEqI(floatQuery_OP.argMaxColNorm(in A, Norm.L1), 0);
            AssertEqI(floatQuery_OP.argMaxColNorm(in A, Norm.L2), 2);
            AssertEqI(floatQuery_OP.argMaxColNorm(in A, Norm.Linf), 2);
        ...
        void DistancesToRowAllMetrics()
        {
            ...
            floatQuery_OP.distancesToRow(in A, in q2, Metric.Cosine, ref d);
            AssertClose(d[0], (float)1,   sqrtEps());
            AssertClose(d[1], (float)0.6, sqrtEps());

            // Dot with q2: r0·q2 = 9+16 = 25 ; r1·q2 = 3+0 = 3.
            floatQuery_OP.distancesToRow(in A, in q2, Metric.Dot, ref d);
        ...
        void DistancesToColumnAllMetrics()
        {
            ...
            // Manhattan: c0=4, c1=4
            floatQuery_OP.distancesToColumn(in A, in q, Metric.Manhattan, ref d);
            AssertClose(d[0], (float)4, fEps()); AssertClose(d[1], (float)4, fEps());

            // SqEuclidean: c0 = 9+1 = 10 ; c1 = 16+0 = 16
            floatQuery_OP.distancesToColumn(in A, in q, Metric.SqEuclidean, ref d);
            AssertClose(d[0], (float)10, fEps()); AssertClose(d[1], (float)16, fEps());

            // Euclidean: sqrt(10), 4
            floatQuery_OP.distancesToColumn(in A, in q, Metric.Euclidean, ref d);
            AssertClose(d[0], math.sqrt((float)10), sqrtEps()); AssertClose(d[1], (float)4, sqrtEps());

            // Chebyshev: c0=max(3,1)=3 ; c1=max(4,0)=4
            floatQuery_OP.distancesToColumn(in A, in q, Metric.Chebyshev, ref d);
        ...
        void NearestFarthestDistance()
        {
            ...
            floatQuery_OP.farthestRow(in A, in q, Metric.SqEuclidean, out int fi, out float fs);
            AssertEqI(fi, 1); AssertClose(fs, (float)25, fEps());   // squared units, not sqrt

            // Euclidean score is in euclidean units: farthest = 5.
            floatQuery_OP.farthestRow(in A, in q, Metric.Euclidean, out int fi2, out float fs2);
        ...
        void NearestFarthestSimilarity()
        {
            ...
            floatQuery_OP.nearestRow(in A, in q, Metric.Dot, out int ni, out float ns);
            AssertEqI(ni, 1); AssertClose(ns, (float)10, fEps());

            floatQuery_OP.farthestRow(in A, in q, Metric.Dot, out int fi, out float fs);
            ...
            floatQuery_OP.nearestRow(in A, in q, Metric.Cosine, out int cni, out float cns);
            AssertEqI(cni, 0); AssertClose(cns, (float)1, sqrtEps());

            floatQuery_OP.farthestRow(in A, in q, Metric.Cosine, out int cfi, out float cfs);
            ...
            floatQuery_OP.nearestColumn(in A, in q3, Metric.Dot, out int cni2, out float cns2);
            AssertEqI(cni2, 0); AssertClose(cns2, (float)1, fEps());
            floatQuery_OP.farthestColumn(in A, in q3, Metric.Dot, out int cfi2, out float cfs2);
        ...
        void KNearestBruteForce()
        {
            ...
            int cnt = floatQuery_OP.kNearestRows(in A, in q, k, Metric.SqEuclidean, ref idx, ref scores);
            AssertEqI(cnt, k);

            // Brute-force all scores then verify: returned set is the k smallest, sorted ascending.
            var all = arena.floatVec(M);
            floatQuery_OP.distancesToRow(in A, in q, Metric.SqEuclidean, ref all);
            ...
            int cnt2 = floatQuery_OP.kNearestRows(in A, in q, k, Metric.Dot, ref idx2, ref scores2);
            AssertEqI(cnt2, k);
            var allDot = arena.floatVec(M);
            floatQuery_OP.distancesToRow(in A, in q, Metric.Dot, ref allDot);
        ...
        void KNearestClampAndZero()
        {
            ...
            int z = floatQuery_OP.kNearestRows(in A, in q, 0, Metric.SqEuclidean, ref idx, ref scores);
            AssertEqI(z, 0);
        ...
        void KFarthest()
        {
            ...
            var idx = arena.Indices(k);
            var scores = arena.floatVec(k);
            int cnt = floatQuery_OP.kFarthestRows(in A, in q, k, Metric.SqEuclidean, ref idx, ref scores);
            AssertEqI(cnt, k);
        ...
        void WithinRadiusBoundary()
        {
            ...
            int cnt = floatQuery_OP.rowsWithinRadius(in A, in q, (float)5, Metric.Euclidean, ref idx);
            int ccnt = floatQuery_OP.countWithinRadius(in A, in q, (float)5, Metric.Euclidean);
            ...
            int cnt2 = floatQuery_OP.rowsWithinRadius(in A, in q, (float)4.9, Metric.Euclidean, ref idx);
            AssertEqI(cnt2, 2);
            AssertEqI(idx[0], 0); AssertEqI(idx[1], 2);
            AssertEqI(floatQuery_OP.countWithinRadius(in A, in q, (float)4.9, Metric.Euclidean), 2);
            ...
            int cnt3 = floatQuery_OP.rowsWithinRadius(in A, in q2, (float)1, Metric.Dot, ref idx);
            AssertEqI(cnt3, 2);
            AssertEqI(idx[0], 1); AssertEqI(idx[1], 2);
            AssertEqI(floatQuery_OP.countWithinRadius(in A, in q2, (float)1, Metric.Dot), 2);
            ...
            var idxc = arena.Indices(2);
            int ccol = floatQuery_OP.columnsWithinRadius(in A, in qcol, (float)10, Metric.SqEuclidean, ref idxc);
            AssertEqI(ccol, 1); AssertEqI(idxc[0], 0);
            AssertEqI(floatQuery_OP.countWithinColumnRadius(in A, in qcol, (float)10, Metric.SqEuclidean), 1);
        ...
        void FindValue()
        {
            ...
            AssertEqI(floatQuery_OP.findValue(in v, (float)2, (float)0), 1);
            // absent -> -1
            AssertEqI(floatQuery_OP.findValue(in v, (float)9, (float)0), -1);
            ...
            AssertEqI(floatQuery_OP.findValue(in v, (float)2.5, (float)0.5), 1);
            // tol below the gap (|2 - 2.5| = 0.5 > 0.25, |3 - 2.5| = 0.5 > 0.25) -> no match.
            AssertEqI(floatQuery_OP.findValue(in v, (float)2.5, (float)0.25), -1);

            // matrix overload (flat index). 2x2 = [5, 6; 7, 6]; first 6 at flat 1.
            var A = arena.floatMat(2, 2);
            A[0, 0] = (float)5; A[0, 1] = (float)6;
            A[1, 0] = (float)7; A[1, 1] = (float)6;
            AssertEqI(floatQuery_OP.findValue(in A, (float)6, (float)0), 1);
        ...
        void NonzeroCountNonzero()
        {
            ...
            AssertEqI(floatQuery_OP.countNonzero(in v, (float)0), 3);
            var idx = arena.Indices(6);
            int c = floatQuery_OP.nonzero(in v, (float)0, ref idx);
            AssertEqI(c, 3);
            AssertEqI(idx[0], 1); AssertEqI(idx[1], 3); AssertEqI(idx[2], 4);

            // tol=0.1: |0.05| filtered out -> indices 1,3 -> count 2
            AssertEqI(floatQuery_OP.countNonzero(in v, (float)0.1), 2);
            int c2 = floatQuery_OP.nonzero(in v, (float)0.1, ref idx);
            AssertEqI(c2, 2);
            ...
            AssertEqI(floatQuery_OP.countNonzero(in A, (float)0), 1);
            var idxA = arena.Indices(4);
            int ca = floatQuery_OP.nonzero(in A, (float)0, ref idxA);
        ...
        void Symmetry()
        {
            ...
            floatQuery_OP.distancesToColumn(in A, in q, Metric.Euclidean, ref dc);
            floatQuery_OP.distancesToRow(in At, in q, Metric.Euclidean, ref dr);
            for (int j = 0; j < N; j++)
            ...
            floatQuery_OP.colArgMin(in A, ref colIdx, ref colVal);
            var rowIdx = arena.Indices(N);
            var rowVal = arena.floatVec(N);
            floatQuery_OP.rowArgMin(in At, ref rowIdx, ref rowVal);
            for (int j = 0; j < N; j++)
            {
            ...
            AssertEqI(floatQuery_OP.argMaxColNorm(in A, Norm.L2),
                      floatQuery_OP.argMaxRowNorm(in At, Norm.L2));

            // farthestColumn(A) == farthestRow(transpose(A)).
            floatQuery_OP.farthestColumn(in A, in q, Metric.SqEuclidean, out int fci, out float fcs);
            floatQuery_OP.farthestRow(in At, in q, Metric.SqEuclidean, out int fri, out float frs);
            AssertEqI(fci, fri); AssertClose(fcs, frs, sqrtEps());

            // kNearestColumns(A) == kNearestRows(transpose(A)): same indices + scores.
            int kk = 3;
            var ncIdx = arena.Indices(kk); var ncVal = arena.floatVec(kk);
            var nrIdx = arena.Indices(kk); var nrVal = arena.floatVec(kk);
            int ncCnt = floatQuery_OP.kNearestColumns(in A, in q, kk, Metric.SqEuclidean, ref ncIdx, ref ncVal);
            int nrCnt = floatQuery_OP.kNearestRows(in At, in q, kk, Metric.SqEuclidean, ref nrIdx, ref nrVal);
            ...
            var fcIdx = arena.Indices(kk); var fcVal = arena.floatVec(kk);
            var frIdx = arena.Indices(kk); var frVal = arena.floatVec(kk);
            int fcCnt = floatQuery_OP.kFarthestColumns(in A, in q, kk, Metric.SqEuclidean, ref fcIdx, ref fcVal);
            int frCnt = floatQuery_OP.kFarthestRows(in At, in q, kk, Metric.SqEuclidean, ref frIdx, ref frVal);
            ...
            int cwrCnt = floatQuery_OP.columnsWithinRadius(in A, in q, rad, Metric.SqEuclidean, ref cwrIdx);
            int rwrCnt = floatQuery_OP.rowsWithinRadius(in At, in q, rad, Metric.SqEuclidean, ref rwrIdx);
            AssertEqI(cwrCnt, rwrCnt);
            for (int i = 0; i < cwrCnt; i++) AssertEqI(cwrIdx[i], rwrIdx[i]);
            AssertEqI(floatQuery_OP.countWithinColumnRadius(in A, in q, rad, Metric.SqEuclidean),
                      floatQuery_OP.countWithinRadius(in At, in q, rad, Metric.SqEuclidean));
        ...
        void ArenaKWrapperClamp()
        {
            ...
            var nrIdx = arena.floatKNearestRows(in A, in q, kRows, Metric.SqEuclidean, out floatN nrScore, out int nrCnt);
            AssertEqI(nrCnt, M);
            AssertEqI(nrIdx.N, M);
            var allR = arena.floatVec(M);
            floatQuery_OP.distancesToRow(in A, in q, Metric.SqEuclidean, ref allR);
            ...
            var frIdx = arena.floatKFarthestRows(in A, in q, kRows, Metric.SqEuclidean, out floatN frScore, out int frCnt);
            AssertEqI(frCnt, M);
            ...
            var ncIdx = arena.floatKNearestColumns(in A, in qc, kCols, Metric.SqEuclidean, out floatN ncScore, out int ncCnt);
            AssertEqI(ncCnt, N);
            var allC = arena.floatVec(N);
            floatQuery_OP.distancesToColumn(in A, in qc, Metric.SqEuclidean, ref allC);
            ...
            var fcIdx = arena.floatKFarthestColumns(in A, in qc, kCols, Metric.SqEuclidean, out floatN fcScore, out int fcCnt);
            AssertEqI(fcCnt, N);
        ...
        void ArenaWrappers()
        {
            ...
            floatQuery_OP.distancesToRow(in A, in q, Metric.SqEuclidean, ref drRef);
            AssertEqI(dr.N, M);
            ...
            floatQuery_OP.distancesToColumn(in A, in qc, Metric.SqEuclidean, ref dcolRef);
            AssertEqI(dcol.N, N);
            ...
            int refCnt = floatQuery_OP.nonzero(in A, (float)0.5, ref refNz);
            ...
            int refRRcnt = floatQuery_OP.rowsWithinRadius(in A, in q, radius, Metric.SqEuclidean, ref refRR);
            ...
            int refCRcnt = floatQuery_OP.columnsWithinRadius(in A, in qc, (float)8, Metric.SqEuclidean, ref refCR);
            ...
            int refCntK = floatQuery_OP.kNearestRows(in A, in q, k, Metric.SqEuclidean, ref refIdxK, ref refScoresK);
            ...
            int refCntKC = floatQuery_OP.kNearestColumns(in A, in qc, k, Metric.SqEuclidean, ref refIdxKC, ref refScoresKC);
    ...
    public void EmptyArgAbsThrows()
    {
        ...
        Assert.Throws<InvalidOperationException>(() =>
            floatQuery_OP.argMaxAbs(in v0, out float _, out int _));
        Assert.Throws<InvalidOperationException>(() =>
            floatQuery_OP.argMinAbs(in v0, out float _, out int _));
        arena.Dispose();
    }
    ...
    public void RowOpDimensionMismatchThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.distancesToRow(in A, in qBad, Metric.SqEuclidean, ref dest));
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.nearestRow(in A, in qBad, Metric.SqEuclidean, out int _, out float _));
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.countWithinRadius(in A, in qBad, (float)1, Metric.SqEuclidean));
        arena.Dispose();
    }
    ...
    public void ColOpDimensionMismatchThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.distancesToColumn(in A, in qBad, Metric.SqEuclidean, ref dest));
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.nearestColumn(in A, in qBad, Metric.SqEuclidean, out int _, out float _));
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.countWithinColumnRadius(in A, in qBad, (float)1, Metric.SqEuclidean));
        arena.Dispose();
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.decodeIndex(5, 0, out int _, out int _));
        Assert.Throws<ArgumentException>(() =>
            floatQuery_OP.decodeIndex(5, -3, out int _, out int _));
