...
public class floatQRLeastSquaresResidualTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RandomOverdeterminedNormalEquations()
        {
            ...
            {
                int m = 24, n = 6;
                var A = arena.floatRandomMatrix(m, n, -2f, 2f, 5500 + t * 17);
                // b is independent random — generically NOT in the column space => non-zero residual.
                var b = arena.floatRandomVector(m, -2f, 2f, 99000 + t * 23);
        ...
        void RandomOverdeterminedOptimality()
        {
            ...
            {
                int m = 16, n = 4;
                var A = arena.floatRandomMatrix(m, n, -2f, 2f, 1200 + t * 11);
                var b = arena.floatRandomVector(m, -2f, 2f, 64000 + t * 29);
