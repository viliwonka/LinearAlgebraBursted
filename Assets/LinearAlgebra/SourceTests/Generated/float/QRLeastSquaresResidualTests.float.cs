        ...
        void RandomOverdeterminedOptimality()
        {
            ...
            for (uint t = 0; t < 12; t++)
            {
                ...
                for (int k = 0; k < n; k++)
                {
                    ...
                    x[k] = saved + delta;
                    float rp = SumSq(b - Blas.dot(A, x));
                    x[k] = saved - delta;
                    float rm = SumSq(b - Blas.dot(A, x));
                    x[k] = saved;
