// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/BlockLSMRTests.fProxy.cs
...
// [BurstCompile] IJob with a TestType switch, mirroring BlockCGrQTests.float.cs's structure. Every
...
public class floatBlockLSMRTests
{
    ...
    public struct BlockLSMRTestJob : IJob
    {
        ...
        void NormalEquationsOptimalAndMatchesScalarLsmr()
        {
            ...
            var info = Krylov.blsmr(in A, in B, ref X, 20 * n, Consts.floatSqrtEps);
        ...
        void NeverNaNOnTinyMaxIter()
        {
            ...
            var X = arena.floatMat(s, n);
            Krylov.blsmr(in A, in B, ref X, 1, Consts.floatSqrtEps);
