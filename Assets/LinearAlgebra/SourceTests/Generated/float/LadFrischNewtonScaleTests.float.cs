// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/LadFrischNewtonScaleTests.fProxy.cs
...
public class floatLadFrischNewtonScaleTests
{
    ...
    static void BuildOutlierLine(floatMxN A, floatN b, double scale)
    {
        for (int i = 0; i < 5; i++) { A[i, 0] = (float)1; A[i, 1] = (float)i; b[i] = (float)(i * scale); }
        b[2] = (float)(10.0 * scale);
    }
    ...
    public void ResponseScaleEquivariance()
    {
        ...
        var bUnit = new floatN(5, Allocator.Temp);
        var xUnit = new floatN(2, Allocator.Temp);
        ...
        {
            double c = scales[k];
            var bc = new floatN(5, Allocator.Temp);
            var xc = new floatN(2, Allocator.Temp);
