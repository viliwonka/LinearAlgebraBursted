...
public class floatCHOTests
{
    ...
    public struct CHOTestJob : IJob
    {
        public enum TestType
        {
            ...
            // n >= CHOL_BLOCK_MIN_N (a measured per-dtype crossover — see Consts.floatCholBlockMinN;
        ...
        void RoundTrip()
        {
            ...
            var AMinusRecon = new floatMxN(in A, Allocator.Temp);
            floatComp.subInPlace(AMinusRecon, recon);
        ...
        void SolveOneStep()
        {
            ...
            var bOrig = new floatN(in b, Allocator.Temp);
            ...
            // Verify A·x ≈ bOrig
            var Ax = Blas.dot(A, b);
            var bOrigMinusAx = new floatN(in bOrig, Allocator.Temp);
            floatComp.subInPlace(bOrigMinusAx, Ax);
        ...
        void SolveInPlaceExitIsUsableFactor()
        {
            ...
            var b1 = GenerateOP.floatRandomVec(dim, -1f, 1f, 1212, Allocator.Temp);
            var b2 = GenerateOP.floatRandomVec(dim, -1f, 1f, 3434, Allocator.Temp);
        ...
        void SolveInPlaceShortCircuitPurity()
        {
            ...
            var b = GenerateOP.floatRandomVec(2, -1f, 1f, 13579, Allocator.Temp);
        ...
        void KnownSmall()
        {
            ...
            var L = new floatMxN(2, 2, Allocator.Temp);
        ...
        void Identity()
        {
            ...
            var A = GenerateOP.floatIdentityMat(dim, Allocator.Temp);
            var L = new floatMxN(dim, dim, Allocator.Temp);
            ...
            var b = GenerateOP.floatRandomVec(dim, -1f, 1f, 9090, Allocator.Temp);
            var bOrig = new floatN(in b, Allocator.Temp);
            CHO.decompSolve(ref L, ref b);
            var bOrigMinusB = new floatN(in bOrig, Allocator.Temp);
            floatComp.subInPlace(bOrigMinusB, b);
        ...
        void NotSPDStatus()
        {
            ...
            var b = GenerateOP.floatRandomVec(2, -1f, 1f, 17, Allocator.Temp);
            DirectSolveInfo solveInfo = CHO.decomp(in A, ref L);
            if (solveInfo.Solved) solveInfo = CHO.decompSolve(ref L, ref b);
        ...
        void CrossCheckLU()
        {
            ...
            var bCholMinusBLU = new floatN(in bChol, Allocator.Temp);
            floatComp.subInPlace(bCholMinusBLU, bLU);
        ...
        void Aliasing()
        {
            ...
            var Lt = Blas.trans(L);
            var recon = Blas.dot(L, Lt, false);
            var AorigMinusRecon = new floatMxN(in Aorig, Allocator.Temp);
            floatComp.subInPlace(AorigMinusRecon, recon);
        ...
        void GalleryGCD()
        {
            ...
            var A = floatGallery.floatGCD(dim, Allocator.Temp);
            var L = new floatMxN(dim, dim, Allocator.Temp);
        ...
        void GalleryFiedlerRejects()
        {
            ...
            var A = floatGallery.floatFiedler(dim, Allocator.Temp);
            var L = new floatMxN(dim, dim, Allocator.Temp);
            ...
            // factor+solve composition must also report failure.
            var b = GenerateOP.floatRandomVec(dim, -1f, 1f, 17, Allocator.Temp);
            DirectSolveInfo solveInfo = CHO.decomp(in A, ref L);
            if (solveInfo.Solved) solveInfo = CHO.decompSolve(ref L, ref b);
            bool solved = solveInfo.Solved;
            Assert.IsFalse(solved);
