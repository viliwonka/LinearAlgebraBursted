...
public class floatBlockIDRTests
{
    ...
    public struct BlockIdrTestJob : IJob
    {
        ...
        static bool BlockResidualDenseOK(ref Arena arena, in floatMxN A, in floatMxN X, in floatMxN B, int m, int n, float tol)
        {
            var AX = arena.floatMat(m, n);
        ...
        static bool BlockResidualBSROK(ref Arena arena, in floatBSR A, in floatMxN X, in floatMxN B, int m, int n, float tol)
        {
            var AX = arena.floatMat(m, n);
        ...
        void SolvesDenseNonsym()
        {
            ...
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B02u);

            var X = arena.floatMat(m, n);                  // zero initial guess
        ...
        void SolvesBSRNonsym()
        {
            ...
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B12u);

            var X = arena.floatMat(m, n);
            var info = Krylov.bidr(in A, in B, ref X, sDepth, 20 * n, ResTol());
        ...
        void MatchesScalarIdrPerColumn()
        {
            ...
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B22u);
        ...
        void KnownSolutionRecovered()
        {
            ...
            var Xk = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B32u);   // known solution

            var B = arena.floatMat(m, n);
        ...
        void IdentityFoldBitIdentical()
        {
            ...
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B42u);
            int maxIter = 12 * n;
            float tol = ResTol();
        ...
        void RankDeficientRHSBlockBreaksDownGracefully()
        {
            ...
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B52u);
        ...
        void DeterminismExplicitSeed()
        {
            ...
            var A = ConvDiff1D(ref arena, n);
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B62u);
            uint seed = 0x1234ABCDu;
        ...
        void DeterminismDefaultSeed()
        {
            ...
            int n = 40, m = 3;
            var A = ConvDiff1D(ref arena, n);
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B72u);
        ...
        void PreconditionedILU0()
        {
            ...
            var A = ConvDiff1D(ref arena, n);
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B82u);
        ...
        void PreconditionedBlockJacobi()
        {
            ...
            int n = 120, m = 3, sDepth = 4;
            var A = ConvDiff1D(ref arena, n);
            var B = arena.floatRandomMat(m, n, (float)(-1f), (float)1f, 0x1B92u);
