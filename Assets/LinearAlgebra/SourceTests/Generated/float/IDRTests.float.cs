...
public class floatIDRTests
{
    ...
    public struct IdrTestJob : IJob
    {
        ...
        void SolvesDenseNonsym()
        {
            ...
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D02u);
        ...
        void KnownSolution()
        {
            ...
            var xTrue = arena.floatRandomVec(n, -1f, 1f, 0x1D12u);
        ...
        void MatchesGmres()
        {
            ...
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D22u);
        ...
        void IdentityFoldDense()
        {
            ...
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D32u);
        ...
        void IdentityFoldBSR()
        {
            ...
            int n = 120;
            var A = ConvDiff1D(ref arena, n);
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D42u);
        ...
        void PreconditionedILU0()
        {
            ...
            int n = 150;
            var A = ConvDiff1D(ref arena, n);
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D52u);
        ...
        void PreconditionedBlockJacobi()
        {
            ...
            int n = 150;
            var A = ConvDiff1D(ref arena, n);
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D62u);
        ...
        void DeterminismExplicitSeed()
        {
            ...
            int n = 60;
            var A = ConvDiff1D(ref arena, n);
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D72u);
        ...
        void DeterminismDefaultSeed()
        {
            ...
            int n = 60;
            var A = ConvDiff1D(ref arena, n);
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D82u);
        ...
        void SEqualsOne()
        {
            ...
            var b = arena.floatRandomVec(n, -1f, 1f, 0x1D92u);
