...
public class floatBlockGCRODRTests
{
    ...
    public struct BgcrodrTestJob : IJob
    {
        ...
        {
            var A = GenerateOP.floatRandomMat(n, n, -1f, 1f, seed, Allocator.Temp);
        ...
        static floatMxN SmallIsolatedEig(int n, uint seed)
        {
        ...
        static floatMxN OneIsolatedEig(int n, uint seed)
        {
            var A = new floatMxN(n, n, Allocator.Temp);
            A[0, 0] = (float)0.01;
            for (int i = 1; i < n; i++)
        ...
        void RecyclingBeatsBgmres()
        {
            ...
            bool assertFewerIterations = true;
        ...
        void MatchesLUOracle()
        {
            ...
            var Aop = new floatDenseOperatorGeneral(in A);
            var Xtrue = GenerateOP.floatRandomMat(s, n, -1f, 1f, 0x7C12u, Allocator.Temp);
            ...
            Assert.IsTrue(floatKrylovBatteryOracles.RelResidualBlockDense(in A, in X, in B) <= Tol());
            ...
            for (int j = 0; j < s; j++)
            {
                ...
                var bj = new floatN(n, Allocator.Temp);
        ...
        void IdentityFoldBitExact()
        {
            ...
            var Aop = new floatDenseOperatorGeneral(in A);
            var B = GenerateOP.floatRandomMat(s, n, -1f, 1f, 0x7C22u, Allocator.Temp);

            var XImplicit = new floatMxN(s, n, Allocator.Temp);
            var i0 = Krylov.bgcrodr(in Aop, in B, ref XImplicit, m, k, 8 * n, Tol());

            var XExplicit = new floatMxN(s, n, Allocator.Temp);
        ...
        void Deterministic()
        {
            ...
            var Aop = new floatDenseOperatorGeneral(in A);
            var B = GenerateOP.floatRandomMat(s, n, -1f, 1f, 0x7C42u, Allocator.Temp);
        ...
        void ZeroRhs()
        {
            ...
            var Aop = new floatDenseOperatorGeneral(in A);
            var B = new floatMxN(s, n, Allocator.Temp);   // all zeros
            var X = new floatMxN(s, n, Allocator.Temp);   // all zeros (warm-start x0 = 0)
        ...
        {
            int n = 10, s = 3;
            var A = new floatMxN(n, n, Allocator.Temp);   // all zeros -> singular
            var Aop = new floatDenseOperatorGeneral(in A);
            var B = GenerateOP.floatRandomMat(s, n, 1f, 2f, 0x7C61u, Allocator.Temp);   // nonzero, not in range(A)
        ...
        void RecycleRebuildStaysFinite()
        {
            ...
            var Aop = new floatDenseOperatorGeneral(in A);
            var B = GenerateOP.floatRandomMat(s, n, -1f, 1f, 0x7C72u, Allocator.Temp);
        ...
        void SmallScaleWellConditioned()
        {
            ...
            for (int r = 0; r < n; r++)
                for (int cc = 0; cc < n; cc++)
                    A[r, cc] = Abase[r, cc] * c;
            var Aop = new floatDenseOperatorGeneral(in A);
            var B = GenerateOP.floatRandomMat(s, n, -1f, 1f, 0x7C92u, Allocator.Temp);
