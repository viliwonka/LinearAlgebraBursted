...
// (docs/spec-gallery.md, Phase 2 table; production template Gallery.Phase2.float.cs).
...
public class floatGalleryPhase2Tests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void GCDSolve()
        {
            ...
            var x = arena.floatVec(n);
            bool conv = Solvers.conjugateGradient(in A, in b, ref x, 500, Consts.floatSqrtEps);
            AssertTrue(conv);
