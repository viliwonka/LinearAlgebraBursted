...
// Tests for the floatComp elementwise math surface (OP.Component.float.cs forwarding to
...
public class floatCompMathTests
{
    ...
    public struct TestsJob : IJob
    {
        public enum TestType
        {
            ...
            // ---- matrix path (generic over IUnsafefloatArray) ----
        ...
        private void AssertClose(float got, float expected)
        {
            float tol = IsDouble() ? (float)1e-11 : (float)1e-4;
        ...
        private floatN MakeUnaryInput(ref Arena arena, TestType k, int n)
        {
            switch (k)
            {
                case TestType.Sqrt:
                ...
                case TestType.Log2:
                case TestType.Log10:
                    return arena.floatLinVec(n, (float)0.02, (float)9);

                case TestType.Rsqrt:
                case TestType.Rcp:
                    return arena.floatLinVec(n, (float)0.05, (float)6);

                case TestType.Acos:
                case TestType.Asin:
                    return arena.floatLinVec(n, (float)(-0.95), (float)0.95);

                case TestType.Acosh:
                    return arena.floatLinVec(n, (float)1, (float)4);

                case TestType.Tan:
                    return arena.floatLinVec(n, (float)(-1.2), (float)1.2);

                case TestType.Exp10:
                    return arena.floatLinVec(n, (float)(-2), (float)3);

                case TestType.Exp:
                case TestType.Exp2:
                    return arena.floatLinVec(n, (float)(-3), (float)4);
                ...
                case TestType.Relu:
                {
                    ...
                    var v = arena.floatLinVec(n, (float)(-3), (float)3);
                    v[0] = (float)0;
                    return v;
                }
                ...
                default:
                    ...
                    return arena.floatLinVec(n, (float)(-3.3), (float)3.7);
            }
        }
        ...
        private void Unary(TestType k, ref Arena arena)
        {
            ...
            floatN x = MakeUnaryInput(ref arena, k, n);
            floatN orig = x.Copy();
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                switch (k)
                {
                    ...
                    case TestType.Acosh: expected = math.log(o + math.sqrt(o * o - (float)1)); break;
                    ...
                    case TestType.Exp10: expected = math.pow((float)10, o); break;
                    ...
                    case TestType.Relu: expected = o < (float)0 ? (float)0 : o; break;
                    default: throw new NotImplementedException();
                }
        ...
        {
            int n = 16;
            floatN x = arena.floatLinVec(n, (float)0.3, (float)3.5);
            floatN orig = x.Copy();
            x.powInPlace(e);
            for (int i = 0; i < n; i++)
                AssertClose(x[i], math.pow(orig[i], (float)e)); // exponent 0 -> 1, negative -> reciprocal power
        }
        ...
        {
            int n = 24;
            floatN a = arena.floatLinVec(n, (float)(-2), (float)5);
            floatN b = arena.floatLinVec(n, (float)3, (float)9);
            floatN a0 = a.Copy();
            floatN b0 = b.Copy();
            float t = (float)0.35;
        ...
        {
            int n = 24;
            floatN a = arena.floatLinVec(n, (float)(-2), (float)1);
            floatN b = arena.floatLinVec(n, (float)6, (float)12); // b != a everywhere (no /0)
            floatN a0 = a.Copy();
            floatN b0 = b.Copy();
            float t = (float)0.4;
        ...
        {
            int n = 24;
            floatN a = arena.floatLinVec(n, (float)(-1), (float)1); // edge0 buffer
            floatN b = arena.floatLinVec(n, (float)2, (float)4);    // edge1 buffer (> edge0)
            floatN a0 = a.Copy();
            floatN b0 = b.Copy();
            float t = (float)0.5;
        ...
        {
            int n = 24;
            floatN x = arena.floatLinVec(n, (float)(-0.5), (float)1.5); // spans below/above edges
            floatN x0 = x.Copy();
            float edge0 = (float)0;
            float edge1 = (float)1;
        ...
        {
            int n = 24;
            floatN x = arena.floatLinVec(n, (float)(-1), (float)2);
            floatN x0 = x.Copy();
        ...
        {
            int n = 24;
            floatN a = arena.floatLinVec(n, (float)(-2), (float)2);
            floatN b = arena.floatLinVec(n, (float)1, (float)3);
            floatN c = arena.floatLinVec(n, (float)(-1), (float)1);
            floatN a0 = a.Copy();
            floatN b0 = b.Copy();
            floatN c0 = c.Copy();
        ...
        {
            int n = 24;
            floatN x = arena.floatLinVec(n, (float)1, (float)9); // strictly inside [oldMin,oldMax]
            floatN x0 = x.Copy();
            float oldMin = (float)0, oldMax = (float)10, newMin = (float)(-1), newMax = (float)1;
        ...
        private void DegreesRadiansTest(ref Arena arena)
        {
            ...
            floatN r = arena.floatLinVec(n, (float)(-3), (float)3);
            floatN r0 = r.Copy();
            floatN d = r.Copy();
            d.degreesInPlace();
            for (int i = 0; i < n; i++)
            ...
            floatN deg = arena.floatLinVec(n, (float)(-180), (float)180);
            floatN deg0 = deg.Copy();
            deg.radiansInPlace();
            for (int i = 0; i < n; i++)
        ...
        private void Atan2Test(ref Arena arena)
        {
            ...
            floatN y = arena.floatLinVec(n, (float)(-3), (float)3);
            floatN x = arena.floatLinVec(n, (float)0.5, (float)4); // x > 0 (principal branch)
            floatN y0 = y.Copy();
            floatN x0 = x.Copy();
        ...
        {
            int n = 24;
            floatN x = arena.floatLinVec(n, (float)(-2), (float)5);
            floatN y = arena.floatLinVec(n, (float)4, (float)(-1)); // crosses x so both branches hit
            floatN x0 = x.Copy();
            floatN y0 = y.Copy();
        ...
        private void MaxBufTest(ref Arena arena)
        {
            int n = 24;
            floatN x = arena.floatLinVec(n, (float)(-2), (float)5);
            floatN y = arena.floatLinVec(n, (float)4, (float)(-1));
            floatN x0 = x.Copy();
            floatN y0 = y.Copy();
        ...
        private void AbsDiffTest(ref Arena arena)
        {
            int n = 24;
            floatN x = arena.floatLinVec(n, (float)(-2), (float)5);
            floatN y = arena.floatLinVec(n, (float)4, (float)(-1)); // crosses x so sign of (x-y) varies
            floatN x0 = x.Copy();
            floatN y0 = y.Copy();
        ...
        {
            int n = 30;
            floatN x = arena.floatLinVec(n, (float)(-3), (float)3);
            floatN x0 = x.Copy();
            floatN s = arena.floatVec(n);
        ...
        // ---- matrix path: proves the generic IUnsafefloatArray constraint covers floatMxN.
        //      Non-square (5x7) so the flat length, not a square dim, drives the loop. ----

        private void MatrixAbsTest(ref Arena arena)
        {
            int rows = 5, cols = 7;
            floatMxN m = arena.floatMat(rows, cols);
            for (int i = 0; i < m.Length; i++)
                m[i] = (float)(i - 15) * (float)0.5; // negatives and positives
            floatMxN m0 = m.Copy();
        ...
        {
            int rows = 5, cols = 7;
            floatMxN a = arena.floatMat(rows, cols);
            floatMxN b = arena.floatMat(rows, cols);
            floatMxN c = arena.floatMat(rows, cols);
            for (int i = 0; i < a.Length; i++)
            {
                a[i] = (float)(i - 15) * (float)0.2;
                b[i] = (float)(i) * (float)0.3 - (float)1;
                c[i] = (float)2 - (float)i * (float)0.1;
            }
            floatMxN a0 = a.Copy();
            floatMxN b0 = b.Copy();
            floatMxN c0 = c.Copy();
        ...
        {
            floatN v = arena.floatVec(1, (float)(-2.5));
            v.absInPlace();
            AssertClose(v[0], (float)2.5);

            floatN a = arena.floatVec(1, (float)3);
            floatN b = arena.floatVec(1, (float)4);
            floatN c = arena.floatVec(1, (float)5);
            a.madInPlace(b, c);
            AssertClose(a[0], (float)17); // 3*4 + 5

            floatN x = arena.floatVec(1, (float)0.7);
            floatN s = arena.floatVec(1);
            floatN co = arena.floatVec(1);
            x.sincos(s, co);
            AssertClose(x[0], (float)0.7);
            AssertClose(s[0], math.sin((float)0.7));
            AssertClose(co[0], math.cos((float)0.7));
        }

        private void EmptyBufferTest(ref Arena arena)
        {
            // zero-length buffers: kernels loop zero times, must not touch memory / throw.
            floatN v = arena.floatVec(0);
            floatN y = arena.floatVec(0);
            v.absInPlace();
            v.sinInPlace();
            v.reluInPlace();
            v.minInPlace(y);
