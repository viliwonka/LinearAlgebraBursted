    ...
    public struct TestJob : IJob
    {
        ...
        void CovarianceIntoSingleRowZeroFill()
        {
            ...
            for (int i = 0; i < 3; i++)
                ...
                {
                    AssertNotNaN(C[i, j]);
                    AssertClose(C[i, j], (float)0f, 0f); // exactly zero
                }
        ...
        void RowColSumMean()
        {
            ...
            AssertClose(rSum[0], (float)6f, 1E-5f);
            AssertClose(rSum[1], (float)18f, 1E-5f);
            AssertClose(cSum[0], (float)5f, 1E-5f);
            AssertClose(cSum[1], (float)8f, 1E-5f);
            AssertClose(cSum[2], (float)11f, 1E-5f);

            AssertClose(rMean[0], (float)2f, 1E-5f);
            AssertClose(rMean[1], (float)6f, 1E-5f);
            AssertClose(cMean[0], (float)2.5f, 1E-5f);
            AssertClose(cMean[1], (float)4f, 1E-5f);
            AssertClose(cMean[2], (float)5.5f, 1E-5f);
        ...
        void RowColNorms()
        {
            ...
            AssertClose(rL1[0], (float)6f, 1E-5f);
            AssertClose(rL1[1], (float)18f, 1E-5f);
            AssertClose(rL2[0], (float)math.sqrt(14f), 1E-5f);
            AssertClose(rL2[1], (float)math.sqrt(116f), 1E-5f);

            AssertClose(cL1[0], (float)5f, 1E-5f);
            AssertClose(cL1[1], (float)8f, 1E-5f);
            AssertClose(cL1[2], (float)11f, 1E-5f);
            AssertClose(cL2[0], (float)math.sqrt(17f), 1E-5f);
            AssertClose(cL2[1], (float)math.sqrt(40f), 1E-5f);
            AssertClose(cL2[2], (float)math.sqrt(73f), 1E-5f);
        ...
        void VectorVarianceStdDev()
        {
            ...
            AssertClose(Stats.mean(in v), (float)5f, 1E-5f);
            AssertClose(Stats.variance(in v), (float)4f, 1E-5f);
            AssertClose(Stats.stdDev(in v), (float)2f, 1E-5f);
            AssertClose(Stats.varianceSample(in v), (float)(32f / 7f), 1E-5f);
            AssertClose(Stats.stdDevSample(in v), (float)math.sqrt(32f / 7f), 1E-5f);
        ...
        void SingleElementVariance()
        {
            ...
            AssertClose(Stats.variance(in v), (float)0f, 1E-5f);
            AssertClose(Stats.stdDev(in v), (float)0f, 1E-5f);
        ...
        void Matrix2x3()
        {
            ...
            AssertClose(rowMin[0], (float)1f, 1E-5f);
            AssertClose(rowMin[1], (float)4f, 1E-5f);
            AssertClose(rowMax[0], (float)3f, 1E-5f);
            AssertClose(rowMax[1], (float)8f, 1E-5f);

            AssertClose(colMin[0], (float)1f, 1E-5f);
            AssertClose(colMin[1], (float)2f, 1E-5f);
            AssertClose(colMin[2], (float)3f, 1E-5f);
            AssertClose(colMax[0], (float)4f, 1E-5f);
            AssertClose(colMax[1], (float)6f, 1E-5f);
            AssertClose(colMax[2], (float)8f, 1E-5f);

            AssertClose(rowVar[0], (float)(2f / 3f), 1E-5f);
            AssertClose(rowVar[1], (float)(8f / 3f), 1E-5f);
            AssertClose(rowStd[0], (float)math.sqrt(2f / 3f), 1E-5f);
            AssertClose(rowStd[1], (float)math.sqrt(8f / 3f), 1E-5f);

            AssertClose(colVar[0], (float)2.25f, 1E-5f);
            AssertClose(colVar[1], (float)4f, 1E-5f);
            AssertClose(colVar[2], (float)6.25f, 1E-5f);
            AssertClose(colStd[0], (float)1.5f, 1E-5f);
            AssertClose(colStd[1], (float)2f, 1E-5f);
            AssertClose(colStd[2], (float)2.5f, 1E-5f);
        ...
        void Matrix3x2Negatives()
        {
            ...
            AssertClose(colMin[0], (float)(-5f), 1E-5f);
            AssertClose(colMin[1], (float)1f, 1E-5f);
            AssertClose(colMax[0], (float)(-1f), 1E-5f);
            AssertClose(colMax[1], (float)5f, 1E-5f);

            AssertClose(colVar[0], (float)(8f / 3f), 1E-5f);
            AssertClose(colVar[1], (float)(8f / 3f), 1E-5f);
        ...
        void OneColumnMatrix()
        {
            ...
            AssertClose(rowVar[0], (float)0f, 1E-5f);
            AssertClose(rowVar[1], (float)0f, 1E-5f);
            AssertClose(rowVar[2], (float)0f, 1E-5f);
        ...
        void CovarianceKnown()
        {
            ...
            AssertClose(C[0, 1], (float)2f, 1E-5f);
            AssertClose(C[1, 0], (float)2f, 1E-5f);
        ...
        void CorrelationKnown()
        {
            ...
            AssertClose(R[0, 1], (float)0.5f, 1E-5f);
            AssertClose(R[1, 0], (float)0.5f, 1E-5f);
        ...
        void CorrelationConstantColumn()
        {
            ...
            AssertClose(R[1, 0], (float)0f, 1E-5f);
        ...
        private void AssertNotNaN(float a)
        {
            if (math.isnan(a) && Fail[0] == (float)0)
            {
                Fail[0] = (float)1;
                Fail[1] = a;
                Fail[2] = (float)0;
