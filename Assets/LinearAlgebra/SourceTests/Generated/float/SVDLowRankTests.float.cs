// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/SVDLowRankTests.fProxy.cs
...
public class floatSVDLowRankTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void CheckAtK(in floatMxN A, in floatN fullS, int k, float normA2)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            var Ak = new floatMxN(m, n, Allocator.Temp);
        ...
        floatN Spectrum(in floatMxN A, out float normA2)
        {
            int n = A.N_Cols;
        ...
        void RandomTall12x5()
        {
            var A = GenerateOP.floatRandomMat(12, 5, (float)(-2f), (float)2f, 555111, allocator: Allocator.Temp);
            var fullS = Spectrum(in A, out float normA2);
        ...
        void RandomSquare8()
        {
            var A = GenerateOP.floatRandomMat(8, 8, (float)(-3f), (float)3f, 909090, allocator: Allocator.Temp);
            var fullS = Spectrum(in A, out float normA2);
            CheckAtK(in A, in fullS, 1, normA2);
        ...
        {
            int m = 10, n = 6, r = 3;
            var B = GenerateOP.floatRandomMat(m, r, (float)(-2f), (float)2f, 121212, allocator: Allocator.Temp);
            var C = GenerateOP.floatRandomMat(r, n, (float)(-2f), (float)2f, 343434, allocator: Allocator.Temp);
        ...
        {
            int m = 40, n = 12;
            var A = GenerateOP.floatRandomMat(m, n, (float)(-2f), (float)2f, 777111, allocator: Allocator.Temp);

            // Full thin SVD as oracle
            var Ufull = new floatMxN(m, n, Allocator.Temp);
            var Sfull = new floatN(n, Allocator.Temp);
            var Vfull = new floatMxN(n, n, Allocator.Temp);
        ...
        {
            int m = 24, n = 8, r = 4;
            var B = GenerateOP.floatRandomMat(m, r, (float)(-2f), (float)2f, 8881, allocator: Allocator.Temp);
            var C = GenerateOP.floatRandomMat(r, n, (float)(-2f), (float)2f, 9992, allocator: Allocator.Temp);
        ...
        {
            int m = 30, n = 10;
            var A = GenerateOP.floatRandomMat(m, n, (float)(-3f), (float)3f, 313131, allocator: Allocator.Temp);
        ...
        {
            int m = 20, n = 7;
            var A = GenerateOP.floatRandomMat(m, n, (float)(-4f), (float)4f, 202020, allocator: Allocator.Temp);
        ...
        void CheckTruncVsThin(in floatMxN A, int k, int oversample, uint seed, int m, int n,
                              float svTol, float vecTol, float orthoTol)
        {
            var Ufull = new floatMxN(m, n, Allocator.Temp);
            var Sfull = new floatN(n, Allocator.Temp);
            var Vfull = new floatMxN(n, n, Allocator.Temp);
        ...
        void GklTruncated_80x40_k3()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0x11223344u, m, n,
                             (float)1f, (float)0.01f, (float)1E-3f);
        }
        ...
        void GklClusteredSpectrum_50x30()
        {
            ...
            var Uf = new floatMxN(m, n, Allocator.Temp);
            var Sf = new floatN(n, Allocator.Temp);
            var Vf = new floatMxN(n, n, Allocator.Temp);
        ...
        void GklIllConditioned_60x20()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0xFEEDC0DEu, m, n,
                             (float)5f, (float)0.01f, (float)1E-3f);
        }
        ...
        void GklConvergedFalse_RankDeficient()
        {
            ...
            var B = GenerateOP.floatRandomMat(m, r, (float)(-2f), (float)2f, 0xBADC0DE0u, allocator: Allocator.Temp);
            var C = GenerateOP.floatRandomMat(r, n, (float)(-2f), (float)2f, 0xBADC0DE1u, allocator: Allocator.Temp);
        ...
        void GklConvergedFalse_TooFewSteps()
        {
            ...
            var A = GenerateOP.floatRandomMat(m, n, (float)(-2f), (float)2f, 0x55AA77BBu, allocator: Allocator.Temp);
        ...
        void GklConvergedFalse_MaxIter1()
        {
            ...
            var A = GenerateOP.floatRandomMat(m, n, (float)(-3f), (float)3f, 0xDEADBEEFu, allocator: Allocator.Temp);
        ...
        void PartialVsFull_Geometric_80x30()
        {
            ...
            var SkP = new floatN(k, Allocator.Temp);
            var SkF = new floatN(k, Allocator.Temp);
        ...
        void PartialClustered_50x30()
        {
            ...
            CheckPartialReorth(in A, in sigma, k, 12, 0xC1057E12u, m, n, (float)0.05f);
        }
        ...
        void PartialIllConditioned_60x20()
        {
            ...
            CheckPartialReorth(in A, in sigma, k, 4, 0x111C0AD3u, m, n, (float)5f);
        }
    ...
    {
        var A = new floatMxN(6, 4, Allocator.Temp);
        var Ak = new floatMxN(4, 6, Allocator.Temp);   // must be m x n = 6 x 4
