...
public class floatDotRefGuardTests
{
    ...
    public void MatVec_BadDestSize_Throws()
    {
        ...
        try
        {
            ...
            var bad = arena.floatVec(2);   // must be length 3 (A.M_Rows)
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in A, in x, ref bad));
        }
    ...
    public void MatMat_BadDestShape_Throws()
    {
        ...
        {
            var a = arena.floatMat(3, 4);
            var b = arena.floatMat(4, 5);
            var bad = arena.floatMat(3, 4);   // must be 3 x 5
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in a, in b, ref bad, false));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void MatMat_IncompatibleInputs_Throws()
    {
        ...
        {
            var a = arena.floatMat(3, 4);
            var b = arena.floatMat(5, 6);     // a.N_Cols (4) != b.M_Rows (5)
            var c = arena.floatMat(3, 6);
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in a, in b, ref c, false));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void Trans_BadDestShape_Throws()
    {
        ...
        try
        {
            ...
            var bad = arena.floatMat(3, 5);   // must be 5 x 3
            Assert.Throws<ArgumentException>(() => Linear_OP.trans(in A, ref bad));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void MatVec_DestAliasesX_Throws()
    {
        ...
        try
        {
            ...
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in A, in x, ref alias));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void VecMat_DestAliasesY_Throws()
    {
        ...
        try
        {
            ...
            var A = arena.floatMat(3, 3);
            var alias = y;
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in y, in A, ref alias));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void MatMat_DestAliasesInput_Throws()
    {
        ...
        try
        {
            ...
            var aliasA = a;
            var aliasB = b;
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in a, in b, ref aliasA, false));
            Assert.Throws<ArgumentException>(() => Linear_OP.dot(in a, in b, ref aliasB, false));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void Trans_DestAliasesInput_Throws()
    {
        ...
        try
        {
            var A = arena.floatMat(3, 3);
            var alias = A;
            Assert.Throws<ArgumentException>(() => Linear_OP.trans(in A, ref alias));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void MatMat_SameInputAlias_DoesNotThrow()
    {
        ...
        try
        {
            ...
            Assert.DoesNotThrow(() => Linear_OP.dot(in a, in a, ref c, false));
        }
        finally { arena.Dispose(); }
    }
}
