...
public class floatDotRefGuardTests
{
    ...
    public void MatVec_BadDestSize_Throws()
    {
        ...
        var bad = new floatN(2, Allocator.Temp);   // must be length 3 (A.M_Rows)
    ...
    {
        var a = new floatMxN(3, 4, Allocator.Temp);
        var b = new floatMxN(4, 5, Allocator.Temp);
        var bad = new floatMxN(3, 4, Allocator.Temp);   // must be 3 x 5
    ...
    {
        var a = new floatMxN(3, 4, Allocator.Temp);
        var b = new floatMxN(5, 6, Allocator.Temp);     // a.N_Cols (4) != b.M_Rows (5)
        var c = new floatMxN(3, 6, Allocator.Temp);
    ...
    public void Trans_BadDestShape_Throws()
    {
        ...
        var bad = new floatMxN(3, 5, Allocator.Temp);   // must be 5 x 3
