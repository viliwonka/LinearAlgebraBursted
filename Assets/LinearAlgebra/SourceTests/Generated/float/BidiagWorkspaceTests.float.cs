...
// floatBidiagWorkspace (Arena.floatBidiagWorkspace(m, n)).
//
...
public class floatBidiagWorkspaceTests
{
    ...
    public struct WorkspaceJob : IJob
    {
        ...
        void BidiagEquiv(int m, int n, uint seed)
        {
            ...
            var ws = arena.floatBidiagWorkspace(m, n);
        ...
        void ReuseBoth()
        {
            ...
            var ws = arena.floatBidiagWorkspace(m, n);   // allocated ONCE
    ...
    public void Bidiagonalize_BadWorkspace_Throws()
    {
        ...
        try
        {
            ...
            var ws = arena.floatBidiagWorkspace(m + 1, n);   // wrong m
    ...
    public void BidiagonalizeValues_BadWorkspace_Throws()
    {
        ...
        try
        {
            ...
            var ws = arena.floatBidiagWorkspace(m, n + 1);   // wrong n (W/vVec/wScratch all wrong)
            Assert.Throws<ArgumentException>(
    ...
    // Arena.floatBidiagWorkspace(m, n): W (m x n), leftU (m x n), uVec (m), vVec (n), wScratch (n).
    [Test]
    public void BidiagWorkspace_Factory_SizesCorrectly()
    {
        ...
        try
        {
            var ws = arena.floatBidiagWorkspace(9, 4);
