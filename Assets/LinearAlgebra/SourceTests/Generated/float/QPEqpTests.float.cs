...
// on TemplateSource/AssemblyInfo.cs (the same grant floatChooseMarkerDemo already relies on) for this
    ...
    public struct EqpJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            else
            {
                ...
                double objTol = 5e-5 + 1e-5 * (1.0 + math.abs(objStar));
