...
public class floatQRCPDowndateTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void KahanSweep()
        {
            try
            {
                ...
                for (int ti = 0; ti < 4; ti++)
                {
                    ...
                    var A0 = floatGallery.floatKahan(dim, c);
                    var Q = new floatMxN(in A0, Allocator.Temp);
        ...
        void KahanRankCrossCheck()
        {
            ...
            {
                int dim = 16;
                var A0 = floatGallery.floatKahan(dim, (float)0.36235775f);
        ...
        void NormCollapseLadder()
        {
            try
            {
                ...
                for (int e = 0; e < 4; e++)
                {
                    ...
                    var B     = GenerateOP.floatRandomMat(m, k, -1f, 1f, 424200u + (uint)e);
                    var X     = GenerateOP.floatRandomMat(k, k, -1f, 1f, 990000u + (uint)e);
                    var noise = GenerateOP.floatRandomMat(m, k, -1f, 1f, 133700u + (uint)e);
        ...
        void MassCancellation()
        {
            try
            {
                ...
                var v = new floatN(m, Allocator.Temp);
                ...
                var As = new floatMxN(in A0, Allocator.Temp);
        ...
        void Ties()
        {
            ...
            {
                int m = 8, n = 5;
                var A0 = GenerateOP.floatRandomMat(m, n, -2f, 2f, 0x71E5u);
                ...
                // Run 1.
                var Q1 = new floatMxN(in A0, Allocator.Temp);
                var R1 = new floatMxN(n, n, Allocator.Temp);
                var P1 = new Pivot(n, Allocator.Temp);
                var u1 = new floatN(m, Allocator.Temp);
                QRCP.decompInPlace(ref Q1, ref R1, ref P1, ref u1);
                TierP(in A0, in Q1, in R1, in P1);

                // Run 2 (independent copy, identical overload).
                var Q2 = new floatMxN(in A0, Allocator.Temp);
                var R2 = new floatMxN(n, n, Allocator.Temp);
                var P2 = new Pivot(n, Allocator.Temp);
                var u2 = new floatN(m, Allocator.Temp);
        ...
        void ScaleExtremes()
        {
            ...
            {
                int m = 10, n = 6;
                var A0 = GenerateOP.floatRandomMat(m, n, -1f, 1f, 0x5CA1E5u);
        ...
        void ZeroAndTinySizes()
        {
            try
            {
                ...
                {
                    var A0 = new floatMxN(5, 3, Allocator.Temp);
                    var Q = new floatMxN(in A0, Allocator.Temp);
                    var R = new floatMxN(3, 3, Allocator.Temp);
                    var P = new Pivot(3, Allocator.Temp);
                    var u = new floatN(5, Allocator.Temp);
                    QRCP.decompInPlace(ref Q, ref R, ref P, ref u);
                    TierP(in A0, in Q, in R, in P);
                ...
                // (c) single-column tall (n=1), a few different m.
                {
                    for (int mi = 0; mi < 3; mi++)
                    {
                        ...
                        var A0 = new floatMxN(m, 1, Allocator.Temp);
                ...
                // (d) tiny full-ish sizes n = 1..3 (m = n and m = n+2), random, generically full rank.
                {
                    ...
                    {
                        int m = mi == 0 ? n : n + 2;
                        var A0 = GenerateOP.floatRandomMat(m, n, -3f, 3f, 0x717Au + (uint)(n * 7 + mi));
        ...
        void TierEDistinctMagnitudes()
        {
            ...
            {
                int m = 10, n = 5;
                var A0 = GenerateOP.floatRandomMat(m, n, -1f, 1f, 0x7E5700u);
                float sc = (float)1;
                for (int c = 0; c < n; c++)
                {
        ...
        // ── Cache-overload equivalence: the zero-alloc cache overloads (floatQRCPCache) must be
        ...
        void CacheEquivalence(int m, int n, uint seed, bool rankDeficient)
        {
            try
            {
                ...
                var Anc = new floatMxN(in A0, Allocator.Temp); var Rnc = new floatMxN(n, n, Allocator.Temp); var Pnc = new Pivot(n, Allocator.Temp); var unc = new floatN(m, Allocator.Temp);
                QRCP.decompInPlace(ref Anc, ref Rnc, ref Pnc, ref unc);

                var Ac = new floatMxN(in A0, Allocator.Temp); var Rc = new floatMxN(n, n, Allocator.Temp); var Pc = new Pivot(n, Allocator.Temp); var uc = new floatN(m, Allocator.Temp);
                var cache = new floatQRCPCache(n, Allocator.Temp);
                ...
                var b0 = GenerateOP.floatRandomVec(m, -3f, 3f, seed + 1u);

                var As1 = new floatMxN(in A0, Allocator.Temp); var b1 = new floatN(in b0, Allocator.Temp); var Rs1 = new floatMxN(n, n, Allocator.Temp); var Ps1 = new Pivot(n, Allocator.Temp); var us1 = new floatN(m, Allocator.Temp); var x1 = new floatN(n, Allocator.Temp);
                RankInfo info1 = QRCP.solveInPlace(ref As1, ref b1, ref x1, ref Rs1, ref Ps1, ref us1);

                var As2 = new floatMxN(in A0, Allocator.Temp); var b2 = new floatN(in b0, Allocator.Temp); var Rs2 = new floatMxN(n, n, Allocator.Temp); var Ps2 = new Pivot(n, Allocator.Temp); var us2 = new floatN(m, Allocator.Temp); var x2 = new floatN(n, Allocator.Temp);
                var cache2 = new floatQRCPCache(n, Allocator.Temp);
        ...
        void BlockedPanels()
        {
            try
            {
                ...
                for (int s = 0; s < shapes; s++)
                {
                    ...
                    var A0 = GenerateOP.floatRandomMat(m, n, -1f, 1f, 0xB10C0000u + (uint)s);
                    ...
                    if (ProdVsOracleTol(in A0, (float)1e-3f)) eligible++;
                }
        ...
        bool ProdVsOracleTol(in floatMxN A0, float relTol)
        {
            int m = A0.M_Rows;
            int n = A0.N_Cols;

            var Qp = new floatMxN(in A0, Allocator.Temp); var Rp = new floatMxN(n, n, Allocator.Temp); var Pp = new Pivot(n, Allocator.Temp); var up = new floatN(m, Allocator.Temp);
            QRCP.decompInPlace(ref Qp, ref Rp, ref Pp, ref up);
            TierP(in A0, in Qp, in Rp, in Pp);

            var Qo = new floatMxN(in A0, Allocator.Temp); var Ro = new floatMxN(n, n, Allocator.Temp); var Po = new Pivot(n, Allocator.Temp); var uo = new floatN(m, Allocator.Temp);
        ...
        void TierP(in floatMxN A0, in floatMxN Q, in floatMxN R, in Pivot P)
        {
            ...
            var Aperm = new floatMxN(in A0, Allocator.Temp);
            for (int r = 0; r < m; r++)
                for (int j = 0; j < n; j++)
                    Aperm[r, j] = A0[r, P[j]];

            floatMxN diff = new floatMxN(in Aperm, Allocator.Temp);
            floatComp.subInPlace(diff, Blas.dot(Q, R));
        ...
        public bool ProdAndOracle(in floatMxN A0, out int prodRank)
        {
            int m = A0.M_Rows;
            int n = A0.N_Cols;
    ...
    {
        var A = GenerateOP.floatRandomMat(5, 3, -1f, 1f, 12345u);
        var R = new floatMxN(3, 3, Allocator.Temp);
        var P = new Pivot(3, Allocator.Persistent);
        var u = new floatN(5, Allocator.Temp);
        var cache = new floatQRCPCache(2, Allocator.Temp); // wrong: must be sized for n == 3
