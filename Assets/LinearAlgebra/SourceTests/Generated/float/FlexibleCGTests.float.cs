...
public class floatFlexibleCGTests
{
    ...
    {
        readonly floatBSR A;
        readonly floatN sr, sp, sAp;
        readonly int steps;

        public InnerCgPreconditioner(in floatBSR a, floatN sr, floatN sp, floatN sAp, int steps)
        ...
        public void Apply(in floatN r, ref floatN z)
        {
            ...
            // floatN handles copied to locals: cg takes them by ref (scratch), and a readonly
            // struct field cannot be passed by ref -- the local aliases the same buffer.
            floatN lr = sr, lp = sp, lAp = sAp;
            Krylov.cg(in A, in r, ref z, ref lr, ref lp, ref lAp, steps, (float)0);
        }
    }
