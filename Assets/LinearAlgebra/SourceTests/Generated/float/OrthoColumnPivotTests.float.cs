...
public class floatOrthoColumnPivotTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void AssertQRCP(in floatMxN A, in floatMxN Q, in floatMxN R, in Pivot P, float precision)
        {
            ...
            floatMxN shouldBeZero = Aperm - floatOP.dot(Q, R);
    ...
    public struct SolveTestJob : IJob
    {
        ...
        void FullRankSquare()
        {
            ...
            var b = floatOP.dot(A, xOrig); // b in range(A) -> exact solution exists
        ...
        void KnownValueRegression()
        {
            ...
            OrthoOP.qrcpDirectSolve(ref A, ref b, ref x, ref Q, ref R, ref P, ref u, out int rank, (float)(-1));
