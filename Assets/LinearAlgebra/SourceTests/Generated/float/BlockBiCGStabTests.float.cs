...
public class floatBlockBiCGStabTests
{
    ...
    public struct BlockBiCGStabTestJob : IJob
    {
        ...
        void IdentityFoldBitIdentical()
        {
            ...
            var R1     = arena.floatMat(s, n);
            var Rhat01 = arena.floatMat(s, n);
            var P1     = arena.floatMat(s, n);
            var V1     = arena.floatMat(s, n);
            var T1     = arena.floatMat(s, n);
            var Phat1  = arena.floatMat(s, n);
            var Shat1  = arena.floatMat(s, n);
            ...
            var R2     = arena.floatMat(s, n);
            var Rhat02 = arena.floatMat(s, n);
            var P2     = arena.floatMat(s, n);
            var V2     = arena.floatMat(s, n);
            var T2     = arena.floatMat(s, n);
        ...
        void PreconditionedMatchesScalar()
        {
            ...
            var A = arena.floatRandomSparse(16, 16, 2, (float)0.4, 85001u);   // 32 dof, nonsymmetric diag-dominant
            int n = A.M_Rows;
            int s = 3;
        ...
        void MaxIterBudgetHonestStatus()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 86002u);
