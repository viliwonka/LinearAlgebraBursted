// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/BlockBiCGStabTests.fProxy.cs
...
// job-safety criterion -- the caller sees the final X written through the ref floatMxN -- is
// exercised by construction.
public class floatBlockBiCGStabTests
{
    ...
    public struct BlockBiCGStabTestJob : IJob
    {
        ...
        // GENERAL block apply (floatDenseOperatorGeneral -- floatDenseOperator.ApplyBlock computes
        ...
        void KnownSolutionRecovered()
        {
            ...
            var info = Krylov.bbiCGStab(in A, in B, ref X, 12 * n, Consts.floatSqrtEps);
            Assert.IsTrue(info.Solved);
        ...
        void IdentityFoldBitIdentical()
        {
            ...
            var R1     = new floatMxN(s, n, Allocator.Temp);
            var Rhat01 = new floatMxN(s, n, Allocator.Temp);
            var P1     = new floatMxN(s, n, Allocator.Temp);
            var V1     = new floatMxN(s, n, Allocator.Temp);
            var T1     = new floatMxN(s, n, Allocator.Temp);
            var Phat1  = new floatMxN(s, n, Allocator.Temp);
            var Shat1  = new floatMxN(s, n, Allocator.Temp);
            var info1 = Krylov.bbiCGStab<floatDenseOperatorGeneral, floatIdentityPreconditioner>(
            ...
            var R2     = new floatMxN(s, n, Allocator.Temp);
            var Rhat02 = new floatMxN(s, n, Allocator.Temp);
            var P2     = new floatMxN(s, n, Allocator.Temp);
            var V2     = new floatMxN(s, n, Allocator.Temp);
            var T2     = new floatMxN(s, n, Allocator.Temp);
            var info2 = Krylov.bbiCGStab<floatDenseOperatorGeneral>(
        ...
        void RankDeficientRHSBlockBreaksDownGracefully()
        {
            ...
            var X = new floatMxN(s, n, Allocator.Temp);
            var info = Krylov.bbiCGStab(in A, in B, ref X, 8 * n, Consts.floatSqrtEps);
        ...
        {
            var A = floatGallery.floatRandomSparse(16, 16, 2, (float)0.4, 85001u);   // 32 dof, nonsymmetric diag-dominant
            int n = A.M_Rows;
            int s = 3;
        ...
        void MaxIterBudgetHonestStatus()
        {
            ...
            var B = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 86002u);
            ...
            var X = new floatMxN(s, n, Allocator.Temp);
            var info = Krylov.bbiCGStab(in A, in B, ref X, 1, Consts.floatSqrtEps);   // deliberately tiny budget
