...
public class floatKrylovVerifyAtExitTests
{
    ...
    static floatMxN BuildDenseNonsym(int dim, uint seed)
    {
        var A = GenerateOP.floatRandomMat(dim, dim, (float)(-1f), (float)1f, seed);
    ...
    public void VerifyAtExitCatchesOptimisticDriftOnIllConditionedMoler()
    {
        ...
        int n = 16;
        var Adense = floatGallery.floatMoler(n, (float)(-0.13f));
        ...
        var rU = new floatN(n, Allocator.Temp);
        var pU = new floatN(n, Allocator.Temp);
        var ApU = new floatN(n, Allocator.Temp);
        var infoU = UnguardedCg(in op, in b, ref xU, ref rU, ref pU, ref ApU, maxIter, tol);

        var scratchU = new floatN(n, Allocator.Temp);
        ...
        var rG = new floatN(n, Allocator.Temp);
        var pG = new floatN(n, Allocator.Temp);
        var ApG = new floatN(n, Allocator.Temp);
        var infoG = Krylov.cg(in op, in b, ref xG, ref rG, ref pG, ref ApG, maxIter, tol);

        var scratchG = new floatN(n, Allocator.Temp);
    ...
    public void VerifyAtExitAddsExactlyOneApplyAndPreservesSolutionOnHealthySolve()
    {
        ...
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 141002);
        int maxIter = 4 * n;
    ...
    public void PcgConvergedRnormIsHonest()
    {
        ...
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 142002);
    ...
    static void AssertSolvedImpliesCertified(in floatMxN A, in floatN b, in floatN x,
                                             SolveInfo info, float tol, string what)
    {
        if (!info.Solved) return;
        var op = new floatDenseOperator(in A);
        var r = new floatN(b.N, Allocator.Temp);
        ...
        var Ar = new floatN(b.N, Allocator.Temp);
    ...
    {
        var A = floatGallery.floatRosser();            // 8x8 symmetric, exactly singular, clustered spectrum
        int n = A.M_Rows;
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 143003);   // INCOMPATIBLE (null-space component)
    ...
    public void MinresQLPNeverFalseConvergesOnCompatibleRosser()
    {
        ...
        int n = A.M_Rows;
        var z = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 143005);
        var b = new floatN(n, Allocator.Temp);
    ...
    public void MinresQLPSolvesSingularDiagLeastSquaresToMinLengthOracle()
    {
        ...
        if (info.Solved)
        {
            ...
            var Ar = new floatN(n, Allocator.Temp);
            op.Apply(in r, ref Ar);
            double arnorm = math.sqrt((double)Blas.dot(Ar, Ar));
    ...
    public void MinresQLPLargeBWellConditionedLargeXIsNotClamped()
    {
        ...
        var xStar = GenerateOP.floatRandomVec(n, (float)(-1e5f), (float)1e5f, 147002);
        var b = new floatN(n, Allocator.Temp);
    ...
    public void MinresQLPStillConvergesHonestlyOnWellConditioned()
    {
        ...
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 143002);
    ...
    {
        var A = floatGallery.floatRosser();            // 8x8 symmetric, clustered near-degenerate spectrum
        int n = A.M_Rows;
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 144003);
    ...
    public void MinresStillConvergesHonestlyOnWellConditioned()
    {
        ...
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 144002);
    ...
    public void BiCGStabNeverFalseConvergesOnRosser()
    {
        ...
        int n = A.M_Rows;
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 145003);
    ...
    public void BiCGStabStillConvergesHonestlyOnWellConditioned()
    {
        ...
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 145002);
    ...
    public void IdrNeverFalseConvergesOnRosser()
    {
        ...
        int n = A.M_Rows;
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 146003);
    ...
    public void IdrStillConvergesHonestlyOnWellConditioned()
    {
        ...
        var op = new floatDenseOperator(in A);
        var b = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 146002);
    ...
    public void BiCGStabVerifyContinueKeepsConvergingOnDrift()
    {
        ...
        var A = GenerateOP.floatRandomMat(n, n, (float)(-1f), (float)1f, 145011);
        for (int i = 0; i < n; i++) A[i, i] += (float)(0.5f * n);
        var op = new floatDenseOperator(in A);

        var xStar = GenerateOP.floatRandomVec(n, (float)(-1f), (float)1f, 145012);
        var b = new floatN(n, Allocator.Temp);
