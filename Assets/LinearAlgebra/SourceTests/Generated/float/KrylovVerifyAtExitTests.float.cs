...
public class floatKrylovVerifyAtExitTests
{
    ...
    public void MinresQLPWarmStartRecoversSolution()
    {
        ...
        var xStar = arena.floatRandomVec(n, (float)(-1f), (float)1f, 143012);   // known exact solution
        var b = arena.floatVec(n);
        ...
        var x0 = arena.floatRandomVec(n, (float)(-1f), (float)1f, 143013);
        var x = arena.floatVec(n);
