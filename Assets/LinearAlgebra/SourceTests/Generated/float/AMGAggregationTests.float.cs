...
public class floatAMGAggregationTests
{
    ...
    public struct AggregateTestJob : IJob
    {
        ...
        static floatBSR Chain(int nb, float offMag)
        {
            var b = new floatBSRBuilder(nb, nb, 1, 1, Allocator.Temp, 3 * nb);
            for (int i = 0; i < nb; i++)
            {
        ...
        {
            int nb = 8;
            var b = new floatBSRBuilder(nb, nb, 1, 1, Allocator.Temp, nb);
        ...
        {
            int nb = 10;
            var A = Chain(nb, (float)0.01);   // off-diagonals tiny vs diagonal 2
            var aggId = new Indices(nb, Allocator.Temp);
