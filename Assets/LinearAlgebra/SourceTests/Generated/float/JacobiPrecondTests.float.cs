...
public class floatJacobiPrecondTests
{
    ...
    public struct JacobiPrecondTestJob : IJob
    {
        ...
        static floatBSM DenseToBSM(ref Arena arena, in floatMxN A, int BR, int BC, int nnzHint)
        {
            var builder = arena.floatBSMBuilder(A.M_Rows / BR, A.N_Cols / BC, BR, BC, math.max(nnzHint, 1));
    ...
    public void ColumnNormsSquaredBSMSymmetricThrows()
    {
        ...
        var s = arena.floatBSMBuilder(3, 3, 1, 1, 3);
