...
public class floatHashTests
{
    ...
    public struct HashTestJob : IJob
    {
        ...
        {
            var v2 = new floatN(2, Allocator.Temp);
            v2[0] = (float)1f; v2[1] = (float)2f;

            var v3 = new floatN(3, Allocator.Temp);
        ...
        {
            var e = new floatN(0, Allocator.Temp);
        ...
        void RowHashesConsistency()
        {
            ...
            var row = new floatN(A.N_Cols, Allocator.Temp);
        ...
        void ColHashesConsistency()
        {
            ...
            var col = new floatN(A.M_Rows, Allocator.Temp);
            for (int c = 0; c < A.N_Cols; c++)
            {
                for (int r = 0; r < A.M_Rows; r++)
                    col[r] = A[r, c];
    ...
    {
        var A = new floatMxN(4, 0, Allocator.Temp); // 4 rows, 0 cols
    ...
    {
        var A = new floatMxN(0, 4, Allocator.Temp); // 0 rows, 4 cols
