...
public class floatTransformsTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void ClampVector()
        {
            ...
            floatComp.clampInPlace(in v, (float)(-1f), (float)4f);
            AssertClose(v[0], (float)(-1f), (float)EPS);
            AssertClose(v[1], (float)(-1f), (float)EPS);
        ...
        void ClampMatrix()
        {
            ...
            floatComp.clampInPlace(in A, (float)0f, (float)1f);
    ...
    public void ClampLoGreaterThanHiThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => floatComp.clampInPlace(in v, (float)4f, (float)(-1f)));
        arena.Dispose();
    }
}
