...
public class floatTransformsTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            var A = GenerateOP.floatRandomMat(4, 5, -3f, 3f, 12345);
        ...
        {
            var A = GenerateOP.floatRandomMat(5, 4, -3f, 3f, 67890);
        ...
        {
            var a = new floatN(5, Allocator.Temp);
        ...
        void RescaleRows()
        {
            var A = GenerateOP.floatRandomMat(4, 5, -3f, 3f, 222);
        ...
        void RescaleColumns()
        {
            var A = GenerateOP.floatRandomMat(5, 4, -3f, 3f, 333);
            float lo = 1f, hi = 3f;
        ...
        void CenterRows()
        {
            var A = GenerateOP.floatRandomMat(4, 5, -5f, 5f, 444);
        ...
        void CenterColumns()
        {
            var A = GenerateOP.floatRandomMat(5, 4, -5f, 5f, 555);
        ...
        void MaxAbsRows()
        {
            var A = GenerateOP.floatRandomMat(4, 5, -3f, 3f, 666);
        ...
        void MaxAbsColumns()
        {
            var A = GenerateOP.floatRandomMat(5, 4, -3f, 3f, 777);
        ...
        void SoftmaxRows()
        {
            var A = GenerateOP.floatRandomMat(4, 5, -2f, 2f, 888);
        ...
        void SoftmaxColumns()
        {
            var A = GenerateOP.floatRandomMat(5, 4, -2f, 2f, 999);
        ...
        {
            var A = GenerateOP.floatRandomMat(4, 5, -3f, 3f, 1212);
        ...
        {
            var A = GenerateOP.floatRandomMat(5, 4, -3f, 3f, 3434);
        ...
        void NormalizeZeroRowColumn()
        {
            ...
            var B = new floatMxN(3, 3, Allocator.Temp);
