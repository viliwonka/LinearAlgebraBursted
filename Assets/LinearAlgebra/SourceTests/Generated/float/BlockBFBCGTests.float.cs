...
public class floatBlockBFBCGTests
{
    ...
    public struct BlockBFBCGTestJob : IJob
    {
        ...
        static floatMxN BuildStretchedSPD(int dim, uint seed, float condSpan)
        {
            ...
            var MtM = new floatMxN(dim, dim, Allocator.Temp);
        ...
        {
            int n = 20, s = 4;
            var A = floatKrylovBatteryOracles.BuildDenseSpdSystem(n, 88001u);
            var B = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 88002u);
        ...
        {
            int n = 20, s = 5;
            var A = floatKrylovBatteryOracles.BuildDenseSpdSystem(n, 88011u);
            var Xk = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 88012u);   // known solution
        ...
        {
            int n = 24, s = 5;
            var A = floatKrylovBatteryOracles.BuildDenseSpdSystem(n, 88021u);
            var B = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 88022u);
        ...
        {
            int n = 16, s = 4;
            var A = floatKrylovBatteryOracles.BuildDenseSpdSystem(n, 88031u);
            var Xk = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 88032u);
        ...
        {
            int n = 18, s = 3;
            var Adense = floatKrylovBatteryOracles.BuildDenseSpdSystem(n, 88041u);
            var A = floatKrylovBatteryOracles.DenseToBSR1x1(in Adense);
            var M = new floatBlockJacobi(in A, Allocator.Temp);
            var B = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 88042u);
        ...
        {
            int n = 16, s = 4;
            var A = floatKrylovBatteryOracles.BuildDenseSpdSystem(n, 88051u);
            var B = GenerateOP.floatRandomMat(s, n, (float)(-1f), (float)1f, 88052u);
            int maxIter = 8 * n;
            float tol = Consts.floatSqrtEps;
        ...
        void NeverWorseThanRidge()
        {
            ...
            var Xbf = new floatMxN(s, n, Allocator.Temp);
