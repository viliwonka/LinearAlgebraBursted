...
public class floatBlockTFQMRTests
{
    ...
    public struct BlockTfqmrTestJob : IJob
    {
        ...
        {
            var A = arena.floatRandomMat(n, n, (float)(-1f), (float)1f, seed);
        ...
        static bool BlockResidualDenseOK(ref Arena arena, in floatMxN A, in floatMxN X, in floatMxN B, int s, int n, float tol)
        {
        ...
        static bool BlockResidualBSROK(ref Arena arena, in floatBSR A, in floatMxN X, in floatMxN B, int s, int n, float tol)
        {
            var AX = arena.floatMat(s, n);
        ...
        void SolvesDenseNonsym()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F02u);
        ...
        void SolvesBSRNonsym()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F12u);
        ...
        void MatchesScalarTfqmrPerColumn()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F22u);
        ...
        void KnownSolutionRecovered()
        {
            ...
            var Xk = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F32u);   // known solution
        ...
        void IdentityFoldBitIdentical()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F42u);
            int maxIter = 30 * n;
            float tol = ResTol();
            ...
            var Rhat01 = arena.floatMat(s, n);
            var U1     = arena.floatMat(s, n);
            var W1     = arena.floatMat(s, n);
            var V1     = arena.floatMat(s, n);
            var AU1    = arena.floatMat(s, n);
            var D1     = arena.floatMat(s, n);
            var UHat1  = arena.floatMat(s, n);
            ...
            var Rhat02 = arena.floatMat(s, n);
            var U2     = arena.floatMat(s, n);
            var W2     = arena.floatMat(s, n);
            var V2     = arena.floatMat(s, n);
            var AU2    = arena.floatMat(s, n);
            var D2     = arena.floatMat(s, n);
        ...
        void DuplicateRHSRowsBitIdentical()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F52u);
        ...
        void MaxIterBudgetHonestStatus()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F62u);
        ...
        void PreconditionedILU0()
        {
            ...
            int n = 120, s = 3;
            var A = ConvDiff1D(ref arena, n);
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F82u);
        ...
        void ZeroRhsRowDoesNotBreakdownWholeSolve()
        {
            ...
            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F72u);
            for (int c = 0; c < n; c++) B[zeroRow, c] = (float)0;   // all-zero row (batch padding)
            ...
            for (int c = 0; c < n; c++)
                Assert.IsTrue(X[zeroRow, c] == (float)0);
        ...
        void WarmStartedExactRowDoesNotBreakdown()
        {
            ...
            var xk = arena.floatRandomVec(n, (float)(-1f), (float)1f, 0x1F82u);

            var B = arena.floatRandomMat(s, n, (float)(-1f), (float)1f, 0x1F83u);
            ...
            var X = arena.floatMat(s, n);                           // rows all zero ...
