// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/RollingWindowTests.fProxy.cs
...
public class floatRollingWindowTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            var w = new floatRollingWindow(3, 2, Allocator.Temp);
        ...
        static void Push1(ref floatRollingWindow w, float v)
        {
            var s = new floatN(1, Allocator.Temp);
            s[0] = v;
            w.Push(in s);
        }
        ...
        {
            var w = new floatRollingWindow(4, 2, Allocator.Temp);
        ...
        {
            var w = new floatRollingWindow(3, 1, Allocator.Temp);
        ...
        void AsMatrixTimeOrder()
        {
            ...
            var M = new floatMxN(w.Count, w.Features, Allocator.Temp);
            w.AsMatrix(ref M);
        ...
        void MovingAverage()
        {
            ...
            var m = new floatN(2, Allocator.Temp);
            w.Mean(ref m);
        ...
        void GetSampleAndIndexer()
        {
            ...
            var got = new floatN(2, Allocator.Temp);
    ...
    {
        public floatRollingWindow W;
        public floatN Sample;
    ...
    {
        var w = new floatRollingWindow(4, 2, Allocator.Persistent);
        var sample = new floatN(2, Allocator.Persistent);
        ...
        var mean = w.Mean();
        AssertCloseManaged(mean[0], (float)2, (float)1E-5f);
        AssertCloseManaged(mean[1], (float)2, (float)1E-5f);

        AssertCloseManaged(w[0, 0], (float)1, (float)1E-6f); AssertCloseManaged(w[0, 1], (float)1, (float)1E-6f); // oldest
        AssertCloseManaged(w[1, 0], (float)2, (float)1E-6f); AssertCloseManaged(w[1, 1], (float)2, (float)1E-6f);
        AssertCloseManaged(w[2, 0], (float)3, (float)1E-6f); AssertCloseManaged(w[2, 1], (float)3, (float)1E-6f); // newest
    ...
    public void CrossRunPushWrapAroundAcrossSeparateRunCalls()
    {
        ...
        AssertCloseManaged(w[0, 0], (float)2, (float)1E-6f); AssertCloseManaged(w[0, 1], (float)2, (float)1E-6f); // oldest retained (1 evicted)
        AssertCloseManaged(w[3, 0], (float)5, (float)1E-6f); AssertCloseManaged(w[3, 1], (float)5, (float)1E-6f); // newest

        var mean = w.Mean();
        AssertCloseManaged(mean[0], (float)3.5f, (float)1E-5f);
        AssertCloseManaged(mean[1], (float)3.5f, (float)1E-5f);
    ...
    static void AssertCloseManaged(float a, float b, float precision)
    {
        float diff = math.abs(a - b);
    ...
    {
        Assert.Throws<ArgumentException>(() => new floatRollingWindow(0, 2, Allocator.Temp));
        Assert.Throws<ArgumentException>(() => new floatRollingWindow(4, 0, Allocator.Temp));
    }

    [Test]
    public void PushWrongLengthThrows()
    {
        var w = new floatRollingWindow(4, 3, Allocator.Temp);
        var bad = new floatN(2, Allocator.Temp);
    ...
    public void AsMatrixWrongSizeThrows()
    {
        ...
        var wrong = new floatMxN(3, 2, Allocator.Temp); // Count is 2, not 3
