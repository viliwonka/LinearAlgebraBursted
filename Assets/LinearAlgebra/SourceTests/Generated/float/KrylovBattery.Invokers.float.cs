...
namespace LinearAlgebra
{
    ...
    /// family through -- same role as <see cref="IfloatLstsqSolverInvoker"/>, block-shaped like
    /// <see cref="IfloatBlockSolverInvoker"/>. Test infrastructure only. Spans both rectangular
    /// regimes: OVERDETERMINED (blsmr/bcgls, tall A, min-RESIDUAL) and UNDERDETERMINED (bcraig/bcraigmr,
    /// wide A, min-NORM). No TPre-generic overload (mirrors <see cref="IfloatLstsqSolverInvoker"/>: neither
    /// production solver has a preconditioned entry point) and no damp parameter (mirrors
    /// <see cref="IfloatBlockSolverInvoker"/>'s NeedsGeneralDenseOperator-free shape -- blsmr/bcgls have
    ...
    /// </summary>
    public interface IfloatBlockLstsqSolverInvoker
    {
        MatrixProfile Requires { get; }
        MatrixProfile Forbids { get; }
        float Tol { get; }
        ...
        BlockSolveInfo Solve<TOp>(in TOp A, in floatMxN B, ref floatMxN X, int maxIter)
            where TOp : struct, IfloatLinearOperator;
        ...
        IfloatLstsqSolverInvoker ScalarCounterpart();
    }
    ...
    public struct floatCgInvoker : IfloatSquareSolverInvoker
    {
        ...
        {
            r = new floatN(n, Allocator.Temp);
            p = new floatN(n, Allocator.Temp);
            Ap = new floatN(n, Allocator.Temp);
            z = new floatN(n, Allocator.Temp);
        }
    ...
    public struct floatFcgInvoker : IfloatSquareSolverInvoker
    {
        ...
        public void Init(int n)
        {
            ...
            Ap = new floatN(n, Allocator.Temp);
            z = new floatN(n, Allocator.Temp);
            rOld = new floatN(n, Allocator.Temp);
        }
    ...
    public struct floatMinresInvoker : IfloatSquareSolverInvoker
    {
        ...
        public void Init(int n)
        {
            y = new floatN(n, Allocator.Temp);
            r1 = new floatN(n, Allocator.Temp);
            r2 = new floatN(n, Allocator.Temp);
            v = new floatN(n, Allocator.Temp);
            w = new floatN(n, Allocator.Temp);
            w1 = new floatN(n, Allocator.Temp);
            w2 = new floatN(n, Allocator.Temp);
            z = new floatN(n, Allocator.Temp);
        }
    ...
    public struct floatMinresQLPInvoker : IfloatSquareSolverInvoker
    {
        ...
        public void Init(int n)
        {
            ...
            r1 = new floatN(n, Allocator.Temp);
            r2 = new floatN(n, Allocator.Temp);
            r3 = new floatN(n, Allocator.Temp);
            w = new floatN(n, Allocator.Temp);
            wl = new floatN(n, Allocator.Temp);
            wl2 = new floatN(n, Allocator.Temp);
            xl2 = new floatN(n, Allocator.Temp);
            t1 = new floatN(n, Allocator.Temp);
        }
    ...
    public struct floatBiCGStabInvoker : IfloatSquareSolverInvoker
    {
        ...
        {
            r = new floatN(n, Allocator.Temp);
            rHat0 = new floatN(n, Allocator.Temp);
            p = new floatN(n, Allocator.Temp);
            v = new floatN(n, Allocator.Temp);
            t = new floatN(n, Allocator.Temp);
            pHat = new floatN(n, Allocator.Temp);
            sHat = new floatN(n, Allocator.Temp);
        }
    ...
    public struct floatTfqmrInvoker : IfloatSquareSolverInvoker
    {
        ...
        {
            rHat0 = new floatN(n, Allocator.Temp);
            u = new floatN(n, Allocator.Temp);
            w = new floatN(n, Allocator.Temp);
            v = new floatN(n, Allocator.Temp);
            au = new floatN(n, Allocator.Temp);
            d = new floatN(n, Allocator.Temp);
            uHat = new floatN(n, Allocator.Temp);
        }
    ...
    public struct floatBcgInvoker : IfloatBlockSolverInvoker
    {
        ...
        {
            R = new floatMxN(s, n, Allocator.Temp);
            P = new floatMxN(s, n, Allocator.Temp);
            Q = new floatMxN(s, n, Allocator.Temp);
            Z = new floatMxN(s, n, Allocator.Temp);
        }
    ...
    public struct floatBcgrqInvoker : IfloatBlockSolverInvoker
    {
        ...
        public void Init(int n, int s)
        {
            R = new floatMxN(s, n, Allocator.Temp);
            P = new floatMxN(s, n, Allocator.Temp);
            AP = new floatMxN(s, n, Allocator.Temp);
            Pa = new floatMxN(s, n, Allocator.Temp);
            Z = new floatMxN(s, n, Allocator.Temp);
        }
    ...
    public struct floatBminresInvoker : IfloatBlockSolverInvoker
    {
        ...
        public void Init(int n, int s)
        {
            Vprev = new floatMxN(s, n, Allocator.Temp);
            Vcur = new floatMxN(s, n, Allocator.Temp);
            Wk = new floatMxN(s, n, Allocator.Temp);
            W = new floatMxN(s, n, Allocator.Temp);
            W1 = new floatMxN(s, n, Allocator.Temp);
            W2 = new floatMxN(s, n, Allocator.Temp);
            Z = new floatMxN(s, n, Allocator.Temp);
        }
    ...
    public struct floatBbiCGStabInvoker : IfloatBlockSolverInvoker
    {
        ...
        {
            R = new floatMxN(s, n, Allocator.Temp);
            Rhat0 = new floatMxN(s, n, Allocator.Temp);
            P = new floatMxN(s, n, Allocator.Temp);
            V = new floatMxN(s, n, Allocator.Temp);
            T = new floatMxN(s, n, Allocator.Temp);
            Phat = new floatMxN(s, n, Allocator.Temp);
            Shat = new floatMxN(s, n, Allocator.Temp);
        }
    ...
    /// <summary>
    /// <see cref="IfloatBlockSolverInvoker"/> for <see cref="Krylov.bidr{TOp, TPre}"/> -- true block
    ...
    /// cref="Init"/> is a no-op (mirrors <see cref="floatIdrInvoker"/>). <see cref="S"/>/<see
    ...
    /// </summary>
    public struct floatBidrInvoker : IfloatBlockSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        public int S;
        ...
        public IfloatSquareSolverInvoker ScalarCounterpart() => new floatIdrInvoker { TolValue = TolValue, MaxIterMul = MaxIterMul, S = S, Seed = Seed };
    }
    ...
    /// <summary>
    /// <see cref="IfloatBlockSolverInvoker"/> for <see cref="Krylov.bgcrodr{TOp, TPre}"/> -- block
    ...
    /// as <see cref="floatBgmresInvoker"/> (including <see cref="NeedsGeneralDenseOperator"/> and the
    /// IllConditioned exclusion -- it shares bgmres's block Arnoldi/Hessenberg machinery, same
    /// rationale). <see cref="ScalarCounterpart"/> is <see cref="floatGcrodrInvoker"/> (same recycled-
    /// subspace family, not plain gmres).
    /// </summary>
    public struct floatBgcrodrInvoker : IfloatBlockSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        public int Restart;
        ...
        public IfloatSquareSolverInvoker ScalarCounterpart() => new floatGcrodrInvoker { TolValue = TolValue, MaxIterMul = MaxIterMul, Restart = Restart, Recycle = Recycle };
    }

    /// <summary>
    /// <see cref="IfloatBlockSolverInvoker"/> for <see cref="Krylov.bfgmres{TOp, TPre}"/> -- restarted
    ...
    /// <see cref="floatBgmresInvoker"/> (including <see cref="NeedsGeneralDenseOperator"/> and the
    ...
    /// </summary>
    public struct floatBfgmresInvoker : IfloatBlockSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        public int Restart;
    ...
    public struct floatBtfqmrInvoker : IfloatBlockSolverInvoker
    {
        ...
        {
            Rhat0 = new floatMxN(s, n, Allocator.Temp);
            U = new floatMxN(s, n, Allocator.Temp);
            W = new floatMxN(s, n, Allocator.Temp);
            V = new floatMxN(s, n, Allocator.Temp);
            AU = new floatMxN(s, n, Allocator.Temp);
            D = new floatMxN(s, n, Allocator.Temp);
            UHat = new floatMxN(s, n, Allocator.Temp);
        }
    ...
    /// <summary>
    /// <see cref="IfloatLstsqSolverInvoker"/> for <see cref="Krylov.lsqr{TOp}"/> -- least-squares
    ...
    /// </summary>
    public struct floatLsqrInvoker : IfloatLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;

        floatN u, v, w, tmpM, tmpN;
        ...
        {
            u = new floatN(rows, Allocator.Temp);
            v = new floatN(cols, Allocator.Temp);
            w = new floatN(cols, Allocator.Temp);
            tmpM = new floatN(rows, Allocator.Temp);
            tmpN = new floatN(cols, Allocator.Temp);
        }
    ...
    /// <summary>
    /// <see cref="IfloatLstsqSolverInvoker"/> for <see cref="Krylov.lsmr{TOp}"/> -- LSMR
    ...
    /// zero-alloc primitive needs (one more than <see cref="floatLsqrInvoker"/> -- the
    /// MINRES-folded direction hbar). Same Requires/Forbids as floatLsqrInvoker.
    /// </summary>
    public struct floatLsmrInvoker : IfloatLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;

        floatN u, v, h, hbar, tmpM, tmpN;
        ...
        public void Init(int rows, int cols)
        {
            u = new floatN(rows, Allocator.Temp);
            v = new floatN(cols, Allocator.Temp);
            h = new floatN(cols, Allocator.Temp);
            hbar = new floatN(cols, Allocator.Temp);
            tmpM = new floatN(rows, Allocator.Temp);
            tmpN = new floatN(cols, Allocator.Temp);
        }
    ...
    /// <summary>
    /// <see cref="IfloatLstsqSolverInvoker"/> for <see cref="Krylov.craig{TOp}"/> -- least-NORM
    ...
    /// <see cref="floatLsqrInvoker"/>).
    /// </summary>
    public struct floatCraigInvoker : IfloatLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
    ...
    /// finds the minimum-‖x‖ one -- the SAME x <see cref="floatCraigInvoker"/> computes, but via a
    ...
    ///
    /// TolValue is set an order of magnitude TIGHTER than <see cref="floatCraigInvoker"/>'s in the
    ...
    /// </summary>
    public struct floatCgneInvoker : IfloatLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        ...
        public void Init(int rows, int cols)
        {
            r = new floatN(rows, Allocator.Temp);
            p = new floatN(cols, Allocator.Temp);
            Ap = new floatN(rows, Allocator.Temp);
            tmpN = new floatN(cols, Allocator.Temp);
        }
    ...
    /// <summary>
    /// <see cref="IfloatLstsqSolverInvoker"/> for <see cref="Krylov.craigmr{TOp}"/> -- MINRES-
    ...
    /// <see cref="floatCraigInvoker"/> -- the running-QR direction d). damp is ignored, same
    /// rationale as floatCraigInvoker.
    /// </summary>
    public struct floatCraigmrInvoker : IfloatLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;

        floatN u, v, d, tmpM, tmpN;
        ...
        public void Init(int rows, int cols)
        {
            u = new floatN(rows, Allocator.Temp);
            v = new floatN(cols, Allocator.Temp);
            d = new floatN(cols, Allocator.Temp);
            tmpM = new floatN(rows, Allocator.Temp);
            tmpN = new floatN(cols, Allocator.Temp);
        }
    ...
    /// <summary>
    /// <see cref="IfloatBlockLstsqSolverInvoker"/> for <see cref="Krylov.blsmr{TOp}"/> -- block LSMR
    ...
    /// from Allocator.Temp, mirroring <see cref="floatGmresInvoker"/>), so <see cref="Init"/> is a
    /// no-op. <see cref="ScalarCounterpart"/> is <see cref="floatLsmrInvoker"/> -- blsmr solves the
    /// same least-squares problem lsmr does, one column at a time.
    /// </summary>
    public struct floatBlsmrInvoker : IfloatBlockLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        ...
        public BlockSolveInfo Solve<TOp>(in TOp A, in floatMxN B, ref floatMxN X, int maxIter)
            where TOp : struct, IfloatLinearOperator
            => Krylov.blsmr(in A, in B, ref X, maxIter, Tol);

        public IfloatLstsqSolverInvoker ScalarCounterpart() => new floatLsmrInvoker { TolValue = TolValue, MaxIterMul = MaxIterMul };
    }

    /// <summary>
    /// <see cref="IfloatBlockLstsqSolverInvoker"/> for <see cref="Krylov.bcgls{TOp}"/> -- block CGLS
    ...
    /// no-op. Same <see cref="ScalarCounterpart"/> as <see cref="floatBlsmrInvoker"/> -- same
    ...
    /// </summary>
    public struct floatBcglsInvoker : IfloatBlockLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
    ...
    /// <summary>
    /// <see cref="IfloatBlockLstsqSolverInvoker"/> for <see cref="Krylov.bcraig{TOp}"/> -- block CRAIG
    ...
    /// Euclidean-norm one. Block min-NORM counterpart to <see cref="floatBlsmrInvoker"/>/
    /// <see cref="floatBcglsInvoker"/> (which are OVERDETERMINED / min-RESIDUAL) -- exactly the block
    /// analog of what <see cref="floatCraigInvoker"/> is to <see cref="floatLsmrInvoker"/>. Owns no
    /// scratch (bcraig allocates its whole workspace from Allocator.Temp, mirroring
    /// <see cref="floatBlsmrInvoker"/>), so <see cref="Init"/> is a no-op. <see cref="ScalarCounterpart"/>
    /// is <see cref="floatCraigInvoker"/> -- bcraig finds the same minimum-norm solution craig does, one
    /// column at a time. Requires Underdetermined and Forbids RankDeficient, mirroring
    /// <see cref="floatCraigInvoker"/>.
    /// </summary>
    public struct floatBcraigInvoker : IfloatBlockLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        ...
        public IfloatLstsqSolverInvoker ScalarCounterpart() => new floatCraigInvoker { TolValue = TolValue, MaxIterMul = MaxIterMul };
    }

    /// <summary>
    /// <see cref="IfloatBlockLstsqSolverInvoker"/> for <see cref="Krylov.bcraigmr{TOp}"/> -- block
    ...
    /// cref="floatBcraigInvoker"/> (Requires Underdetermined, Forbids RankDeficient) -- bcraigmr finds
    ...
    /// Allocator.Temp, mirroring <see cref="floatBcraigInvoker"/>), so <see cref="Init"/> is a no-op.
    /// <see cref="ScalarCounterpart"/> is <see cref="floatCraigmrInvoker"/> -- bcraigmr reduces to
    /// scalar craigmr one column at a time, not to plain craig.
    /// </summary>
    public struct floatBcraigmrInvoker : IfloatBlockLstsqSolverInvoker
    {
        public float TolValue;
        public int MaxIterMul;
        ...
        public IfloatLstsqSolverInvoker ScalarCounterpart() => new floatCraigmrInvoker { TolValue = TolValue, MaxIterMul = MaxIterMul };
    }
}
