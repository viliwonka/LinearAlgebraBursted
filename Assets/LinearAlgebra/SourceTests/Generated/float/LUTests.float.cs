    ...
    public struct TestJob : IJob
    {
        ...
        public void LUDecompSingular()
        {
            ...
            // Case 1: zero matrix is singular -> all variants must return false.
            {
                ...
                var Lp = arena.floatIdentityMatrix(dim);
                var pivot = new Pivot(dim, Allocator.Temp);
            ...
            {
                var U = arena.floatRandomMatrix(dim, dim, 1f, 10f, 8821);
            ...
            // but inplace (with partial pivoting) succeeds.
            {
                ...
                var L = arena.floatIdentityMatrix(2);
        ...
        public void LUDeterminant()
        {
            ...
            {
                int dim = 6;
                var I = arena.floatIdentityMatrix(dim);
                var pivot = new Pivot(dim, Allocator.Temp);
        ...
        public void LUReusePivot()
        {
            ...
            var A1 = arena.floatRandomMatrix(dim, dim, -5f, 5f, 7777);
            for (int d = 0; d < dim; d++)
                A1[d, d] += 15f;
            var LU1 = A1.Copy();
            ...
            var A2 = arena.floatRandomMatrix(dim, dim, -5f, 5f, 9999);
            for (int d = 0; d < dim; d++)
                A2[d, d] += 15f;
        ...
        {
            floatMxN shouldBeZero = A - float_OP.dot(L, U);
