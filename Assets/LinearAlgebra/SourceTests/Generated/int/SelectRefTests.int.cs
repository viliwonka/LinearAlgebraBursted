...
public class intSelectRefTests
{
    ...
    public struct SelectRefTestJob : IJob
    {
        ...
        void VecCond()
        {
            ...
            var a = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 11111);
            var b = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 22222);
        ...
        void MatCond()
        {
            ...
            var a = GenerateOP.intRandomMat(M, N, (int)(-100), (int)100, 44444);
            var b = GenerateOP.intRandomMat(M, N, (int)(-100), (int)100, 55555);
        ...
        void VecScalarTrue()
        {
            ...
            var a = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 77777);
            var b = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 88888);
        ...
        void VecScalarFalse()
        {
            ...
            var a = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 99999);
            var b = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 10101);
        ...
        void MatScalarTrue()
        {
            ...
            var a = GenerateOP.intRandomMat(M, N, (int)(-100), (int)100, 20202);
            var b = GenerateOP.intRandomMat(M, N, (int)(-100), (int)100, 30303);
        ...
        void MatScalarFalse()
        {
            ...
            var a = GenerateOP.intRandomMat(M, N, (int)(-100), (int)100, 40404);
            var b = GenerateOP.intRandomMat(M, N, (int)(-100), (int)100, 50505);
        ...
        void VecAliasDest()
        {
            ...
            var a = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 60606);
            var b = GenerateOP.intRandomVec(N, (int)(-100), (int)100, 70707);
            var c = GenerateOP.boolRandomVec(N, 80808);

            // Reference into a SEPARATE buffer before a is overwritten.
            var R = new intN(N, Allocator.Temp);
