...
public class intHashTests
{
    ...
    public struct HashTestJob : IJob
    {
        ...
        void RowHashesConsistency()
        {
            ...
            var row = new intN(A.N_Cols, Allocator.Temp);
        ...
        void ColHashesConsistency()
        {
            ...
            var col = new intN(A.M_Rows, Allocator.Temp);
            for (int c = 0; c < A.N_Cols; c++)
            {
                for (int r = 0; r < A.M_Rows; r++)
                    col[r] = A[r, c];
    ...
    {
        var A = new intMxN(3, 4, Allocator.Temp);
        for (int r = 0; r < 3; r++)
            for (int c = 0; c < 4; c++)
                A[r, c] = (int)(r + c);
    ...
    {
        var A = new intMxN(4, 0, Allocator.Temp);
    ...
    {
        var A = new intMxN(0, 4, Allocator.Temp);
