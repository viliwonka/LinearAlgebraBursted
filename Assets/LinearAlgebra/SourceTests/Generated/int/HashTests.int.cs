...
// Property tests for the integer Hash surface (int / short / long / uint) over intN / intMxN.
...
public class intHashTests
{
    ...
    public struct HashTestJob : IJob
    {
        ...
        intN MakeVec(ref Arena arena, int n)
        {
        ...
        intMxN MakeMat(ref Arena arena, int m, int n)
        {
            var A = arena.intMat(m, n);
            for (int r = 0; r < m; r++)
                for (int c = 0; c < n; c++)
                    A[r, c] = (int)((r * 7 + c * 2 + 1) % 50);
            return A;
        }
        ...
        void AvalancheElement(ref Arena arena)
        {
            ...
            v[3] = (int)(v[3] + (int)1); // perturb one element (cast: short+short widens to int)
        ...
        void LengthSensitivity(ref Arena arena)
        {
            ...
            v2[0] = (int)1; v2[1] = (int)2;

            var v3 = arena.intVec(3);
            v3[0] = (int)1; v3[1] = (int)2; v3[2] = (int)0;
