...
// Tests for the integer uniform-refill core (intRandomOP.nextUniformInpl), expanded to
...
public class intRandomTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RangeVector()
        {
            ...
            intRandomOP.nextUniformInpl(ref rng, ref v, min, max);
        ...
        void ConstantFillNoAdvance()
        {
            ...
            intRandomOP.nextUniformInpl(ref rng, ref v, c, c);
        ...
        void Determinism()
        {
            ...
            intRandomOP.nextUniformInpl(ref r1, ref v1, min, max);

            var r2 = new Random(55u);
            var v2 = arena.intVec(256);
            intRandomOP.nextUniformInpl(ref r2, ref v2, min, max);
        ...
        void StreamAdvance()
        {
            ...
            intRandomOP.nextUniformInpl(ref rng, ref v1, min, max);
            var v2 = arena.intVec(n);
            intRandomOP.nextUniformInpl(ref rng, ref v2, min, max);
            ...
            intRandomOP.nextUniformInpl(ref rng3, ref v3, min, max);
            for (int i = 0; i < n; i++)
        ...
        void EmptyAndSingle()
        {
            ...
            intRandomOP.nextUniformInpl(ref rng, ref empty, (int)(-2), (int)2);
            AssertTrue(empty.N == 0);

            int min = (int)5, max = (int)6;   // {5}
            var one = arena.intVec(1);
            intRandomOP.nextUniformInpl(ref rng, ref one, min, max);
            AssertTrue(one.N == 1);
        ...
        void MatrixRange()
        {
            ...
            intRandomOP.nextUniformInpl(ref rng, ref M, min, max);
        ...
        void MatrixConstant()
        {
            ...
            uint before = rng.state;
            intRandomOP.nextUniformInpl(ref rng, ref M, c, c);
            uint after = rng.state;
    ...
    public void NextUniformInplMinGreaterMaxThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => intRandomOP.nextUniformInpl(ref rng, ref v, (int)5, (int)1));

        var M = arena.intMat(3, 3);
        Assert.Throws<ArgumentException>(() => intRandomOP.nextUniformInpl(ref rng, ref M, (int)5, (int)1));
