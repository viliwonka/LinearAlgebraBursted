...
public class intQueryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void ArgMaxMinAbsVector()
        {
            ...
            intQueryOP.argMaxAbs(in v, out int maxVal, out int maxIdx);
            AssertEqI(maxIdx, 1);                  // first of the two |5| entries
            AssertEqV(maxVal, (int)5);

            intQueryOP.argMinAbs(in v, out int minVal, out int minIdx);
            ...
            one[0] = (int)(-7);
            intQueryOP.argMaxAbs(in one, out int ov, out int oi);
            AssertEqI(oi, 0);
            AssertEqV(ov, (int)7);
        ...
        void ArgMaxMinAbsMatrix()
        {
            ...
            intQueryOP.argMaxAbs(in A, out int maxVal, out int maxIdx);
            AssertEqI(maxIdx, 4);                  // (r,c) = (4/3, 4%3) = (1,1)
            AssertEqV(maxVal, (int)4);

            // minAbs is the 0 at flat 3 (r1,c0).
            intQueryOP.argMinAbs(in A, out int minVal, out int minIdx);
        ...
        void RowColArgMinMax()
        {
            ...
            int nr = intQueryOP.rowArgMin(in A, ref idxR, ref valR);
            AssertEqI(nr, 3);
            ...
            intQueryOP.rowArgMin(in A, ref idxR2);
            AssertEqI(idxR2[0], 1); AssertEqI(idxR2[1], 1); AssertEqI(idxR2[2], 0);

            intQueryOP.rowArgMax(in A, ref idxR, ref valR);
            ...
            intQueryOP.rowArgMax(in A, ref idxR3);
            ...
            int nc = intQueryOP.colArgMin(in A, ref idxC, ref valC);
            AssertEqI(nc, 3);
            ...
            intQueryOP.colArgMin(in A, ref idxC2);
            AssertEqI(idxC2[0], 2); AssertEqI(idxC2[1], 0); AssertEqI(idxC2[2], 0);

            intQueryOP.colArgMax(in A, ref idxC, ref valC);
            ...
            intQueryOP.colArgMax(in A, ref idxC3);
        ...
        void ColArgStrided()
        {
            ...
            intQueryOP.colArgMin(in A, ref idxC, ref valC);
        ...
        void ArgMaxRowNorm()
        {
            ...
            AssertEqI(intQueryOP.argMaxRowNorm(in A, Norm.L1), 2);
            AssertEqI(intQueryOP.argMaxRowNorm(in A, Norm.Linf), 0);
            ...
            AssertEqI(intQueryOP.argMaxRowNorm(in T, Norm.L1), 0);
        ...
        void ArgMaxColNorm()
        {
            ...
            AssertEqI(intQueryOP.argMaxColNorm(in A, Norm.L1), 0);
            AssertEqI(intQueryOP.argMaxColNorm(in A, Norm.Linf), 2);
        ...
        void DistancesToRowAllMetrics()
        {
            ...
            intQueryOP.distancesToRow(in A, in q, Metric.Manhattan, ref d);
            AssertEqV(d[0], (int)7); AssertEqV(d[1], (int)1);

            // SqEuclidean (unsquared, no sqrt): 25 ; 1
            intQueryOP.distancesToRow(in A, in q, Metric.SqEuclidean, ref d);
            AssertEqV(d[0], (int)25); AssertEqV(d[1], (int)1);

            // Chebyshev: max(3,4)=4 ; max(1,0)=1
            intQueryOP.distancesToRow(in A, in q, Metric.Chebyshev, ref d);
            AssertEqV(d[0], (int)4); AssertEqV(d[1], (int)1);

            // Dot with q=(0,0) is 0 for every row.
            intQueryOP.distancesToRow(in A, in q, Metric.Dot, ref d);
            ...
            intQueryOP.distancesToRow(in A, in q2, Metric.Dot, ref d);
        ...
        void DistancesToColumnAllMetrics()
        {
            ...
            // Manhattan: c0=4, c1=4
            intQueryOP.distancesToColumn(in A, in q, Metric.Manhattan, ref d);
            AssertEqV(d[0], (int)4); AssertEqV(d[1], (int)4);

            // SqEuclidean: c0 = 9+1 = 10 ; c1 = 16+0 = 16
            intQueryOP.distancesToColumn(in A, in q, Metric.SqEuclidean, ref d);
            AssertEqV(d[0], (int)10); AssertEqV(d[1], (int)16);

            // Chebyshev: c0=max(3,1)=3 ; c1=max(4,0)=4
            intQueryOP.distancesToColumn(in A, in q, Metric.Chebyshev, ref d);
            AssertEqV(d[0], (int)3); AssertEqV(d[1], (int)4);

            // Dot with q=(0,0) is 0 for every column.
            intQueryOP.distancesToColumn(in A, in q, Metric.Dot, ref d);
            AssertEqV(d[0], (int)0); AssertEqV(d[1], (int)0);
        ...
        void NearestFarthestDistance()
        {
            ...
            intQueryOP.nearestRow(in A, in q, Metric.SqEuclidean, out int ni, out int ns);
            AssertEqI(ni, 0); AssertEqV(ns, (int)0);

            intQueryOP.farthestRow(in A, in q, Metric.SqEuclidean, out int fi, out int fs);
            AssertEqI(fi, 1); AssertEqV(fs, (int)25);

            // Manhattan: distances 0, 7, 2. nearest=r0, farthest=r1 (score 7).
            intQueryOP.nearestRow(in A, in q, Metric.Manhattan, out int ni2, out int ns2);
            AssertEqI(ni2, 0); AssertEqV(ns2, (int)0);
            intQueryOP.farthestRow(in A, in q, Metric.Manhattan, out int fi2, out int fs2);
        ...
        void NearestFarthestSimilarity()
        {
            ...
            intQueryOP.nearestRow(in A, in q, Metric.Dot, out int ni, out int ns);
            AssertEqI(ni, 1); AssertEqV(ns, (int)10);

            intQueryOP.farthestRow(in A, in q, Metric.Dot, out int fi, out int fs);
            ...
            intQueryOP.nearestColumn(in A, in q3, Metric.Dot, out int cni, out int cns);
            AssertEqI(cni, 0); AssertEqV(cns, (int)1);
            intQueryOP.farthestColumn(in A, in q3, Metric.Dot, out int cfi, out int cfs);
        ...
        void KNearestBruteForce()
        {
            ...
            int cnt = intQueryOP.kNearestRows(in A, in q, k, Metric.SqEuclidean, ref idx, ref scores);
            AssertEqI(cnt, k);

            var all = arena.intVec(M);
            intQueryOP.distancesToRow(in A, in q, Metric.SqEuclidean, ref all);
            ...
            int cnt2 = intQueryOP.kNearestRows(in A, in q, k, Metric.Dot, ref idx2, ref scores2);
            AssertEqI(cnt2, k);
            var allDot = arena.intVec(M);
            intQueryOP.distancesToRow(in A, in q, Metric.Dot, ref allDot);
            ...
            int cntC = intQueryOP.kNearestColumns(in A, in qc, kc, Metric.SqEuclidean, ref idxC, ref scoresC);
            AssertEqI(cntC, kc);
            var allC = arena.intVec(N);
            intQueryOP.distancesToColumn(in A, in qc, Metric.SqEuclidean, ref allC);
        ...
        void KNearestClampAndZero()
        {
            ...
            int z = intQueryOP.kNearestRows(in A, in q, 0, Metric.SqEuclidean, ref idx, ref scores);
            AssertEqI(z, 0);
        ...
        void KFarthest()
        {
            ...
            var idx = arena.Indices(k);
            var scores = arena.intVec(k);
            int cnt = intQueryOP.kFarthestRows(in A, in q, k, Metric.SqEuclidean, ref idx, ref scores);
            AssertEqI(cnt, k);
            ...
            var idxC = arena.Indices(kc);
            var scoresC = arena.intVec(kc);
            int cntC = intQueryOP.kFarthestColumns(in A, in qc, kc, Metric.SqEuclidean, ref idxC, ref scoresC);
            AssertEqI(cntC, kc);
            var allC = arena.intVec(N);
            intQueryOP.distancesToColumn(in A, in qc, Metric.SqEuclidean, ref allC);
        ...
        void WithinRadiusBoundary()
        {
            ...
            int cnt = intQueryOP.rowsWithinRadius(in A, in q, (int)25, Metric.SqEuclidean, ref idx);
            int ccnt = intQueryOP.countWithinRadius(in A, in q, (int)25, Metric.SqEuclidean);
            AssertEqI(cnt, 3); AssertEqI(ccnt, 3);
            AssertEqI(idx[0], 0); AssertEqI(idx[1], 1); AssertEqI(idx[2], 2);

            // radius 24 -> r1 (distance 25) excluded.
            int cnt2 = intQueryOP.rowsWithinRadius(in A, in q, (int)24, Metric.SqEuclidean, ref idx);
            AssertEqI(cnt2, 2);
            AssertEqI(idx[0], 0); AssertEqI(idx[1], 2);
            AssertEqI(intQueryOP.countWithinRadius(in A, in q, (int)24, Metric.SqEuclidean), 2);
            ...
            int cnt3 = intQueryOP.rowsWithinRadius(in A, in q2, (int)1, Metric.Dot, ref idx);
            AssertEqI(cnt3, 2);
            AssertEqI(idx[0], 1); AssertEqI(idx[1], 2);
            AssertEqI(intQueryOP.countWithinRadius(in A, in q2, (int)1, Metric.Dot), 2);
            ...
            var idxc = arena.Indices(2);
            int ccol = intQueryOP.columnsWithinRadius(in A, in qcol, (int)10, Metric.SqEuclidean, ref idxc);
            AssertEqI(ccol, 1); AssertEqI(idxc[0], 0);
            AssertEqI(intQueryOP.countWithinColumnRadius(in A, in qcol, (int)10, Metric.SqEuclidean), 1);
        ...
        void FindValue()
        {
            ...
            AssertEqI(intQueryOP.findValue(in v, (int)2, (int)0), 1);
            // absent -> -1
            AssertEqI(intQueryOP.findValue(in v, (int)9, (int)0), -1);
            // integer tol: target 4, tol 1 -> first element with |x-4| <= 1 is the 3 at index 3.
            AssertEqI(intQueryOP.findValue(in v, (int)4, (int)1), 3);
            // tol 0 of an absent target -> no match.
            AssertEqI(intQueryOP.findValue(in v, (int)4, (int)0), -1);

            // matrix overload (flat index). 2x2 = [5, 6; 7, 6]; first 6 at flat 1.
            var A = arena.intMat(2, 2);
            A[0, 0] = (int)5; A[0, 1] = (int)6;
            A[1, 0] = (int)7; A[1, 1] = (int)6;
            AssertEqI(intQueryOP.findValue(in A, (int)6, (int)0), 1);
        ...
        void NonzeroCountNonzero()
        {
            ...
            AssertEqI(intQueryOP.countNonzero(in v, (int)0), 3);
            var idx = arena.Indices(6);
            int c = intQueryOP.nonzero(in v, (int)0, ref idx);
            AssertEqI(c, 3);
            AssertEqI(idx[0], 1); AssertEqI(idx[1], 3); AssertEqI(idx[2], 4);

            // tol=1 (strict |x|>tol): |1| filtered out -> indices 1,3 -> count 2
            AssertEqI(intQueryOP.countNonzero(in v, (int)1), 2);
            int c2 = intQueryOP.nonzero(in v, (int)1, ref idx);
            AssertEqI(c2, 2);
            ...
            AssertEqI(intQueryOP.countNonzero(in A, (int)0), 1);
            var idxA = arena.Indices(4);
            int ca = intQueryOP.nonzero(in A, (int)0, ref idxA);
        ...
        void MinValueEdge()
        {
            ...
            intQueryOP.argMaxAbs(in v, out int mv, out int mi);
            AssertEqI(mi, 0);
            ...
            AssertEqI(intQueryOP.findValue(in v, (int)int.MinValue, (int)0), 0);
        ...
        void ArenaWrappers()
        {
            ...
            intQueryOP.distancesToRow(in A, in q, Metric.SqEuclidean, ref drRef);
            AssertEqI(dr.N, M);
            ...
            intQueryOP.distancesToColumn(in A, in qc, Metric.SqEuclidean, ref dcolRef);
            AssertEqI(dcol.N, N);
            ...
            int refCnt = intQueryOP.nonzero(in A, (int)0, ref refNz);
            ...
            int refRRcnt = intQueryOP.rowsWithinRadius(in A, in q, radius, Metric.SqEuclidean, ref refRR);
            ...
            int refCRcnt = intQueryOP.columnsWithinRadius(in A, in qc, (int)40, Metric.SqEuclidean, ref refCR);
            ...
            int refCntK = intQueryOP.kNearestRows(in A, in q, k, Metric.SqEuclidean, ref refIdxK, ref refScoresK);
            ...
            int refCntKC = intQueryOP.kNearestColumns(in A, in qc, k, Metric.SqEuclidean, ref refIdxKC, ref refScoresKC);
            ...
            int refCntKF = intQueryOP.kFarthestRows(in A, in q, k, Metric.SqEuclidean, ref refIdxKF, ref refScoresKF);
            ...
            int refCntKFC = intQueryOP.kFarthestColumns(in A, in qc, k, Metric.SqEuclidean, ref refIdxKFC, ref refScoresKFC);
    ...
    public void NormL2ThrowsTest()
    {
        ...
        Assert.Throws<ArgumentException>(() => intQueryOP.argMaxRowNorm(in A, Norm.L2));
        Assert.Throws<ArgumentException>(() => intQueryOP.argMaxColNorm(in A, Norm.L2));
        // L1 / Linf must NOT throw.
        Assert.DoesNotThrow(() => intQueryOP.argMaxRowNorm(in A, Norm.L1));
        Assert.DoesNotThrow(() => intQueryOP.argMaxColNorm(in A, Norm.Linf));
    ...
    public void MetricEuclideanCosineThrowTest()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.distancesToRow(in A, in q, Metric.Euclidean, ref dest));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.distancesToRow(in A, in q, Metric.Cosine, ref dest));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.nearestRow(in A, in q, Metric.Euclidean, out int _, out int _));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.farthestRow(in A, in q, Metric.Cosine, out int _, out int _));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.kNearestRows(in A, in q, 2, Metric.Euclidean, ref idx, ref scores));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.kFarthestRows(in A, in q, 2, Metric.Cosine, ref idx, ref scores));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.rowsWithinRadius(in A, in q, (int)1, Metric.Euclidean, ref idx));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.countWithinRadius(in A, in q, (int)1, Metric.Cosine));
    ...
    public void DimensionMismatchThrowTest()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.distancesToRow(in A, in qBadRow, Metric.SqEuclidean, ref destRow));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.nearestRow(in A, in qBadRow, Metric.SqEuclidean, out int _, out int _));

        var qBadCol = arena.intVec(4);         // wrong for col ops
        var destCol = arena.intVec(4);
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.distancesToColumn(in A, in qBadCol, Metric.SqEuclidean, ref destCol));
        Assert.Throws<ArgumentException>(() =>
            intQueryOP.countWithinColumnRadius(in A, in qBadCol, (int)1, Metric.SqEuclidean));
