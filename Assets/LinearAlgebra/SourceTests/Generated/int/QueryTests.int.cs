...
public class intQueryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RowColArgMinMax()
        {
            ...
            var valR = new intN(3, Allocator.Temp);
            ...
            var valC = new intN(3, Allocator.Temp);
        ...
        void ColArgStrided()
        {
            ...
            var A = new intMxN(4, 2, Allocator.Temp);
            ...
            var valC = new intN(2, Allocator.Temp);
        ...
        void ArgMaxRowNorm()
        {
            ...
            var T = new intMxN(2, 2, Allocator.Temp);
        ...
        void DistancesToRowAllMetrics()
        {
            ...
            var q = new intN(2, Allocator.Temp);
            q[0] = (int)0; q[1] = (int)0;

            var d = new intN(2, Allocator.Temp);
            ...
            var q2 = new intN(2, Allocator.Temp);
        ...
        void NearestFarthestDistance()
        {
            ...
            var A = new intMxN(3, 2, Allocator.Temp);
        ...
        void NearestFarthestSimilarity()
        {
            ...
            var q3 = new intN(3, Allocator.Temp);
        ...
        void KNearestBruteForce()
        {
            ...
            int M = 6, N = 3;
            var A = GenerateOP.intRandomMat(M, N, (int)(-3), (int)4, 424242);
            var q = new intN(N, Allocator.Temp);
            q[0] = (int)1; q[1] = (int)(-2); q[2] = (int)2;

            int k = 3;
            var idx = new Indices(k, Allocator.Temp);
            var scores = new intN(k, Allocator.Temp);
            ...
            var all = new intN(M, Allocator.Temp);
            ...
            var scores2 = new intN(k, Allocator.Temp);
            int cnt2 = Query.kNearestRows(in A, in q, k, Metric.Dot, ref idx2, ref scores2);
            AssertEqI(cnt2, k);
            var allDot = new intN(M, Allocator.Temp);
        ...
        {
            int M = 3, N = 2;
            var A = new intMxN(M, N, Allocator.Temp);
        ...
        {
            int M = 5, N = 2;
            var A = GenerateOP.intRandomMat(M, N, (int)(-2), (int)3, 99887);
            var q = new intN(N, Allocator.Temp);
            q[0] = (int)1; q[1] = (int)(-1);
        ...
        void WithinRadiusBoundary()
        {
            ...
            var qcol = new intN(3, Allocator.Temp);
        ...
        void ArenaWrappers()
        {
            ...
            int M = 6, N = 4;
            var A = GenerateOP.intRandomMat(M, N, (int)(-2), (int)3, 7777);
            var q = new intN(N, Allocator.Temp);
            for (int i = 0; i < N; i++) q[i] = (int)(i - 2);

            // --- intDistancesToRow / Column wrappers vs primitive ---
            var dr = Query.intDistancesToRow(in A, in q, Metric.SqEuclidean);
            var drRef = new intN(M, Allocator.Temp);
            ...
            var qc = new intN(M, Allocator.Temp);
            for (int i = 0; i < M; i++) qc[i] = (int)(i - 3);
            var dcol = Query.intDistancesToColumn(in A, in qc, Metric.SqEuclidean);
            var dcolRef = new intN(N, Allocator.Temp);
            ...
            var idxNz = Query.intNonzeroIndices(in A, (int)0);
            ...
            int radius = (int)20;
            var idxRR = Query.intRowsWithinRadius(in A, in q, radius, Metric.SqEuclidean);
            ...
            var idxCR = Query.intColumnsWithinRadius(in A, in qc, (int)40, Metric.SqEuclidean);
            ...
            int k = 3;
            var idxK = Query.intKNearestRows(in A, in q, k, Metric.SqEuclidean, out intN scoresK, out int cntK);
            var refIdxK = new Indices(k, Allocator.Temp);
            var refScoresK = new intN(k, Allocator.Temp);
            ...
            // --- intKNearestColumns ---
            var idxKC = Query.intKNearestColumns(in A, in qc, k, Metric.SqEuclidean, out intN scoresKC, out int cntKC);
            var refIdxKC = new Indices(k, Allocator.Temp);
            var refScoresKC = new intN(k, Allocator.Temp);
            ...
            var idxKF = Query.intKFarthestRows(in A, in q, k, Metric.SqEuclidean, out intN scoresKF, out int cntKF);
            var refIdxKF = new Indices(k, Allocator.Temp);
            var refScoresKF = new intN(k, Allocator.Temp);
            ...
            var idxKFC = Query.intKFarthestColumns(in A, in qc, k, Metric.SqEuclidean, out intN scoresKFC, out int cntKFC);
            var refIdxKFC = new Indices(k, Allocator.Temp);
            var refScoresKFC = new intN(k, Allocator.Temp);
    ...
    public void MetricEuclideanCosineThrowTest()
    {
        ...
        var q = new intN(2, Allocator.Temp);
        q[0] = (int)0; q[1] = (int)0;
        var dest = new intN(3, Allocator.Temp);
        var idx = new Indices(3, Allocator.Temp);
        var scores = new intN(2, Allocator.Temp);
    ...
    {
        var A = new intMxN(3, 4, Allocator.Temp);            // row ops need q.N == N_Cols == 4; col ops need q.N == M_Rows == 3
        var qBadRow = new intN(3, Allocator.Temp);         // wrong for row ops
        var destRow = new intN(3, Allocator.Temp);
        Assert.Throws<ArgumentException>(() =>
        ...
        var qBadCol = new intN(4, Allocator.Temp);         // wrong for col ops
        var destCol = new intN(4, Allocator.Temp);
        Assert.Throws<ArgumentException>(() =>
