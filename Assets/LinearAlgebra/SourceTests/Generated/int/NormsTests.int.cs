// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/iProxy/NormsTests.iProxy.cs
...
public class intNormsTests
{
    ...
    public struct NormsTestJob : IJob
    {
        ...
        void PythagoreanTriple()
        {
            ...
            var w = GenerateOP.intVec(2, (int)1);
        ...
        void Matrix()
        {
            var A = GenerateOP.intMat(2, 2, (int)0);
        ...
        void AllZero()
        {
            var v = GenerateOP.intVec(4, (int)0);
