...
public class intClampTests
{
    ...
    public struct ClampTestJob : IJob
    {
        ...
        void ClampVector()
        {
            ...
            int_OP.clampInpl(in v, (int)(-2), (int)5);
        ...
        void ClampMatrix()
        {
            ...
            int_OP.clampInpl(in A, (int)0, (int)10);
        ...
        void ClampNoOpInRange()
        {
            ...
            int_OP.clampInpl(in v, (int)0, (int)5);
            for (int i = 0; i < 4; i++)
    ...
    public void ClampLoGreaterThanHiThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => int_OP.clampInpl(in v, (int)6, (int)(-1)));
        arena.Dispose();
    }
}
