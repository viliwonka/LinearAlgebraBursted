...
public class doubleSelectRefTests
{
    ...
    public struct SelectRefTestJob : IJob
    {
        ...
        void VecCond()
        {
            ...
            var a = arena.doubleRandomVec(N, -1f, 1f, 11111);
        ...
        void MatCond()
        {
            ...
            var a = arena.doubleRandomMat(M, N, -1f, 1f, 44444);
            var b = arena.doubleRandomMat(M, N, -1f, 1f, 55555);
        ...
        void VecScalarTrue()
        {
            ...
            var a = arena.doubleRandomVec(N, -1f, 1f, 77777);
            var b = arena.doubleRandomVec(N, -1f, 1f, 88888);
        ...
        void VecScalarFalse()
        {
            ...
            var a = arena.doubleRandomVec(N, -1f, 1f, 99999);
            var b = arena.doubleRandomVec(N, -1f, 1f, 10101);
        ...
        void MatScalarTrue()
        {
            ...
            var b = arena.doubleRandomMat(M, N, -1f, 1f, 30303);
        ...
        void MatScalarFalse()
        {
            ...
            var a = arena.doubleRandomMat(M, N, -1f, 1f, 40404);
            var b = arena.doubleRandomMat(M, N, -1f, 1f, 50505);
        ...
        void VecAliasDest()
        {
            ...
            var a = arena.doubleRandomVec(N, -1f, 1f, 60606);
            var b = arena.doubleRandomVec(N, -1f, 1f, 70707);
