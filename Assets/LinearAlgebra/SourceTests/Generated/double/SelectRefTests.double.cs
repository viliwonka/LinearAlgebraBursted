...
public class doubleSelectRefTests
{
    [BurstCompile]
    public struct SelectRefTestJob : IJob
    {
        ...
        void VecCond()
        {
            ...
            var a = arena.doubleRandomVector(N, -1f, 1f, 11111);
        ...
        void MatCond()
        {
            ...
            var a = arena.doubleRandomMatrix(M, N, -1f, 1f, 44444);
            var b = arena.doubleRandomMatrix(M, N, -1f, 1f, 55555);
        ...
        void VecScalarTrue()
        {
            ...
            var a = arena.doubleRandomVector(N, -1f, 1f, 77777);
            var b = arena.doubleRandomVector(N, -1f, 1f, 88888);
        ...
        void VecScalarFalse()
        {
            ...
            var a = arena.doubleRandomVector(N, -1f, 1f, 99999);
            var b = arena.doubleRandomVector(N, -1f, 1f, 10101);
        ...
        void MatScalarTrue()
        {
            ...
            var b = arena.doubleRandomMatrix(M, N, -1f, 1f, 30303);
        ...
        void MatScalarFalse()
        {
            ...
            var a = arena.doubleRandomMatrix(M, N, -1f, 1f, 40404);
            var b = arena.doubleRandomMatrix(M, N, -1f, 1f, 50505);
        ...
        void VecAliasDest()
        {
            ...
            var a = arena.doubleRandomVector(N, -1f, 1f, 60606);
            var b = arena.doubleRandomVector(N, -1f, 1f, 70707);
