...
// a [BurstCompile] IJob.
public class doubleAMGProlongatorTests
{
    ...
    public struct ProlongatorTestJob : IJob
    {
        ...
        static double TBcoarse(in doubleBSR T, in doubleMxN Bcoarse, int i, int BR, int m, int r, int c)
        {
            int k0 = T.RowPtr[i];
            int a = T.ColInd[k0];
            int blockLen = BR * m;
        ...
        static void AssertOneBlockPerRow(in doubleBSR T, int nb)
        {
            for (int i = 0; i < nb; i++)
