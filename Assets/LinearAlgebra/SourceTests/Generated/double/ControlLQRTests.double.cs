...
// "Tests" section items 1-7). The coder's smoke tests live in ControlTests.double.cs; this file is the
...
public class doubleControlLQRTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            int n = M.M_Rows;
            var C = new doubleMxN(in M, Allocator.Temp);   // valuesQR is destructive
