...
public class doubleRollingWindowTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void CovarianceMatchesStatsOP()
        {
            ...
            var viaStats = doubleStatsOP.covariance(w.AsMatrix());
            for (int i = 0; i < 2; i++)
                for (int j = 0; j < 2; j++)
        ...
        {
            if (expected != got && Fail[0] == (double)0)
            {
                Fail[0] = (double)1; Fail[1] = (double)got; Fail[2] = (double)expected; Fail[3] = (double)(got - expected);
            }
        ...
        void AssertTrue(bool ok)
        {
            ...
            {
                Fail[0] = (double)1; Fail[1] = (double)(-1); Fail[2] = (double)(-1); Fail[3] = (double)(-1);
            }
            Assert.IsTrue(ok);
        }
    }
