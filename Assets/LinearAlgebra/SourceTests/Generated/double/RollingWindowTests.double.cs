...
public class doubleRollingWindowTests
{
    ...
    {
        public doubleRollingWindow W;
        public doubleN Sample;
    ...
    {
        var w = new doubleRollingWindow(4, 2, Allocator.Persistent);
        var sample = new doubleN(2, Allocator.Persistent);
        ...
        var mean = w.Mean();
        AssertCloseManaged(mean[0], (double)2, (double)1E-5f);
        AssertCloseManaged(mean[1], (double)2, (double)1E-5f);

        AssertCloseManaged(w[0, 0], (double)1, (double)1E-6f); AssertCloseManaged(w[0, 1], (double)1, (double)1E-6f); // oldest
        AssertCloseManaged(w[1, 0], (double)2, (double)1E-6f); AssertCloseManaged(w[1, 1], (double)2, (double)1E-6f);
        AssertCloseManaged(w[2, 0], (double)3, (double)1E-6f); AssertCloseManaged(w[2, 1], (double)3, (double)1E-6f); // newest
    ...
    public void CrossRunPushWrapAroundAcrossSeparateRunCalls()
    {
        ...
        AssertCloseManaged(w[0, 0], (double)2, (double)1E-6f); AssertCloseManaged(w[0, 1], (double)2, (double)1E-6f); // oldest retained (1 evicted)
        AssertCloseManaged(w[3, 0], (double)5, (double)1E-6f); AssertCloseManaged(w[3, 1], (double)5, (double)1E-6f); // newest

        var mean = w.Mean();
        AssertCloseManaged(mean[0], (double)3.5f, (double)1E-5f);
        AssertCloseManaged(mean[1], (double)3.5f, (double)1E-5f);
    ...
    static void AssertCloseManaged(double a, double b, double precision)
    {
        double diff = math.abs(a - b);
