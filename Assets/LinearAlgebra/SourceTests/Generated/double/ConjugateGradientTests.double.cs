...
public class doubleConjugateGradientTests
{
    ...
    public struct ConjugateGradientTestJob : IJob
    {
        ...
        void AddScaledInpl()
        {
            ...
            var y = arena.doubleRandomVector(n, -1f, 1f, 11111);
            var x = arena.doubleRandomVector(n, -1f, 1f, 22222);
        ...
        void ScaleAddInpl()
        {
            ...
            var y = arena.doubleRandomVector(n, -1f, 1f, 33333);
        ...
        void CrossCheckCholesky()
        {
            ...
            bool ok = Solvers.conjugateGradient(in A, in b, ref xCG);
            Assert.IsTrue(ok);
        ...
        void ZeroRhs()
        {
            ...
            var b = arena.doubleVec(dim); // zero vector

            // Non-zero initial guess must still be driven to zero.
            var x = arena.doubleRandomVector(dim, -1f, 1f, 9999);
        ...
        void AlreadyConverged()
        {
            ...
            var b = arena.doubleRandomVector(dim, -1f, 1f, 6363);
