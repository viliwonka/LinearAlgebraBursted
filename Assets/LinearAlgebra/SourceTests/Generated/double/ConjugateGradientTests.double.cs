...
public class doubleConjugateGradientTests
{
    ...
    public struct ConjugateGradientTestJob : IJob
    {
        ...
        void AddScaledInpl()
        {
            ...
            var y = arena.doubleRandomVec(n, -1f, 1f, 11111);
            var x = arena.doubleRandomVec(n, -1f, 1f, 22222);
        ...
        void ScaleAddInpl()
        {
            ...
            var y = arena.doubleRandomVec(n, -1f, 1f, 33333);
        ...
        void ZeroRhs()
        {
            ...
            var x = arena.doubleRandomVec(dim, -1f, 1f, 9999);
        ...
        void AlreadyConverged()
        {
            ...
            var b = arena.doubleRandomVec(dim, -1f, 1f, 6363);
