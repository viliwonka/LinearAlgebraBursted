...
public class doubleSVDLowRankTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void CheckAtK(in doubleMxN A, in doubleN fullS, int k, double normA2)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            var Ak = new doubleMxN(m, n, Allocator.Temp);
        ...
        doubleN Spectrum(in doubleMxN A, out double normA2)
        {
            int n = A.N_Cols;
        ...
        void RandomTall12x5()
        {
            var A = GenerateOP.doubleRandomMat(12, 5, (double)(-2f), (double)2f, 555111, allocator: Allocator.Temp);
            var fullS = Spectrum(in A, out double normA2);
        ...
        void RandomSquare8()
        {
            var A = GenerateOP.doubleRandomMat(8, 8, (double)(-3f), (double)3f, 909090, allocator: Allocator.Temp);
            var fullS = Spectrum(in A, out double normA2);
            CheckAtK(in A, in fullS, 1, normA2);
        ...
        {
            int m = 10, n = 6, r = 3;
            var B = GenerateOP.doubleRandomMat(m, r, (double)(-2f), (double)2f, 121212, allocator: Allocator.Temp);
            var C = GenerateOP.doubleRandomMat(r, n, (double)(-2f), (double)2f, 343434, allocator: Allocator.Temp);
        ...
        {
            int m = 40, n = 12;
            var A = GenerateOP.doubleRandomMat(m, n, (double)(-2f), (double)2f, 777111, allocator: Allocator.Temp);

            // Full thin SVD as oracle
            var Ufull = new doubleMxN(m, n, Allocator.Temp);
            var Sfull = new doubleN(n, Allocator.Temp);
            var Vfull = new doubleMxN(n, n, Allocator.Temp);
        ...
        {
            int m = 24, n = 8, r = 4;
            var B = GenerateOP.doubleRandomMat(m, r, (double)(-2f), (double)2f, 8881, allocator: Allocator.Temp);
            var C = GenerateOP.doubleRandomMat(r, n, (double)(-2f), (double)2f, 9992, allocator: Allocator.Temp);
        ...
        {
            int m = 30, n = 10;
            var A = GenerateOP.doubleRandomMat(m, n, (double)(-3f), (double)3f, 313131, allocator: Allocator.Temp);
        ...
        {
            int m = 20, n = 7;
            var A = GenerateOP.doubleRandomMat(m, n, (double)(-4f), (double)4f, 202020, allocator: Allocator.Temp);
        ...
        void CheckTruncVsThin(in doubleMxN A, int k, int oversample, uint seed, int m, int n,
                              double svTol, double vecTol, double orthoTol)
        {
            var Ufull = new doubleMxN(m, n, Allocator.Temp);
            var Sfull = new doubleN(n, Allocator.Temp);
            var Vfull = new doubleMxN(n, n, Allocator.Temp);
        ...
        void GklTruncated_80x40_k3()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0x11223344u, m, n,
                             (double)1f, (double)0.01f, (double)1E-3f);
        }
        ...
        void GklClusteredSpectrum_50x30()
        {
            ...
            var Uf = new doubleMxN(m, n, Allocator.Temp);
            var Sf = new doubleN(n, Allocator.Temp);
            var Vf = new doubleMxN(n, n, Allocator.Temp);
        ...
        void GklIllConditioned_60x20()
        {
            ...
            CheckTruncVsThin(in A, 3, 4, 0xFEEDC0DEu, m, n,
                             (double)5f, (double)0.01f, (double)1E-3f);
        }
        ...
        void GklConvergedFalse_RankDeficient()
        {
            ...
            var B = GenerateOP.doubleRandomMat(m, r, (double)(-2f), (double)2f, 0xBADC0DE0u, allocator: Allocator.Temp);
            var C = GenerateOP.doubleRandomMat(r, n, (double)(-2f), (double)2f, 0xBADC0DE1u, allocator: Allocator.Temp);
        ...
        void GklConvergedFalse_TooFewSteps()
        {
            ...
            var A = GenerateOP.doubleRandomMat(m, n, (double)(-2f), (double)2f, 0x55AA77BBu, allocator: Allocator.Temp);
        ...
        void GklConvergedFalse_MaxIter1()
        {
            ...
            var A = GenerateOP.doubleRandomMat(m, n, (double)(-3f), (double)3f, 0xDEADBEEFu, allocator: Allocator.Temp);
        ...
        void PartialVsFull_Geometric_80x30()
        {
            ...
            var SkP = new doubleN(k, Allocator.Temp);
            var SkF = new doubleN(k, Allocator.Temp);
        ...
        void PartialClustered_50x30()
        {
            ...
            CheckPartialReorth(in A, in sigma, k, 12, 0xC1057E12u, m, n, (double)0.05f);
        }
        ...
        void PartialIllConditioned_60x20()
        {
            ...
            CheckPartialReorth(in A, in sigma, k, 4, 0x111C0AD3u, m, n, (double)5f);
        }
    ...
    {
        var A = new doubleMxN(6, 4, Allocator.Temp);
        var Ak = new doubleMxN(4, 6, Allocator.Temp);   // must be m x n = 6 x 4
