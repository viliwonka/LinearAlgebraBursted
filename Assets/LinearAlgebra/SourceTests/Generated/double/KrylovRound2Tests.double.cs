...
public class doubleKrylovRound2Tests
{
    ...
    public struct KrylovRound2TestJob : IJob
    {
        ...
        void ApplyDotBSRSymExact()
        {
            ...
            builder.AddBlock(1, 0, arena.doubleRandomMat(b, b, -1f, 1f, 70205));  // lower off-diagonals
            builder.AddBlock(3, 1, arena.doubleRandomMat(b, b, -1f, 1f, 70206));
        ...
        static doubleBSR BuildSymMultiBlock(ref Arena arena, int b, uint seed)
        {
            ...
            for (int i = 0; i < 5; i++)
                builder.AddBlock(i, i, SpdBlock(ref arena, b, seed + (uint)i + 1u));
            builder.AddBlock(4, 3, arena.doubleRandomMat(b, b, -1f, 1f, seed + 11u));  // row4: diag + 3
            builder.AddBlock(4, 2, arena.doubleRandomMat(b, b, -1f, 1f, seed + 12u));
            builder.AddBlock(4, 0, arena.doubleRandomMat(b, b, -1f, 1f, seed + 13u));
            builder.AddBlock(3, 1, arena.doubleRandomMat(b, b, -1f, 1f, seed + 14u));  // row3: diag + 2
            builder.AddBlock(3, 0, arena.doubleRandomMat(b, b, -1f, 1f, seed + 15u));
            builder.AddBlock(2, 1, arena.doubleRandomMat(b, b, -1f, 1f, seed + 16u));  // row2: diag + 1
