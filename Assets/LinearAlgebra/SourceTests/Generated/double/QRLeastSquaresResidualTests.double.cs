    ...
    public struct TestJob : IJob
    {
        ...
        void RandomOverdeterminedNormalEquations()
        {
            ...
            for (uint t = 0; t < 24; t++)
            {
                ...
                double rNorm = doubleNormsOP.L2(in r);
        ...
        void RandomOverdeterminedOptimality()
        {
            ...
            for (uint t = 0; t < 12; t++)
            {
                ...
                double r0 = SumSq(b - doubleOP.dot(A, x));
                ...
                for (int k = 0; k < n; k++)
                {
                    ...
                    x[k] = saved + delta;
                    double rp = SumSq(b - doubleOP.dot(A, x));
                    x[k] = saved - delta;
                    double rm = SumSq(b - doubleOP.dot(A, x));
                    x[k] = saved;
