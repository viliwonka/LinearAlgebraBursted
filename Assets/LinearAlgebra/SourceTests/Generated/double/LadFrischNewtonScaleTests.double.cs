...
public class doubleLadFrischNewtonScaleTests
{
    ...
    static void BuildOutlierLine(doubleMxN A, doubleN b, double scale)
    {
        for (int i = 0; i < 5; i++) { A[i, 0] = (double)1; A[i, 1] = (double)i; b[i] = (double)(i * scale); }
        b[2] = (double)(10.0 * scale);
    }
    ...
    public void ResponseScaleEquivariance()
    {
        ...
        var bUnit = new doubleN(5, Allocator.Temp);
        var xUnit = new doubleN(2, Allocator.Temp);
        ...
        {
            double c = scales[k];
            var bc = new doubleN(5, Allocator.Temp);
            var xc = new doubleN(2, Allocator.Temp);
