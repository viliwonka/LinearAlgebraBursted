...
public class doubleCHOPTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void FullRankSPD()
        {
            ...
            {
                int n = 8;
                var B = GenerateOP.doubleRandomMat(n, n, -1f, 1f, 6100 + t * 13, Allocator.Temp);
                var A = Gram(in B);
                ...
                var xOrig = GenerateOP.doubleRandomVec(n, -3f, 3f, 71000 + t * 7, Allocator.Temp);
        ...
        void RankDeficientReconstructAndSolve()
        {
            ...
            {
                int n = 7, r = 4;
                var B = GenerateOP.doubleRandomMat(n, r, -1f, 1f, 8200 + t * 11, Allocator.Temp);
                var A = Gram(in B);
                ...
                var w = GenerateOP.doubleRandomVec(n, -2f, 2f, 51000 + t * 5, Allocator.Temp);
                ...
                var diff = new doubleN(n, Allocator.Temp);
        ...
        void MinNormCertificate()
        {
            ...
            {
                int n = 7, r = 3;
                var B = GenerateOP.doubleRandomMat(n, r, -1f, 1f, 3300 + t * 17, Allocator.Temp);
                var A = Gram(in B);

                var xOrig = GenerateOP.doubleRandomVec(n, -2f, 2f, 42000 + t * 9, Allocator.Temp);
                var b = Blas.dot(A, xOrig);     // b ∈ range(A)
                var bForResidual = new doubleN(in b, Allocator.Temp);

                var P = new Pivot(n, Allocator.Persistent);
                var Awork = new doubleMxN(in A, Allocator.Temp); // solveInPlace is destructive; A is still needed below
        ...
        void ZeroMatrix()
        {
            ...
            // solve: x = 0 for any b.
            var b = GenerateOP.doubleRandomVec(n, -1f, 1f, 999, Allocator.Temp);
        ...
        void OutOfRangeLeastSquares()
        {
            ...
            {
                int n = 7, r = 3;
                var B = GenerateOP.doubleRandomMat(n, r, -1f, 1f, 2600 + t * 19, Allocator.Temp);
                var A = Gram(in B);

                // arbitrary b, generically NOT in range(A) since rank r < n.
                var b = GenerateOP.doubleRandomVec(n, -2f, 2f, 77000 + t * 13, Allocator.Temp);
                ...
                var bOrig = GenerateOP.doubleRandomVec(n, -2f, 2f, 77000 + t * 13, Allocator.Temp);
        ...
        {
            var B = GenerateOP.doubleRandomMat(n, r, -1f, 1f, seed, Allocator.Temp);
            var A = Gram(in B);
            if (r >= n)
                for (int d = 0; d < n; d++) A[d, d] += (double)n; // diagonal boost -> well-conditioned full rank

            var b1 = GenerateOP.doubleRandomVec(n, -2f, 2f, seed + 1u, Allocator.Temp);
            var b2 = GenerateOP.doubleRandomVec(n, -2f, 2f, seed + 2u, Allocator.Temp);
        ...
        void SolveInPlaceShortCircuitPurity()
        {
            ...
            var b = GenerateOP.doubleRandomVec(n, -1f, 1f, 24680, Allocator.Temp);
        ...
        {
            var B = GenerateOP.doubleRandomMat(n, n, -1f, 1f, seed, Allocator.Temp);
            var A = Gram(in B);
        ...
        void BlockedRankDeficientMidBlock()
        {
            ...
            var B = GenerateOP.doubleRandomMat(n, r, -1f, 1f, 701333u, Allocator.Temp);
        ...
        void BlockedIndefiniteDeep()
        {
            ...
            var R = GenerateOP.doubleRandomMat(n, n, -1f, 1f, 701444u, Allocator.Temp);
            var A = new doubleMxN(n, n, Allocator.Temp); // zero
        ...
        void BlockedFirstPivotDeep()
        {
            ...
            var B = GenerateOP.doubleRandomMat(n, n, -1f, 1f, 701555u, Allocator.Temp);
            var A = Gram(in B);
        ...
        void BlockedVsUnblockedReference()
        {
            ...
            var R = GenerateOP.doubleRandomMat(n, n, -1f, 1f, 701666u, Allocator.Temp);
            var A = new doubleMxN(n, n, Allocator.Temp);
            ...
            var Lb = new doubleMxN(n, n, Allocator.Temp);
            ...
            var Lr = new doubleMxN(n, n, Allocator.Temp);
        ...
        int ReferenceUnblockedDecomp(in doubleMxN A, ref doubleMxN L, ref Pivot P)
        {
            int n = A.M_Rows;
            P.Reset();
            int rank = n;
            ...
            var urow = new doubleN(n, Allocator.Temp);
        ...
        static doubleMxN Gram(in doubleMxN B)
        {
