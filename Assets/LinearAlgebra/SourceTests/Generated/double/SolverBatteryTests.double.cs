// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/SolverBatteryTests.fProxy.cs
...
using LinearAlgebra;
using LinearAlgebra.Gallery;   // opt-in: doubleGallery.doubleHilbert(n), doubleGallery.doubleKahan(n,θ), ...
...
public class doubleSolverBatteryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            var H = doubleGallery.doubleHilbert(4);            CheckCholeskyReconstruct(in H, (double)50);
            var P = doubleGallery.doublePascal(5);             CheckCholeskyReconstruct(in P, (double)50);
            var L = doubleGallery.doubleLehmer(5);             CheckCholeskyReconstruct(in L, (double)50);
            var M = doubleGallery.doubleMinIJ(5);              CheckCholeskyReconstruct(in M, (double)50);
            var Pe = doubleGallery.doublePei(5, (double)2);    CheckCholeskyReconstruct(in Pe, (double)50);
            var Mo = doubleGallery.doubleMoler(5);             CheckCholeskyReconstruct(in Mo, (double)100);
            var T = doubleGallery.doubleLaplacian1D(6);        CheckCholeskyReconstruct(in T, (double)50);
            var G = doubleGallery.doubleGCD(5);                CheckCholeskyReconstruct(in G, (double)50);
        }

        void CheckCholeskyReconstruct(in doubleMxN A, double factor)
        {
            int n = A.M_Rows;
            ...
            // rec = L · Lᵀ
            var Lt = new doubleMxN(n, n, Allocator.Temp);
            Blas.trans(in L, ref Lt);
            var rec = new doubleMxN(n, n, Allocator.Temp);
        ...
        {
            var F = doubleGallery.doubleFiedler(3);
            var Lf = new doubleMxN(3, 3, Allocator.Temp);
            AssertTrue(!CHO.decomp(in F, ref Lf));

            var C = doubleGallery.doubleClement(3);
            var Lc = new doubleMxN(3, 3, Allocator.Temp);
            AssertTrue(!CHO.decomp(in C, ref Lc));

            var R = doubleGallery.doubleRosser();
            var Lr = new doubleMxN(8, 8, Allocator.Temp);
        ...
        void LUDeterminantBattery()
        {
            ...
            var G = doubleGallery.doubleGCD(5);
            AssertClose(Determinant(in G), (double)16, (double)0.5);

            var Rh = doubleGallery.doubleRedheffer(5);
        ...
        void LUSolveBattery()
        {
            var T = doubleGallery.doubleLaplacian1D(8);
            CheckLUSolve(in T, (double)200 * Consts.doubleSqrtEps);

            var P = doubleGallery.doublePascal(5);
            CheckLUSolve(in P, (double)5E-2);
        }

        void CheckLUSolve(in doubleMxN A, double xtol)
        {
            int n = A.M_Rows;
        ...
        {
            var T = doubleGallery.doubleLaplacian1D(8);
            CheckQRSquare(in T, (double)200 * Consts.doubleSqrtEps);

            var Pe = doubleGallery.doublePei(5, (double)2);
            CheckQRSquare(in Pe, (double)50 * Consts.doubleSqrtEps);
        }

        void CheckQRSquare(in doubleMxN A, double xtol)
        {
            int n = A.M_Rows;
        ...
        {
            int n = 3;
            var A = doubleGallery.doubleLauchli(n, (double)0.5);   // 4×3
        ...
        {
            int n = 5;
            var A = doubleGallery.doubleKahan(n, (double)0.36235775);
        ...
        void CheckQRCPReconstruct(in doubleMxN A)
        {
            int m = A.M_Rows;
            int n = A.N_Cols;
            ...
            // QRProduct = Q · R (m × n)
            var QRProduct = new doubleMxN(m, n, Allocator.Temp);
        ...
        {
            var A = doubleGallery.doubleHadamard(n);
        ...
        {
            int n = 8;
            var A = doubleGallery.doubleParter(n);
        ...
        void SVDLauchliRankStress()
        {
            ...
            var A = doubleGallery.doubleLauchli(n, eps);   // 4×3
        ...
        {
            var T = doubleGallery.doubleLaplacian1D(6);     CheckEigenReconstruct(in T);
            var Pe = doubleGallery.doublePei(5, (double)2);  CheckEigenReconstruct(in Pe);
            var P = doubleGallery.doublePascal(5);           CheckEigenReconstruct(in P);
        }

        void CheckEigenReconstruct(in doubleMxN A)
        {
            int n = A.M_Rows;
            ...
            // VᵀV ≈ I
            var VtV = new doubleMxN(n, n, Allocator.Temp);
            ...
            // rec = V · diag(eig) · Vᵀ
            var D = new doubleMxN(n, n, Allocator.Temp);   // zero-initialized
            for (int i = 0; i < n; i++) D[i, i] = eig[i];
            var VD = new doubleMxN(n, n, Allocator.Temp);
        ...
        {
            int n = 6;
            var T = doubleGallery.doubleLaplacian1D(n);
        ...
        {
            int n = 4;
            var C = doubleGallery.doubleClement(n);
        ...
        {
            int n = 5;
            var F = doubleGallery.doubleFiedler(n);
        ...
        {
            int n = 6;
            var D = doubleGallery.doubleDingDong(n);
        ...
        {
            var A = doubleGallery.doubleRosser();

            var expected = new doubleN(8, Allocator.Temp);
            ...
            var Ac = A.Copy();
            var eig = new doubleN(8, Allocator.Temp);
            var V = new doubleMxN(8, 8, Allocator.Temp);
            AssertTrue(Eigen.decompInPlace(ref Ac, ref eig, ref V));
        ...
        {
            int n = 4;
            var F = doubleGallery.doubleFrank(n);
        ...
        {
            var coeffs = new doubleN(3, Allocator.Temp);
            coeffs[0] = (double)(-6); coeffs[1] = (double)11; coeffs[2] = (double)(-6);
            var C = doubleGallery.doubleCompanion(in coeffs);
        ...
        {
            var T = doubleGallery.doubleLaplacian1D(8);
            CheckCG(in T, (double)200 * Consts.doubleSqrtEps);
            ...
            var M = doubleGallery.doubleMinIJ(5);
            CheckCG(in M, (double)5E-2);

            var Pe = doubleGallery.doublePei(5, (double)2);
            CheckCG(in Pe, (double)50 * Consts.doubleSqrtEps);
        }

        void CheckCG(in doubleMxN A, double xtol)
        {
            int n = A.M_Rows;
        ...
        void CondBattery()
        {
            var Hd = doubleGallery.doubleHadamard(4);
