...
public class doubleMatrixMetricsTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void Trace()
        {
            ...
            AssertClose(Linear_OP.trace(in A), (double)5, (double)1E-5);
        ...
        void WideMatrix()
        {
            ...
            AssertClose(Linear_OP.cond(in A), (double)4 / (double)3, (double)1E-4);
        ...
        void Cond()
        {
            ...
            AssertClose(Linear_OP.cond(in A), (double)4, (double)1E-4);
        ...
        void CondIdentity()
        {
            ...
            AssertClose(Linear_OP.cond(in A), (double)1, (double)1E-4);
        ...
        void CondZero()
        {
            ...
            AssertGreater(Linear_OP.cond(in A), (double)1E6);
        ...
        void CondNonDiagonal()
        {
            ...
            AssertClose(Linear_OP.cond(in A), (double)3, (double)1E-4);
        ...
        void OneByOne()
        {
            ...
            AssertClose(Linear_OP.trace(in A), (double)7, (double)1E-5);
            AssertClose(Linear_OP.cond(in A), (double)1, (double)1E-4);
        ...
        void RankExplicitTol()
        {
            ...
            AssertIntEqual(Linear_OP.rank(in A, (double)1E-2), 1);         // loose tol drops σ=1e-5
