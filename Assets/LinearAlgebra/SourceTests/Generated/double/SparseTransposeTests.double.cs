...
// doubleSparseSymmetricTests). There are no guard/exception cases here, so no managed-thread
// Assert.Throws methods are needed.
public class doubleSparseTransposeTests
{
    ...
    public struct SparseTransposeTestJob : IJob
    {
        ...
        // cross-check idiom of doubleSparseSymmetricTests.Tol().
        ...
        void OperatorApplyTParity()
        {
            ...
            var xT = arena.doubleRandomVec(A.M_Rows, -1f, 1f, 73001);
            var yT1 = arena.doubleVec(A.N_Cols);
            var yT2 = arena.doubleVec(A.N_Cols);
            ...
            var xF = arena.doubleRandomVec(A.N_Cols, -1f, 1f, 73002);
            var yF1 = arena.doubleVec(A.M_Rows);
            var yF2 = arena.doubleVec(A.M_Rows);
