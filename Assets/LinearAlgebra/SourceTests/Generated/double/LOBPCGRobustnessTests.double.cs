...
public class doubleLOBPCGRobustnessTests
{
    ...
    static double[] DenseSmallestAscending(in doubleMxN A, int k)
    {
        int n = A.M_Rows;
        var Acopy = new doubleMxN(in A, Allocator.Temp);
    ...
    {
        int k = 4, guard = 4;
        var A = doubleGallery.doublePenalizedGrid3D(1, 1, 1, (double)8, (double)1e3);
        int n = A.M_Rows;
        ...
        var ws = new doubleLOBPCGCache(n, k + guard, Allocator.Temp);
    ...
    {
        int n = 21, k = 2;
        var A = doubleGallery.doubleWilkinsonMinus(n);
    ...
    public void LauchliGramSmallestNonNegativeOrHonest()
    {
        ...
        var L = doubleGallery.doubleLauchli(n, eps);
    ...
    public void JobbedExactWarmStartCertifiesInCache()
    {
        ...
        var D = A.ToDense(Allocator.Temp);
        var Dcopy = new doubleMxN(in D, Allocator.Temp);
        var eigAll = new doubleN(n, Allocator.Temp);
        var Vall = new doubleMxN(n, n, Allocator.Temp);
