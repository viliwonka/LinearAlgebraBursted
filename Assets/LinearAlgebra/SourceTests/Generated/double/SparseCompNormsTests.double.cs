...
public class doubleSparseCompNormsTests
{
    ...
    public struct SparseCompNormsTestJob : IJob
    {
        ...
        static doubleBSR BuildTestBSR(ref Arena arena, double scale)
        {
            const int BR = 2, BC = 2;
        ...
        void NormsMatchDense()
        {
            ...
            var A = BuildTestBSR(ref arena, (double)1);
        ...
        void AddScaledSamePattern()
        {
            ...
            var y = BuildTestBSR(ref arena, (double)1);
            var x = BuildTestBSR(ref arena, (double)10);
    ...
    public void AddScaledPatternMismatchThrows()
    {
        ...
        {
            const int BR = 2, BC = 2;
            var by = arena.doubleBSRBuilder(2, 2, BR, BC);
            var bx = arena.doubleBSRBuilder(2, 2, BR, BC);
