...
public class doubleFFTTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            var arena = new Arena(Allocator.Persistent);
            var ws    = arena.doubleFftWorkspace(N);   // has both half-table and full-circle table
            ...
            doubleFFT.fft(ref reRef, ref imRef, in ws);
            ...
            doubleFFT.fftRadix4(ref reR4, ref imR4, in ws);
        ...
        void Radix4RoundTripOneSize(int N, uint seedRe, uint seedIm)
        {
            ...
            doubleFFT.ifftRadix4(ref re, ref im, in ws);
