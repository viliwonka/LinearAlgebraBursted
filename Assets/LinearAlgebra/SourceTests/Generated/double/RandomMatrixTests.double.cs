...
public class doubleRandomMatrixTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void SpdDeterminism()
        {
            ...
            Rand.randomSpdInpl(ref r1, ref A1, (double)1, (double)10);

            var r2 = new Random(96321u);
            var A2 = arena.doubleMat(n, n);
            Rand.randomSpdInpl(ref r2, ref A2, (double)1, (double)10);
        ...
        void ConditionRankOne()
        {
            ...
            Rand.randomMatrixWithConditionInpl(ref rng, ref A, (double)50);
    ...
    public void SpdValidationThrows()
    {
        ...
        try
        {
            ...
            Assert.Throws<ArgumentException>(
                () => Rand.randomSpdInpl(ref rng, ref nonSquare, (double)1, (double)2));

            var A = arena.doubleMat(3, 3);
            // minEig <= 0
            Assert.Throws<ArgumentException>(
                () => Rand.randomSpdInpl(ref rng, ref A, (double)0, (double)2));
            Assert.Throws<ArgumentException>(
                () => Rand.randomSpdInpl(ref rng, ref A, (double)(-1), (double)2));
            // minEig > maxEig
            Assert.Throws<ArgumentException>(
                () => Rand.randomSpdInpl(ref rng, ref A, (double)5, (double)2));
            // non-finite bounds
            Assert.Throws<ArgumentException>(
                () => Rand.randomSpdInpl(ref rng, ref A, (double)double.PositiveInfinity, (double)2));
            Assert.Throws<ArgumentException>(
                () => Rand.randomSpdInpl(ref rng, ref A, (double)1, (double)float.NaN));
        }
        finally { arena.Dispose(); }
    }
    ...
    public void ConditionValidationThrows()
    {
        ...
        try
        {
            ...
            // cond < 1
            Assert.Throws<ArgumentException>(
                () => Rand.randomMatrixWithConditionInpl(ref rng, ref A, (double)0.5));
            // non-finite cond
            Assert.Throws<ArgumentException>(
                () => Rand.randomMatrixWithConditionInpl(ref rng, ref A, (double)double.PositiveInfinity));
            Assert.Throws<ArgumentException>(
                () => Rand.randomMatrixWithConditionInpl(ref rng, ref A, (double)float.NaN));
        }
        finally { arena.Dispose(); }
    }
