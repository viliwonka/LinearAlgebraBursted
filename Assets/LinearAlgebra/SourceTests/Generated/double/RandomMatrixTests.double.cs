// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/RandomMatrixTests.fProxy.cs
...
public class doubleRandomMatrixTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void CheckOrthogonal(int n, uint seed)
        {
            ...
            // QᵀQ
            var QtQ = new doubleMxN(n, n, Allocator.Temp);
        ...
        void OrthogonalDeterminism()
        {
            ...
            var Q1 = new doubleMxN(n, n, Allocator.Temp);
            Rand.orthogonalInPlace(ref r1, ref Q1);

            var r2 = new Random(424242u);
            var Q2 = new doubleMxN(n, n, Allocator.Temp);
        ...
        void SpdProperties()
        {
            ...
            for (uint t = 0; t < 6; t++)
            {
                ...
                var evals = new doubleN(n, Allocator.Temp);
        ...
        void SpdDeterminism()
        {
            ...
            var A1 = new doubleMxN(n, n, Allocator.Temp);
            Rand.spdInPlace(ref r1, ref A1, (double)1, (double)10);

            var r2 = new Random(96321u);
            var A2 = new doubleMxN(n, n, Allocator.Temp);
        ...
        void ConditionRankOne()
        {
            ...
            var A = new doubleMxN(1, 4, Allocator.Temp);
            Rand.conditionedInPlace(ref rng, ref A, (double)50);

            var S = new doubleN(1, Allocator.Temp);    // k = min(1,4) = 1
            SVD.singularValues(in A, ref S);
        ...
        void RankZeroAndFull()
        {
            ...
            var AF = new doubleMxN(m, n, Allocator.Temp);
        ...
        int NumericalRank(in doubleMxN A)
        {
        ...
        void MvnCovariance()
        {
            ...
            var mean = new doubleN(n, Allocator.Persistent);
            mean[0] = (double)(-2); mean[1] = (double)3;

            var rng = new Random(13000u);
            var dest = new doubleMxN(rows, n, Allocator.Persistent);
    ...
    public void OrthogonalNonSquareThrows()
    {
        ...
        var dest = new doubleMxN(3, 4, Allocator.Temp);
    ...
    public void SpdValidationThrows()
    {
        ...
        var nonSquare = new doubleMxN(3, 4, Allocator.Temp);
        Assert.Throws<ArgumentException>(
    ...
    {
        var rng = new Random(1u);
        var A = new doubleMxN(5, 3, Allocator.Temp);   // min(m,n) = 3
    ...
    public void MultivariateNormalDimensionMismatchThrows()
    {
        ...
        // cholL not square
        var nonSquare = new doubleMxN(3, 2, Allocator.Temp);
        var mean3 = new doubleN(3, Allocator.Temp);
        var dest3 = new doubleN(3, Allocator.Temp);
        var z3 = new doubleN(3, Allocator.Temp);
        Assert.Throws<ArgumentException>(
        ...
        // mean.N mismatch
        var meanBad = new doubleN(2, Allocator.Temp);
        Assert.Throws<ArgumentException>(
        ...
        var destRowsBad = new doubleMxN(8, 4, Allocator.Temp);
        Assert.Throws<ArgumentException>(
