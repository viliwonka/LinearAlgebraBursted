...
public class doubleBlockCraigGuardTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        static doubleMxN BuildWideFullRowRank(ref Arena arena, int m, int n, uint seed)
        {
        ...
        void BcraigDistinctXBSolves()
        {
            ...
            var B = arena.doubleRandomMat(s, m, (double)(-1f), (double)1f, 88102u);
        ...
        void BcraigmrDistinctXBSolves()
        {
            ...
            var B = arena.doubleRandomMat(s, m, (double)(-1f), (double)1f, 89102u);
            var X = arena.doubleMat(s, n);
    ...
    static doubleMxN BuildSquareFullRank(ref Arena arena, int nn, uint seed)
    {
        var A = arena.doubleRandomMat(nn, nn, (double)(-1f), (double)1f, seed);
    ...
    public void BcraigAliasedXBThrows()
    {
        ...
        try
        {
            ...
            var B = arena.doubleRandomMat(s, nn, (double)(-1f), (double)1f, 88002u);
    ...
    public void BcraigmrAliasedXBThrows()
    {
        ...
        try
        {
            ...
            var B = arena.doubleRandomMat(s, nn, (double)(-1f), (double)1f, 89002u);
            var X = B;   // ALIASES B -> distinct-buffer guard must fire
