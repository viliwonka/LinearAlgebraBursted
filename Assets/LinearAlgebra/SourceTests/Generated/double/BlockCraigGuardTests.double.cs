...
// managed exception), mirroring doubleKrylovPMinresTests.AliasedScratchThrows.
public class doubleBlockCraigGuardTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        static doubleMxN BuildWideFullRowRank(int m, int n, uint seed)
        {
        ...
        void BcraigDistinctXBSolves()
        {
            ...
            var B = GenerateOP.doubleRandomMat(s, m, (double)(-1f), (double)1f, 88102u, Allocator.Temp);
        ...
        void BcraigmrDistinctXBSolves()
        {
            ...
            var B = GenerateOP.doubleRandomMat(s, m, (double)(-1f), (double)1f, 89102u, Allocator.Temp);
            var X = new doubleMxN(s, n, Allocator.Temp);
    ...
    static doubleMxN BuildSquareFullRank(int nn, uint seed)
    {
        var A = GenerateOP.doubleRandomMat(nn, nn, (double)(-1f), (double)1f, seed, Allocator.Temp);
        for (int d = 0; d < nn; d++) A[d, d] += (double)10;
        return A;
    }
    ...
    public void BcraigAliasedXBThrows()
    {
        ...
        var B = GenerateOP.doubleRandomMat(s, nn, (double)(-1f), (double)1f, 88002u, Allocator.Temp);
    ...
    public void BcraigmrAliasedXBThrows()
    {
        ...
        var B = GenerateOP.doubleRandomMat(s, nn, (double)(-1f), (double)1f, 89002u, Allocator.Temp);
        var X = B;   // ALIASES B -> distinct-buffer guard must fire
