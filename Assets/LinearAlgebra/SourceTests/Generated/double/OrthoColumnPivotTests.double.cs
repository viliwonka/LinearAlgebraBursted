...
public class doubleOrthoColumnPivotTests
{
    ...
    public struct AssemblyTestJob : IJob
    {
        public void Execute()
        {
            ...
            var Q = arena.doubleRandomMatrix(12, 6);
    ...
    public struct TestJob : IJob
    {
        ...
        void ReconstructRandomTall()
        {
            ...
            try
            {
                for (uint t = 0; t < 16; t++)
                {
                    var Q = arena.doubleRandomMatrix(m, n, -3f, 3f, 7001 + t * 13);
        ...
        void ReconstructRandomSquare()
        {
            ...
            try
            {
                for (uint t = 0; t < 16; t++)
                {
                    var Q = arena.doubleRandomMatrix(dim, dim, -3f, 3f, 4220 + t * 7);
        ...
        void FirstPivotLargestColumn()
        {
            ...
            int m = 7, n = 4;
            var Q = arena.doubleRandomMatrix(m, n, -1f, 1f, 31337);
        ...
        void RankRevealingDeficient()
        {
            ...
            int m = 6, n = 5;
            var Q = arena.doubleRandomMatrix(m, n, -1f, 1f, 90210);
        ...
        void DuplicateColumns()
        {
            ...
            int m = 4, n = 3;
            var Q = arena.doubleRandomMatrix(m, n, -1f, 1f, 13579);
            for (int r = 0; r < m; r++)
        ...
        void AssertQRCP(in doubleMxN A, in doubleMxN Q, in doubleMxN R, in Pivot P, double precision)
        {
            ...
            doubleMxN shouldBeZero = Aperm - double_OP.dot(Q, R);
    ...
    public struct SolveTestJob : IJob
    {
        ...
        void FullRankSquare()
        {
            ...
            var b = double_OP.dot(A, xOrig); // b in range(A) -> exact solution exists
        ...
        void AutoSentinel()
        {
            ...
            Ortho_OP.qrcpDirectSolve(ref A, ref b, ref xNeg, out int rankNeg, (double)(-1)); // sentinel
        ...
        void KnownValueRegression()
        {
            ...
            Ortho_OP.qrcpDirectSolve(ref A, ref b, ref x, ref Q, ref R, ref P, ref u, out int rank, (double)(-1));
