...
public class doubleOrthoColumnPivotTests
{
    ...
    public struct SolveTestJob : IJob
    {
        ...
        void AutoSentinel()
        {
            ...
            int rankNeg = QRCP.solveInPlace(ref A, ref b, ref xNeg, (double)(-1)).rank; // sentinel
        ...
        void KnownValueRegression()
        {
            ...
            int rank = QRCP.solveInPlace(ref A, ref b, ref x, ref Q, ref R, ref P, ref u, (double)(-1)).rank;
