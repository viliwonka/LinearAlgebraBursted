...
public class doubleStatsTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            int m = 5, n = 4;
            var A = GenerateOP.doubleRandomMat(m, n, -3f, 3f, 778899);

            var rDest = new doubleN(m, Allocator.Temp);
            var cDest = new doubleN(n, Allocator.Temp);
        ...
        {
            var A = new doubleMxN(3, 1, Allocator.Temp);
            A[0, 0] = 2f;
            A[1, 0] = 7f;
            A[2, 0] = -4f;
        ...
        void CovarianceDiagEqualsVarianceSample()
        {
            ...
            var col0 = new doubleN(3, Allocator.Temp);
            col0[0] = A[0, 0]; col0[1] = A[1, 0]; col0[2] = A[2, 0];
            var col1 = new doubleN(3, Allocator.Temp);
        ...
        {
            var Apos = new doubleMxN(3, 2, Allocator.Temp);
            ...
            var Aneg = new doubleMxN(3, 2, Allocator.Temp);
    ...
    {
        var v = new doubleN(0, Allocator.Temp);
    ...
    public void EmptyMatrixStatisticsThrows()
    {
        ...
        var A = new doubleMxN(0, 3, Allocator.Temp);
    ...
    {
        var A = new doubleMxN(1, 2, Allocator.Temp);
        A[0, 0] = 1f; A[0, 1] = 2f;
    ...
    public void CovarianceCorrelationZeroColumnsThrows()
    {
        ...
        var A = new doubleMxN(3, 0, Allocator.Temp);
