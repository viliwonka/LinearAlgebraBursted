...
public class doubleLOBPCGSmokeTests
{
    ...
    public void PreconditionedConvergesInFewerIterationsThanUnpreconditioned()
    {
        ...
        var infoUnprecond = LOBPCG.lobpcg(in A, ref wsUnprecond, k, Consts.doubleSqrtEps, 500);

        var wsPrecond = arena.doubleLOBPCGCache(n, k);
        var infoPrecond = LOBPCG.lobpcg(in A, in M, ref wsPrecond, k, Consts.doubleSqrtEps, 500);
    ...
    public void RankDeficiencyStressDoesNotNaNOrDiverge()
    {
        ...
        var eig = LOBPCG.lobpcg(ref arena, in A, k, out var vecs, out var info, Consts.doubleSqrtEps, 300);
    ...
    public void GeneralizedLaplacianDiagBMatchesDenseReduction()
    {
        ...
        var info = LOBPCG.lobpcg(in A, in B, ref ws, k, Consts.doubleSqrtEps, 1000);
        Assert.IsTrue(info.Solved, info.ToString());
    ...
    public void BucklingMappingRecoversKnownCriticalLoadFromCongruentPencil()
    {
        ...
        int k = 2;
        var ws = arena.doubleLOBPCGCache(n, k);
        var info = LOBPCG.lobpcg(in Kg, in Ke, ref ws, k, Consts.doubleSqrtEps, 2000);
        Assert.IsTrue(info.Solved, info.ToString());
