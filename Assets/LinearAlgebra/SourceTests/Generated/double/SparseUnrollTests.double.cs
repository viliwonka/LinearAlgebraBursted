...
public class doubleSparseUnrollTests
{
    ...
    public struct SparseUnrollTestJob : IJob
    {
        ...
        void CheckSquareSpMV(int b, uint seedBase)
        {
            ...
            var x = GenerateOP.doubleRandomVec(A.N_Cols, (double)(-1f), (double)1f, seedBase + 900u);
        ...
        void CheckSquareSpMVT(int b, uint seedBase)
        {
            var A = BuildRandomSquare(b, seedBase);
            var dense = A.ToDense(Allocator.Temp);
            var xt = GenerateOP.doubleRandomVec(A.M_Rows, (double)(-1f), (double)1f, seedBase + 900u);
            ...
            var diff = new doubleN(in yt, Allocator.Temp);
            doubleComp.subInPlace(diff, ytRef);
            Assert.IsTrue(Analysis.isZero(diff, Tol()));

            var yt2 = BSR.spMVT(in A, in xt);
            var diff2 = new doubleN(in yt2, Allocator.Temp);
        ...
        void CheckRectangularSpMV()
        {
            ...
            builder.AddBlock(0, 0, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 71001));
            builder.AddBlock(0, 2, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 71002));
            builder.AddBlock(1, 1, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 71003));
            builder.AddBlock(2, 0, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 71004));
            var A = builder.ToBSR(Allocator.Temp);
            var dense = A.ToDense(Allocator.Temp);

            var x = GenerateOP.doubleRandomVec(A.N_Cols, (double)(-1f), (double)1f, 71100);
            var y = new doubleN(A.M_Rows, Allocator.Temp);
            BSR.spMV(in A, in x, ref y);
            var diff = new doubleN(in y, Allocator.Temp);
        ...
        void CheckRectangularSpMVT()
        {
            const int BR = 2, BC = 3;
            var builder = new doubleBSRBuilder(3, 3, BR, BC, Allocator.Temp);
            builder.AddBlock(0, 0, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 72001));
            builder.AddBlock(0, 2, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 72002));
            builder.AddBlock(1, 1, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 72003));
            builder.AddBlock(2, 0, GenerateOP.doubleRandomMat(BR, BC, (double)(-1f), (double)1f, 72004));
            var A = builder.ToBSR(Allocator.Temp);
            var dense = A.ToDense(Allocator.Temp);

            var xt = GenerateOP.doubleRandomVec(A.M_Rows, (double)(-1f), (double)1f, 72100);
            var yt = new doubleN(A.N_Cols, Allocator.Temp);
            BSR.spMVT(in A, in xt, ref yt);
