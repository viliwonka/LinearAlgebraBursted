...
public class doubleAMGSolverTests
{
    ...
    // constructing doubleAMGPreconditioner must throw. Runs on the managed thread (Assert.Throws)
    ...
    public void AsymmetricCyclePreconditionerThrows()
    {
        ...
        Assert.IsTrue(info.Solved);
        Assert.Throws<ArgumentException>(() => { var m = new doubleAMGPreconditioner(in amg); });
