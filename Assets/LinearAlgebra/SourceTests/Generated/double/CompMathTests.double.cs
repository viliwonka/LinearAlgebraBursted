...
// Tests for the doubleComp elementwise math surface (OP.Component.double.cs forwarding to
...
public class doubleCompMathTests
{
    ...
    public struct TestsJob : IJob
    {
        public enum TestType
        {
            ...
            // ---- matrix path (generic over IUnsafedoubleArray) ----
        ...
        private void AssertClose(double got, double expected)
        {
            double tol = IsDouble() ? (double)1e-11 : (double)1e-4;
        ...
        private void Unary(TestType k, ref Arena arena)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                switch (k)
                {
                    ...
                    case TestType.Acosh: expected = math.log(o + math.sqrt(o * o - (double)1)); break;
                    ...
                    case TestType.Exp10: expected = math.pow((double)10, o); break;
                    ...
                    case TestType.Relu: expected = o < (double)0 ? (double)0 : o; break;
                    default: throw new NotImplementedException();
                }
