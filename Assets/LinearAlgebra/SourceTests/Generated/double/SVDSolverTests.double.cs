...
public class doubleSVDSolverTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        public void PinvSquareFullRank()
        {
            ...
            var b = doubleOP.dot(A_copy, xOrig);
        ...
        public void PinvOverdeterminedResidual()
        {
            ...
            Assert.IsTrue(maxAbs < (double)1E-2f, $"||A^T(Ax-b)||inf = {maxAbs}");
        ...
        public void PinvRankDeficientMinNorm()
        {
            ...
            AssertClose(x[0], (double)0.25f, 1E-4f);
            AssertClose(x[1], (double)0.25f, 1E-4f);
        ...
        public void PseudoInverseSquareInvertible()
        {
            ...
            var prod = doubleOP.dot(A_copy, Aplus);
        ...
        public void PseudoInverseMoorePenrose()
        {
            ...
            var AplusA = doubleOP.dot(Aplus, A_copy);          // n x n
            var AplusAAplus = doubleOP.dot(AplusA, Aplus);     // n x m
