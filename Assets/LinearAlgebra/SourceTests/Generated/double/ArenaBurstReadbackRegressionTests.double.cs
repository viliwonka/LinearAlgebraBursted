// <auto-generated>
//   Generated from Assets/LinearAlgebra/CodeGen/TemplateSourceTests/fProxy/ArenaBurstReadbackRegressionTests.fProxy.cs
...
public class doubleArenaBurstReadbackRegressionTests
{
    ...
    public struct ChecksumJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            var A = arena.doubleRandomMat(M, N, (double)(-1f), (double)1f, SeedA);
            var B = arena.doubleRandomMat(S, M, (double)(-1f), (double)1f, SeedB);
            ...
            var ATB = arena.doubleMat(S, N);
            for (int j = 0; j < S; j++)
            {
                var bj = arena.doubleVec(M);
                for (int c = 0; c < M; c++) bj[c] = B[j, c];
                var atbj = arena.doubleVec(N);
