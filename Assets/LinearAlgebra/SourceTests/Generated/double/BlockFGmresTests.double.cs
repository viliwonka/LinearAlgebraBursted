...
public class doubleBlockFGmresTests
{
    ...
    public struct BlockFGmresTestJob : IJob
    {
        ...
        void KnownSolutionRecovered()
        {
            ...
            var Xk = GenerateOP.doubleRandomMat(s, n, (double)(-1f), (double)1f, 82002u, Allocator.Temp);   // known solution
        ...
        void MatchesScalarFgmresPerColumn()
        {
            ...
            var B = GenerateOP.doubleRandomMat(s, n, (double)(-1f), (double)1f, 81002u, Allocator.Temp);
        ...
        void IdentityFoldMatchesBgmresBitIdentical()
        {
            ...
            var B = GenerateOP.doubleRandomMat(s, n, (double)(-1f), (double)1f, 83002u, Allocator.Temp);
            ...
            var Xf = new doubleMxN(s, n, Allocator.Temp);
        ...
        void VariableInnerGmresConverges()
        {
            int n = 150, s = 3;
            var A = ConvDiff1D(n);
            var B = GenerateOP.doubleRandomMat(s, n, (double)(-1f), (double)1f, 84001u, Allocator.Temp);
        ...
        void RestartCorrectness()
        {
            ...
            var B = GenerateOP.doubleRandomMat(s, n, (double)(-1f), (double)1f, 85002u, Allocator.Temp);
