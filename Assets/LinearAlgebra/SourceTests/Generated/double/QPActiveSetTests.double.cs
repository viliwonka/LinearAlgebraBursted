...
public class doubleQPActiveSetTests
{
    ...
    public struct HS21Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = arena.doubleVec(2); x[0] = 5f; x[1] = 10f;
    ...
    public struct HS35Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = arena.doubleVec(3); x[0] = 0.5f; x[1] = 0.5f; x[2] = 0.5f;
    ...
    public struct HS52Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = arena.doubleVec(5);   // origin: all three equalities are homogeneous (RHS 0)
    ...
    public struct HS76Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = arena.doubleVec(4); for (int i = 0; i < 4; i++) x[i] = 0.5f;
    ...
    public struct LpLimitJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            var Q = arena.doubleMat(n, n);   // zero
            var xl = arena.doubleVec(n);
            var xu = arena.doubleVec(n); for (int i = 0; i < n; i++) xu[i] = 1e30f;
    ...
    public struct DegenerateJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            for (int i = 0; i < n; i++) c[i] = rng.NextDouble(-1f, 1f);
            var xl = arena.doubleVec(n);
            var xu = arena.doubleVec(n); for (int i = 0; i < n; i++) xu[i] = 5f;
            var x0 = arena.doubleVec(n); x0[0] = 2f; x0[1] = 2f; x0[2] = 2f;   // sum = 6, tight below

            // single copy
            var A1 = arena.doubleMat(1, n); A1[0, 0] = 1f; A1[0, 1] = 1f; A1[0, 2] = 1f;
            var b1 = arena.doubleVec(1); b1[0] = 6f;
            ...
            var b2 = arena.doubleVec(2); b2[0] = 6f; b2[1] = 6f;
    ...
    public struct UnboundedJob : IJob
    {
        ...
        {
            var arena = new Arena(Allocator.Persistent);
            var Q = arena.doubleMat(2, 2); Q[0, 0] = 1f; Q[1, 1] = 0f;
            var c = arena.doubleVec(2); c[1] = -1f;
            var A = arena.doubleMat(0, 2);
            var b = arena.doubleVec(0);
            var senses = new NativeArray<ConstraintSense>(0, Allocator.Temp);
            var xl = arena.doubleVec(2); xl[0] = -1e30f; xl[1] = 0f;
            var xu = arena.doubleVec(2); xu[0] = 1e30f; xu[1] = 1e30f;
            var x = arena.doubleVec(2);   // (0,0), feasible
