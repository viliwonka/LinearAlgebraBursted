...
// (TemplateSource/AssemblyInfo.cs), the same route QPEqpTests.double.cs uses for QP.eqpSolve.
//
...
// back on the managed side -- the exact pattern QPEqpTests.double.cs / LPTests.double.cs use.
//
// ---- Acceptance oracles ----
//
...
public class doubleQPActiveSetTests
{
    // ================================================================================================
    ...
    public struct HS21Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new doubleN(2, Allocator.Temp); x[0] = 5f; x[1] = 10f;
    ...
    public struct HS35Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new doubleN(3, Allocator.Temp); x[0] = 0.5f; x[1] = 0.5f; x[2] = 0.5f;
    ...
    public struct HS52Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new doubleN(5, Allocator.Temp);   // origin: all three equalities are homogeneous (RHS 0)
    ...
    public struct HS76Job : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x = new doubleN(4, Allocator.Temp); for (int i = 0; i < 4; i++) x[i] = 0.5f;
    ...
    public struct BruteForceJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            for (int i = 0; i < n; i++) { xl[i] = rng.NextDouble(-3f, -1f); xu[i] = rng.NextDouble(1f, 3f); }
            ...
            var xEq = new doubleN(n, Allocator.Temp, true);
            var Qcopy = new doubleMxN(n, n, Allocator.Temp, true);
            var rhs = new doubleN(n, Allocator.Temp, true);
            ...
            for (int combo = 0; combo < combos; combo++)
            {
                ...
                {
                    var AWv = new doubleMxN(k, n, Allocator.Temp);   // k x n, zero-init
                ...
                {
                    for (int i = 0; i < n; i++)
                        if ((double)xEq[i] < (double)xl[i] - 1e-9
                            || (double)xEq[i] > (double)xu[i] + 1e-9)
    ...
    public struct LpLimitJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            var x0 = new doubleN(n, Allocator.Temp);
            for (int i = 0; i < n; i++) x0[i] = rng.NextDouble(0f, 1f);
            var Ax0 = new doubleN(m, Allocator.Temp);
            Blas.dot(in A, in x0, ref Ax0);
            var b = new doubleN(m, Allocator.Temp);
            for (int i = 0; i < m; i++) b[i] = Ax0[i] + rng.NextDouble(0.1f, 1f);
            var c = new doubleN(n, Allocator.Temp);
            for (int i = 0; i < n; i++) c[i] = rng.NextDouble(-1f, 1f);
            var senses = new NativeArray<ConstraintSense>(m, Allocator.Temp);
            for (int i = 0; i < m; i++) senses[i] = ConstraintSense.LessEqual;

            var Q = new doubleMxN(n, n, Allocator.Temp);   // zero
            var xl = new doubleN(n, Allocator.Temp);
            var xu = new doubleN(n, Allocator.Temp); for (int i = 0; i < n; i++) xu[i] = 1e30f;

            var xQp = new doubleN(n, Allocator.Temp);
            ...
            var xLp = new doubleN(n, Allocator.Temp);
    ...
    public struct DegenerateJob : IJob
    {
        ...
        public void Execute()
        {
            ...
            for (int i = 0; i < n; i++) c[i] = rng.NextDouble(-1f, 1f);
            var xl = new doubleN(n, Allocator.Temp);
            var xu = new doubleN(n, Allocator.Temp); for (int i = 0; i < n; i++) xu[i] = 5f;
            var x0 = new doubleN(n, Allocator.Temp); x0[0] = 2f; x0[1] = 2f; x0[2] = 2f;   // sum = 6, tight below

            // single copy
            var A1 = new doubleMxN(1, n, Allocator.Temp); A1[0, 0] = 1f; A1[0, 1] = 1f; A1[0, 2] = 1f;
            var b1 = new doubleN(1, Allocator.Temp); b1[0] = 6f;
            var senses1 = new NativeArray<ConstraintSense>(1, Allocator.Temp); senses1[0] = ConstraintSense.LessEqual;
            var x1 = new doubleN(n, Allocator.Temp); x1[0] = x0[0]; x1[1] = x0[1]; x1[2] = x0[2];
            ...
            var A2 = new doubleMxN(2, n, Allocator.Temp);
            A2[0, 0] = 1f; A2[0, 1] = 1f; A2[0, 2] = 1f;
            A2[1, 0] = 1f; A2[1, 1] = 1f; A2[1, 2] = 1f;
            var b2 = new doubleN(2, Allocator.Temp); b2[0] = 6f; b2[1] = 6f;
            ...
            var x2 = new doubleN(n, Allocator.Temp); x2[0] = x0[0]; x2[1] = x0[1]; x2[2] = x0[2];
            ...
            for (int i = 0; i < n; i++)
                H.AssertLE(Fail, 4 + i, math.abs((double)x1[i] - (double)x2[i]), 1e-6);
    ...
    public struct UnboundedJob : IJob
    {
        ...
        public void Execute()
        {
            var Q = new doubleMxN(2, 2, Allocator.Temp); Q[0, 0] = 1f; Q[1, 1] = 0f;
            var c = new doubleN(2, Allocator.Temp); c[1] = -1f;
            var A = new doubleMxN(0, 2, Allocator.Temp);
            var b = new doubleN(0, Allocator.Temp);
            var senses = new NativeArray<ConstraintSense>(0, Allocator.Temp);
            var xl = new doubleN(2, Allocator.Temp); xl[0] = -1e30f; xl[1] = 0f;
            var xu = new doubleN(2, Allocator.Temp); xu[0] = 1e30f; xu[1] = 1e30f;
            var x = new doubleN(2, Allocator.Temp);   // (0,0), feasible
