...
// [BurstCompile] IJob with a TestType switch, mirroring BlockCGrQTests.double.cs's structure. Every
...
public class doubleBlockLSMRTests
{
    ...
    public struct BlockLSMRTestJob : IJob
    {
        ...
        void NormalEquationsOptimalAndMatchesScalarLsmr()
        {
            ...
            var info = Krylov.blsmr(in A, in B, ref X, 20 * n, Consts.doubleSqrtEps);
        ...
        void NeverNaNOnTinyMaxIter()
        {
            ...
            var X = arena.doubleMat(s, n);
            Krylov.blsmr(in A, in B, ref X, 1, Consts.doubleSqrtEps);
