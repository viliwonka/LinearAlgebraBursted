...
public class doubleTransformsTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void StandardizeVector()
        {
            ...
            AssertClose(Stats.mean(in v), (double)0f, (double)EPS);
            AssertClose(Stats.stdDev(in v), (double)1f, (double)EPS);
            arena.Dispose();
        }
        ...
        void StandardizeFlatMatrix()
        {
            ...
            AssertClose(Stats.mean(in A), (double)0f, (double)EPS);
            AssertClose(Stats.stdDev(in A), (double)1f, (double)EPS);
            arena.Dispose();
        }
        ...
        void RescaleConstant()
        {
            ...
            Stats.rescale(in v, (double)(-3f), (double)9f);
            for (int i = 0; i < 4; i++)
            {
        ...
        void RescaleForwardingEquals()
        {
            ...
            Stats.rescale(in a);
            Stats.rescale(in b, (double)0f, (double)1f);
            for (int i = 0; i < 5; i++)
        ...
        void MaxAbsVector()
        {
            ...
            AssertTrue(Norms.LInf(in v) <= (double)1f + (double)EPS);
            arena.Dispose();
        }
        ...
        void SoftmaxVector()
        {
            ...
            Stats.softmax(in v);
            AssertClose(Stats.sum(in v), (double)1f, (double)EPS);
            for (int i = 0; i < 5; i++)
        ...
        void SoftmaxFlatMatrixWhole()
        {
            ...
            AssertClose(Stats.sum(in A), (double)1f, (double)EPS);
        ...
        void ClampVector()
        {
            ...
            doubleComp.clampInPlace(v, (double)(-1f), (double)4f);
            AssertClose(v[0], (double)(-1f), (double)EPS);
            AssertClose(v[1], (double)(-1f), (double)EPS);
        ...
        void ClampMatrix()
        {
            ...
            doubleComp.clampInPlace(A, (double)0f, (double)1f);
    ...
    public void ClampLoGreaterThanHiThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => doubleComp.clampInPlace(v, (double)4f, (double)(-1f)));
        arena.Dispose();
    }
}
