...
public class doubleSparseSolverTests
{
    ...
    public struct SparseSolverTestJob : IJob
    {
        ...
        void JacobiPreconditionerReducesIterations()
        {
            ...
            Assert.IsTrue(Solvers.lsqr(in A, in b, ref xPlain, maxIter, tol, (double)0, out var infoPlain));
            ...
            Assert.IsTrue(Solvers.lsqr(op, in b, ref y, ref u, ref v, ref w, ref tmpM, ref tmpN, maxIter, tol, (double)0, out doubleLstsqInfo infoJac));
        ...
        void LstsqInfoStrangLineFitExact()
        {
            ...
            for (int which = 0; which < 3; which++)
            {
                ...
                bool ok;
                if (which == 0)      ok = Solvers.cgls(in A, in b, ref x, 50, tol, (double)0, out info);
                else if (which == 1) ok = Solvers.lsqr(in A, in b, ref x, 50, tol, (double)0, out info);
                else                 ok = Solvers.lsmr(in A, in b, ref x, 50, tol, (double)0, out info);
