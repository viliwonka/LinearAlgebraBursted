    ...
    public struct TestJob : IJob
    {
        ...
        public void LUDeterminant()
        {
            ...
            // identity -> det = 1
            {
                ...
                double det = Analysis.determinant(in I, in pivot);
            ...
            // diagonal -> det = product of diagonal
            {
                ...
                double det = Analysis.determinant(in D, in pivot);
            ...
            // A = [[0,2,1],[1,1,1],[2,1,0]]; det = 3 (hand computed, nonsingular).
            {
                ...
                double det = Analysis.determinant(in A, in pivot);
            ...
            // single transposition (rows 0 and 2 swapped) -> det = -1.
            {
                ...
                double det = Analysis.determinant(in P, in pivot);
        ...
        public void LUBlockedDecompInPlaceEquivalence()
        {
            ...
            int sizeBoundary    = 160;
            int sizePastBoundary = 161;
        ...
        void LUSolveInPlaceShortCircuitPurity()
        {
            ...
            if (info.status != DirectSolveStatus.Singular && Fail[0] == (double)0)
            {
                Fail[0] = (double)1; Fail[1] = (double)(int)info.status;
                Fail[2] = (double)(int)DirectSolveStatus.Singular; Fail[3] = (double)0;
            }
        ...
        void LUDecompSolveTransA()
        {
            ...
            if (!(eta < (double)1E-04f) && Fail[0] == (double)0)
            {
                Fail[0] = (double)1; Fail[1] = eta; Fail[2] = (double)1E-04f; Fail[3] = eta - (double)1E-04f;
            }
            Assert.IsTrue(eta < 1E-04f);
        ...
        {
            doubleMxN shouldBeZero = A - Blas.dot(L, U);
