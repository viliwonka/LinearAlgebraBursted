...
public class shortNormsTests
{
    ...
    public struct NormsTestJob : IJob
    {
        ...
        void PythagoreanTriple(ref Arena arena)
        {
            ...
            v[0] = (short)1; v[1] = (short)2; v[2] = (short)2;
            ...
            var w = arena.shortVec(2, (short)1);
        ...
        {
            var A = arena.shortMat(2, 2, (short)0);
        ...
        // ABS-OVERFLOW EDGE: single element == short.MinValue. The kernel widens each element to
        ...
        //     WRONG answer; see NormsOP.short.cs's LInf doc comment), so it also surfaces ->
        ...
        void MinValueAbsOverflow(ref Arena arena)
        {
            ...
            v[0] = (short)short.MinValue;

            long expectedL1 = 32768L;
            long expectedLInf = 32768L;

            Assert.IsTrue(Norms.L1(in v) == expectedL1);
            Assert.IsTrue(Norms.LInf(in v) == expectedLInf);
        }

        // MIXED-INPUT contrast (see NormsOP.short.cs's L1/LInf doc comments for the full
