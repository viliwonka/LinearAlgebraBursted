...
public class shortQueryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void KNearestBruteForce()
        {
            ...
            int M = 6, N = 3;
            var A = arena.shortRandomMat(M, N, (short)(-3), (short)4, 424242);
        ...
        void KFarthest()
        {
            ...
            int M = 5, N = 2;
            var A = arena.shortRandomMat(M, N, (short)(-2), (short)3, 99887);
            var q = arena.shortVec(N);
        ...
        void ArenaWrappers()
        {
            ...
            int M = 6, N = 4;
            var A = arena.shortRandomMat(M, N, (short)(-2), (short)3, 7777);
            var q = arena.shortVec(N);
