...
// Tests for the integer uniform-refill core (shortRandom_OP.nextUniformInpl), expanded to
...
public class shortRandomTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void RangeVector()
        {
            ...
            shortRandom_OP.nextUniformInpl(ref rng, ref v, min, max);
        ...
        void ConstantFillNoAdvance()
        {
            ...
            shortRandom_OP.nextUniformInpl(ref rng, ref v, c, c);
        ...
        void Determinism()
        {
            ...
            shortRandom_OP.nextUniformInpl(ref r1, ref v1, min, max);

            var r2 = new Random(55u);
            var v2 = arena.shortVec(256);
            shortRandom_OP.nextUniformInpl(ref r2, ref v2, min, max);
        ...
        void StreamAdvance()
        {
            ...
            shortRandom_OP.nextUniformInpl(ref rng, ref v1, min, max);
            var v2 = arena.shortVec(n);
            shortRandom_OP.nextUniformInpl(ref rng, ref v2, min, max);
            ...
            shortRandom_OP.nextUniformInpl(ref rng3, ref v3, min, max);
            for (int i = 0; i < n; i++)
        ...
        void EmptyAndSingle()
        {
            ...
            shortRandom_OP.nextUniformInpl(ref rng, ref empty, (short)(-2), (short)2);
            AssertTrue(empty.N == 0);

            short min = (short)5, max = (short)6;   // {5}
            var one = arena.shortVec(1);
            shortRandom_OP.nextUniformInpl(ref rng, ref one, min, max);
            AssertTrue(one.N == 1);
        ...
        void MatrixRange()
        {
            ...
            shortRandom_OP.nextUniformInpl(ref rng, ref M, min, max);
        ...
        void MatrixConstant()
        {
            ...
            uint before = rng.state;
            shortRandom_OP.nextUniformInpl(ref rng, ref M, c, c);
            uint after = rng.state;
    ...
    public void NextUniformInplMinGreaterMaxThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => shortRandom_OP.nextUniformInpl(ref rng, ref v, (short)5, (short)1));

        var M = arena.shortMat(3, 3);
        Assert.Throws<ArgumentException>(() => shortRandom_OP.nextUniformInpl(ref rng, ref M, (short)5, (short)1));
