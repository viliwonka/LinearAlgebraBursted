...
public class shortAnalysisTests
{
    ...
    public struct AnalysisTestJob : IJob
    {
        ...
        void ZeroVector()
        {
            var v = GenerateOP.shortVec(5, (short)0);
        ...
        void ZeroMatrix()
        {
            var A = GenerateOP.shortMat(3, 3, (short)0);
        ...
        void Identity()
        {
            var A = GenerateOP.shortIdentityMat(4);
        ...
        void IdentityNegatives()
        {
            ...
            var B = GenerateOP.shortIdentityMat(4);
        ...
        void NonSquare()
        {
            var A = GenerateOP.shortMat(2, 3, (short)0);
            ...
            var Z = GenerateOP.shortMat(2, 3, (short)0);
