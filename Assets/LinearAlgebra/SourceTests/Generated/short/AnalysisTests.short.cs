...
public class shortAnalysisTests
{
    ...
    public struct AnalysisTestJob : IJob
    {
        ...
        {
            var A = arena.shortMat(3, 3, (short)0);
        ...
        {
            var A = arena.shortIdentityMat(4);
        ...
        {
            var A = arena.shortIdentityMat(4);
            A[0, 1] = (short)1; // exactly one off-diagonal entry
            Assert.IsFalse(Analysis.isIdentity(in A));
            Assert.IsFalse(Analysis.isDiagonal(in A));
            Assert.IsFalse(Analysis.isSymmetric(in A)); // A[0,1]=1 but A[1,0]=0

            var B = arena.shortIdentityMat(4);
            B[2, 2] = (short)5; // diagonal value != 1
        ...
        void Symmetric(ref Arena arena)
        {
            ...
            A[1, 0] = (short)2; A[1, 1] = (short)4; A[1, 2] = (short)5;
            A[2, 0] = (short)3; A[2, 1] = (short)5; A[2, 2] = (short)6;

            Assert.IsTrue(Analysis.isSymmetric(in A));
            Assert.IsFalse(Analysis.isDiagonal(in A)); // has off-diagonal nonzeros
            Assert.IsFalse(Analysis.isIdentity(in A));

            A[0, 1] = (short)9; // now A[0,1]=9 != A[1,0]=2
        ...
        {
            var A = arena.shortMat(3, 3, (short)0);
            A[0, 0] = (short)1; A[1, 1] = (short)2; A[2, 2] = (short)3;
        ...
        void UpperTriangular(ref Arena arena)
        {
            ...
            A[1, 0] = (short)7; // exactly one below-diagonal entry
        ...
        void LowerTriangular(ref Arena arena)
        {
            var A = arena.shortMat(3, 3, (short)0);
            A[0, 0] = (short)1;
            A[1, 0] = (short)2; A[1, 1] = (short)3;
            A[2, 0] = (short)4; A[2, 1] = (short)5; A[2, 2] = (short)6;

            Assert.IsTrue(Analysis.isLowerTriangular(in A));
            Assert.IsFalse(Analysis.isUpperTriangular(in A));
            Assert.IsFalse(Analysis.isDiagonal(in A));

            A[0, 2] = (short)7; // exactly one above-diagonal entry
            Assert.IsFalse(Analysis.isLowerTriangular(in A));
        }
        ...
        {
            var A = arena.shortMat(2, 3, (short)0);
            A[0, 0] = (short)1; A[1, 1] = (short)1; // identity-looking leading block
            ...
            var Z = arena.shortMat(2, 3, (short)0);
