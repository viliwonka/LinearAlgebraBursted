...
public class longStatsTests
{
    ...
    public struct StatsTestJob : IJob
    {
        ...
        void SumVector()
        {
            ...
            var w = new longN(3, Allocator.Temp);
        ...
        void MeanFractional()
        {
            var v = new longN(2, Allocator.Temp);
        ...
        {
            var v = new longN(1, Allocator.Temp);
            v[0] = (long)3;
        ...
        void AllEqual()
        {
            var v = GenerateOP.longVec(3, (long)7);
        ...
        {
            int n = 1;
            var v = GenerateOP.longVec(n, (long)long.MaxValue);
        ...
        {
            var v = GenerateOP.longVec(2, (long)long.MaxValue);
    ...
    {
        var v = new longN(0, Allocator.Temp);
    ...
    public void EmptyMatrixReductionsThrow()
    {
        ...
        var A = new longMxN(0, 3, Allocator.Temp);
