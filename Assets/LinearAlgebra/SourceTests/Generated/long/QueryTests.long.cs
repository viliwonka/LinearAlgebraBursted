...
public class longQueryTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        {
            var v = new longN(6, Allocator.Temp);
            ...
            var one = new longN(1, Allocator.Temp);
            one[0] = (long)(-7);
        ...
        {
            var A = new longMxN(2, 3, Allocator.Temp);
            // row 0: 1 -3  2
        ...
        void RowColArgMinMax()
        {
            ...
            var A = new longMxN(3, 3, Allocator.Temp);
            ...
            var valR = new longN(3, Allocator.Temp);
            ...
            var valC = new longN(3, Allocator.Temp);
        ...
        void ColArgStrided()
        {
            ...
            var A = new longMxN(4, 2, Allocator.Temp);
            ...
            var valC = new longN(2, Allocator.Temp);
        ...
        void ArgMaxRowNorm()
        {
            ...
            var T = new longMxN(2, 2, Allocator.Temp);
        ...
        void DistancesToRowAllMetrics()
        {
            ...
            var q = new longN(2, Allocator.Temp);
            q[0] = (long)0; q[1] = (long)0;

            var d = new longN(2, Allocator.Temp);
            ...
            var q2 = new longN(2, Allocator.Temp);
        ...
        void NearestFarthestDistance()
        {
            ...
            var A = new longMxN(3, 2, Allocator.Temp);
        ...
        void NearestFarthestSimilarity()
        {
            ...
            var q3 = new longN(3, Allocator.Temp);
        ...
        void KNearestBruteForce()
        {
            ...
            int M = 6, N = 3;
            var A = GenerateOP.longRandomMat(M, N, (long)(-3), (long)4, 424242);
            var q = new longN(N, Allocator.Temp);
            q[0] = (long)1; q[1] = (long)(-2); q[2] = (long)2;

            int k = 3;
            var idx = new Indices(k, Allocator.Temp);
            var scores = new longN(k, Allocator.Temp);
            ...
            var all = new longN(M, Allocator.Temp);
            ...
            var scores2 = new longN(k, Allocator.Temp);
            int cnt2 = Query.kNearestRows(in A, in q, k, Metric.Dot, ref idx2, ref scores2);
            AssertEqI(cnt2, k);
            var allDot = new longN(M, Allocator.Temp);
        ...
        {
            int M = 3, N = 2;
            var A = new longMxN(M, N, Allocator.Temp);
        ...
        {
            int M = 5, N = 2;
            var A = GenerateOP.longRandomMat(M, N, (long)(-2), (long)3, 99887);
            var q = new longN(N, Allocator.Temp);
        ...
        void WithinRadiusBoundary()
        {
            ...
            var qcol = new longN(3, Allocator.Temp);
        ...
        void FindValue()
        {
            var v = new longN(5, Allocator.Temp);
        ...
        void ArenaWrappers()
        {
            ...
            int M = 6, N = 4;
            var A = GenerateOP.longRandomMat(M, N, (long)(-2), (long)3, 7777);
            var q = new longN(N, Allocator.Temp);
            for (int i = 0; i < N; i++) q[i] = (long)(i - 2);

            // --- longDistancesToRow / Column wrappers vs primitive ---
            var dr = Query.longDistancesToRow(in A, in q, Metric.SqEuclidean);
            var drRef = new longN(M, Allocator.Temp);
            ...
            var qc = new longN(M, Allocator.Temp);
            for (int i = 0; i < M; i++) qc[i] = (long)(i - 3);
            var dcol = Query.longDistancesToColumn(in A, in qc, Metric.SqEuclidean);
            var dcolRef = new longN(N, Allocator.Temp);
            ...
            var idxNz = Query.longNonzeroIndices(in A, (long)0);
            ...
            long radius = (long)20;
            var idxRR = Query.longRowsWithinRadius(in A, in q, radius, Metric.SqEuclidean);
            ...
            var idxCR = Query.longColumnsWithinRadius(in A, in qc, (long)40, Metric.SqEuclidean);
            ...
            int k = 3;
            var idxK = Query.longKNearestRows(in A, in q, k, Metric.SqEuclidean, out longN scoresK, out int cntK);
            var refIdxK = new Indices(k, Allocator.Temp);
            var refScoresK = new longN(k, Allocator.Temp);
            ...
            // --- longKNearestColumns ---
            var idxKC = Query.longKNearestColumns(in A, in qc, k, Metric.SqEuclidean, out longN scoresKC, out int cntKC);
            var refIdxKC = new Indices(k, Allocator.Temp);
            var refScoresKC = new longN(k, Allocator.Temp);
            ...
            var idxKF = Query.longKFarthestRows(in A, in q, k, Metric.SqEuclidean, out longN scoresKF, out int cntKF);
            var refIdxKF = new Indices(k, Allocator.Temp);
            var refScoresKF = new longN(k, Allocator.Temp);
            ...
            var idxKFC = Query.longKFarthestColumns(in A, in qc, k, Metric.SqEuclidean, out longN scoresKFC, out int cntKFC);
            var refIdxKFC = new Indices(k, Allocator.Temp);
            var refScoresKFC = new longN(k, Allocator.Temp);
    ...
    public void MetricEuclideanCosineThrowTest()
    {
        ...
        var q = new longN(2, Allocator.Temp);
        q[0] = (long)0; q[1] = (long)0;
        var dest = new longN(3, Allocator.Temp);
        var idx = new Indices(3, Allocator.Temp);
        var scores = new longN(2, Allocator.Temp);
    ...
    {
        var A = new longMxN(3, 4, Allocator.Temp);            // row ops need q.N == N_Cols == 4; col ops need q.N == M_Rows == 3
        var qBadRow = new longN(3, Allocator.Temp);         // wrong for row ops
        var destRow = new longN(3, Allocator.Temp);
        Assert.Throws<ArgumentException>(() =>
        ...
        var qBadCol = new longN(4, Allocator.Temp);         // wrong for col ops
        var destCol = new longN(4, Allocator.Temp);
        Assert.Throws<ArgumentException>(() =>
