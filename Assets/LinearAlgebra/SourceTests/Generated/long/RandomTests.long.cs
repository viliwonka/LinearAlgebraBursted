...
public class longRandomTests
{
    ...
    public struct TestJob : IJob
    {
        ...
        void EmptyAndSingle()
        {
            ...
            Rand.nextUniformInpl(ref rng, ref empty, (long)(-2), (long)2);
    ...
    public void NextUniformInplMinGreaterMaxThrows()
    {
        ...
        Assert.Throws<ArgumentException>(() => Rand.nextUniformInpl(ref rng, ref v, (long)5, (long)1));

        var M = arena.longMat(3, 3);
        Assert.Throws<ArgumentException>(() => Rand.nextUniformInpl(ref rng, ref M, (long)5, (long)1));
