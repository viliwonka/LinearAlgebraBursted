...
namespace LinearAlgebra.Benchmarks
{
    ...
    [BurstCompile(CompileSynchronously = true, FloatPrecision = FloatPrecision.High, FloatMode = FloatMode.Default)]
    public struct CgTolJobDouble : IJob
    {
        public doubleBSR A;
        public doubleN b, x, r, p, Ap;
        public int K;
    ...
    [BurstCompile(CompileSynchronously = true, FloatPrecision = FloatPrecision.High, FloatMode = FloatMode.Default)]
    public struct PcgSchwarzTolJobDouble : IJob
    {
        public doubleBSR A;
    ...
    [BurstCompile(CompileSynchronously = true, FloatPrecision = FloatPrecision.High, FloatMode = FloatMode.Default)]
    public struct PcgChebyshevTolJobDouble : IJob
    {
        public doubleBSR A;
    ...
    [BurstCompile(CompileSynchronously = true, FloatPrecision = FloatPrecision.High, FloatMode = FloatMode.Default)]
    public struct PcgFSAITolJobDouble : IJob
    {
        public doubleBSR A;
        public doubleFSAI M;
        public doubleN b, x, r, p, Ap, z;
    ...
    [BurstCompile(CompileSynchronously = true, FloatPrecision = FloatPrecision.High, FloatMode = FloatMode.Default)]
    public struct PcgAMGTolJobDouble : IJob
    {
        public doubleBSR A;
        public doubleAMGPreconditioner M;
        public doubleN b, x, r, p, Ap, z;
        public int K;
        public double Tol;
        public Indices Iters;
    ...
    [BurstCompile(CompileSynchronously = true, FloatPrecision = FloatPrecision.High, FloatMode = FloatMode.Default)]
    public struct FcgAMGKTolJobDouble : IJob
    {
        public doubleBSR A;
        public doubleAMGPreconditioner M;
        public doubleN b, x, r, p, Ap, z, rOld;
        public int K;
        public double Tol;
        public Indices Iters;
    ...
    public static partial class PCGBenchmark
    {
        ...
        static string BenchPrecondDouble(int gridX, int gridY)
            => BenchPrecondCoreDouble(gridX, gridY, 0, 0);

        static string BenchPrecondRandomDouble(int nb, int bs, float density, uint seed)
            => BenchPrecondCoreDouble(nb, bs, 1, density, seed);

        static string BenchPrecondScalarPoissonDouble(int gridX, int gridY)
            => BenchPrecondCoreDouble(gridX, gridY, 2, 0);
        ...
        static string BenchPrecondCoreDouble(int p1, int p2, int kind, float density, uint seed = 0)
        {
            ...
            sb.AppendLine(string.Format(System.Globalization.CultureInfo.InvariantCulture, fmt,
                "double", n, "PCG-FSAI", fStat.Median, fStat.Min, iters[0], Residual(in A, in x, in b)));
            ...
            sb.AppendLine(string.Format(System.Globalization.CultureInfo.InvariantCulture, fmt,
                "double", n, "PCG-AMG-V", aStat.Median, aStat.Min, iters[0], Residual(in A, in x, in b)));
            ...
            sb.Append(string.Format(System.Globalization.CultureInfo.InvariantCulture, fmt,
                "double", n, "FCG-AMG-K", akStat.Median, akStat.Min, iters[0], Residual(in A, in x, in b)));
