...
namespace LinearAlgebra.Benchmarks
{
    ...
    public static partial class LOBPCGBenchmark
    {
        ...
        static string BenchSparsePrecondFloat(bool laplacian, int p1, int p2, float density, uint seed, int k)
        {
            ...
            var A = laplacian ? floatGallery.floatLaplacian2D(p1, p2, Allocator.Persistent)
                              : floatGallery.floatRandomSparseSPD(p1, p2, (float)density, seed, Allocator.Persistent);
            int n = A.M_Rows;
