...
namespace LinearAlgebraDemos
{
    ...
    /// servo thruster's force stays in a forward-up plane, so the rig has no lateral force authority
    /// at all and there is nothing to allocate along hull x.
    /// </summary>
    public struct HoverWrench
    {
    ...
    public struct ThrusterSettings
    {
        ...
        public static ThrusterSettings Default => new ThrusterSettings
        {
            maxThrust = 12000f,
            minThrust = 300f,
            servoMinDeg = -55f,
    ...
    /// (<see cref="ThrusterAllocation.BuildRig"/>).
    /// </summary>
    public struct ThrusterRig
    {
    ...
    /// <summary>
    /// Control allocation for four servo thrusters: choose 4 servo angles and 4 throttles whose
    /// combined wrench matches a demanded <see cref="HoverWrench"/>, under the rig's angle range,
    ...
    /// </summary>
    public static class ThrusterAllocation
    {
        ...
        /// <summary>Throttle of thruster i, fraction of <see cref="ThrusterRig.MaxThrust"/>.</summary>
        ...
        /// </summary>
        public static HoverWrench Wrench(in ThrusterRig rig, in floatN z)
        {
            float4 mx = rig.MountX, my = rig.MountY, mz = rig.MountZ, health = rig.Health;

            var w = new HoverWrench();
        ...
        /// </summary>
        public static void ScaledJacobian(in ThrusterRig rig, in floatN z, ref floatMxN A)
        {
            float4 mx = rig.MountX, my = rig.MountY, mz = rig.MountZ, health = rig.Health;
        ...
        /// </summary>
        public static ThrusterRig BuildRig(in ThrusterSettings s,
        ...
        /// </summary>
        public static QPInfo Solve(in ThrusterRig rig, in HoverWrench desired, ref floatN z, int maxIter)
        {
            ...
            HoverWrench w0 = Wrench(in rig, in z);
        ...
        public static void ClampToRanges(in ThrusterRig rig, ref floatN z)
        {
