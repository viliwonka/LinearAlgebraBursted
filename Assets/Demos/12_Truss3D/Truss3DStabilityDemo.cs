    ...
    public class Truss3DStabilityDemo : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            if (built && lambda.IsCreated)
            {
                ...
                // Two signs mark a mechanism instead: (1) lambda0 at the float noise floor (a singular
                ...
                // x0|| / ||A x0|| near 1 (a near-null mode the solver cannot pin). Together they are
                // robust to tower height and to HOW MANY null modes exist.
