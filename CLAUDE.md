...
`Assets/LinearAlgebra/Source/` (the UPM package root) is 100% codegen OUTPUT — every .cs in it
carries an `<auto-generated>` banner; only package.json and the asmdef are hand-placed. Never
hand-edit generated files (there or in `SourceTests/Generated`, `Benchmarks/Generated`) — edit
the template and regenerate (`Tools/regen.ps1`). Tests and compilation run headlessly via
`Tools/*.ps1`.
